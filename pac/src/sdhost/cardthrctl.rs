...
pub type CardclrintenR = crate::BitReader;
...
pub type CardclrintenW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CardwrthrenR = crate::BitReader;
...
pub type CardwrthrenW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CardthresholdR = crate::FieldReader<u16>;
...
pub type CardthresholdW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ...
    #[inline(always)]
    pub fn cardclrinten(&self) -> CardclrintenR {
        CardclrintenR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Applicable when HS400 mode is enabled. 1'b0-Card write Threshold disabled. 1'b1-Card write Threshold enabled."]
    #[inline(always)]
    pub fn cardwrthren(&self) -> CardwrthrenR {
        CardwrthrenR::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    pub fn cardthreshold(&self) -> CardthresholdR {
        CardthresholdR::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bit 0 - Card read threshold enable. 1'b0-Card read threshold disabled. 1'b1-Card read threshold enabled."]
    #[inline(always)]
    pub fn cardrdthren(&mut self) -> CardrdthrenW<'_, CardthrctlSpec> {
        CardrdthrenW::new(self, 0)
    }
    #[doc = "Bit 1 - Busy clear interrupt generation: 1'b0-Busy clear interrypt disabled. 1'b1-Busy clear interrypt enabled."]
    #[inline(always)]
    pub fn cardclrinten(&mut self) -> CardclrintenW<'_, CardthrctlSpec> {
        CardclrintenW::new(self, 1)
    }
    #[doc = "Bit 2 - Applicable when HS400 mode is enabled. 1'b0-Card write Threshold disabled. 1'b1-Card write Threshold enabled."]
    #[inline(always)]
    pub fn cardwrthren(&mut self) -> CardwrthrenW<'_, CardthrctlSpec> {
        CardwrthrenW::new(self, 2)
    }
    #[doc = "Bits 16:31 - The inside FIFO size is 512,This register is applicable when SDHOST_CARDERTHREN_REG is set to 1 or SDHOST_CARDRDTHREN_REG set to 1."]
    #[inline(always)]
    pub fn cardthreshold(&mut self) -> CardthresholdW<'_, CardthrctlSpec> {

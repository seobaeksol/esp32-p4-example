...
pub struct BuffifoSpec;
impl crate::RegisterSpec for BuffifoSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`buffifo::R`](R) reader structure"]
impl crate::Readable for BuffifoSpec {}
#[doc = "`write(|w| ..)` method takes [`buffifo::W`](W) writer structure"]
impl crate::Writable for BuffifoSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BUFFIFO to value 0"]
impl crate::Resettable for BuffifoSpec {}

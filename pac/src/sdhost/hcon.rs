...
pub type CardTypeR = crate::BitReader;
#[doc = "Field `CARD_NUM` reader - Support card number is 2."]
pub type CardNumR = crate::FieldReader;
#[doc = "Field `BUS_TYPE` reader - Register config is APB bus."]
pub type BusTypeR = crate::BitReader;
...
pub type DmaWidthR = crate::FieldReader;
#[doc = "Field `RAM_INDISE` reader - Inside RAM in SDMMC module."]
pub type RamIndiseR = crate::BitReader;
...
pub type NumClkDivR = crate::FieldReader;
impl R {
    #[doc = "Bit 0 - Hardware support SDIO and MMC."]
    #[inline(always)]
    pub fn card_type(&self) -> CardTypeR {
        CardTypeR::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 1:5 - Support card number is 2."]
    #[inline(always)]
    pub fn card_num(&self) -> CardNumR {
        CardNumR::new(((self.bits >> 1) & 0x1f) as u8)
    }
    #[doc = "Bit 6 - Register config is APB bus."]
    #[inline(always)]
    pub fn bus_type(&self) -> BusTypeR {
        BusTypeR::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bits 7:9 - Regisger data widht is 32."]
    #[inline(always)]
    pub fn data_width(&self) -> DataWidthR {
        DataWidthR::new(((self.bits >> 7) & 7) as u8)
    }
    #[doc = "Bits 10:15 - Register address width is 32."]
    #[inline(always)]
    pub fn addr_width(&self) -> AddrWidthR {
        AddrWidthR::new(((self.bits >> 10) & 0x3f) as u8)
    }
    #[doc = "Bits 18:20 - DMA data witdth is 32."]
    #[inline(always)]
    pub fn dma_width(&self) -> DmaWidthR {
        DmaWidthR::new(((self.bits >> 18) & 7) as u8)
    }
    #[doc = "Bit 21 - Inside RAM in SDMMC module."]
    #[inline(always)]
    pub fn ram_indise(&self) -> RamIndiseR {
        RamIndiseR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - Have a hold regiser in data path ."]
    #[inline(always)]
    pub fn hold(&self) -> HoldR {
        HoldR::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bits 24:25 - Have 4 clk divider in design ."]
    #[inline(always)]
    pub fn num_clk_div(&self) -> NumClkDivR {
        NumClkDivR::new(((self.bits >> 24) & 3) as u8)
    }
}

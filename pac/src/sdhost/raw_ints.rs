...
pub type R = crate::R<RawIntsSpec>;
#[doc = "Field `RAW_INTS` reader - It indicates raw ints."]
pub type RawIntsR = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - It indicates raw ints."]
    #[inline(always)]
    pub fn raw_ints(&self) -> RawIntsR {
        RawIntsR::new(self.bits)
    }
}
...
pub struct RawIntsSpec;
impl crate::RegisterSpec for RawIntsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`raw_ints::R`](R) reader structure"]
impl crate::Readable for RawIntsSpec {}
#[doc = "`reset()` method sets RAW_INTS to value 0"]
impl crate::Resettable for RawIntsSpec {}

...
pub type CardWidth4R = crate::FieldReader;
...
pub type CardWidth4W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type CardWidth8R = crate::FieldReader;
...
pub type CardWidth8W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ...
    #[inline(always)]
    pub fn card_width4(&self) -> CardWidth4R {
        CardWidth4R::new((self.bits & 3) as u8)
    }
    ...
    #[inline(always)]
    pub fn card_width8(&self) -> CardWidth8R {
        CardWidth8R::new(((self.bits >> 16) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - One bit per card indicates if card is 1-bit or 4-bit mode. 0: 1-bit mode; 1: 4-bit mode. Bit\\[1:0\\] correspond to card\\[1:0\\] respectively."]
    #[inline(always)]
    pub fn card_width4(&mut self) -> CardWidth4W<'_, CtypeSpec> {
        CardWidth4W::new(self, 0)
    }
    #[doc = "Bits 16:17 - One bit per card indicates if card is in 8-bit mode. 0: Non 8-bit mode; 1: 8-bit mode. Bit\\[17:16\\] correspond to card\\[1:0\\] respectively."]
    #[inline(always)]
    pub fn card_width8(&mut self) -> CardWidth8W<'_, CtypeSpec> {

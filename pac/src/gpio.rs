...
pub struct RegisterBlock {
    ...
    _reserved7: [u8; 0x04],
    enable: Enable,
    enable_w1ts: EnableW1ts,
    enable_w1tc: EnableW1tc,
    enable1: Enable1,
    enable1_w1ts: Enable1W1ts,
    enable1_w1tc: Enable1W1tc,
    strap: Strap,
    in_: In,
    in1: In1,
    status: Status,
    status_w1ts: StatusW1ts,
    status_w1tc: StatusW1tc,
    status1: Status1,
    status1_w1ts: Status1W1ts,
    status1_w1tc: Status1W1tc,
    intr_0: Intr0,
    intr1_0: Intr1_0,
    intr_1: Intr1,
    intr1_1: Intr1_1,
    status_next: StatusNext,
    status_next1: StatusNext1,
    pin: [Pin; 57],
    _reserved29: [u8; 0x04],
    func_in_sel_cfg: [FuncInSelCfg; 255],
    func_out_sel_cfg: [FuncOutSelCfg; 57],
    intr_2: Intr2,
    intr1_2: Intr1_2,
    intr_3: Intr3,
    intr1_3: Intr1_3,
    ...
    int_ena: IntEna,
    int_clr: IntClr,
    zero_det0_filter_cnt: ZeroDet0FilterCnt,
    zero_det1_filter_cnt: ZeroDet1FilterCnt,
    send_seq: SendSeq,
    recive_seq: ReciveSeq,
    bistin_sel: BistinSel,
    bist_ctrl: BistCtrl,
    _reserved46: [u8; 0xd4],
    date: Date,
}
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn bt_select(&self) -> &BtSelect {
        &self.bt_select
    }
    ...
    #[inline(always)]
    pub const fn out_w1ts(&self) -> &OutW1ts {
        &self.out_w1ts
    }
    #[doc = "0x0c - GPIO output clear register for GPIO0-31"]
    #[inline(always)]
    pub const fn out_w1tc(&self) -> &OutW1tc {
        &self.out_w1tc
    }
    ...
    #[inline(always)]
    pub const fn out1_w1ts(&self) -> &Out1W1ts {
        &self.out1_w1ts
    }
    #[doc = "0x18 - GPIO output clear register for GPIO32-56"]
    #[inline(always)]
    pub const fn out1_w1tc(&self) -> &Out1W1tc {
        &self.out1_w1tc
    }
    ...
    #[inline(always)]
    pub const fn enable_w1ts(&self) -> &EnableW1ts {
        &self.enable_w1ts
    }
    #[doc = "0x28 - GPIO output enable clear register for GPIO0-31"]
    #[inline(always)]
    pub const fn enable_w1tc(&self) -> &EnableW1tc {
        &self.enable_w1tc
    }
    ...
    #[inline(always)]
    pub const fn enable1_w1ts(&self) -> &Enable1W1ts {
        &self.enable1_w1ts
    }
    #[doc = "0x34 - GPIO output enable clear register for GPIO32-56"]
    #[inline(always)]
    pub const fn enable1_w1tc(&self) -> &Enable1W1tc {
        &self.enable1_w1tc
    }
    ...
    #[inline(always)]
    pub const fn status_w1ts(&self) -> &StatusW1ts {
        &self.status_w1ts
    }
    #[doc = "0x4c - GPIO interrupt status clear register for GPIO0-31"]
    #[inline(always)]
    pub const fn status_w1tc(&self) -> &StatusW1tc {
        &self.status_w1tc
    }
    ...
    #[inline(always)]
    pub const fn status1_w1ts(&self) -> &Status1W1ts {
        &self.status1_w1ts
    }
    #[doc = "0x58 - GPIO interrupt status clear register for GPIO32-56"]
    #[inline(always)]
    pub const fn status1_w1tc(&self) -> &Status1W1tc {
        &self.status1_w1tc
    }
    #[doc = "0x5c - GPIO interrupt 0 status register for GPIO0-31"]
    #[inline(always)]
    pub const fn intr_0(&self) -> &Intr0 {
        &self.intr_0
    }
    ...
    #[inline(always)]
    pub const fn intr_1(&self) -> &Intr1 {
        &self.intr_1
    }
    ...
    #[inline(always)]
    pub const fn status_next(&self) -> &StatusNext {
        &self.status_next
    }
    #[doc = "0x70 - GPIO interrupt source register for GPIO32-56"]
    #[inline(always)]
    pub const fn status_next1(&self) -> &StatusNext1 {
        &self.status_next1
    }
    ...
    #[inline(always)]
    pub const fn intr_3(&self) -> &Intr3 {
        &self.intr_3
    }
...
#[doc(alias = "BT_SELECT")]
pub type BtSelect = crate::Reg<bt_select::BtSelectSpec>;
...
#[doc(alias = "OUT_W1TS")]
pub type OutW1ts = crate::Reg<out_w1ts::OutW1tsSpec>;
...
#[doc(alias = "OUT_W1TC")]
pub type OutW1tc = crate::Reg<out_w1tc::OutW1tcSpec>;
...
#[doc(alias = "OUT1_W1TS")]
pub type Out1W1ts = crate::Reg<out1_w1ts::Out1W1tsSpec>;
...
#[doc(alias = "OUT1_W1TC")]
pub type Out1W1tc = crate::Reg<out1_w1tc::Out1W1tcSpec>;
...
#[doc(alias = "ENABLE_W1TS")]
pub type EnableW1ts = crate::Reg<enable_w1ts::EnableW1tsSpec>;
...
#[doc(alias = "ENABLE_W1TC")]
pub type EnableW1tc = crate::Reg<enable_w1tc::EnableW1tcSpec>;
...
#[doc(alias = "ENABLE1")]
pub type Enable1 = crate::Reg<enable1::Enable1Spec>;
...
#[doc(alias = "ENABLE1_W1TS")]
pub type Enable1W1ts = crate::Reg<enable1_w1ts::Enable1W1tsSpec>;
...
#[doc(alias = "ENABLE1_W1TC")]
pub type Enable1W1tc = crate::Reg<enable1_w1tc::Enable1W1tcSpec>;
...
#[doc(alias = "STRAP")]
pub type Strap = crate::Reg<strap::StrapSpec>;
...
#[doc(alias = "IN1")]
pub type In1 = crate::Reg<in1::In1Spec>;
...
#[doc(alias = "STATUS_W1TS")]
pub type StatusW1ts = crate::Reg<status_w1ts::StatusW1tsSpec>;
...
#[doc(alias = "STATUS_W1TC")]
pub type StatusW1tc = crate::Reg<status_w1tc::StatusW1tcSpec>;
...
#[doc(alias = "STATUS1_W1TS")]
pub type Status1W1ts = crate::Reg<status1_w1ts::Status1W1tsSpec>;
...
#[doc(alias = "STATUS1_W1TC")]
pub type Status1W1tc = crate::Reg<status1_w1tc::Status1W1tcSpec>;
...
#[doc(alias = "INTR_0")]
pub type Intr0 = crate::Reg<intr_0::Intr0Spec>;
...
#[doc(alias = "INTR1_0")]
pub type Intr1_0 = crate::Reg<intr1_0::Intr1_0Spec>;
...
#[doc(alias = "INTR_1")]
pub type Intr1 = crate::Reg<intr_1::Intr1Spec>;
...
#[doc(alias = "INTR1_1")]
pub type Intr1_1 = crate::Reg<intr1_1::Intr1_1Spec>;
...
#[doc(alias = "STATUS_NEXT")]
pub type StatusNext = crate::Reg<status_next::StatusNextSpec>;
...
#[doc(alias = "STATUS_NEXT1")]
pub type StatusNext1 = crate::Reg<status_next1::StatusNext1Spec>;
...
#[doc(alias = "FUNC_IN_SEL_CFG")]
pub type FuncInSelCfg = crate::Reg<func_in_sel_cfg::FuncInSelCfgSpec>;
...
#[doc(alias = "FUNC_OUT_SEL_CFG")]
pub type FuncOutSelCfg = crate::Reg<func_out_sel_cfg::FuncOutSelCfgSpec>;
...
#[doc(alias = "INTR_2")]
pub type Intr2 = crate::Reg<intr_2::Intr2Spec>;
...
#[doc(alias = "INTR1_2")]
pub type Intr1_2 = crate::Reg<intr1_2::Intr1_2Spec>;
...
#[doc(alias = "INTR_3")]
pub type Intr3 = crate::Reg<intr_3::Intr3Spec>;
...
#[doc(alias = "INTR1_3")]
pub type Intr1_3 = crate::Reg<intr1_3::Intr1_3Spec>;
...
#[doc(alias = "ZERO_DET0_FILTER_CNT")]
pub type ZeroDet0FilterCnt = crate::Reg<zero_det0_filter_cnt::ZeroDet0FilterCntSpec>;
...
#[doc(alias = "ZERO_DET1_FILTER_CNT")]
pub type ZeroDet1FilterCnt = crate::Reg<zero_det1_filter_cnt::ZeroDet1FilterCntSpec>;
#[doc = "GPIO analog comparator zero detect filter count"]
...
#[doc(alias = "SEND_SEQ")]
pub type SendSeq = crate::Reg<send_seq::SendSeqSpec>;
...
#[doc(alias = "RECIVE_SEQ")]
pub type ReciveSeq = crate::Reg<recive_seq::ReciveSeqSpec>;
...
#[doc(alias = "BISTIN_SEL")]
pub type BistinSel = crate::Reg<bistin_sel::BistinSelSpec>;
...
#[doc(alias = "BIST_CTRL")]
pub type BistCtrl = crate::Reg<bist_ctrl::BistCtrlSpec>;

...
pub type R = crate::R<FilterMatchControlSpec>;
#[doc = "Register `FILTER_MATCH_CONTROL` writer"]
pub type W = crate::W<FilterMatchControlSpec>;
...
pub type MatchChoicePrivilegeR = crate::BitReader;
...
pub type MatchChoicePrivilegeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type MatchValueInterruptR = crate::BitReader;
...
pub type MatchValueInterruptW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MATCH_CHOICE_ECAUSE` reader - specified which ecause matched."]
pub type MatchChoiceEcauseR = crate::FieldReader;
#[doc = "Field `MATCH_CHOICE_ECAUSE` writer - specified which ecause matched."]
pub type MatchChoiceEcauseW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ...
    #[inline(always)]
    pub fn match_choice_privilege(&self) -> MatchChoicePrivilegeR {
        MatchChoicePrivilegeR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn match_value_interrupt(&self) -> MatchValueInterruptR {
        MatchValueInterruptR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 2:7 - specified which ecause matched."]
    #[inline(always)]
    pub fn match_choice_ecause(&self) -> MatchChoiceEcauseR {
        MatchChoiceEcauseR::new(((self.bits >> 2) & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - Select match which privilege level when \\hyperref\\[fielddesc:TRACEMATCHPRIVILEGE\\]{TRACE_MATCH_PRIVILEGE} is set. \\\\1: machine mode. \\\\0: user mode"]
    #[inline(always)]
    pub fn match_choice_privilege(&mut self) -> MatchChoicePrivilegeW<'_, FilterMatchControlSpec> {
        MatchChoicePrivilegeW::new(self, 0)
    }
    #[doc = "Bit 1 - Select which match which itype when \\hyperref\\[fielddesc:TRACEMATCHINTERRUPT\\]{TRACE_MATCH_INTERRUP} is set. \\\\1: match itype of 2. \\\\0: match itype or 1."]
    #[inline(always)]
    pub fn match_value_interrupt(&mut self) -> MatchValueInterruptW<'_, FilterMatchControlSpec> {
        MatchValueInterruptW::new(self, 1)
    }
    #[doc = "Bits 2:7 - specified which ecause matched."]
    #[inline(always)]
    pub fn match_choice_ecause(&mut self) -> MatchChoiceEcauseW<'_, FilterMatchControlSpec> {
        MatchChoiceEcauseW::new(self, 2)
    }
}
...
pub struct FilterMatchControlSpec;
impl crate::RegisterSpec for FilterMatchControlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`filter_match_control::R`](R) reader structure"]
impl crate::Readable for FilterMatchControlSpec {}
#[doc = "`write(|w| ..)` method takes [`filter_match_control::W`](W) writer structure"]
impl crate::Writable for FilterMatchControlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FILTER_MATCH_CONTROL to value 0"]
impl crate::Resettable for FilterMatchControlSpec {}

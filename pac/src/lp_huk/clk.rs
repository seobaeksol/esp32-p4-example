...
pub type MemCgForceOnR = crate::BitReader;
#[doc = "Field `MEM_CG_FORCE_ON` writer - Write 1 to force on memory clock gate."]
pub type MemCgForceOnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn mem_cg_force_on(&self) -> MemCgForceOnR {
        MemCgForceOnR::new(((self.bits >> 1) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Write 1 to force on register clock gate."]
    ...
    #[doc = "Bit 1 - Write 1 to force on memory clock gate."]
    #[inline(always)]
    pub fn mem_cg_force_on(&mut self) -> MemCgForceOnW<'_, ClkSpec> {
        MemCgForceOnW::new(self, 1)
    }
}

...
pub type LpAnaDateR = crate::FieldReader<u32>;
#[doc = "Field `LP_ANA_DATE` writer - need_des"]
pub type LpAnaDateW<'a, REG> = crate::FieldWriter<'a, REG, 31, u32>;
...
impl R {
    ...
    #[inline(always)]
    pub fn lp_ana_date(&self) -> LpAnaDateR {
        LpAnaDateR::new(self.bits & 0x7fff_ffff)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:30 - need_des"]
    #[inline(always)]
    pub fn lp_ana_date(&mut self) -> LpAnaDateW<'_, DateSpec> {
        LpAnaDateW::new(self, 0)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]

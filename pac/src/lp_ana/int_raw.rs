...
impl W {
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    pub fn vddbat_charge_upvoltage(&mut self) -> VddbatChargeUpvoltageW<'_, IntRawSpec> {
        VddbatChargeUpvoltageW::new(self, 27)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    pub fn vddbat_charge_undervoltage(&mut self) -> VddbatChargeUndervoltageW<'_, IntRawSpec> {
        VddbatChargeUndervoltageW::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    pub fn vddbat_upvoltage(&mut self) -> VddbatUpvoltageW<'_, IntRawSpec> {
        VddbatUpvoltageW::new(self, 29)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn vddbat_undervoltage(&mut self) -> VddbatUndervoltageW<'_, IntRawSpec> {
        VddbatUndervoltageW::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn bod_mode0(&mut self) -> BodMode0W<'_, IntRawSpec> {

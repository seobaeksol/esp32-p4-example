...
pub type VddbatChargeUpvoltageW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `VDDBAT_CHARGE_UNDERVOLTAGE` writer - need_des"]
pub type VddbatChargeUndervoltageW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `VDDBAT_UPVOLTAGE` writer - need_des"]
pub type VddbatUpvoltageW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `VDDBAT_UNDERVOLTAGE` writer - need_des"]
pub type VddbatUndervoltageW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `BOD_MODE0` writer - need_des"]
pub type BodMode0W<'a, REG> = crate::BitWriter1C<'a, REG>;
impl W {
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    pub fn vddbat_charge_upvoltage(&mut self) -> VddbatChargeUpvoltageW<'_, IntClrSpec> {
        VddbatChargeUpvoltageW::new(self, 27)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    pub fn vddbat_charge_undervoltage(&mut self) -> VddbatChargeUndervoltageW<'_, IntClrSpec> {
        VddbatChargeUndervoltageW::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    pub fn vddbat_upvoltage(&mut self) -> VddbatUpvoltageW<'_, IntClrSpec> {
        VddbatUpvoltageW::new(self, 29)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn vddbat_undervoltage(&mut self) -> VddbatUndervoltageW<'_, IntClrSpec> {
        VddbatUndervoltageW::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn bod_mode0(&mut self) -> BodMode0W<'_, IntClrSpec> {

...
pub type R = crate::R<RxTailingBitsSpec>;
#[doc = "Register `RX_TAILING_BITS` writer"]
pub type W = crate::W<RxTailingBitsSpec>;
#[doc = "Field `RX_TAILING_BITS` reader - write this bits to specify the extra data bit length after getting EOF"]
pub type RxTailingBitsR = crate::FieldReader<u16>;
#[doc = "Field `RX_TAILING_BITS` writer - write this bits to specify the extra data bit length after getting EOF"]
pub type RxTailingBitsW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - write this bits to specify the extra data bit length after getting EOF"]
    #[inline(always)]
    pub fn rx_tailing_bits(&self) -> RxTailingBitsR {
        RxTailingBitsR::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - write this bits to specify the extra data bit length after getting EOF"]
    #[inline(always)]
    pub fn rx_tailing_bits(&mut self) -> RxTailingBitsW<'_, RxTailingBitsSpec> {
        RxTailingBitsW::new(self, 0)
    }
}
...
pub struct RxTailingBitsSpec;
impl crate::RegisterSpec for RxTailingBitsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rx_tailing_bits::R`](R) reader structure"]
impl crate::Readable for RxTailingBitsSpec {}
#[doc = "`write(|w| ..)` method takes [`rx_tailing_bits::W`](W) writer structure"]
impl crate::Writable for RxTailingBitsSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RX_TAILING_BITS to value 0"]
impl crate::Resettable for RxTailingBitsSpec {}

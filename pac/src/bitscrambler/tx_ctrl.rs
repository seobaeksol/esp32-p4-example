...
pub type TxEofModeR = crate::BitReader;
...
pub type TxEofModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TxCondModeR = crate::BitReader;
...
pub type TxCondModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TxFetchModeR = crate::BitReader;
...
pub type TxFetchModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TxHaltModeR = crate::BitReader;
...
pub type TxHaltModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TxRdDummyR = crate::BitReader;
...
pub type TxRdDummyW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn tx_eof_mode(&self) -> TxEofModeR {
        TxEofModeR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn tx_cond_mode(&self) -> TxCondModeR {
        TxCondModeR::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn tx_fetch_mode(&self) -> TxFetchModeR {
        TxFetchModeR::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn tx_halt_mode(&self) -> TxHaltModeR {
        TxHaltModeR::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn tx_rd_dummy(&self) -> TxRdDummyR {
        TxRdDummyR::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - write this bit to enable the bitscrambler tx"]
    #[inline(always)]
    pub fn tx_ena(&mut self) -> TxEnaW<'_, TxCtrlSpec> {
        TxEnaW::new(self, 0)
    }
    #[doc = "Bit 1 - write this bit to pause the bitscrambler tx core"]
    #[inline(always)]
    pub fn tx_pause(&mut self) -> TxPauseW<'_, TxCtrlSpec> {
        TxPauseW::new(self, 1)
    }
    #[doc = "Bit 2 - write this bit to halt the bitscrambler tx core"]
    #[inline(always)]
    pub fn tx_halt(&mut self) -> TxHaltW<'_, TxCtrlSpec> {
        TxHaltW::new(self, 2)
    }
    #[doc = "Bit 3 - write this bit to ser the bitscrambler tx core EOF signal generating mode which is combined with reg_bitscrambler_tx_tailing_bits, 0: counter by read dma fifo, 0 counter by write peripheral buffer"]
    #[inline(always)]
    pub fn tx_eof_mode(&mut self) -> TxEofModeW<'_, TxCtrlSpec> {
        TxEofModeW::new(self, 3)
    }
    #[doc = "Bit 4 - write this bit to specify the LOOP instruction condition mode of bitscrambler tx core, 0: use the little than operator to get the condition, 1: use not equal operator to get the condition"]
    #[inline(always)]
    pub fn tx_cond_mode(&mut self) -> TxCondModeW<'_, TxCtrlSpec> {
        TxCondModeW::new(self, 4)
    }
    #[doc = "Bit 5 - write this bit to set the bitscrambler tx core fetch instruction mode, 0: prefetch by reset, 1: fetch by instrutions"]
    #[inline(always)]
    pub fn tx_fetch_mode(&mut self) -> TxFetchModeW<'_, TxCtrlSpec> {
        TxFetchModeW::new(self, 5)
    }
    #[doc = "Bit 6 - write this bit to set the bitscrambler tx core halt mode when tx_halt is set, 0: wait write data back done, , 1: ignore write data back"]
    #[inline(always)]
    pub fn tx_halt_mode(&mut self) -> TxHaltModeW<'_, TxCtrlSpec> {
        TxHaltModeW::new(self, 6)
    }
    #[doc = "Bit 7 - write this bit to set the bitscrambler tx core read data mode when EOF received.0: wait read data, 1: ignore read data"]
    #[inline(always)]
    pub fn tx_rd_dummy(&mut self) -> TxRdDummyW<'_, TxCtrlSpec> {
        TxRdDummyW::new(self, 7)
    }
    #[doc = "Bit 8 - write this bit to reset the bitscrambler tx fifo"]
    #[inline(always)]
    pub fn tx_fifo_rst(&mut self) -> TxFifoRstW<'_, TxCtrlSpec> {

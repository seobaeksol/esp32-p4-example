...
pub type RxEofTraceClrW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - represents the bitscrambler rx core in halt mode"]
    #[inline(always)]
    pub fn rx_in_idle(&self) -> RxInIdleR {
        RxInIdleR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - represents the bitscrambler rx core in run mode"]
    #[inline(always)]
    pub fn rx_in_run(&self) -> RxInRunR {
        RxInRunR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - represents the bitscrambler rx core in wait mode to wait write back done"]
    #[inline(always)]
    pub fn rx_in_wait(&self) -> RxInWaitR {
        RxInWaitR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - represents the bitscrambler rx core in pause mode"]
    #[inline(always)]
    pub fn rx_in_pause(&self) -> RxInPauseR {
        RxInPauseR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn rx_eof_get_cnt(&self) -> RxEofGetCntR {
        RxEofGetCntR::new(((self.bits >> 16) & 0x3fff) as u16)
    }
    #[doc = "Bit 30 - represents the some EOFs will be lost for bitscrambler rx core"]
    #[inline(always)]
    pub fn rx_eof_overload(&self) -> RxEofOverloadR {
        RxEofOverloadR::new(((self.bits >> 30) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 31 - write this bit to clear reg_bitscrambler_rx_eof_overload and reg_bitscrambler_rx_eof_get_cnt registers"]
    #[inline(always)]
    pub fn rx_eof_trace_clr(&mut self) -> RxEofTraceClrW<'_, RxStateSpec> {
        RxEofTraceClrW::new(self, 31)
    }
}
...
pub struct RxStateSpec;
impl crate::RegisterSpec for RxStateSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rx_state::R`](R) reader structure"]
impl crate::Readable for RxStateSpec {}
#[doc = "`write(|w| ..)` method takes [`rx_state::W`](W) writer structure"]
impl crate::Writable for RxStateSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RX_STATE to value 0x01"]
impl crate::Resettable for RxStateSpec {

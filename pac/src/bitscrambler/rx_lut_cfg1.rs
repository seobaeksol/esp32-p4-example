...
pub type R = crate::R<RxLutCfg1Spec>;
#[doc = "Register `RX_LUT_CFG1` writer"]
pub type W = crate::W<RxLutCfg1Spec>;
...
pub type RxLutR = crate::FieldReader<u32>;
...
pub type RxLutW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ...
    #[inline(always)]
    pub fn rx_lut(&self) -> RxLutR {
        RxLutR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - write this bits to update LUT which specified by BITSCRAMBLER_RX_LUT_CFG0_REG, Read this bits to get LUT which specified by BITSCRAMBLER_RX_LUT_CFG0_REG"]
    #[inline(always)]
    pub fn rx_lut(&mut self) -> RxLutW<'_, RxLutCfg1Spec> {
        RxLutW::new(self, 0)
    }
}
...
pub struct RxLutCfg1Spec;
impl crate::RegisterSpec for RxLutCfg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rx_lut_cfg1::R`](R) reader structure"]
impl crate::Readable for RxLutCfg1Spec {}
#[doc = "`write(|w| ..)` method takes [`rx_lut_cfg1::W`](W) writer structure"]
impl crate::Writable for RxLutCfg1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RX_LUT_CFG1 to value 0x1c"]
impl crate::Resettable for RxLutCfg1Spec {

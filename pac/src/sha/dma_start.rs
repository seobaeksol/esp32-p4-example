...
pub type W = crate::W<DmaStartSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn dma_start(&mut self) -> DmaStartW<'_, DmaStartSpec> {
...
pub struct DmaStartSpec;
impl crate::RegisterSpec for DmaStartSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`dma_start::W`](W) writer structure"]
impl crate::Writable for DmaStartSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DMA_START to value 0"]
impl crate::Resettable for DmaStartSpec {}

...
pub type W = crate::W<DmaContinueSpec>;
#[doc = "Field `DMA_CONTINUE` writer - Write 1 to continue DMA-SHA calculation."]
pub type DmaContinueW<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    #[doc = "Bit 0 - Write 1 to continue DMA-SHA calculation."]
    #[inline(always)]
    pub fn dma_continue(&mut self) -> DmaContinueW<'_, DmaContinueSpec> {
        DmaContinueW::new(self, 0)
    }
}
...
pub struct DmaContinueSpec;
impl crate::RegisterSpec for DmaContinueSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`dma_continue::W`](W) writer structure"]
impl crate::Writable for DmaContinueSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DMA_CONTINUE to value 0"]
impl crate::Resettable for DmaContinueSpec {}

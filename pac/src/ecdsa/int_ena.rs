...
pub type PrepDoneW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type ProcDoneW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn sha_release(&self) -> ShaReleaseR {
        ShaReleaseR::new(((self.bits >> 3) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - The interrupt enable bit for the ecdsa_prep_done_int interrupt"]
    #[inline(always)]
    pub fn prep_done(&mut self) -> PrepDoneW<'_, IntEnaSpec> {
        PrepDoneW::new(self, 0)
    }
    #[doc = "Bit 1 - The interrupt enable bit for the ecdsa_proc_done_int interrupt"]
    #[inline(always)]
    pub fn proc_done(&mut self) -> ProcDoneW<'_, IntEnaSpec> {
        ProcDoneW::new(self, 1)
    }
    #[doc = "Bit 2 - The interrupt enable bit for the ecdsa_post_done_int interrupt"]
    #[inline(always)]
    pub fn post_done(&mut self) -> PostDoneW<'_, IntEnaSpec> {
        PostDoneW::new(self, 2)
    }
    #[doc = "Bit 3 - The interrupt enable bit for the ecdsa_sha_release_int interrupt"]
    #[inline(always)]
    pub fn sha_release(&mut self) -> ShaReleaseW<'_, IntEnaSpec> {
        ShaReleaseW::new(self, 3)
    }
}

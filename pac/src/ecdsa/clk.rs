...
pub type GateForceOnR = crate::BitReader;
#[doc = "Field `GATE_FORCE_ON` writer - Write 1 to force on register clock gate."]
pub type GateForceOnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Write 1 to force on register clock gate."]
    #[inline(always)]
    pub fn gate_force_on(&self) -> GateForceOnR {
        GateForceOnR::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Write 1 to force on register clock gate."]
    #[inline(always)]
    pub fn gate_force_on(&mut self) -> GateForceOnW<'_, ClkSpec> {
        GateForceOnW::new(self, 0)
    }
}

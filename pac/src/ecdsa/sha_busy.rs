...
pub type R = crate::R<ShaBusySpec>;
...
pub struct ShaBusySpec;
impl crate::RegisterSpec for ShaBusySpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sha_busy::R`](R) reader structure"]
impl crate::Readable for ShaBusySpec {}
#[doc = "`reset()` method sets SHA_BUSY to value 0"]
impl crate::Resettable for ShaBusySpec {}

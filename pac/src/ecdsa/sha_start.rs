...
pub type W = crate::W<ShaStartSpec>;
...
pub type ShaStartW<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    ...
    #[inline(always)]
    pub fn sha_start(&mut self) -> ShaStartW<'_, ShaStartSpec> {
        ShaStartW::new(self, 0)
    }
}
...
pub struct ShaStartSpec;
impl crate::RegisterSpec for ShaStartSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`sha_start::W`](W) writer structure"]
impl crate::Writable for ShaStartSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SHA_START to value 0"]
impl crate::Resettable for ShaStartSpec {}

...
pub type R = crate::R<FuncOutSelCfgSpec>;
#[doc = "Register `FUNC%s_OUT_SEL_CFG` writer"]
pub type W = crate::W<FuncOutSelCfgSpec>;
...
pub type OutSelR = crate::FieldReader<u16>;
...
pub type OutSelW<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
...
pub type OenSelR = crate::BitReader;
...
impl R {
    ...
    pub fn out_sel(&self) -> OutSelR {
        OutSelR::new((self.bits & 0x01ff) as u16)
    }
    #[doc = "Bit 9 - set this bit to invert output signal.1:invert.0:not invert."]
    #[inline(always)]
    pub fn inv_sel(&self) -> InvSelR {
        InvSelR::new(((self.bits >> 9) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn oen_sel(&self) -> OenSelR {
        OenSelR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - set this bit to invert output enable signal.1:invert.0:not invert."]
    #[inline(always)]
    pub fn oen_inv_sel(&self) -> OenInvSelR {
        OenInvSelR::new(((self.bits >> 11) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:8 - The value of the bits: 0<=s<=256. Set the value to select output signal. s=0-255: output of GPIO\\[n\\] equals input of peripheral\\[s\\]. s=256: output of GPIO\\[n\\] equals GPIO_OUT_REG\\[n\\]."]
    #[inline(always)]
    pub fn out_sel(&mut self) -> OutSelW<'_, FuncOutSelCfgSpec> {
        OutSelW::new(self, 0)
    }
    #[doc = "Bit 9 - set this bit to invert output signal.1:invert.0:not invert."]
    #[inline(always)]
    pub fn inv_sel(&mut self) -> InvSelW<'_, FuncOutSelCfgSpec> {
        InvSelW::new(self, 9)
    }
    #[doc = "Bit 10 - set this bit to select output enable signal.1:use GPIO_ENABLE_REG\\[n\\] as output enable signal.0:use peripheral output enable signal."]
    #[inline(always)]
    pub fn oen_sel(&mut self) -> OenSelW<'_, FuncOutSelCfgSpec> {
        OenSelW::new(self, 10)
    }
    #[doc = "Bit 11 - set this bit to invert output enable signal.1:invert.0:not invert."]
    #[inline(always)]
    pub fn oen_inv_sel(&mut self) -> OenInvSelW<'_, FuncOutSelCfgSpec> {
        OenInvSelW::new(self, 11)
    }
}
...
pub struct FuncOutSelCfgSpec;
impl crate::RegisterSpec for FuncOutSelCfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`func_out_sel_cfg::R`](R) reader structure"]
impl crate::Readable for FuncOutSelCfgSpec {}
#[doc = "`write(|w| ..)` method takes [`func_out_sel_cfg::W`](W) writer structure"]
impl crate::Writable for FuncOutSelCfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FUNC%s_OUT_SEL_CFG to value 0x0100"]
impl crate::Resettable for FuncOutSelCfgSpec {

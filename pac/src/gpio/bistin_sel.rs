...
pub type R = crate::R<BistinSelSpec>;
#[doc = "Register `BISTIN_SEL` writer"]
pub type W = crate::W<BistinSelSpec>;
#[doc = "Field `BISTIN_SEL` reader - High speed sdio pad bist in pad sel 0:pad39, 1: pad40..."]
pub type BistinSelR = crate::FieldReader;
#[doc = "Field `BISTIN_SEL` writer - High speed sdio pad bist in pad sel 0:pad39, 1: pad40..."]
pub type BistinSelW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bits 0:3 - High speed sdio pad bist in pad sel 0:pad39, 1: pad40..."]
    #[inline(always)]
    pub fn bistin_sel(&self) -> BistinSelR {
        BistinSelR::new((self.bits & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3 - High speed sdio pad bist in pad sel 0:pad39, 1: pad40..."]
    #[inline(always)]
    pub fn bistin_sel(&mut self) -> BistinSelW<'_, BistinSelSpec> {
        BistinSelW::new(self, 0)
    }
}
...
pub struct BistinSelSpec;
impl crate::RegisterSpec for BistinSelSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bistin_sel::R`](R) reader structure"]
impl crate::Readable for BistinSelSpec {}
#[doc = "`write(|w| ..)` method takes [`bistin_sel::W`](W) writer structure"]
impl crate::Writable for BistinSelSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BISTIN_SEL to value 0x0f"]
impl crate::Resettable for BistinSelSpec {

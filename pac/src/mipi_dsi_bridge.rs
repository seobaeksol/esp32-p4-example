...
pub struct RegisterBlock {
    clk_en: ClkEn,
    en: En,
    dma_req_cfg: DmaReqCfg,
    raw_num_cfg: RawNumCfg,
    raw_buf_credit_ctl: RawBufCreditCtl,
    fifo_flow_status: FifoFlowStatus,
    pixel_type: PixelType,
    dma_block_interval: DmaBlockInterval,
    dma_req_interval: DmaReqInterval,
    dpi_lcd_ctl: DpiLcdCtl,
    dpi_rsv_dpi_data: DpiRsvDpiData,
    _reserved11: [u8; 0x04],
    dpi_v_cfg0: DpiVCfg0,
    dpi_v_cfg1: DpiVCfg1,
    dpi_h_cfg0: DpiHCfg0,
    dpi_h_cfg1: DpiHCfg1,
    dpi_misc_config: DpiMiscConfig,
    dpi_config_update: DpiConfigUpdate,
    _reserved17: [u8; 0x08],
    int_ena: IntEna,
    int_clr: IntClr,
    int_raw: IntRaw,
    int_st: IntSt,
    host_bist_ctl: HostBistCtl,
    host_trigger_rev: HostTriggerRev,
    blk_raw_num_cfg: BlkRawNumCfg,
    dma_frame_interval: DmaFrameInterval,
    mem_aux_ctrl: MemAuxCtrl,
    rdn_eco_cs: RdnEcoCs,
    rdn_eco_low: RdnEcoLow,
    rdn_eco_high: RdnEcoHigh,
    host_ctrl: HostCtrl,
    mem_clk_ctrl: MemClkCtrl,
    dma_flow_ctrl: DmaFlowCtrl,
    raw_buf_almost_empty_thrd: RawBufAlmostEmptyThrd,
    yuv_cfg: YuvCfg,
    phy_lp_loopback_ctrl: PhyLpLoopbackCtrl,
    phy_hs_loopback_ctrl: PhyHsLoopbackCtrl,
    phy_loopback_cnt: PhyLoopbackCnt,
    _reserved37: [u8; 0x60],
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn dma_req_cfg(&self) -> &DmaReqCfg {
        &self.dma_req_cfg
    }
    #[doc = "0x0c - dsi bridge raw number control register"]
    #[inline(always)]
    pub const fn raw_num_cfg(&self) -> &RawNumCfg {
        &self.raw_num_cfg
    }
    #[doc = "0x10 - dsi bridge credit register"]
    #[inline(always)]
    pub const fn raw_buf_credit_ctl(&self) -> &RawBufCreditCtl {
        &self.raw_buf_credit_ctl
    }
    #[doc = "0x14 - dsi bridge raw buffer depth register"]
    #[inline(always)]
    pub const fn fifo_flow_status(&self) -> &FifoFlowStatus {
    ...
    #[inline(always)]
    pub const fn mem_clk_ctrl(&self) -> &MemClkCtrl {
        &self.mem_clk_ctrl
    }
    #[doc = "0x88 - dsi_bridge dma flow controller register"]
    #[inline(always)]
    pub const fn dma_flow_ctrl(&self) -> &DmaFlowCtrl {
        &self.dma_flow_ctrl
    }
    #[doc = "0x8c - dsi_bridge buffer empty threshold register"]
    #[inline(always)]
    pub const fn raw_buf_almost_empty_thrd(&self) -> &RawBufAlmostEmptyThrd {
        &self.raw_buf_almost_empty_thrd
    }
    #[doc = "0x90 - dsi_bridge yuv format config register"]
    #[inline(always)]
    pub const fn yuv_cfg(&self) -> &YuvCfg {
        &self.yuv_cfg
    }
    #[doc = "0x94 - dsi phy lp_loopback test ctrl"]
    #[inline(always)]
    pub const fn phy_lp_loopback_ctrl(&self) -> &PhyLpLoopbackCtrl {
        &self.phy_lp_loopback_ctrl
    }
    #[doc = "0x98 - dsi phy hp_loopback test ctrl"]
    #[inline(always)]
    pub const fn phy_hs_loopback_ctrl(&self) -> &PhyHsLoopbackCtrl {
        &self.phy_hs_loopback_ctrl
    }
    #[doc = "0x9c - loopback test cnt"]
    #[inline(always)]
    pub const fn phy_loopback_cnt(&self) -> &PhyLoopbackCnt {
        &self.phy_loopback_cnt
    }
    #[doc = "0x100 - "]
    #[inline(always)]
    pub const fn dsi_brg_ver_date(&self) -> &DsiBrgVerDate {
...
#[doc(alias = "DMA_REQ_CFG")]
pub type DmaReqCfg = crate::Reg<dma_req_cfg::DmaReqCfgSpec>;
...
#[doc(alias = "RAW_NUM_CFG")]
pub type RawNumCfg = crate::Reg<raw_num_cfg::RawNumCfgSpec>;
...
#[doc(alias = "RAW_BUF_CREDIT_CTL")]
pub type RawBufCreditCtl = crate::Reg<raw_buf_credit_ctl::RawBufCreditCtlSpec>;
...
#[doc(alias = "FIFO_FLOW_STATUS")]
pub type FifoFlowStatus = crate::Reg<fifo_flow_status::FifoFlowStatusSpec>;
...
#[doc(alias = "PIXEL_TYPE")]
pub type PixelType = crate::Reg<pixel_type::PixelTypeSpec>;
...
#[doc(alias = "DMA_BLOCK_INTERVAL")]
pub type DmaBlockInterval = crate::Reg<dma_block_interval::DmaBlockIntervalSpec>;
...
#[doc(alias = "DMA_REQ_INTERVAL")]
pub type DmaReqInterval = crate::Reg<dma_req_interval::DmaReqIntervalSpec>;
...
#[doc(alias = "DPI_LCD_CTL")]
pub type DpiLcdCtl = crate::Reg<dpi_lcd_ctl::DpiLcdCtlSpec>;
...
#[doc(alias = "DPI_RSV_DPI_DATA")]
pub type DpiRsvDpiData = crate::Reg<dpi_rsv_dpi_data::DpiRsvDpiDataSpec>;
...
#[doc(alias = "DPI_V_CFG0")]
pub type DpiVCfg0 = crate::Reg<dpi_v_cfg0::DpiVCfg0Spec>;
...
#[doc(alias = "DPI_V_CFG1")]
pub type DpiVCfg1 = crate::Reg<dpi_v_cfg1::DpiVCfg1Spec>;
...
#[doc(alias = "DPI_H_CFG0")]
pub type DpiHCfg0 = crate::Reg<dpi_h_cfg0::DpiHCfg0Spec>;
...
#[doc(alias = "DPI_H_CFG1")]
pub type DpiHCfg1 = crate::Reg<dpi_h_cfg1::DpiHCfg1Spec>;
...
#[doc(alias = "DPI_MISC_CONFIG")]
pub type DpiMiscConfig = crate::Reg<dpi_misc_config::DpiMiscConfigSpec>;
...
#[doc(alias = "DPI_CONFIG_UPDATE")]
pub type DpiConfigUpdate = crate::Reg<dpi_config_update::DpiConfigUpdateSpec>;
...
#[doc(alias = "HOST_BIST_CTL")]
pub type HostBistCtl = crate::Reg<host_bist_ctl::HostBistCtlSpec>;
...
#[doc(alias = "HOST_TRIGGER_REV")]
pub type HostTriggerRev = crate::Reg<host_trigger_rev::HostTriggerRevSpec>;
...
#[doc(alias = "BLK_RAW_NUM_CFG")]
pub type BlkRawNumCfg = crate::Reg<blk_raw_num_cfg::BlkRawNumCfgSpec>;
...
#[doc(alias = "DMA_FRAME_INTERVAL")]
pub type DmaFrameInterval = crate::Reg<dma_frame_interval::DmaFrameIntervalSpec>;
...
#[doc(alias = "MEM_AUX_CTRL")]
pub type MemAuxCtrl = crate::Reg<mem_aux_ctrl::MemAuxCtrlSpec>;
...
#[doc(alias = "MEM_CLK_CTRL")]
pub type MemClkCtrl = crate::Reg<mem_clk_ctrl::MemClkCtrlSpec>;
...
#[doc(alias = "DMA_FLOW_CTRL")]
pub type DmaFlowCtrl = crate::Reg<dma_flow_ctrl::DmaFlowCtrlSpec>;
...
#[doc(alias = "RAW_BUF_ALMOST_EMPTY_THRD")]
pub type RawBufAlmostEmptyThrd = crate::Reg<raw_buf_almost_empty_thrd::RawBufAlmostEmptyThrdSpec>;
...
#[doc(alias = "YUV_CFG")]
pub type YuvCfg = crate::Reg<yuv_cfg::YuvCfgSpec>;
...
#[doc(alias = "PHY_LP_LOOPBACK_CTRL")]
pub type PhyLpLoopbackCtrl = crate::Reg<phy_lp_loopback_ctrl::PhyLpLoopbackCtrlSpec>;
...
#[doc(alias = "PHY_HS_LOOPBACK_CTRL")]
pub type PhyHsLoopbackCtrl = crate::Reg<phy_hs_loopback_ctrl::PhyHsLoopbackCtrlSpec>;
...
#[doc(alias = "PHY_LOOPBACK_CNT")]
pub type PhyLoopbackCnt = crate::Reg<phy_loopback_cnt::PhyLoopbackCntSpec>;
...
#[doc(alias = "DSI_BRG_VER_DATE")]
pub type DsiBrgVerDate = crate::Reg<dsi_brg_ver_date::DsiBrgVerDateSpec>;
#[doc = ""]

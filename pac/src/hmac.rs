...
pub struct RegisterBlock {
    _reserved0: [u8; 0x40],
    set_start: SetStart,
    set_para_purpose: SetParaPurpose,
    set_para_key: SetParaKey,
    set_para_finish: SetParaFinish,
    set_message_one: SetMessageOne,
    set_message_ing: SetMessageIng,
    set_message_end: SetMessageEnd,
    set_result_finish: SetResultFinish,
    set_invalidate_jtag: SetInvalidateJtag,
    set_invalidate_ds: SetInvalidateDs,
    query_error: QueryError,
    query_busy: QueryBusy,
    _reserved12: [u8; 0x10],
    wr_message_mem: [WrMessageMem; 16],
    rd_result_mem: [RdResultMem; 8],
    _reserved14: [u8; 0x10],
    set_message_pad: SetMessagePad,
    one_block: OneBlock,
    soft_jtag_ctrl: SoftJtagCtrl,
    wr_jtag: WrJtag,
    _reserved18: [u8; 0xfc],
    date: Date,
}
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn wr_message_mem(&self, n: usize) -> &WrMessageMem {
        &self.wr_message_mem[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x80..0xc0 - Message block memory."]
    #[inline(always)]
    pub fn wr_message_mem_iter(&self) -> impl Iterator<Item = &WrMessageMem> {
        self.wr_message_mem.iter()
    }
    #[doc = "0xc0..0xe0 - Result from upstream."]
    #[inline(always)]
    pub const fn rd_result_mem(&self, n: usize) -> &RdResultMem {
        &self.rd_result_mem[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0xc0..0xe0 - Result from upstream."]
    #[inline(always)]
    pub fn rd_result_mem_iter(&self) -> impl Iterator<Item = &RdResultMem> {
        self.rd_result_mem.iter()
    }
    #[doc = "0xf0 - Software padding register"]
    #[inline(always)]
    pub const fn set_message_pad(&self) -> &SetMessagePad {
        &self.set_message_pad
    }
    #[doc = "0xf4 - One block message register"]
    #[inline(always)]
    pub const fn one_block(&self) -> &OneBlock {
        &self.one_block
    }
    #[doc = "0xf8 - Jtag register 0."]
    #[inline(always)]
    pub const fn soft_jtag_ctrl(&self) -> &SoftJtagCtrl {
        &self.soft_jtag_ctrl
    }
    #[doc = "0xfc - Re-enable JTAG register 1"]
    #[inline(always)]
    pub const fn wr_jtag(&self) -> &WrJtag {
        &self.wr_jtag
    }
...
#[doc(alias = "SET_PARA_PURPOSE")]
pub type SetParaPurpose = crate::Reg<set_para_purpose::SetParaPurposeSpec>;
...
#[doc(alias = "SET_PARA_KEY")]
pub type SetParaKey = crate::Reg<set_para_key::SetParaKeySpec>;
...
#[doc(alias = "SET_PARA_FINISH")]
pub type SetParaFinish = crate::Reg<set_para_finish::SetParaFinishSpec>;
...
#[doc(alias = "SET_MESSAGE_ONE")]
pub type SetMessageOne = crate::Reg<set_message_one::SetMessageOneSpec>;
...
#[doc(alias = "SET_MESSAGE_ING")]
pub type SetMessageIng = crate::Reg<set_message_ing::SetMessageIngSpec>;
...
#[doc(alias = "SET_MESSAGE_END")]
pub type SetMessageEnd = crate::Reg<set_message_end::SetMessageEndSpec>;
...
#[doc(alias = "SET_RESULT_FINISH")]
pub type SetResultFinish = crate::Reg<set_result_finish::SetResultFinishSpec>;
...
#[doc(alias = "SET_INVALIDATE_JTAG")]
pub type SetInvalidateJtag = crate::Reg<set_invalidate_jtag::SetInvalidateJtagSpec>;
...
#[doc(alias = "SET_INVALIDATE_DS")]
pub type SetInvalidateDs = crate::Reg<set_invalidate_ds::SetInvalidateDsSpec>;
...
#[doc(alias = "QUERY_ERROR")]
pub type QueryError = crate::Reg<query_error::QueryErrorSpec>;
...
#[doc(alias = "WR_MESSAGE_MEM")]
pub type WrMessageMem = crate::Reg<wr_message_mem::WrMessageMemSpec>;
...
#[doc(alias = "RD_RESULT_MEM")]
pub type RdResultMem = crate::Reg<rd_result_mem::RdResultMemSpec>;
...
#[doc(alias = "SET_MESSAGE_PAD")]
pub type SetMessagePad = crate::Reg<set_message_pad::SetMessagePadSpec>;
...
#[doc(alias = "ONE_BLOCK")]
pub type OneBlock = crate::Reg<one_block::OneBlockSpec>;
...
#[doc(alias = "SOFT_JTAG_CTRL")]
pub type SoftJtagCtrl = crate::Reg<soft_jtag_ctrl::SoftJtagCtrlSpec>;
#[doc = "Jtag register 0."]
...
#[doc(alias = "WR_JTAG")]
pub type WrJtag = crate::Reg<wr_jtag::WrJtagSpec>;

...
pub struct InfifoStatus1Ch1Spec;
impl crate::RegisterSpec for InfifoStatus1Ch1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`infifo_status1_ch1::R`](R) reader structure"]
impl crate::Readable for InfifoStatus1Ch1Spec {}
#[doc = "`reset()` method sets INFIFO_STATUS1_CH1 to value 0"]
impl crate::Resettable for InfifoStatus1Ch1Spec {}

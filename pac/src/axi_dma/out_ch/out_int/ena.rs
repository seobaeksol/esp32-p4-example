...
pub type OutfifoL1OvfW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OutfifoL1UdfW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OutfifoL2OvfW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OutfifoL2UdfW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OutfifoL3OvfW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    pub fn outfifo_l1_ovf(&self) -> OutfifoL1OvfR {
        OutfifoL1OvfR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - The interrupt enable bit for the OUTFIFO_UDF_L1_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l1_udf(&self) -> OutfifoL1UdfR {
        OutfifoL1UdfR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - The interrupt enable bit for the OUTFIFO_OVF_L2_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l2_ovf(&self) -> OutfifoL2OvfR {
        OutfifoL2OvfR::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - The interrupt enable bit for the OUTFIFO_UDF_L2_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l2_udf(&self) -> OutfifoL2UdfR {
        OutfifoL2UdfR::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - The interrupt enable bit for the OUTFIFO_OVF_L3_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l3_ovf(&self) -> OutfifoL3OvfR {
        OutfifoL3OvfR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - The interrupt enable bit for the OUTFIFO_UDF_L3_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l3_udf(&self) -> OutfifoL3UdfR {
        OutfifoL3UdfR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - The interrupt enable bit for the OUT_LINK_SWITCH_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_link_switch(&self) -> OutLinkSwitchR {
        OutLinkSwitchR::new(((self.bits >> 10) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - The interrupt enable bit for the OUT_DONE_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_done(&mut self) -> OutDoneW<'_, EnaSpec> {
        OutDoneW::new(self, 0)
    }
    #[doc = "Bit 1 - The interrupt enable bit for the OUT_EOF_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_eof(&mut self) -> OutEofW<'_, EnaSpec> {
        OutEofW::new(self, 1)
    }
    #[doc = "Bit 2 - The interrupt enable bit for the OUT_DSCR_ERR_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_dscr_err(&mut self) -> OutDscrErrW<'_, EnaSpec> {
        OutDscrErrW::new(self, 2)
    }
    #[doc = "Bit 3 - The interrupt enable bit for the OUT_TOTAL_EOF_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_total_eof(&mut self) -> OutTotalEofW<'_, EnaSpec> {
        OutTotalEofW::new(self, 3)
    }
    #[doc = "Bit 4 - The interrupt enable bit for the OUTFIFO_OVF_L1_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l1_ovf(&mut self) -> OutfifoL1OvfW<'_, EnaSpec> {
        OutfifoL1OvfW::new(self, 4)
    }
    #[doc = "Bit 5 - The interrupt enable bit for the OUTFIFO_UDF_L1_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l1_udf(&mut self) -> OutfifoL1UdfW<'_, EnaSpec> {
        OutfifoL1UdfW::new(self, 5)
    }
    #[doc = "Bit 6 - The interrupt enable bit for the OUTFIFO_OVF_L2_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l2_ovf(&mut self) -> OutfifoL2OvfW<'_, EnaSpec> {
        OutfifoL2OvfW::new(self, 6)
    }
    #[doc = "Bit 7 - The interrupt enable bit for the OUTFIFO_UDF_L2_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l2_udf(&mut self) -> OutfifoL2UdfW<'_, EnaSpec> {
        OutfifoL2UdfW::new(self, 7)
    }
    #[doc = "Bit 8 - The interrupt enable bit for the OUTFIFO_OVF_L3_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l3_ovf(&mut self) -> OutfifoL3OvfW<'_, EnaSpec> {
        OutfifoL3OvfW::new(self, 8)
    }
    #[doc = "Bit 9 - The interrupt enable bit for the OUTFIFO_UDF_L3_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l3_udf(&mut self) -> OutfifoL3UdfW<'_, EnaSpec> {
        OutfifoL3UdfW::new(self, 9)
    }
    #[doc = "Bit 10 - The interrupt enable bit for the OUT_LINK_SWITCH_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_link_switch(&mut self) -> OutLinkSwitchW<'_, EnaSpec> {

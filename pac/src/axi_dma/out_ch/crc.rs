...
#[doc(alias = "CRC")]
pub struct Crc {
    out_crc_init_data: OutCrcInitData,
    tx_crc_width: TxCrcWidth,
    out_crc_clear: OutCrcClear,
    out_crc_final_result: OutCrcFinalResult,
    tx_crc_en_wr_data: TxCrcEnWrData,
    tx_crc_en_addr: TxCrcEnAddr,
    tx_crc_data_en_wr_data: TxCrcDataEnWrData,
    tx_crc_data_en_addr: TxCrcDataEnAddr,
}
impl Crc {
    #[doc = "0x00 - This register is used to config ch0 crc initial data(max 32 bit)"]
    #[inline(always)]
    pub const fn out_crc_init_data(&self) -> &OutCrcInitData {
...
#[doc(alias = "OUT_CRC_INIT_DATA")]
pub type OutCrcInitData = crate::Reg<out_crc_init_data::OutCrcInitDataSpec>;
...
#[doc(alias = "TX_CRC_WIDTH")]
pub type TxCrcWidth = crate::Reg<tx_crc_width::TxCrcWidthSpec>;
...
#[doc(alias = "OUT_CRC_CLEAR")]
pub type OutCrcClear = crate::Reg<out_crc_clear::OutCrcClearSpec>;
...
#[doc(alias = "OUT_CRC_FINAL_RESULT")]
pub type OutCrcFinalResult = crate::Reg<out_crc_final_result::OutCrcFinalResultSpec>;
...
#[doc(alias = "TX_CRC_EN_WR_DATA")]
pub type TxCrcEnWrData = crate::Reg<tx_crc_en_wr_data::TxCrcEnWrDataSpec>;
...
#[doc(alias = "TX_CRC_EN_ADDR")]
pub type TxCrcEnAddr = crate::Reg<tx_crc_en_addr::TxCrcEnAddrSpec>;
...
#[doc(alias = "TX_CRC_DATA_EN_WR_DATA")]
pub type TxCrcDataEnWrData = crate::Reg<tx_crc_data_en_wr_data::TxCrcDataEnWrDataSpec>;
...
#[doc(alias = "TX_CRC_DATA_EN_ADDR")]
pub type TxCrcDataEnAddr = crate::Reg<tx_crc_data_en_addr::TxCrcDataEnAddrSpec>;

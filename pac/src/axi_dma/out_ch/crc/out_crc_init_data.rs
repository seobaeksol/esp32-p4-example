...
pub type R = crate::R<OutCrcInitDataSpec>;
#[doc = "Register `OUT_CRC_INIT_DATA` writer"]
pub type W = crate::W<OutCrcInitDataSpec>;
#[doc = "Field `OUT_CRC_INIT_DATA` reader - This register is used to config ch0 of tx crc initial value"]
pub type OutCrcInitDataR = crate::FieldReader<u32>;
#[doc = "Field `OUT_CRC_INIT_DATA` writer - This register is used to config ch0 of tx crc initial value"]
pub type OutCrcInitDataW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - This register is used to config ch0 of tx crc initial value"]
    #[inline(always)]
    pub fn out_crc_init_data(&self) -> OutCrcInitDataR {
        OutCrcInitDataR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - This register is used to config ch0 of tx crc initial value"]
    #[inline(always)]
    pub fn out_crc_init_data(&mut self) -> OutCrcInitDataW<'_, OutCrcInitDataSpec> {
        OutCrcInitDataW::new(self, 0)
    }
}
...
pub struct OutCrcInitDataSpec;
impl crate::RegisterSpec for OutCrcInitDataSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`out_crc_init_data::R`](R) reader structure"]
impl crate::Readable for OutCrcInitDataSpec {}
#[doc = "`write(|w| ..)` method takes [`out_crc_init_data::W`](W) writer structure"]
impl crate::Writable for OutCrcInitDataSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OUT_CRC_INIT_DATA to value 0xffff_ffff"]
impl crate::Resettable for OutCrcInitDataSpec {

...
pub type R = crate::R<TxCrcDataEnAddrSpec>;
#[doc = "Register `TX_CRC_DATA_EN_ADDR` writer"]
pub type W = crate::W<TxCrcDataEnAddrSpec>;
#[doc = "Field `TX_CRC_DATA_EN_ADDR` reader - reserved"]
pub type TxCrcDataEnAddrR = crate::FieldReader<u32>;
#[doc = "Field `TX_CRC_DATA_EN_ADDR` writer - reserved"]
pub type TxCrcDataEnAddrW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - reserved"]
    #[inline(always)]
    pub fn tx_crc_data_en_addr(&self) -> TxCrcDataEnAddrR {
        TxCrcDataEnAddrR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - reserved"]
    #[inline(always)]
    pub fn tx_crc_data_en_addr(&mut self) -> TxCrcDataEnAddrW<'_, TxCrcDataEnAddrSpec> {
        TxCrcDataEnAddrW::new(self, 0)
    }
}
...
pub struct TxCrcDataEnAddrSpec;
impl crate::RegisterSpec for TxCrcDataEnAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tx_crc_data_en_addr::R`](R) reader structure"]
impl crate::Readable for TxCrcDataEnAddrSpec {}
#[doc = "`write(|w| ..)` method takes [`tx_crc_data_en_addr::W`](W) writer structure"]
impl crate::Writable for TxCrcDataEnAddrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TX_CRC_DATA_EN_ADDR to value 0"]
impl crate::Resettable for TxCrcDataEnAddrSpec {}

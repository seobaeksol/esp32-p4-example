...
pub struct OutfifoStatus1Ch1Spec;
impl crate::RegisterSpec for OutfifoStatus1Ch1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`outfifo_status1_ch1::R`](R) reader structure"]
impl crate::Readable for OutfifoStatus1Ch1Spec {}
#[doc = "`reset()` method sets OUTFIFO_STATUS1_CH1 to value 0"]
impl crate::Resettable for OutfifoStatus1Ch1Spec {}

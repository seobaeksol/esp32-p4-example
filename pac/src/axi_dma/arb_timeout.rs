...
pub type R = crate::R<ArbTimeoutSpec>;
#[doc = "Register `ARB_TIMEOUT` writer"]
pub type W = crate::W<ArbTimeoutSpec>;
...
pub type RxR = crate::FieldReader<u16>;
#[doc = "Field `RX` writer - This register is used to config rx arbiter time out value"]
pub type RxW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ...
    #[inline(always)]
    pub fn rx(&self) -> RxR {
        RxR::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - This register is used to config tx arbiter time out value"]
    #[inline(always)]
    pub fn tx(&mut self) -> TxW<'_, ArbTimeoutSpec> {
        TxW::new(self, 0)
    }
    #[doc = "Bits 16:31 - This register is used to config rx arbiter time out value"]
    #[inline(always)]
    pub fn rx(&mut self) -> RxW<'_, ArbTimeoutSpec> {
        RxW::new(self, 16)
    }
}
...
pub struct ArbTimeoutSpec;
impl crate::RegisterSpec for ArbTimeoutSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`arb_timeout::R`](R) reader structure"]
impl crate::Readable for ArbTimeoutSpec {}
#[doc = "`write(|w| ..)` method takes [`arb_timeout::W`](W) writer structure"]
impl crate::Writable for ArbTimeoutSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ARB_TIMEOUT to value 0"]
impl crate::Resettable for ArbTimeoutSpec {}

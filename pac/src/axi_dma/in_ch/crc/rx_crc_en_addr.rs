...
pub type R = crate::R<RxCrcEnAddrSpec>;
#[doc = "Register `RX_CRC_EN_ADDR` writer"]
pub type W = crate::W<RxCrcEnAddrSpec>;
#[doc = "Field `RX_CRC_EN_ADDR` reader - reserved"]
pub type RxCrcEnAddrR = crate::FieldReader<u32>;
#[doc = "Field `RX_CRC_EN_ADDR` writer - reserved"]
pub type RxCrcEnAddrW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - reserved"]
    #[inline(always)]
    pub fn rx_crc_en_addr(&self) -> RxCrcEnAddrR {
        RxCrcEnAddrR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - reserved"]
    #[inline(always)]
    pub fn rx_crc_en_addr(&mut self) -> RxCrcEnAddrW<'_, RxCrcEnAddrSpec> {
        RxCrcEnAddrW::new(self, 0)
    }
}
...
pub struct RxCrcEnAddrSpec;
impl crate::RegisterSpec for RxCrcEnAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rx_crc_en_addr::R`](R) reader structure"]
impl crate::Readable for RxCrcEnAddrSpec {}
#[doc = "`write(|w| ..)` method takes [`rx_crc_en_addr::W`](W) writer structure"]
impl crate::Writable for RxCrcEnAddrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RX_CRC_EN_ADDR to value 0"]
impl crate::Resettable for RxCrcEnAddrSpec {}

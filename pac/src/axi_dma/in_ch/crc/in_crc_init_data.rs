...
pub type R = crate::R<InCrcInitDataSpec>;
#[doc = "Register `IN_CRC_INIT_DATA` writer"]
pub type W = crate::W<InCrcInitDataSpec>;
#[doc = "Field `IN_CRC_INIT_DATA` reader - This register is used to config ch0 of rx crc initial value"]
pub type InCrcInitDataR = crate::FieldReader<u32>;
#[doc = "Field `IN_CRC_INIT_DATA` writer - This register is used to config ch0 of rx crc initial value"]
pub type InCrcInitDataW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - This register is used to config ch0 of rx crc initial value"]
    #[inline(always)]
    pub fn in_crc_init_data(&self) -> InCrcInitDataR {
        InCrcInitDataR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - This register is used to config ch0 of rx crc initial value"]
    #[inline(always)]
    pub fn in_crc_init_data(&mut self) -> InCrcInitDataW<'_, InCrcInitDataSpec> {
        InCrcInitDataW::new(self, 0)
    }
}
...
pub struct InCrcInitDataSpec;
impl crate::RegisterSpec for InCrcInitDataSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`in_crc_init_data::R`](R) reader structure"]
impl crate::Readable for InCrcInitDataSpec {}
#[doc = "`write(|w| ..)` method takes [`in_crc_init_data::W`](W) writer structure"]
impl crate::Writable for InCrcInitDataSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets IN_CRC_INIT_DATA to value 0xffff_ffff"]
impl crate::Resettable for InCrcInitDataSpec {

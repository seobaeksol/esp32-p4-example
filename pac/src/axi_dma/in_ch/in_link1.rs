...
pub type R = crate::R<InLink1Spec>;
#[doc = "Register `IN_LINK1` writer"]
pub type W = crate::W<InLink1Spec>;
...
impl R {
    ...
    pub fn inlink_auto_ret(&self) -> InlinkAutoRetR {
        InlinkAutoRetR::new((self.bits & 1) != 0)
    }
    ...
    pub fn inlink_park(&self) -> InlinkParkR {
        InlinkParkR::new(((self.bits >> 4) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Set this bit to return to current inlink descriptor's address when there are some errors in current receiving data."]
    #[inline(always)]
    pub fn inlink_auto_ret(&mut self) -> InlinkAutoRetW<'_, InLink1Spec> {
        InlinkAutoRetW::new(self, 0)
    }
    #[doc = "Bit 1 - Set this bit to stop dealing with the inlink descriptors."]
    #[inline(always)]
    pub fn inlink_stop(&mut self) -> InlinkStopW<'_, InLink1Spec> {
        InlinkStopW::new(self, 1)
    }
    #[doc = "Bit 2 - Set this bit to start dealing with the inlink descriptors."]
    #[inline(always)]
    pub fn inlink_start(&mut self) -> InlinkStartW<'_, InLink1Spec> {
        InlinkStartW::new(self, 2)
    }
    #[doc = "Bit 3 - Set this bit to mount a new inlink descriptor."]
    #[inline(always)]
    pub fn inlink_restart(&mut self) -> InlinkRestartW<'_, InLink1Spec> {
        InlinkRestartW::new(self, 3)
    }
}
...
pub struct InLink1Spec;
impl crate::RegisterSpec for InLink1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`in_link1::R`](R) reader structure"]
impl crate::Readable for InLink1Spec {}
#[doc = "`write(|w| ..)` method takes [`in_link1::W`](W) writer structure"]
impl crate::Writable for InLink1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets IN_LINK1 to value 0x11"]
impl crate::Resettable for InLink1Spec {

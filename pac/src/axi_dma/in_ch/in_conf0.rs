...
pub type IndscrBurstEnR = crate::BitReader;
...
pub type IndscrBurstEnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - This bit is used to reset AXI_DMA channel 0 Rx FSM and Rx FIFO pointer."]
    #[inline(always)]
    pub fn in_rst(&self) -> InRstR {
        InRstR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - reserved"]
    #[inline(always)]
    pub fn in_loop_test(&self) -> InLoopTestR {
        InLoopTestR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Set this bit 1 to enable automatic transmitting data from memory to memory via AXI_DMA."]
    #[inline(always)]
    pub fn mem_trans_en(&self) -> MemTransEnR {
        MemTransEnR::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    pub fn in_etm_en(&self) -> InEtmEnR {
        InEtmEnR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bits 4:6 - 3'b000-3'b100:burst length 8byte~128byte"]
    #[inline(always)]
    pub fn in_burst_size_sel(&self) -> InBurstSizeSelR {
        InBurstSizeSelR::new(((self.bits >> 4) & 7) as u8)
    }
    #[doc = "Bit 7 - 1:mean disable cmd of this ch0"]
    #[inline(always)]
    pub fn in_cmd_disable(&self) -> InCmdDisableR {
        InCmdDisableR::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - 1: mean access ecc or aes domain,0: mean not"]
    #[inline(always)]
    pub fn in_ecc_aec_en(&self) -> InEccAecEnR {
        InEccAecEnR::new(((self.bits >> 8) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn indscr_burst_en(&self) -> IndscrBurstEnR {
        IndscrBurstEnR::new(((self.bits >> 9) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - This bit is used to reset AXI_DMA channel 0 Rx FSM and Rx FIFO pointer."]
    #[inline(always)]
    pub fn in_rst(&mut self) -> InRstW<'_, InConf0Spec> {
        InRstW::new(self, 0)
    }
    #[doc = "Bit 1 - reserved"]
    #[inline(always)]
    pub fn in_loop_test(&mut self) -> InLoopTestW<'_, InConf0Spec> {
        InLoopTestW::new(self, 1)
    }
    #[doc = "Bit 2 - Set this bit 1 to enable automatic transmitting data from memory to memory via AXI_DMA."]
    #[inline(always)]
    pub fn mem_trans_en(&mut self) -> MemTransEnW<'_, InConf0Spec> {
        MemTransEnW::new(self, 2)
    }
    #[doc = "Bit 3 - Set this bit to 1 to enable etm control mode, dma Rx channel 0 is triggered by etm task."]
    #[inline(always)]
    pub fn in_etm_en(&mut self) -> InEtmEnW<'_, InConf0Spec> {
        InEtmEnW::new(self, 3)
    }
    #[doc = "Bits 4:6 - 3'b000-3'b100:burst length 8byte~128byte"]
    #[inline(always)]
    pub fn in_burst_size_sel(&mut self) -> InBurstSizeSelW<'_, InConf0Spec> {
        InBurstSizeSelW::new(self, 4)
    }
    #[doc = "Bit 7 - 1:mean disable cmd of this ch0"]
    #[inline(always)]
    pub fn in_cmd_disable(&mut self) -> InCmdDisableW<'_, InConf0Spec> {
        InCmdDisableW::new(self, 7)
    }
    #[doc = "Bit 8 - 1: mean access ecc or aes domain,0: mean not"]
    #[inline(always)]
    pub fn in_ecc_aec_en(&mut self) -> InEccAecEnW<'_, InConf0Spec> {
        InEccAecEnW::new(self, 8)
    }
    #[doc = "Bit 9 - Set this bit to 1 to enable INCR burst transfer for Rx channel 0 reading link descriptor when accessing internal SRAM."]
    #[inline(always)]
    pub fn indscr_burst_en(&mut self) -> IndscrBurstEnW<'_, InConf0Spec> {
        IndscrBurstEnW::new(self, 9)
    }
}

...
pub type R = crate::R<ExtrMemStartAddrSpec>;
#[doc = "Register `EXTR_MEM_START_ADDR` writer"]
pub type W = crate::W<ExtrMemStartAddrSpec>;
#[doc = "Field `ACCESS_EXTR_MEM_START_ADDR` reader - The start address of accessible address space."]
pub type AccessExtrMemStartAddrR = crate::FieldReader<u32>;
#[doc = "Field `ACCESS_EXTR_MEM_START_ADDR` writer - The start address of accessible address space."]
pub type AccessExtrMemStartAddrW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - The start address of accessible address space."]
    #[inline(always)]
    pub fn access_extr_mem_start_addr(&self) -> AccessExtrMemStartAddrR {
        AccessExtrMemStartAddrR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - The start address of accessible address space."]
    ...
    pub fn access_extr_mem_start_addr(
        &mut self,
    ) -> AccessExtrMemStartAddrW<'_, ExtrMemStartAddrSpec> {
        AccessExtrMemStartAddrW::new(self, 0)
    }
}
...
pub struct ExtrMemStartAddrSpec;
impl crate::RegisterSpec for ExtrMemStartAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`extr_mem_start_addr::R`](R) reader structure"]
impl crate::Readable for ExtrMemStartAddrSpec {}
#[doc = "`write(|w| ..)` method takes [`extr_mem_start_addr::W`](W) writer structure"]
impl crate::Writable for ExtrMemStartAddrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EXTR_MEM_START_ADDR to value 0x3010_0000"]
impl crate::Resettable for ExtrMemStartAddrSpec {

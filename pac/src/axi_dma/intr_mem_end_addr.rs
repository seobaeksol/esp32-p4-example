...
pub type R = crate::R<IntrMemEndAddrSpec>;
#[doc = "Register `INTR_MEM_END_ADDR` writer"]
pub type W = crate::W<IntrMemEndAddrSpec>;
...
pub type AccessIntrMemEndAddrR = crate::FieldReader<u32>;
...
pub type AccessIntrMemEndAddrW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ...
    #[inline(always)]
    pub fn access_intr_mem_end_addr(&self) -> AccessIntrMemEndAddrR {
        AccessIntrMemEndAddrR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - The end address of accessible address space. The access address beyond this range would lead to descriptor error."]
    #[inline(always)]
    pub fn access_intr_mem_end_addr(&mut self) -> AccessIntrMemEndAddrW<'_, IntrMemEndAddrSpec> {
        AccessIntrMemEndAddrW::new(self, 0)
    }
}
...
pub struct IntrMemEndAddrSpec;
impl crate::RegisterSpec for IntrMemEndAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intr_mem_end_addr::R`](R) reader structure"]
impl crate::Readable for IntrMemEndAddrSpec {}
#[doc = "`write(|w| ..)` method takes [`intr_mem_end_addr::W`](W) writer structure"]
impl crate::Writable for IntrMemEndAddrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets INTR_MEM_END_ADDR to value 0x8fff_ffff"]
impl crate::Resettable for IntrMemEndAddrSpec {

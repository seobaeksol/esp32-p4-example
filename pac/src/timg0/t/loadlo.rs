...
pub type R = crate::R<LoadloSpec>;
#[doc = "Register `LOADLO` writer"]
pub type W = crate::W<LoadloSpec>;
...
pub type LoadLoW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - Low 32 bits of the value that a reload will load onto timer %s time-base Counter."]
    #[inline(always)]
    pub fn load_lo(&mut self) -> LoadLoW<'_, LoadloSpec> {
        LoadLoW::new(self, 0)
    }
}
...
pub struct LoadloSpec;
impl crate::RegisterSpec for LoadloSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`loadlo::R`](R) reader structure"]
impl crate::Readable for LoadloSpec {}
#[doc = "`write(|w| ..)` method takes [`loadlo::W`](W) writer structure"]
impl crate::Writable for LoadloSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LOADLO to value 0"]
impl crate::Resettable for LoadloSpec {}

...
pub struct AlarmloSpec;
impl crate::RegisterSpec for AlarmloSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`alarmlo::R`](R) reader structure"]
impl crate::Readable for AlarmloSpec {}
#[doc = "`write(|w| ..)` method takes [`alarmlo::W`](W) writer structure"]
impl crate::Writable for AlarmloSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ALARMLO to value 0"]
impl crate::Resettable for AlarmloSpec {}

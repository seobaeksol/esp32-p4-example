...
pub type WdtStg3W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type WdtStg2W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type WdtStg1W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type WdtStg0W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl R {
    ...
    pub fn wdt_sys_reset_length(&self) -> WdtSysResetLengthR {
        WdtSysResetLengthR::new(((self.bits >> 15) & 7) as u8)
    }
...
impl W {
    #[doc = "Bit 12 - WDT reset CPU enable."]
    #[inline(always)]
    pub fn wdt_appcpu_reset_en(&mut self) -> WdtAppcpuResetEnW<'_, Wdtconfig0Spec> {
        WdtAppcpuResetEnW::new(self, 12)
    }
    #[doc = "Bit 13 - WDT reset CPU enable."]
    #[inline(always)]
    pub fn wdt_procpu_reset_en(&mut self) -> WdtProcpuResetEnW<'_, Wdtconfig0Spec> {
        WdtProcpuResetEnW::new(self, 13)
    }
    #[doc = "Bit 14 - When set, Flash boot protection is enabled."]
    #[inline(always)]
    pub fn wdt_flashboot_mod_en(&mut self) -> WdtFlashbootModEnW<'_, Wdtconfig0Spec> {
        WdtFlashbootModEnW::new(self, 14)
    }
    #[doc = "Bits 15:17 - System reset signal length selection. 0: 100 ns, 1: 200 ns, 2: 300 ns, 3: 400 ns, 4: 500 ns, 5: 800 ns, 6: 1.6 us, 7: 3.2 us."]
    #[inline(always)]
    pub fn wdt_sys_reset_length(&mut self) -> WdtSysResetLengthW<'_, Wdtconfig0Spec> {
        WdtSysResetLengthW::new(self, 15)
    }
    #[doc = "Bits 18:20 - CPU reset signal length selection. 0: 100 ns, 1: 200 ns, 2: 300 ns, 3: 400 ns, 4: 500 ns, 5: 800 ns, 6: 1.6 us, 7: 3.2 us."]
    #[inline(always)]
    pub fn wdt_cpu_reset_length(&mut self) -> WdtCpuResetLengthW<'_, Wdtconfig0Spec> {
        WdtCpuResetLengthW::new(self, 18)
    }
    #[doc = "Bit 21 - choose WDT clock:0-apb_clk, 1-xtal_clk."]
    #[inline(always)]
    pub fn wdt_use_xtal(&mut self) -> WdtUseXtalW<'_, Wdtconfig0Spec> {
        WdtUseXtalW::new(self, 21)
    }
    #[doc = "Bit 22 - update the WDT configuration registers"]
    #[inline(always)]
    pub fn wdt_conf_update_en(&mut self) -> WdtConfUpdateEnW<'_, Wdtconfig0Spec> {
        WdtConfUpdateEnW::new(self, 22)
    }
    #[doc = "Bits 23:24 - Stage 3 configuration. 0: off, 1: interrupt, 2: reset CPU, 3: reset system."]
    #[inline(always)]
    pub fn wdt_stg3(&mut self) -> WdtStg3W<'_, Wdtconfig0Spec> {
        WdtStg3W::new(self, 23)
    }
    #[doc = "Bits 25:26 - Stage 2 configuration. 0: off, 1: interrupt, 2: reset CPU, 3: reset system."]
    #[inline(always)]
    pub fn wdt_stg2(&mut self) -> WdtStg2W<'_, Wdtconfig0Spec> {
        WdtStg2W::new(self, 25)
    }
    #[doc = "Bits 27:28 - Stage 1 configuration. 0: off, 1: interrupt, 2: reset CPU, 3: reset system."]
    #[inline(always)]
    pub fn wdt_stg1(&mut self) -> WdtStg1W<'_, Wdtconfig0Spec> {
        WdtStg1W::new(self, 27)
    }
    #[doc = "Bits 29:30 - Stage 0 configuration. 0: off, 1: interrupt, 2: reset CPU, 3: reset system."]
    #[inline(always)]
    pub fn wdt_stg0(&mut self) -> WdtStg0W<'_, Wdtconfig0Spec> {
        WdtStg0W::new(self, 29)
    }
    #[doc = "Bit 31 - When set, MWDT is enabled."]
    #[inline(always)]
    pub fn wdt_en(&mut self) -> WdtEnW<'_, Wdtconfig0Spec> {
        WdtEnW::new(self, 31)
    }
}
...
impl crate::Resettable for Wdtconfig0Spec {

...
pub type R = crate::R<WdtconfigSpec>;
#[doc = "Register `WDTCONFIG%s` writer"]
pub type W = crate::W<WdtconfigSpec>;
...
impl W {
    #[doc = "Bits 0:31 - Stage 0 timeout value, in MWDT clock cycles."]
    #[inline(always)]
    pub fn hold(&mut self) -> HoldW<'_, WdtconfigSpec> {
        HoldW::new(self, 0)
    }
}
...
pub struct WdtconfigSpec;
impl crate::RegisterSpec for WdtconfigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wdtconfig::R`](R) reader structure"]
impl crate::Readable for WdtconfigSpec {}
#[doc = "`write(|w| ..)` method takes [`wdtconfig::W`](W) writer structure"]
impl crate::Writable for WdtconfigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WDTCONFIG%s to value 0x018c_ba80"]
impl crate::Resettable for WdtconfigSpec {

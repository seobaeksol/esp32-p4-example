...
pub type RtcCaliValueR = crate::FieldReader<u32>;
impl R {
    #[doc = "Bit 0 - indicate periodic frequency calculation is done."]
    #[inline(always)]
    pub fn rtc_cali_cycling_data_vld(&self) -> RtcCaliCyclingDataVldR {
        RtcCaliCyclingDataVldR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn rtc_cali_value(&self) -> RtcCaliValueR {
        RtcCaliValueR::new((self.bits >> 7) & 0x01ff_ffff)
    }
}
...
pub struct Rtccalicfg1Spec;
impl crate::RegisterSpec for Rtccalicfg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rtccalicfg1::R`](R) reader structure"]
impl crate::Readable for Rtccalicfg1Spec {}
#[doc = "`reset()` method sets RTCCALICFG1 to value 0"]
impl crate::Resettable for Rtccalicfg1Spec {}

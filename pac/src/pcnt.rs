...
pub struct RegisterBlock {
    ...
    u_status: [UStatus; 4],
    ctrl: Ctrl,
    u3_change_conf: U3ChangeConf,
    u2_change_conf: U2ChangeConf,
    u1_change_conf: U1ChangeConf,
    u0_change_conf: U0ChangeConf,
    _reserved12: [u8; 0x88],
    date: Date,
}
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn u_cnt(&self, n: usize) -> &UCnt {
        &self.u_cnt[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x30..0x40 - Counter value for unit %s"]
    #[inline(always)]
    pub fn u_cnt_iter(&self) -> impl Iterator<Item = &UCnt> {
        self.u_cnt.iter()
    }
    #[doc = "0x30 - Counter value for unit 0"]
    #[inline(always)]
    pub const fn u0_cnt(&self) -> &UCnt {
        self.u_cnt(0)
    }
    #[doc = "0x34 - Counter value for unit 1"]
    #[inline(always)]
    pub const fn u1_cnt(&self) -> &UCnt {
        self.u_cnt(1)
    }
    #[doc = "0x38 - Counter value for unit 2"]
    #[inline(always)]
    pub const fn u2_cnt(&self) -> &UCnt {
        self.u_cnt(2)
    }
    #[doc = "0x3c - Counter value for unit 3"]
    #[inline(always)]
    pub const fn u3_cnt(&self) -> &UCnt {
        self.u_cnt(3)
    }
    ...
    #[inline(always)]
    pub const fn u_status(&self, n: usize) -> &UStatus {
        &self.u_status[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x50..0x60 - PNCT UNIT%s status register"]
    #[inline(always)]
    pub fn u_status_iter(&self) -> impl Iterator<Item = &UStatus> {
        self.u_status.iter()
    }
    #[doc = "0x50 - PNCT UNIT0 status register"]
    #[inline(always)]
    pub const fn u0_status(&self) -> &UStatus {
        self.u_status(0)
    }
    #[doc = "0x54 - PNCT UNIT1 status register"]
    #[inline(always)]
    pub const fn u1_status(&self) -> &UStatus {
        self.u_status(1)
    }
    #[doc = "0x58 - PNCT UNIT2 status register"]
    #[inline(always)]
    pub const fn u2_status(&self) -> &UStatus {
        self.u_status(2)
    }
    #[doc = "0x5c - PNCT UNIT3 status register"]
    #[inline(always)]
    pub const fn u3_status(&self) -> &UStatus {
        self.u_status(3)
    }
    ...
    #[inline(always)]
    pub const fn u3_change_conf(&self) -> &U3ChangeConf {
        &self.u3_change_conf
    }
    #[doc = "0x68 - Configuration register for unit $n's step value."]
    #[inline(always)]
    pub const fn u2_change_conf(&self) -> &U2ChangeConf {
        &self.u2_change_conf
    }
    #[doc = "0x6c - Configuration register for unit $n's step value."]
    #[inline(always)]
    pub const fn u1_change_conf(&self) -> &U1ChangeConf {
        &self.u1_change_conf
    }
    #[doc = "0x70 - Configuration register for unit $n's step value."]
    #[inline(always)]
    pub const fn u0_change_conf(&self) -> &U0ChangeConf {
        &self.u0_change_conf
    }
...
#[doc(alias = "U_CNT")]
pub type UCnt = crate::Reg<u_cnt::UCntSpec>;
...
#[doc(alias = "U_STATUS")]
pub type UStatus = crate::Reg<u_status::UStatusSpec>;
...
#[doc(alias = "U3_CHANGE_CONF")]
pub type U3ChangeConf = crate::Reg<u3_change_conf::U3ChangeConfSpec>;
...
#[doc(alias = "U2_CHANGE_CONF")]
pub type U2ChangeConf = crate::Reg<u2_change_conf::U2ChangeConfSpec>;
#[doc = "Configuration register for unit $n's step value."]
...
#[doc(alias = "U1_CHANGE_CONF")]
pub type U1ChangeConf = crate::Reg<u1_change_conf::U1ChangeConfSpec>;
#[doc = "Configuration register for unit $n's step value."]
...
#[doc(alias = "U0_CHANGE_CONF")]
pub type U0ChangeConf = crate::Reg<u0_change_conf::U0ChangeConfSpec>;
#[doc = "Configuration register for unit $n's step value."]

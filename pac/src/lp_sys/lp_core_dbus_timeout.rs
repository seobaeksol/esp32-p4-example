...
pub type R = crate::R<LpCoreDbusTimeoutSpec>;
#[doc = "Register `LP_CORE_DBUS_TIMEOUT` writer"]
pub type W = crate::W<LpCoreDbusTimeoutSpec>;
...
impl W {
    #[doc = "Bit 0 - set this field to 1 to enable lp core dbus timeout handle"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, LpCoreDbusTimeoutSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bits 1:16 - This field used to set lp core dbus timeout threshold"]
    #[inline(always)]
    pub fn thres(&mut self) -> ThresW<'_, LpCoreDbusTimeoutSpec> {
        ThresW::new(self, 1)
    }
}
...
pub struct LpCoreDbusTimeoutSpec;
impl crate::RegisterSpec for LpCoreDbusTimeoutSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lp_core_dbus_timeout::R`](R) reader structure"]
impl crate::Readable for LpCoreDbusTimeoutSpec {}
#[doc = "`write(|w| ..)` method takes [`lp_core_dbus_timeout::W`](W) writer structure"]
impl crate::Writable for LpCoreDbusTimeoutSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LP_CORE_DBUS_TIMEOUT to value 0x0001_ffff"]
impl crate::Resettable for LpCoreDbusTimeoutSpec {

...
pub type R = crate::R<DedPadRtcHoldCtrlSpec>;
#[doc = "Register `DED_PAD_RTC_HOLD_CTRL` writer"]
pub type W = crate::W<DedPadRtcHoldCtrlSpec>;
#[doc = "Field `DED_PAD_RTC_HOLD_CTRL` reader - Set bit0-5 to hold flash pad status. Set bit6-25 to hold psram pad status."]
pub type DedPadRtcHoldCtrlR = crate::FieldReader<u32>;
#[doc = "Field `DED_PAD_RTC_HOLD_CTRL` writer - Set bit0-5 to hold flash pad status. Set bit6-25 to hold psram pad status."]
pub type DedPadRtcHoldCtrlW<'a, REG> = crate::FieldWriter<'a, REG, 26, u32>;
impl R {
    #[doc = "Bits 0:25 - Set bit0-5 to hold flash pad status. Set bit6-25 to hold psram pad status."]
    #[inline(always)]
    pub fn ded_pad_rtc_hold_ctrl(&self) -> DedPadRtcHoldCtrlR {
        DedPadRtcHoldCtrlR::new(self.bits & 0x03ff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:25 - Set bit0-5 to hold flash pad status. Set bit6-25 to hold psram pad status."]
    #[inline(always)]
    pub fn ded_pad_rtc_hold_ctrl(&mut self) -> DedPadRtcHoldCtrlW<'_, DedPadRtcHoldCtrlSpec> {
        DedPadRtcHoldCtrlW::new(self, 0)
    }
}
...
pub struct DedPadRtcHoldCtrlSpec;
impl crate::RegisterSpec for DedPadRtcHoldCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ded_pad_rtc_hold_ctrl::R`](R) reader structure"]
impl crate::Readable for DedPadRtcHoldCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`ded_pad_rtc_hold_ctrl::W`](W) writer structure"]
impl crate::Writable for DedPadRtcHoldCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DED_PAD_RTC_HOLD_CTRL to value 0"]
impl crate::Resettable for DedPadRtcHoldCtrlSpec {}

...
pub type R = crate::R<LpStore12Spec>;
#[doc = "Register `LP_STORE12` writer"]
pub type W = crate::W<LpStore12Spec>;
#[doc = "Field `LP_SCRATCH12` reader - need_des"]
pub type LpScratch12R = crate::FieldReader<u32>;
#[doc = "Field `LP_SCRATCH12` writer - need_des"]
pub type LpScratch12W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - need_des"]
    #[inline(always)]
    pub fn lp_scratch12(&self) -> LpScratch12R {
        LpScratch12R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - need_des"]
    #[inline(always)]
    pub fn lp_scratch12(&mut self) -> LpScratch12W<'_, LpStore12Spec> {
        LpScratch12W::new(self, 0)
    }
}
...
pub struct LpStore12Spec;
impl crate::RegisterSpec for LpStore12Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lp_store12::R`](R) reader structure"]
impl crate::Readable for LpStore12Spec {}
#[doc = "`write(|w| ..)` method takes [`lp_store12::W`](W) writer structure"]
impl crate::Writable for LpStore12Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LP_STORE12 to value 0"]
impl crate::Resettable for LpStore12Spec {}

...
pub type R = crate::R<LpCoreErrRespDisSpec>;
#[doc = "Register `LP_CORE_ERR_RESP_DIS` writer"]
pub type W = crate::W<LpCoreErrRespDisSpec>;
...
pub type LpCoreErrRespDisR = crate::FieldReader;
...
pub type LpCoreErrRespDisW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bits 0:2 - Set bit0 to disable ibus err resp;Set bit1 to disable dbus err resp; Set bit 2 to disable ahb err resp."]
    #[inline(always)]
    pub fn lp_core_err_resp_dis(&self) -> LpCoreErrRespDisR {
        LpCoreErrRespDisR::new((self.bits & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:2 - Set bit0 to disable ibus err resp;Set bit1 to disable dbus err resp; Set bit 2 to disable ahb err resp."]
    #[inline(always)]
    pub fn lp_core_err_resp_dis(&mut self) -> LpCoreErrRespDisW<'_, LpCoreErrRespDisSpec> {
        LpCoreErrRespDisW::new(self, 0)
    }
}
...
pub struct LpCoreErrRespDisSpec;
impl crate::RegisterSpec for LpCoreErrRespDisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lp_core_err_resp_dis::R`](R) reader structure"]
impl crate::Readable for LpCoreErrRespDisSpec {}
#[doc = "`write(|w| ..)` method takes [`lp_core_err_resp_dis::W`](W) writer structure"]
impl crate::Writable for LpCoreErrRespDisSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LP_CORE_ERR_RESP_DIS to value 0"]
impl crate::Resettable for LpCoreErrRespDisSpec {}

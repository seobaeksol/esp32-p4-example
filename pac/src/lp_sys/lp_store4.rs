...
pub type R = crate::R<LpStore4Spec>;
#[doc = "Register `LP_STORE4` writer"]
pub type W = crate::W<LpStore4Spec>;
#[doc = "Field `LP_SCRATCH4` reader - need_des"]
pub type LpScratch4R = crate::FieldReader<u32>;
#[doc = "Field `LP_SCRATCH4` writer - need_des"]
pub type LpScratch4W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - need_des"]
    #[inline(always)]
    pub fn lp_scratch4(&self) -> LpScratch4R {
        LpScratch4R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - need_des"]
    #[inline(always)]
    pub fn lp_scratch4(&mut self) -> LpScratch4W<'_, LpStore4Spec> {
        LpScratch4W::new(self, 0)
    }
}
...
pub struct LpStore4Spec;
impl crate::RegisterSpec for LpStore4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lp_store4::R`](R) reader structure"]
impl crate::Readable for LpStore4Spec {}
#[doc = "`write(|w| ..)` method takes [`lp_store4::W`](W) writer structure"]
impl crate::Writable for LpStore4Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LP_STORE4 to value 0"]
impl crate::Resettable for LpStore4Spec {}

...
pub type R = crate::R<LpAddrholeInfoSpec>;
...
impl R {
    ...
    #[inline(always)]
    pub fn lp_addrhole_id(&self) -> LpAddrholeIdR {
        LpAddrholeIdR::new((self.bits & 0x1f) as u8)
    }
    #[doc = "Bit 5 - 1:write trans, 0: read trans."]
    #[inline(always)]
    pub fn lp_addrhole_wr(&self) -> LpAddrholeWrR {
        LpAddrholeWrR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - 1: illegal address access, 0: access without permission"]
    #[inline(always)]
    pub fn lp_addrhole_secure(&self) -> LpAddrholeSecureR {
        LpAddrholeSecureR::new(((self.bits >> 6) & 1) != 0)
    }
}
...
pub struct LpAddrholeInfoSpec;
impl crate::RegisterSpec for LpAddrholeInfoSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lp_addrhole_info::R`](R) reader structure"]
impl crate::Readable for LpAddrholeInfoSpec {}
#[doc = "`reset()` method sets LP_ADDRHOLE_INFO to value 0"]
impl crate::Resettable for LpAddrholeInfoSpec {}

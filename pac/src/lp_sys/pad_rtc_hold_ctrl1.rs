...
pub type R = crate::R<PadRtcHoldCtrl1Spec>;
#[doc = "Register `PAD_RTC_HOLD_CTRL1` writer"]
pub type W = crate::W<PadRtcHoldCtrl1Spec>;
#[doc = "Field `PAD_RTC_HOLD_CTRL1` reader - Set 1 to hold pad 32-56 status"]
pub type PadRtcHoldCtrl1R = crate::FieldReader<u32>;
#[doc = "Field `PAD_RTC_HOLD_CTRL1` writer - Set 1 to hold pad 32-56 status"]
pub type PadRtcHoldCtrl1W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
impl R {
    #[doc = "Bits 0:24 - Set 1 to hold pad 32-56 status"]
    #[inline(always)]
    pub fn pad_rtc_hold_ctrl1(&self) -> PadRtcHoldCtrl1R {
        PadRtcHoldCtrl1R::new(self.bits & 0x01ff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:24 - Set 1 to hold pad 32-56 status"]
    #[inline(always)]
    pub fn pad_rtc_hold_ctrl1(&mut self) -> PadRtcHoldCtrl1W<'_, PadRtcHoldCtrl1Spec> {
        PadRtcHoldCtrl1W::new(self, 0)
    }
}
...
pub struct PadRtcHoldCtrl1Spec;
impl crate::RegisterSpec for PadRtcHoldCtrl1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pad_rtc_hold_ctrl1::R`](R) reader structure"]
impl crate::Readable for PadRtcHoldCtrl1Spec {}
#[doc = "`write(|w| ..)` method takes [`pad_rtc_hold_ctrl1::W`](W) writer structure"]
impl crate::Writable for PadRtcHoldCtrl1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PAD_RTC_HOLD_CTRL1 to value 0"]
impl crate::Resettable for PadRtcHoldCtrl1Spec {}

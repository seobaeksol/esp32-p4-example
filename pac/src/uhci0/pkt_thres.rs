...
pub struct PktThresSpec;
impl crate::RegisterSpec for PktThresSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pkt_thres::R`](R) reader structure"]
impl crate::Readable for PktThresSpec {}
#[doc = "`write(|w| ..)` method takes [`pkt_thres::W`](W) writer structure"]
impl crate::Writable for PktThresSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PKT_THRES to value 0x80"]
impl crate::Resettable for PktThresSpec {

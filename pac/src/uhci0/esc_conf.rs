...
pub struct EscConfSpec;
impl crate::RegisterSpec for EscConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`esc_conf::R`](R) reader structure"]
impl crate::Readable for EscConfSpec {}
#[doc = "`write(|w| ..)` method takes [`esc_conf::W`](W) writer structure"]
impl crate::Writable for EscConfSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ESC_CONF%s to value 0x00dc_dbc0"]
impl crate::Resettable for EscConfSpec {

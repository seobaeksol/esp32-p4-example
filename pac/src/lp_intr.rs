...
impl RegisterBlock {
    #[doc = "0x00 - need_des"]
    #[inline(always)]
    pub const fn sw_int_raw(&self) -> &SwIntRaw {
        &self.sw_int_raw
    }
    #[doc = "0x04 - need_des"]
    #[inline(always)]
    pub const fn sw_int_st(&self) -> &SwIntSt {
        &self.sw_int_st
    }
    #[doc = "0x08 - need_des"]
    #[inline(always)]
    pub const fn sw_int_ena(&self) -> &SwIntEna {
        &self.sw_int_ena
    }
    #[doc = "0x0c - need_des"]
    #[inline(always)]
    pub const fn sw_int_clr(&self) -> &SwIntClr {
        &self.sw_int_clr
    }
    #[doc = "0x10 - need_des"]
    #[inline(always)]
...
#[doc(alias = "SW_INT_RAW")]
pub type SwIntRaw = crate::Reg<sw_int_raw::SwIntRawSpec>;
#[doc = "need_des"]
pub mod sw_int_raw;
...
#[doc(alias = "SW_INT_ST")]
pub type SwIntSt = crate::Reg<sw_int_st::SwIntStSpec>;
#[doc = "need_des"]
pub mod sw_int_st;
...
#[doc(alias = "SW_INT_ENA")]
pub type SwIntEna = crate::Reg<sw_int_ena::SwIntEnaSpec>;
#[doc = "need_des"]
pub mod sw_int_ena;
...
#[doc(alias = "SW_INT_CLR")]
pub type SwIntClr = crate::Reg<sw_int_clr::SwIntClrSpec>;
#[doc = "need_des"]
pub mod sw_int_clr;

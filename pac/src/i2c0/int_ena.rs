...
pub type RxfifoWmW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TxfifoWmW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EndDetectW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type ByteTransDoneW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type ArbitrationLostW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type MstTxfifoUdfW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TransCompleteW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TxfifoOvfW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RxfifoUdfW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SclStToW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SclMainStToW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DetStartW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SlaveStretchW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SlaveAddrUnmatchW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    #[doc = "Bit 0 - Write 1 to enable I2C_RXFIFO_WM_INT interrupt."]
    #[inline(always)]
    pub fn rxfifo_wm(&mut self) -> RxfifoWmW<'_, IntEnaSpec> {
        RxfifoWmW::new(self, 0)
    }
    #[doc = "Bit 1 - Write 1 to enable I2C_TXFIFO_WM_INT interrupt."]
    #[inline(always)]
    pub fn txfifo_wm(&mut self) -> TxfifoWmW<'_, IntEnaSpec> {
    ...
    #[doc = "Bit 3 - Write 1 to enable the I2C_END_DETECT_INT interrupt."]
    #[inline(always)]
    pub fn end_detect(&mut self) -> EndDetectW<'_, IntEnaSpec> {
        EndDetectW::new(self, 3)
    }
    #[doc = "Bit 4 - Write 1 to enable the I2C_END_DETECT_INT interrupt."]
    #[inline(always)]
    pub fn byte_trans_done(&mut self) -> ByteTransDoneW<'_, IntEnaSpec> {
        ByteTransDoneW::new(self, 4)
    }
    #[doc = "Bit 5 - Write 1 to enable the I2C_ARBITRATION_LOST_INT interrupt."]
    #[inline(always)]
    pub fn arbitration_lost(&mut self) -> ArbitrationLostW<'_, IntEnaSpec> {
        ArbitrationLostW::new(self, 5)
    }
    #[doc = "Bit 6 - Write 1 to enable I2C_TRANS_COMPLETE_INT interrupt."]
    #[inline(always)]
    pub fn mst_txfifo_udf(&mut self) -> MstTxfifoUdfW<'_, IntEnaSpec> {
        MstTxfifoUdfW::new(self, 6)
    }
    #[doc = "Bit 7 - Write 1 to enable the I2C_TRANS_COMPLETE_INT interrupt."]
    #[inline(always)]
    pub fn trans_complete(&mut self) -> TransCompleteW<'_, IntEnaSpec> {
        TransCompleteW::new(self, 7)
    }
    #[doc = "Bit 8 - Write 1 to enable the I2C_TIME_OUT_INT interrupt."]
    #[inline(always)]
    pub fn time_out(&mut self) -> TimeOutW<'_, IntEnaSpec> {
        TimeOutW::new(self, 8)
    }
    #[doc = "Bit 9 - Write 1 to enable the I2C_TRANS_START_INT interrupt."]
    #[inline(always)]
    pub fn trans_start(&mut self) -> TransStartW<'_, IntEnaSpec> {
        TransStartW::new(self, 9)
    }
    #[doc = "Bit 10 - Write 1 to enable I2C_SLAVE_STRETCH_INT interrupt."]
    #[inline(always)]
    pub fn nack(&mut self) -> NackW<'_, IntEnaSpec> {
        NackW::new(self, 10)
    }
    #[doc = "Bit 11 - Write 1 to enable I2C_TXFIFO_OVF_INT interrupt."]
    #[inline(always)]
    pub fn txfifo_ovf(&mut self) -> TxfifoOvfW<'_, IntEnaSpec> {
        TxfifoOvfW::new(self, 11)
    }
    #[doc = "Bit 12 - Write 1 to enable I2C_RXFIFO_UDF_INT interrupt."]
    #[inline(always)]
    pub fn rxfifo_udf(&mut self) -> RxfifoUdfW<'_, IntEnaSpec> {
        RxfifoUdfW::new(self, 12)
    }
    #[doc = "Bit 13 - Write 1 to enable I2C_SCL_ST_TO_INT interrupt."]
    #[inline(always)]
    pub fn scl_st_to(&mut self) -> SclStToW<'_, IntEnaSpec> {
        SclStToW::new(self, 13)
    }
    #[doc = "Bit 14 - Write 1 to enable I2C_SCL_MAIN_ST_TO_INT interrupt."]
    #[inline(always)]
    pub fn scl_main_st_to(&mut self) -> SclMainStToW<'_, IntEnaSpec> {
        SclMainStToW::new(self, 14)
    }
    #[doc = "Bit 15 - Write 1 to enable I2C_DET_START_INT interrupt."]
    #[inline(always)]
    pub fn det_start(&mut self) -> DetStartW<'_, IntEnaSpec> {
        DetStartW::new(self, 15)
    }
    #[doc = "Bit 16 - Write 1 to enable I2C_SLAVE_STRETCH_INT interrupt."]
    #[inline(always)]
    pub fn slave_stretch(&mut self) -> SlaveStretchW<'_, IntEnaSpec> {
        SlaveStretchW::new(self, 16)
    }
    #[doc = "Bit 17 - Write 1 to enable I2C_GENARAL_CALL_INT interrupt."]
    #[inline(always)]
    pub fn general_call(&mut self) -> GeneralCallW<'_, IntEnaSpec> {
        GeneralCallW::new(self, 17)
    }
    #[doc = "Bit 18 - Write 1 to enable I2C_SLAVE_ADDR_UNMATCH_INT interrupt."]
    #[inline(always)]
    pub fn slave_addr_unmatch(&mut self) -> SlaveAddrUnmatchW<'_, IntEnaSpec> {

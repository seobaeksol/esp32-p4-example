...
pub type RespRecR = crate::BitReader;
...
pub type SlaveRwR = crate::BitReader;
...
pub type SlaveAddressedR = crate::BitReader;
...
pub type StretchCauseR = crate::FieldReader;
...
pub type SclMainStateLastR = crate::FieldReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn slave_addressed(&self) -> SlaveAddressedR {
        SlaveAddressedR::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn stretch_cause(&self) -> StretchCauseR {
        StretchCauseR::new(((self.bits >> 14) & 3) as u8)
    }
    #[doc = "Bits 18:23 - Represents the number of data bytes to be sent."]
    #[inline(always)]
    pub fn txfifo_cnt(&self) -> TxfifoCntR {
        TxfifoCntR::new(((self.bits >> 18) & 0x3f) as u8)
    }
    ...
    #[inline(always)]
    pub fn scl_main_state_last(&self) -> SclMainStateLastR {
        SclMainStateLastR::new(((self.bits >> 24) & 7) as u8)
    }
    ...
    #[inline(always)]
    pub fn scl_state_last(&self) -> SclStateLastR {
        SclStateLastR::new(((self.bits >> 28) & 7) as u8)
    }
}

...
pub type R = crate::R<SdaSampleSpec>;
#[doc = "Register `SDA_SAMPLE` writer"]
pub type W = crate::W<SdaSampleSpec>;
...
impl W {
    #[doc = "Bits 0:8 - Configures the time for sampling SDA.\\\\ Measurement unit: i2c_sclk \\\\"]
    #[inline(always)]
    pub fn time(&mut self) -> TimeW<'_, SdaSampleSpec> {
        TimeW::new(self, 0)
    }
}
...
pub struct SdaSampleSpec;
impl crate::RegisterSpec for SdaSampleSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sda_sample::R`](R) reader structure"]
impl crate::Readable for SdaSampleSpec {}
#[doc = "`write(|w| ..)` method takes [`sda_sample::W`](W) writer structure"]
impl crate::Writable for SdaSampleSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SDA_SAMPLE to value 0"]
impl crate::Resettable for SdaSampleSpec {}

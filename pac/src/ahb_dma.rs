...
pub struct RegisterBlock {
    in_int_ch: [InIntCh; 3],
    out_int_ch: [OutIntCh; 3],
    ahb_test: AhbTest,
    misc_conf: MiscConf,
    date: Date,
    _reserved5: [u8; 0x04],
    ch: (),
    _reserved6: [u8; 0x024c],
    ...
    _reserved14: [u8; 0x04],
    tx_ch_arb_weight_ch0: TxChArbWeightCh0,
    tx_arb_weight_opt_dir_ch0: TxArbWeightOptDirCh0,
    _reserved16: [u8; 0x20],
    tx_ch_arb_weight_ch1: TxChArbWeightCh1,
    tx_arb_weight_opt_dir_ch1: TxArbWeightOptDirCh1,
    _reserved18: [u8; 0x20],
    tx_ch_arb_weight_ch2: TxChArbWeightCh2,
    tx_arb_weight_opt_dir_ch2: TxArbWeightOptDirCh2,
    in_crc_init_data_ch: (),
    _reserved21: [u8; 0x04],
    rx_crc_width_ch: (),
    _reserved22: [u8; 0x04],
    ...
    _reserved28: [u8; 0x04],
    rx_ch_arb_weight_ch0: RxChArbWeightCh0,
    rx_arb_weight_opt_dir_ch0: RxArbWeightOptDirCh0,
    _reserved30: [u8; 0x20],
    rx_ch_arb_weight_ch1: RxChArbWeightCh1,
    rx_arb_weight_opt_dir_ch1: RxArbWeightOptDirCh1,
    _reserved32: [u8; 0x20],
    rx_ch_arb_weight_ch2: RxChArbWeightCh2,
    rx_arb_weight_opt_dir_ch2: RxArbWeightOptDirCh2,
    in_link_addr_ch: [InLinkAddrCh; 3],
    out_link_addr_ch: [OutLinkAddrCh; 3],
    intr_mem_start_addr: IntrMemStartAddr,
    intr_mem_end_addr: IntrMemEndAddr,
    arb_timeout_tx: ArbTimeoutTx,
    arb_timeout_rx: ArbTimeoutRx,
    weight_en_tx: WeightEnTx,
    weight_en_rx: WeightEnRx,
    arb_timeout: ArbTimeout,
    _reserved43: [u8; 0x20],
    weight_en: WeightEn,
    module_clk_en: ModuleClkEn,
    ahbinf_resp_err_status0: AhbinfRespErrStatus0,
    ahbinf_resp_err_status1: AhbinfRespErrStatus1,
    in_done_des_addr_ch0: InDoneDesAddrCh0,
    out_done_des_addr_ch0: OutDoneDesAddrCh0,
    in_done_des_addr_ch1: InDoneDesAddrCh1,
    out_done_des_addr_ch1: OutDoneDesAddrCh1,
    in_done_des_addr_ch2: InDoneDesAddrCh2,
    out_done_des_addr_ch2: OutDoneDesAddrCh2,
}
impl RegisterBlock {
    #[doc = "0x00..0x30 - Cluster IN_INT_CH%s, containing IN_INT_RAW_CH?, IN_INT_ST_CH?, IN_INT_ENA_CH?, IN_INT_CLR_CH?"]
    #[inline(always)]
    pub const fn in_int_ch(&self, n: usize) -> &InIntCh {
        &self.in_int_ch[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x00..0x30 - Cluster IN_INT_CH%s, containing IN_INT_RAW_CH?, IN_INT_ST_CH?, IN_INT_ENA_CH?, IN_INT_CLR_CH?"]
    #[inline(always)]
    pub fn in_int_ch_iter(&self) -> impl Iterator<Item = &InIntCh> {
        self.in_int_ch.iter()
    }
    #[doc = "0x30..0x60 - Cluster OUT_INT_CH%s, containing OUT_INT_RAW_CH?, OUT_INT_ST_CH?, OUT_INT_ENA_CH?, OUT_INT_CLR_CH?"]
    #[inline(always)]
    pub const fn out_int_ch(&self, n: usize) -> &OutIntCh {
        &self.out_int_ch[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x30..0x60 - Cluster OUT_INT_CH%s, containing OUT_INT_RAW_CH?, OUT_INT_ST_CH?, OUT_INT_ENA_CH?, OUT_INT_CLR_CH?"]
    #[inline(always)]
    pub fn out_int_ch_iter(&self) -> impl Iterator<Item = &OutIntCh> {
        self.out_int_ch.iter()
    }
    #[doc = "0x60 - only for test"]
    #[inline(always)]
    pub const fn ahb_test(&self) -> &AhbTest {
        &self.ahb_test
    }
    #[doc = "0x64 - reserved"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn out_crc_init_data_ch(&self, n: usize) -> &OutCrcInitDataCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x2bc..0x2c8 - This register is used to config ch%s crc initial data(max 32 bit)"]
    #[inline(always)]
    pub fn out_crc_init_data_ch_iter(&self) -> impl Iterator<Item = &OutCrcInitDataCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(700)
    ...
    #[inline(always)]
    pub const fn tx_crc_width_ch(&self, n: usize) -> &TxCrcWidthCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x2c0..0x2cc - This register is used to confiig tx ch%s crc result width,2'b00 mean crc_width <=8bit,2'b01 8<crc_width<=16 ,2'b10 mean 16<crc_width <=24,2'b11 mean 24<crc_width<=32"]
    #[inline(always)]
    pub fn tx_crc_width_ch_iter(&self) -> impl Iterator<Item = &TxCrcWidthCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(704)
    ...
    #[inline(always)]
    pub const fn out_crc_clear_ch(&self, n: usize) -> &OutCrcClearCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x2c4..0x2d0 - This register is used to clear ch%s crc result"]
    #[inline(always)]
    pub fn out_crc_clear_ch_iter(&self) -> impl Iterator<Item = &OutCrcClearCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(708)
    ...
    #[inline(always)]
    pub const fn out_crc_final_result_ch(&self, n: usize) -> &OutCrcFinalResultCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x2c8..0x2d4 - This register is used to store ch%s crc result"]
    #[inline(always)]
    pub fn out_crc_final_result_ch_iter(&self) -> impl Iterator<Item = &OutCrcFinalResultCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(712)
    ...
    #[inline(always)]
    pub const fn tx_crc_en_wr_data_ch(&self, n: usize) -> &TxCrcEnWrDataCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x2cc..0x2d8 - This resister is used to config ch%s crc en for every bit"]
    #[inline(always)]
    pub fn tx_crc_en_wr_data_ch_iter(&self) -> impl Iterator<Item = &TxCrcEnWrDataCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(716)
    ...
    #[inline(always)]
    pub const fn tx_crc_en_addr_ch(&self, n: usize) -> &TxCrcEnAddrCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x2d0..0x2dc - This register is used to config ch%s crc en addr"]
    #[inline(always)]
    pub fn tx_crc_en_addr_ch_iter(&self) -> impl Iterator<Item = &TxCrcEnAddrCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(720)
    ...
    #[inline(always)]
    pub const fn tx_crc_data_en_wr_data_ch(&self, n: usize) -> &TxCrcDataEnWrDataCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x2d4..0x2e0 - This register is used to config crc data_8bit en"]
    #[inline(always)]
    pub fn tx_crc_data_en_wr_data_ch_iter(&self) -> impl Iterator<Item = &TxCrcDataEnWrDataCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(724)
    ...
    #[inline(always)]
    pub const fn tx_crc_data_en_addr_ch(&self, n: usize) -> &TxCrcDataEnAddrCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x2d8..0x2e4 - This register is used to config addr of crc data_8bit en"]
    #[inline(always)]
    pub fn tx_crc_data_en_addr_ch_iter(&self) -> impl Iterator<Item = &TxCrcDataEnAddrCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(728)
    ...
    #[doc = "0x334..0x340 - This register is used to config ch%s crc initial data(max 32 bit)"]
    #[inline(always)]
    pub fn in_crc_init_data_ch_iter(&self) -> impl Iterator<Item = &InCrcInitDataCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(820)
    ...
    #[inline(always)]
    pub const fn rx_crc_width_ch(&self, n: usize) -> &RxCrcWidthCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x338..0x344 - This register is used to confiig rx ch%s crc result width,2'b00 mean crc_width <=8bit,2'b01 8<crc_width<=16 ,2'b10 mean 16<crc_width <=24,2'b11 mean 24<crc_width<=32"]
    #[inline(always)]
    pub fn rx_crc_width_ch_iter(&self) -> impl Iterator<Item = &RxCrcWidthCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(824)
    ...
    #[inline(always)]
    pub const fn in_crc_clear_ch(&self, n: usize) -> &InCrcClearCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x33c..0x348 - This register is used to clear ch%s crc result"]
    #[inline(always)]
    pub fn in_crc_clear_ch_iter(&self) -> impl Iterator<Item = &InCrcClearCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(828)
    ...
    #[inline(always)]
    pub const fn in_crc_final_result_ch(&self, n: usize) -> &InCrcFinalResultCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x340..0x34c - This register is used to store ch%s crc result"]
    #[inline(always)]
    pub fn in_crc_final_result_ch_iter(&self) -> impl Iterator<Item = &InCrcFinalResultCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(832)
    ...
    #[inline(always)]
    pub const fn rx_crc_en_wr_data_ch(&self, n: usize) -> &RxCrcEnWrDataCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x344..0x350 - This resister is used to config ch%s crc en for every bit"]
    #[inline(always)]
    pub fn rx_crc_en_wr_data_ch_iter(&self) -> impl Iterator<Item = &RxCrcEnWrDataCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(836)
    ...
    #[inline(always)]
    pub const fn rx_crc_en_addr_ch(&self, n: usize) -> &RxCrcEnAddrCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x348..0x354 - This register is used to config ch%s crc en addr"]
    #[inline(always)]
    pub fn rx_crc_en_addr_ch_iter(&self) -> impl Iterator<Item = &RxCrcEnAddrCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(840)
    ...
    #[inline(always)]
    pub const fn rx_crc_data_en_wr_data_ch(&self, n: usize) -> &RxCrcDataEnWrDataCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x34c..0x358 - This register is used to config crc data_8bit en"]
    #[inline(always)]
    pub fn rx_crc_data_en_wr_data_ch_iter(&self) -> impl Iterator<Item = &RxCrcDataEnWrDataCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(844)
    ...
    #[inline(always)]
    pub const fn rx_crc_data_en_addr_ch(&self, n: usize) -> &RxCrcDataEnAddrCh {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x350..0x35c - This register is used to config addr of crc data_8bit en"]
    #[inline(always)]
    pub fn rx_crc_data_en_addr_ch_iter(&self) -> impl Iterator<Item = &RxCrcDataEnAddrCh> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(848)
    ...
    #[inline(always)]
    pub const fn arb_timeout_tx(&self) -> &ArbTimeoutTx {
        &self.arb_timeout_tx
    }
    #[doc = "0x3d0 - RX arbitration timeout configuration register"]
    #[inline(always)]
    pub const fn arb_timeout_rx(&self) -> &ArbTimeoutRx {
        &self.arb_timeout_rx
    }
    #[doc = "0x3d4 - TX weight arbitration enable register"]
    #[inline(always)]
    pub const fn weight_en_tx(&self) -> &WeightEnTx {
        &self.weight_en_tx
    }
    #[doc = "0x3d8 - RX weight arbitration enable register"]
    #[inline(always)]
    pub const fn weight_en_rx(&self) -> &WeightEnRx {
        &self.weight_en_rx
    }
...
#[doc(alias = "AHB_TEST")]
pub type AhbTest = crate::Reg<ahb_test::AhbTestSpec>;
#[doc = "only for test"]
pub mod ahb_test;
...
#[doc(alias = "OUT_CRC_INIT_DATA_CH")]
pub type OutCrcInitDataCh = crate::Reg<out_crc_init_data_ch::OutCrcInitDataChSpec>;
...
#[doc(alias = "TX_CRC_WIDTH_CH")]
pub type TxCrcWidthCh = crate::Reg<tx_crc_width_ch::TxCrcWidthChSpec>;
...
#[doc(alias = "OUT_CRC_CLEAR_CH")]
pub type OutCrcClearCh = crate::Reg<out_crc_clear_ch::OutCrcClearChSpec>;
...
#[doc(alias = "OUT_CRC_FINAL_RESULT_CH")]
pub type OutCrcFinalResultCh = crate::Reg<out_crc_final_result_ch::OutCrcFinalResultChSpec>;
...
#[doc(alias = "TX_CRC_EN_WR_DATA_CH")]
pub type TxCrcEnWrDataCh = crate::Reg<tx_crc_en_wr_data_ch::TxCrcEnWrDataChSpec>;
...
#[doc(alias = "TX_CRC_EN_ADDR_CH")]
pub type TxCrcEnAddrCh = crate::Reg<tx_crc_en_addr_ch::TxCrcEnAddrChSpec>;
...
#[doc(alias = "TX_CRC_DATA_EN_WR_DATA_CH")]
pub type TxCrcDataEnWrDataCh = crate::Reg<tx_crc_data_en_wr_data_ch::TxCrcDataEnWrDataChSpec>;
...
#[doc(alias = "TX_CRC_DATA_EN_ADDR_CH")]
pub type TxCrcDataEnAddrCh = crate::Reg<tx_crc_data_en_addr_ch::TxCrcDataEnAddrChSpec>;
...
#[doc(alias = "TX_CH_ARB_WEIGHT_CH0")]
pub type TxChArbWeightCh0 = crate::Reg<tx_ch_arb_weight_ch0::TxChArbWeightCh0Spec>;
...
#[doc(alias = "TX_ARB_WEIGHT_OPT_DIR_CH0")]
pub type TxArbWeightOptDirCh0 = crate::Reg<tx_arb_weight_opt_dir_ch0::TxArbWeightOptDirCh0Spec>;
...
#[doc(alias = "TX_CH_ARB_WEIGHT_CH1")]
pub type TxChArbWeightCh1 = crate::Reg<tx_ch_arb_weight_ch1::TxChArbWeightCh1Spec>;
...
#[doc(alias = "TX_ARB_WEIGHT_OPT_DIR_CH1")]
pub type TxArbWeightOptDirCh1 = crate::Reg<tx_arb_weight_opt_dir_ch1::TxArbWeightOptDirCh1Spec>;
...
#[doc(alias = "TX_CH_ARB_WEIGHT_CH2")]
pub type TxChArbWeightCh2 = crate::Reg<tx_ch_arb_weight_ch2::TxChArbWeightCh2Spec>;
...
#[doc(alias = "TX_ARB_WEIGHT_OPT_DIR_CH2")]
pub type TxArbWeightOptDirCh2 = crate::Reg<tx_arb_weight_opt_dir_ch2::TxArbWeightOptDirCh2Spec>;
...
#[doc(alias = "IN_CRC_INIT_DATA_CH")]
pub type InCrcInitDataCh = crate::Reg<in_crc_init_data_ch::InCrcInitDataChSpec>;
#[doc = "This register is used to config ch%s crc initial data(max 32 bit)"]
...
#[doc(alias = "RX_CRC_WIDTH_CH")]
pub type RxCrcWidthCh = crate::Reg<rx_crc_width_ch::RxCrcWidthChSpec>;
...
#[doc(alias = "IN_CRC_CLEAR_CH")]
pub type InCrcClearCh = crate::Reg<in_crc_clear_ch::InCrcClearChSpec>;
#[doc = "This register is used to clear ch%s crc result"]
...
#[doc(alias = "IN_CRC_FINAL_RESULT_CH")]
pub type InCrcFinalResultCh = crate::Reg<in_crc_final_result_ch::InCrcFinalResultChSpec>;
#[doc = "This register is used to store ch%s crc result"]
...
#[doc(alias = "RX_CRC_EN_WR_DATA_CH")]
pub type RxCrcEnWrDataCh = crate::Reg<rx_crc_en_wr_data_ch::RxCrcEnWrDataChSpec>;
#[doc = "This resister is used to config ch%s crc en for every bit"]
...
#[doc(alias = "RX_CRC_EN_ADDR_CH")]
pub type RxCrcEnAddrCh = crate::Reg<rx_crc_en_addr_ch::RxCrcEnAddrChSpec>;
#[doc = "This register is used to config ch%s crc en addr"]
...
#[doc(alias = "RX_CRC_DATA_EN_WR_DATA_CH")]
pub type RxCrcDataEnWrDataCh = crate::Reg<rx_crc_data_en_wr_data_ch::RxCrcDataEnWrDataChSpec>;
#[doc = "This register is used to config crc data_8bit en"]
...
#[doc(alias = "RX_CRC_DATA_EN_ADDR_CH")]
pub type RxCrcDataEnAddrCh = crate::Reg<rx_crc_data_en_addr_ch::RxCrcDataEnAddrChSpec>;
#[doc = "This register is used to config addr of crc data_8bit en"]
...
#[doc(alias = "RX_CH_ARB_WEIGHT_CH0")]
pub type RxChArbWeightCh0 = crate::Reg<rx_ch_arb_weight_ch0::RxChArbWeightCh0Spec>;
...
#[doc(alias = "RX_ARB_WEIGHT_OPT_DIR_CH0")]
pub type RxArbWeightOptDirCh0 = crate::Reg<rx_arb_weight_opt_dir_ch0::RxArbWeightOptDirCh0Spec>;
...
#[doc(alias = "RX_CH_ARB_WEIGHT_CH1")]
pub type RxChArbWeightCh1 = crate::Reg<rx_ch_arb_weight_ch1::RxChArbWeightCh1Spec>;
...
#[doc(alias = "RX_ARB_WEIGHT_OPT_DIR_CH1")]
pub type RxArbWeightOptDirCh1 = crate::Reg<rx_arb_weight_opt_dir_ch1::RxArbWeightOptDirCh1Spec>;
...
#[doc(alias = "RX_CH_ARB_WEIGHT_CH2")]
pub type RxChArbWeightCh2 = crate::Reg<rx_ch_arb_weight_ch2::RxChArbWeightCh2Spec>;
...
#[doc(alias = "RX_ARB_WEIGHT_OPT_DIR_CH2")]
pub type RxArbWeightOptDirCh2 = crate::Reg<rx_arb_weight_opt_dir_ch2::RxArbWeightOptDirCh2Spec>;
...
pub use self::in_link_addr_ch::InLinkAddrCh;
#[doc = r"Cluster"]
#[doc = "Cluster IN_LINK_ADDR_CH%s, containing IN_LINK_ADDR_CH?"]
pub mod in_link_addr_ch;
#[doc = "Cluster OUT_LINK_ADDR_CH%s, containing OUT_LINK_ADDR_CH?"]
pub use self::out_link_addr_ch::OutLinkAddrCh;
#[doc = r"Cluster"]
#[doc = "Cluster OUT_LINK_ADDR_CH%s, containing OUT_LINK_ADDR_CH?"]
...
#[doc(alias = "ARB_TIMEOUT_TX")]
pub type ArbTimeoutTx = crate::Reg<arb_timeout_tx::ArbTimeoutTxSpec>;
...
#[doc(alias = "ARB_TIMEOUT_RX")]
pub type ArbTimeoutRx = crate::Reg<arb_timeout_rx::ArbTimeoutRxSpec>;
...
#[doc(alias = "WEIGHT_EN_TX")]
pub type WeightEnTx = crate::Reg<weight_en_tx::WeightEnTxSpec>;
...
#[doc(alias = "WEIGHT_EN_RX")]
pub type WeightEnRx = crate::Reg<weight_en_rx::WeightEnRxSpec>;
...
#[doc(alias = "MODULE_CLK_EN")]
pub type ModuleClkEn = crate::Reg<module_clk_en::ModuleClkEnSpec>;
...
#[doc(alias = "AHBINF_RESP_ERR_STATUS0")]
pub type AhbinfRespErrStatus0 = crate::Reg<ahbinf_resp_err_status0::AhbinfRespErrStatus0Spec>;
...
#[doc(alias = "AHBINF_RESP_ERR_STATUS1")]
pub type AhbinfRespErrStatus1 = crate::Reg<ahbinf_resp_err_status1::AhbinfRespErrStatus1Spec>;
...
#[doc(alias = "IN_DONE_DES_ADDR_CH0")]
pub type InDoneDesAddrCh0 = crate::Reg<in_done_des_addr_ch0::InDoneDesAddrCh0Spec>;
...
#[doc(alias = "OUT_DONE_DES_ADDR_CH0")]
pub type OutDoneDesAddrCh0 = crate::Reg<out_done_des_addr_ch0::OutDoneDesAddrCh0Spec>;
...
#[doc(alias = "IN_DONE_DES_ADDR_CH1")]
pub type InDoneDesAddrCh1 = crate::Reg<in_done_des_addr_ch1::InDoneDesAddrCh1Spec>;
...
#[doc(alias = "OUT_DONE_DES_ADDR_CH1")]
pub type OutDoneDesAddrCh1 = crate::Reg<out_done_des_addr_ch1::OutDoneDesAddrCh1Spec>;
...
#[doc(alias = "IN_DONE_DES_ADDR_CH2")]
pub type InDoneDesAddrCh2 = crate::Reg<in_done_des_addr_ch2::InDoneDesAddrCh2Spec>;
...
#[doc(alias = "OUT_DONE_DES_ADDR_CH2")]
pub type OutDoneDesAddrCh2 = crate::Reg<out_done_des_addr_ch2::OutDoneDesAddrCh2Spec>;

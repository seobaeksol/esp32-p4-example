...
pub type R = crate::R<Core1Dram0ExceptionMonitor1Spec>;
#[doc = "Field `CORE_1_DRAM0_RECORDING_ADDR_0` reader - reg_core_1_dram0_recording_addr_0"]
pub type Core1Dram0RecordingAddr0R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:23 - reg_core_1_dram0_recording_addr_0"]
    #[inline(always)]
    pub fn core_1_dram0_recording_addr_0(&self) -> Core1Dram0RecordingAddr0R {
        Core1Dram0RecordingAddr0R::new(self.bits & 0x00ff_ffff)
    }
}
...
pub struct Core1Dram0ExceptionMonitor1Spec;
impl crate::RegisterSpec for Core1Dram0ExceptionMonitor1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`core_1_dram0_exception_monitor_1::R`](R) reader structure"]
impl crate::Readable for Core1Dram0ExceptionMonitor1Spec {}
#[doc = "`reset()` method sets CORE_1_DRAM0_EXCEPTION_MONITOR_1 to value 0"]
impl crate::Resettable for Core1Dram0ExceptionMonitor1Spec {}

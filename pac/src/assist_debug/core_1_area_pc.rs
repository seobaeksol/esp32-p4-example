...
pub struct Core1AreaPcSpec;
impl crate::RegisterSpec for Core1AreaPcSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`core_1_area_pc::R`](R) reader structure"]
impl crate::Readable for Core1AreaPcSpec {}
#[doc = "`reset()` method sets CORE_1_AREA_PC to value 0"]
impl crate::Resettable for Core1AreaPcSpec {}

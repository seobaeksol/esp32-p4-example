...
pub type R = crate::R<CoreXIram0Dram0ExceptionMonitor0Spec>;
#[doc = "Register `CORE_X_IRAM0_DRAM0_EXCEPTION_MONITOR_0` writer"]
pub type W = crate::W<CoreXIram0Dram0ExceptionMonitor0Spec>;
#[doc = "Field `CORE_X_IRAM0_DRAM0_LIMIT_CYCLE_0` reader - reg_core_x_iram0_dram0_limit_cycle_0"]
pub type CoreXIram0Dram0LimitCycle0R = crate::FieldReader<u32>;
#[doc = "Field `CORE_X_IRAM0_DRAM0_LIMIT_CYCLE_0` writer - reg_core_x_iram0_dram0_limit_cycle_0"]
pub type CoreXIram0Dram0LimitCycle0W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
impl R {
    #[doc = "Bits 0:19 - reg_core_x_iram0_dram0_limit_cycle_0"]
    #[inline(always)]
    pub fn core_x_iram0_dram0_limit_cycle_0(&self) -> CoreXIram0Dram0LimitCycle0R {
        CoreXIram0Dram0LimitCycle0R::new(self.bits & 0x000f_ffff)
    }
}
impl W {
    #[doc = "Bits 0:19 - reg_core_x_iram0_dram0_limit_cycle_0"]
    ...
    pub fn core_x_iram0_dram0_limit_cycle_0(
        &mut self,
    ) -> CoreXIram0Dram0LimitCycle0W<'_, CoreXIram0Dram0ExceptionMonitor0Spec> {
        CoreXIram0Dram0LimitCycle0W::new(self, 0)
    }
}
...
pub struct CoreXIram0Dram0ExceptionMonitor0Spec;
impl crate::RegisterSpec for CoreXIram0Dram0ExceptionMonitor0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`core_x_iram0_dram0_exception_monitor_0::R`](R) reader structure"]
impl crate::Readable for CoreXIram0Dram0ExceptionMonitor0Spec {}
#[doc = "`write(|w| ..)` method takes [`core_x_iram0_dram0_exception_monitor_0::W`](W) writer structure"]
impl crate::Writable for CoreXIram0Dram0ExceptionMonitor0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CORE_X_IRAM0_DRAM0_EXCEPTION_MONITOR_0 to value 0"]
impl crate::Resettable for CoreXIram0Dram0ExceptionMonitor0Spec {}

...
pub type R = crate::R<Core1AreaDram0_0MinSpec>;
#[doc = "Register `CORE_1_AREA_DRAM0_0_MIN` writer"]
pub type W = crate::W<Core1AreaDram0_0MinSpec>;
#[doc = "Field `CORE_1_AREA_DRAM0_0_MIN` reader - Core1 dram0 region0 start addr"]
pub type Core1AreaDram0_0MinR = crate::FieldReader<u32>;
#[doc = "Field `CORE_1_AREA_DRAM0_0_MIN` writer - Core1 dram0 region0 start addr"]
pub type Core1AreaDram0_0MinW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Core1 dram0 region0 start addr"]
    #[inline(always)]
    pub fn core_1_area_dram0_0_min(&self) -> Core1AreaDram0_0MinR {
        Core1AreaDram0_0MinR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Core1 dram0 region0 start addr"]
    #[inline(always)]
    pub fn core_1_area_dram0_0_min(&mut self) -> Core1AreaDram0_0MinW<'_, Core1AreaDram0_0MinSpec> {
        Core1AreaDram0_0MinW::new(self, 0)
    }
}
...
pub struct Core1AreaDram0_0MinSpec;
impl crate::RegisterSpec for Core1AreaDram0_0MinSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`core_1_area_dram0_0_min::R`](R) reader structure"]
impl crate::Readable for Core1AreaDram0_0MinSpec {}
#[doc = "`write(|w| ..)` method takes [`core_1_area_dram0_0_min::W`](W) writer structure"]
impl crate::Writable for Core1AreaDram0_0MinSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CORE_1_AREA_DRAM0_0_MIN to value 0xffff_ffff"]
impl crate::Resettable for Core1AreaDram0_0MinSpec {

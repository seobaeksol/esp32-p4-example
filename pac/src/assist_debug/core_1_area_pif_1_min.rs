...
pub type R = crate::R<Core1AreaPif1MinSpec>;
#[doc = "Register `CORE_1_AREA_PIF_1_MIN` writer"]
pub type W = crate::W<Core1AreaPif1MinSpec>;
#[doc = "Field `CORE_1_AREA_PIF_1_MIN` reader - Core1 PIF region1 start addr"]
pub type Core1AreaPif1MinR = crate::FieldReader<u32>;
#[doc = "Field `CORE_1_AREA_PIF_1_MIN` writer - Core1 PIF region1 start addr"]
pub type Core1AreaPif1MinW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Core1 PIF region1 start addr"]
    #[inline(always)]
    pub fn core_1_area_pif_1_min(&self) -> Core1AreaPif1MinR {
        Core1AreaPif1MinR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Core1 PIF region1 start addr"]
    #[inline(always)]
    pub fn core_1_area_pif_1_min(&mut self) -> Core1AreaPif1MinW<'_, Core1AreaPif1MinSpec> {
        Core1AreaPif1MinW::new(self, 0)
    }
}
...
pub struct Core1AreaPif1MinSpec;
impl crate::RegisterSpec for Core1AreaPif1MinSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`core_1_area_pif_1_min::R`](R) reader structure"]
impl crate::Readable for Core1AreaPif1MinSpec {}
#[doc = "`write(|w| ..)` method takes [`core_1_area_pif_1_min::W`](W) writer structure"]
impl crate::Writable for Core1AreaPif1MinSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CORE_1_AREA_PIF_1_MIN to value 0xffff_ffff"]
impl crate::Resettable for Core1AreaPif1MinSpec {

...
pub type R = crate::R<Core1AreaPif1MaxSpec>;
#[doc = "Register `CORE_1_AREA_PIF_1_MAX` writer"]
pub type W = crate::W<Core1AreaPif1MaxSpec>;
#[doc = "Field `CORE_1_AREA_PIF_1_MAX` reader - Core1 PIF region1 end addr"]
pub type Core1AreaPif1MaxR = crate::FieldReader<u32>;
#[doc = "Field `CORE_1_AREA_PIF_1_MAX` writer - Core1 PIF region1 end addr"]
pub type Core1AreaPif1MaxW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Core1 PIF region1 end addr"]
    #[inline(always)]
    pub fn core_1_area_pif_1_max(&self) -> Core1AreaPif1MaxR {
        Core1AreaPif1MaxR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Core1 PIF region1 end addr"]
    #[inline(always)]
    pub fn core_1_area_pif_1_max(&mut self) -> Core1AreaPif1MaxW<'_, Core1AreaPif1MaxSpec> {
        Core1AreaPif1MaxW::new(self, 0)
    }
}
...
pub struct Core1AreaPif1MaxSpec;
impl crate::RegisterSpec for Core1AreaPif1MaxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`core_1_area_pif_1_max::R`](R) reader structure"]
impl crate::Readable for Core1AreaPif1MaxSpec {}
#[doc = "`write(|w| ..)` method takes [`core_1_area_pif_1_max::W`](W) writer structure"]
impl crate::Writable for Core1AreaPif1MaxSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CORE_1_AREA_PIF_1_MAX to value 0"]
impl crate::Resettable for Core1AreaPif1MaxSpec {}

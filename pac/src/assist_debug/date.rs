...
pub type AssistDebugDateR = crate::FieldReader<u32>;
#[doc = "Field `ASSIST_DEBUG_DATE` writer - version register"]
pub type AssistDebugDateW<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    #[doc = "Bits 0:27 - version register"]
    #[inline(always)]
    pub fn assist_debug_date(&self) -> AssistDebugDateR {
        AssistDebugDateR::new(self.bits & 0x0fff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:27 - version register"]
    #[inline(always)]
    pub fn assist_debug_date(&mut self) -> AssistDebugDateW<'_, DateSpec> {
        AssistDebugDateW::new(self, 0)
    }
}

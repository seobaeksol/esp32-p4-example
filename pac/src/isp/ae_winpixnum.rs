...
pub type R = crate::R<AeWinpixnumSpec>;
#[doc = "Register `AE_WINPIXNUM` writer"]
pub type W = crate::W<AeWinpixnumSpec>;
#[doc = "Field `AE_SUBWIN_PIXNUM` reader - this field configures the pixel number of each sub win"]
pub type AeSubwinPixnumR = crate::FieldReader<u32>;
#[doc = "Field `AE_SUBWIN_PIXNUM` writer - this field configures the pixel number of each sub win"]
pub type AeSubwinPixnumW<'a, REG> = crate::FieldWriter<'a, REG, 17, u32>;
impl R {
    #[doc = "Bits 0:16 - this field configures the pixel number of each sub win"]
    #[inline(always)]
    pub fn ae_subwin_pixnum(&self) -> AeSubwinPixnumR {
        AeSubwinPixnumR::new(self.bits & 0x0001_ffff)
    }
}
impl W {
    #[doc = "Bits 0:16 - this field configures the pixel number of each sub win"]
    #[inline(always)]
    pub fn ae_subwin_pixnum(&mut self) -> AeSubwinPixnumW<'_, AeWinpixnumSpec> {
        AeSubwinPixnumW::new(self, 0)
    }
}
...
pub struct AeWinpixnumSpec;
impl crate::RegisterSpec for AeWinpixnumSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ae_winpixnum::R`](R) reader structure"]
impl crate::Readable for AeWinpixnumSpec {}
#[doc = "`write(|w| ..)` method takes [`ae_winpixnum::W`](W) writer structure"]
impl crate::Writable for AeWinpixnumSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AE_WINPIXNUM to value 0x0001_4400"]
impl crate::Resettable for AeWinpixnumSpec {

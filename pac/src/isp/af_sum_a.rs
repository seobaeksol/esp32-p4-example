...
pub struct AfSumASpec;
impl crate::RegisterSpec for AfSumASpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`af_sum_a::R`](R) reader structure"]
impl crate::Readable for AfSumASpec {}
#[doc = "`reset()` method sets AF_SUM_A to value 0"]
impl crate::Resettable for AfSumASpec {}

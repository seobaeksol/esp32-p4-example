...
pub type R = crate::R<AfThresholdSpec>;
#[doc = "Register `AF_THRESHOLD` writer"]
pub type W = crate::W<AfThresholdSpec>;
...
pub type AfThresholdR = crate::FieldReader<u16>;
...
pub type AfThresholdW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `AF_GEN_THRESHOLD` reader - this field represents the last calculated threshold"]
pub type AfGenThresholdR = crate::FieldReader<u16>;
impl R {
    #[doc = "Bits 0:15 - this field configures user threshold. When set to non-zero, autofocus will use this threshold"]
    #[inline(always)]
    pub fn af_threshold(&self) -> AfThresholdR {
        AfThresholdR::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - this field represents the last calculated threshold"]
    #[inline(always)]
    pub fn af_gen_threshold(&self) -> AfGenThresholdR {
        AfGenThresholdR::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - this field configures user threshold. When set to non-zero, autofocus will use this threshold"]
    #[inline(always)]
    pub fn af_threshold(&mut self) -> AfThresholdW<'_, AfThresholdSpec> {
        AfThresholdW::new(self, 0)
    }
}
...
pub struct AfThresholdSpec;
impl crate::RegisterSpec for AfThresholdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`af_threshold::R`](R) reader structure"]
impl crate::Readable for AfThresholdSpec {}
#[doc = "`write(|w| ..)` method takes [`af_threshold::W`](W) writer structure"]
impl crate::Writable for AfThresholdSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AF_THRESHOLD to value 0x0100"]
impl crate::Resettable for AfThresholdSpec {

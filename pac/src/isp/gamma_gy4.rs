...
pub struct GammaGy4Spec;
impl crate::RegisterSpec for GammaGy4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gamma_gy4::R`](R) reader structure"]
impl crate::Readable for GammaGy4Spec {}
#[doc = "`write(|w| ..)` method takes [`gamma_gy4::W`](W) writer structure"]
impl crate::Writable for GammaGy4Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GAMMA_GY4 to value 0xd0e0_f0ff"]
impl crate::Resettable for GammaGy4Spec {

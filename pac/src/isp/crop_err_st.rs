...
pub struct CropErrStSpec;
impl crate::RegisterSpec for CropErrStSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`crop_err_st::R`](R) reader structure"]
impl crate::Readable for CropErrStSpec {}
#[doc = "`reset()` method sets CROP_ERR_ST to value 0"]
impl crate::Resettable for CropErrStSpec {}

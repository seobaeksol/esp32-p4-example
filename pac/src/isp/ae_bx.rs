...
pub type R = crate::R<AeBxSpec>;
#[doc = "Register `AE_BX` writer"]
pub type W = crate::W<AeBxSpec>;
#[doc = "Field `AE_X_BSIZE` reader - this field configures every block x size"]
pub type AeXBsizeR = crate::FieldReader<u16>;
#[doc = "Field `AE_X_BSIZE` writer - this field configures every block x size"]
pub type AeXBsizeW<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
#[doc = "Field `AE_X_START` reader - this field configures first block start x address"]
pub type AeXStartR = crate::FieldReader<u16>;
#[doc = "Field `AE_X_START` writer - this field configures first block start x address"]
pub type AeXStartW<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
impl R {
    #[doc = "Bits 0:10 - this field configures every block x size"]
    #[inline(always)]
    pub fn ae_x_bsize(&self) -> AeXBsizeR {
        AeXBsizeR::new((self.bits & 0x07ff) as u16)
    }
    #[doc = "Bits 11:21 - this field configures first block start x address"]
    #[inline(always)]
    pub fn ae_x_start(&self) -> AeXStartR {
        AeXStartR::new(((self.bits >> 11) & 0x07ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:10 - this field configures every block x size"]
    #[inline(always)]
    pub fn ae_x_bsize(&mut self) -> AeXBsizeW<'_, AeBxSpec> {
        AeXBsizeW::new(self, 0)
    }
    #[doc = "Bits 11:21 - this field configures first block start x address"]
    #[inline(always)]
    pub fn ae_x_start(&mut self) -> AeXStartW<'_, AeBxSpec> {
        AeXStartW::new(self, 11)
    }
}

...
pub type TailBusyR = crate::BitReader;
#[doc = "Field `HEADER_BUSY` reader - Represents isp_header state"]
pub type HeaderBusyR = crate::BitReader;
impl R {
    #[doc = "Bit 0 - Represents isp_tail state"]
    #[inline(always)]
    pub fn tail_busy(&self) -> TailBusyR {
        TailBusyR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Represents isp_header state"]
    #[inline(always)]
    pub fn header_busy(&self) -> HeaderBusyR {
        HeaderBusyR::new(((self.bits >> 1) & 1) != 0)
    }
}

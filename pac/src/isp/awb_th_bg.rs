...
pub struct AwbThBgSpec;
impl crate::RegisterSpec for AwbThBgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`awb_th_bg::R`](R) reader structure"]
impl crate::Readable for AwbThBgSpec {}
#[doc = "`write(|w| ..)` method takes [`awb_th_bg::W`](W) writer structure"]
impl crate::Writable for AwbThBgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AWB_TH_BG to value 0x03ff_0000"]
impl crate::Resettable for AwbThBgSpec {

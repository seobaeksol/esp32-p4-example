...
pub struct AwbThRgSpec;
impl crate::RegisterSpec for AwbThRgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`awb_th_rg::R`](R) reader structure"]
impl crate::Readable for AwbThRgSpec {}
#[doc = "`write(|w| ..)` method takes [`awb_th_rg::W`](W) writer structure"]
impl crate::Writable for AwbThRgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AWB_TH_RG to value 0x03ff_0000"]
impl crate::Resettable for AwbThRgSpec {

...
pub struct CcmCoef3Spec;
impl crate::RegisterSpec for CcmCoef3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ccm_coef3::R`](R) reader structure"]
impl crate::Readable for CcmCoef3Spec {}
#[doc = "`write(|w| ..)` method takes [`ccm_coef3::W`](W) writer structure"]
impl crate::Writable for CcmCoef3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CCM_COEF3 to value 0x0100"]
impl crate::Resettable for CcmCoef3Spec {

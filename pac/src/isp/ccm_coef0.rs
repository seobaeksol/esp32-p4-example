...
pub struct CcmCoef0Spec;
impl crate::RegisterSpec for CcmCoef0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ccm_coef0::R`](R) reader structure"]
impl crate::Readable for CcmCoef0Spec {}
#[doc = "`write(|w| ..)` method takes [`ccm_coef0::W`](W) writer structure"]
impl crate::Writable for CcmCoef0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CCM_COEF0 to value 0x0100"]
impl crate::Resettable for CcmCoef0Spec {

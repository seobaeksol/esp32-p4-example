...
pub struct BlcCtrl2Spec;
impl crate::RegisterSpec for BlcCtrl2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`blc_ctrl2::R`](R) reader structure"]
impl crate::Readable for BlcCtrl2Spec {}
#[doc = "`write(|w| ..)` method takes [`blc_ctrl2::W`](W) writer structure"]
impl crate::Writable for BlcCtrl2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BLC_CTRL2 to value 0"]
impl crate::Resettable for BlcCtrl2Spec {}

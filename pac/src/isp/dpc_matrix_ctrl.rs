...
pub type R = crate::R<DpcMatrixCtrlSpec>;
#[doc = "Register `DPC_MATRIX_CTRL` writer"]
pub type W = crate::W<DpcMatrixCtrlSpec>;
...
pub type DpcTailPixenPulseTlR = crate::FieldReader;
...
pub type DpcTailPixenPulseTlW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
pub type DpcTailPixenPulseThR = crate::FieldReader;
...
pub type DpcTailPixenPulseThW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `DPC_PADDING_DATA` reader - this field configures dpc matrix padding data"]
pub type DpcPaddingDataR = crate::FieldReader;
#[doc = "Field `DPC_PADDING_DATA` writer - this field configures dpc matrix padding data"]
pub type DpcPaddingDataW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
pub type DpcPaddingModeR = crate::BitReader;
...
pub type DpcPaddingModeW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn dpc_tail_pixen_pulse_tl(&self) -> DpcTailPixenPulseTlR {
        DpcTailPixenPulseTlR::new((self.bits & 0xff) as u8)
    }
    ...
    #[inline(always)]
    pub fn dpc_tail_pixen_pulse_th(&self) -> DpcTailPixenPulseThR {
        DpcTailPixenPulseThR::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - this field configures dpc matrix padding data"]
    #[inline(always)]
    pub fn dpc_padding_data(&self) -> DpcPaddingDataR {
        DpcPaddingDataR::new(((self.bits >> 16) & 0xff) as u8)
    }
    ...
    #[inline(always)]
    pub fn dpc_padding_mode(&self) -> DpcPaddingModeR {
        DpcPaddingModeR::new(((self.bits >> 24) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:7 - matrix tail pixen low level threshold, should not to large to prevent expanding to next frame, only reg_dpc_tail_pixen_pulse_th!=0 and reg_dpc_tail_pixen_pulse_tl!=0 and reg_dpc_tail_pixen_pulse_th < reg_dpc_tail_pixen_pulse_tl will enable tail pulse function"]
    #[inline(always)]
    pub fn dpc_tail_pixen_pulse_tl(&mut self) -> DpcTailPixenPulseTlW<'_, DpcMatrixCtrlSpec> {
        DpcTailPixenPulseTlW::new(self, 0)
    }
    #[doc = "Bits 8:15 - matrix tail pixen high level threshold, must < hnum-1, only reg_dpc_tail_pixen_pulse_th!=0 and reg_dpc_tail_pixen_pulse_tl!=0 and reg_dpc_tail_pixen_pulse_th < reg_dpc_tail_pixen_pulse_tl will enable tail pulse function"]
    #[inline(always)]
    pub fn dpc_tail_pixen_pulse_th(&mut self) -> DpcTailPixenPulseThW<'_, DpcMatrixCtrlSpec> {
        DpcTailPixenPulseThW::new(self, 8)
    }
    #[doc = "Bits 16:23 - this field configures dpc matrix padding data"]
    #[inline(always)]
    pub fn dpc_padding_data(&mut self) -> DpcPaddingDataW<'_, DpcMatrixCtrlSpec> {
        DpcPaddingDataW::new(self, 16)
    }
    #[doc = "Bit 24 - this bit configures the padding mode of dpc matrix. 0: use pixel in image to do padding 1: use reg_padding_data to do padding"]
    #[inline(always)]
    pub fn dpc_padding_mode(&mut self) -> DpcPaddingModeW<'_, DpcMatrixCtrlSpec> {
        DpcPaddingModeW::new(self, 24)
    }
}
...
pub struct DpcMatrixCtrlSpec;
impl crate::RegisterSpec for DpcMatrixCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dpc_matrix_ctrl::R`](R) reader structure"]
impl crate::Readable for DpcMatrixCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`dpc_matrix_ctrl::W`](W) writer structure"]
impl crate::Writable for DpcMatrixCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DPC_MATRIX_CTRL to value 0"]
impl crate::Resettable for DpcMatrixCtrlSpec {}

...
pub type R = crate::R<IvMemSpec>;
#[doc = "Register `IV_MEM[%s]` writer"]
pub type W = crate::W<IvMemSpec>;
...
pub struct IvMemSpec;
impl crate::RegisterSpec for IvMemSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`iv_mem::R`](R) reader structure"]
impl crate::Readable for IvMemSpec {}
#[doc = "`write(|w| ..)` method takes [`iv_mem::W`](W) writer structure"]
impl crate::Writable for IvMemSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets IV_MEM[%s] to value 0"]
impl crate::Resettable for IvMemSpec {}

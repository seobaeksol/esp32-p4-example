...
pub type R = crate::R<BoxMemSpec>;
#[doc = "Register `BOX_MEM[%s]` writer"]
pub type W = crate::W<BoxMemSpec>;
...
pub struct BoxMemSpec;
impl crate::RegisterSpec for BoxMemSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`box_mem::R`](R) reader structure"]
impl crate::Readable for BoxMemSpec {}
#[doc = "`write(|w| ..)` method takes [`box_mem::W`](W) writer structure"]
impl crate::Writable for BoxMemSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BOX_MEM[%s] to value 0"]
impl crate::Resettable for BoxMemSpec {}

...
pub struct QueryCheckSpec;
impl crate::RegisterSpec for QueryCheckSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`query_check::R`](R) reader structure"]
impl crate::Readable for QueryCheckSpec {}
#[doc = "`reset()` method sets QUERY_CHECK to value 0"]
impl crate::Resettable for QueryCheckSpec {}

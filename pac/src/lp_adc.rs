...
pub struct RegisterBlock {
    reader1_ctrl: Reader1Ctrl,
    reader1_status: Reader1Status,
    meas1_ctrl1: Meas1Ctrl1,
    meas1_ctrl2: Meas1Ctrl2,
    meas1_mux: Meas1Mux,
    atten1: Atten1,
    amp_ctrl1: AmpCtrl1,
    amp_ctrl2: AmpCtrl2,
    amp_ctrl3: AmpCtrl3,
    reader2_ctrl: Reader2Ctrl,
    reader2_status: Reader2Status,
    meas2_ctrl1: Meas2Ctrl1,
    meas2_ctrl2: Meas2Ctrl2,
    meas2_mux: Meas2Mux,
    atten2: Atten2,
    force_wpd_sar: ForceWpdSar,
    meas_status: MeasStatus,
    reg_clken: RegClken,
    cocpu_int_raw: CocpuIntRaw,
    int_ena: IntEna,
    int_st: IntSt,
    int_clr: IntClr,
    ...
    wakeup1: Wakeup1,
    wakeup2: Wakeup2,
    wakeup_sel: WakeupSel,
    sar1_hw_wakeup: Sar1HwWakeup,
    sar2_hw_wakeup: Sar2HwWakeup,
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn reader1_ctrl(&self) -> &Reader1Ctrl {
        &self.reader1_ctrl
    }
    #[doc = "0x04 - N/A"]
    #[inline(always)]
    pub const fn reader1_status(&self) -> &Reader1Status {
        &self.reader1_status
    }
    #[doc = "0x08 - N/A"]
    #[inline(always)]
    pub const fn meas1_ctrl1(&self) -> &Meas1Ctrl1 {
        &self.meas1_ctrl1
    }
    #[doc = "0x0c - ADC1 configuration registers."]
    #[inline(always)]
    pub const fn meas1_ctrl2(&self) -> &Meas1Ctrl2 {
        &self.meas1_ctrl2
    }
    #[doc = "0x10 - SAR ADC1 MUX register."]
    #[inline(always)]
    pub const fn meas1_mux(&self) -> &Meas1Mux {
        &self.meas1_mux
    }
    ...
    #[doc = "0x18 - N/A"]
    #[inline(always)]
    pub const fn amp_ctrl1(&self) -> &AmpCtrl1 {
        &self.amp_ctrl1
    }
    #[doc = "0x1c - N/A"]
    #[inline(always)]
    pub const fn amp_ctrl2(&self) -> &AmpCtrl2 {
        &self.amp_ctrl2
    }
    #[doc = "0x20 - N/A"]
    #[inline(always)]
    pub const fn amp_ctrl3(&self) -> &AmpCtrl3 {
        &self.amp_ctrl3
    }
    #[doc = "0x24 - Control the read operation of ADC2."]
    #[inline(always)]
    pub const fn reader2_ctrl(&self) -> &Reader2Ctrl {
        &self.reader2_ctrl
    }
    #[doc = "0x28 - N/A"]
    #[inline(always)]
    pub const fn reader2_status(&self) -> &Reader2Status {
        &self.reader2_status
    }
    #[doc = "0x2c - ADC2 configuration registers."]
    #[inline(always)]
    pub const fn meas2_ctrl1(&self) -> &Meas2Ctrl1 {
        &self.meas2_ctrl1
    }
    #[doc = "0x30 - ADC2 configuration registers."]
    #[inline(always)]
    pub const fn meas2_ctrl2(&self) -> &Meas2Ctrl2 {
        &self.meas2_ctrl2
    }
    #[doc = "0x34 - SAR ADC2 MUX register."]
    #[inline(always)]
    pub const fn meas2_mux(&self) -> &Meas2Mux {
        &self.meas2_mux
    }
    ...
    #[inline(always)]
    pub const fn force_wpd_sar(&self) -> &ForceWpdSar {
        &self.force_wpd_sar
    }
    #[doc = "0x40 - N/A"]
    #[inline(always)]
    pub const fn meas_status(&self) -> &MeasStatus {
        &self.meas_status
    }
    #[doc = "0x44 - N/A"]
    #[inline(always)]
    pub const fn reg_clken(&self) -> &RegClken {
        &self.reg_clken
    }
    #[doc = "0x48 - Interrupt raw registers."]
    #[inline(always)]
    pub const fn cocpu_int_raw(&self) -> &CocpuIntRaw {
        &self.cocpu_int_raw
    }
...
#[doc(alias = "READER1_CTRL")]
pub type Reader1Ctrl = crate::Reg<reader1_ctrl::Reader1CtrlSpec>;
...
#[doc(alias = "READER1_STATUS")]
pub type Reader1Status = crate::Reg<reader1_status::Reader1StatusSpec>;
#[doc = "N/A"]
...
#[doc(alias = "MEAS1_CTRL1")]
pub type Meas1Ctrl1 = crate::Reg<meas1_ctrl1::Meas1Ctrl1Spec>;
#[doc = "N/A"]
pub mod meas1_ctrl1;
...
#[doc(alias = "MEAS1_CTRL2")]
pub type Meas1Ctrl2 = crate::Reg<meas1_ctrl2::Meas1Ctrl2Spec>;
...
#[doc(alias = "MEAS1_MUX")]
pub type Meas1Mux = crate::Reg<meas1_mux::Meas1MuxSpec>;
...
#[doc(alias = "ATTEN1")]
pub type Atten1 = crate::Reg<atten1::Atten1Spec>;
...
#[doc(alias = "AMP_CTRL1")]
pub type AmpCtrl1 = crate::Reg<amp_ctrl1::AmpCtrl1Spec>;
#[doc = "N/A"]
pub mod amp_ctrl1;
...
#[doc(alias = "AMP_CTRL2")]
pub type AmpCtrl2 = crate::Reg<amp_ctrl2::AmpCtrl2Spec>;
#[doc = "N/A"]
pub mod amp_ctrl2;
...
#[doc(alias = "AMP_CTRL3")]
pub type AmpCtrl3 = crate::Reg<amp_ctrl3::AmpCtrl3Spec>;
#[doc = "N/A"]
pub mod amp_ctrl3;
...
#[doc(alias = "READER2_CTRL")]
pub type Reader2Ctrl = crate::Reg<reader2_ctrl::Reader2CtrlSpec>;
...
#[doc(alias = "READER2_STATUS")]
pub type Reader2Status = crate::Reg<reader2_status::Reader2StatusSpec>;
#[doc = "N/A"]
...
#[doc(alias = "MEAS2_CTRL1")]
pub type Meas2Ctrl1 = crate::Reg<meas2_ctrl1::Meas2Ctrl1Spec>;
...
#[doc(alias = "MEAS2_CTRL2")]
pub type Meas2Ctrl2 = crate::Reg<meas2_ctrl2::Meas2Ctrl2Spec>;
#[doc = "ADC2 configuration registers."]
pub mod meas2_ctrl2;
...
#[doc(alias = "MEAS2_MUX")]
pub type Meas2Mux = crate::Reg<meas2_mux::Meas2MuxSpec>;
...
#[doc(alias = "ATTEN2")]
pub type Atten2 = crate::Reg<atten2::Atten2Spec>;
#[doc = "ADC1 attenuation registers."]
pub mod atten2;
...
#[doc(alias = "FORCE_WPD_SAR")]
pub type ForceWpdSar = crate::Reg<force_wpd_sar::ForceWpdSarSpec>;
...
#[doc(alias = "MEAS_STATUS")]
pub type MeasStatus = crate::Reg<meas_status::MeasStatusSpec>;
#[doc = "N/A"]
pub mod meas_status;
...
#[doc(alias = "REG_CLKEN")]
pub type RegClken = crate::Reg<reg_clken::RegClkenSpec>;
#[doc = "N/A"]
pub mod reg_clken;
...
#[doc(alias = "COCPU_INT_RAW")]
pub type CocpuIntRaw = crate::Reg<cocpu_int_raw::CocpuIntRawSpec>;
...
#[doc(alias = "WAKEUP1")]
pub type Wakeup1 = crate::Reg<wakeup1::Wakeup1Spec>;
...
#[doc(alias = "WAKEUP2")]
pub type Wakeup2 = crate::Reg<wakeup2::Wakeup2Spec>;
...
#[doc(alias = "WAKEUP_SEL")]
pub type WakeupSel = crate::Reg<wakeup_sel::WakeupSelSpec>;
...
#[doc(alias = "SAR1_HW_WAKEUP")]
pub type Sar1HwWakeup = crate::Reg<sar1_hw_wakeup::Sar1HwWakeupSpec>;
...
#[doc(alias = "SAR2_HW_WAKEUP")]
pub type Sar2HwWakeup = crate::Reg<sar2_hw_wakeup::Sar2HwWakeupSpec>;
#[doc = "Hardware automatic sampling registers for wakeup function."]

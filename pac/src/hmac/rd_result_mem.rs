...
pub type R = crate::R<RdResultMemSpec>;
#[doc = "Register `RD_RESULT_MEM[%s]` writer"]
pub type W = crate::W<RdResultMemSpec>;
...
pub struct RdResultMemSpec;
impl crate::RegisterSpec for RdResultMemSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rd_result_mem::R`](R) reader structure"]
impl crate::Readable for RdResultMemSpec {}
#[doc = "`write(|w| ..)` method takes [`rd_result_mem::W`](W) writer structure"]
impl crate::Writable for RdResultMemSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RD_RESULT_MEM[%s] to value 0"]
impl crate::Resettable for RdResultMemSpec {}

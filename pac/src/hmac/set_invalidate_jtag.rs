...
pub type W = crate::W<SetInvalidateJtagSpec>;
...
pub type SetInvalidateJtagW<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    ...
    #[inline(always)]
    pub fn set_invalidate_jtag(&mut self) -> SetInvalidateJtagW<'_, SetInvalidateJtagSpec> {
        SetInvalidateJtagW::new(self, 0)
    }
}
...
pub struct SetInvalidateJtagSpec;
impl crate::RegisterSpec for SetInvalidateJtagSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`set_invalidate_jtag::W`](W) writer structure"]
impl crate::Writable for SetInvalidateJtagSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SET_INVALIDATE_JTAG to value 0"]
impl crate::Resettable for SetInvalidateJtagSpec {}

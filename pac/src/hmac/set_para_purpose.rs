...
pub struct SetParaPurposeSpec;
impl crate::RegisterSpec for SetParaPurposeSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`set_para_purpose::W`](W) writer structure"]
impl crate::Writable for SetParaPurposeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SET_PARA_PURPOSE to value 0"]
impl crate::Resettable for SetParaPurposeSpec {}

...
pub type W = crate::W<SetResultFinishSpec>;
...
pub type SetResultEndW<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    ...
    #[inline(always)]
    pub fn set_result_end(&mut self) -> SetResultEndW<'_, SetResultFinishSpec> {
        SetResultEndW::new(self, 0)
    }
}
...
pub struct SetResultFinishSpec;
impl crate::RegisterSpec for SetResultFinishSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`set_result_finish::W`](W) writer structure"]
impl crate::Writable for SetResultFinishSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SET_RESULT_FINISH to value 0"]
impl crate::Resettable for SetResultFinishSpec {}

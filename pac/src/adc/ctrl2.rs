...
pub type TimerTargetW<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
...
impl R {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn meas_num_limit(&self) -> MeasNumLimitR {
        MeasNumLimitR::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 1:8 - max conversion number"]
    #[inline(always)]
    pub fn max_meas_num(&self) -> MaxMeasNumR {
        MaxMeasNumR::new(((self.bits >> 1) & 0xff) as u8)
    }
    #[doc = "Bit 9 - 1: data to DIG ADC1 CTRL is inverted, otherwise not"]
    #[inline(always)]
    pub fn sar1_inv(&self) -> Sar1InvR {
        Sar1InvR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - 1: data to DIG ADC2 CTRL is inverted, otherwise not"]
    #[inline(always)]
    pub fn sar2_inv(&self) -> Sar2InvR {
        Sar2InvR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - 1: select saradc timer 0: i2s_ws trigger"]
    #[inline(always)]
    pub fn timer_sel(&self) -> TimerSelR {
        TimerSelR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bits 12:23 - to set saradc timer target"]
    #[inline(always)]
    pub fn timer_target(&self) -> TimerTargetR {
        TimerTargetR::new(((self.bits >> 12) & 0x0fff) as u16)
    }
    #[doc = "Bit 24 - to enable saradc timer trigger"]
    #[inline(always)]
    pub fn timer_en(&self) -> TimerEnR {
        TimerEnR::new(((self.bits >> 24) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn meas_num_limit(&mut self) -> MeasNumLimitW<'_, Ctrl2Spec> {
        MeasNumLimitW::new(self, 0)
    }
    #[doc = "Bits 1:8 - max conversion number"]
    #[inline(always)]
    pub fn max_meas_num(&mut self) -> MaxMeasNumW<'_, Ctrl2Spec> {
        MaxMeasNumW::new(self, 1)
    }
    #[doc = "Bit 9 - 1: data to DIG ADC1 CTRL is inverted, otherwise not"]
    #[inline(always)]
    pub fn sar1_inv(&mut self) -> Sar1InvW<'_, Ctrl2Spec> {
        Sar1InvW::new(self, 9)
    }
    #[doc = "Bit 10 - 1: data to DIG ADC2 CTRL is inverted, otherwise not"]
    #[inline(always)]
    pub fn sar2_inv(&mut self) -> Sar2InvW<'_, Ctrl2Spec> {
        Sar2InvW::new(self, 10)
    }
    #[doc = "Bit 11 - 1: select saradc timer 0: i2s_ws trigger"]
    #[inline(always)]
    pub fn timer_sel(&mut self) -> TimerSelW<'_, Ctrl2Spec> {
        TimerSelW::new(self, 11)
    }
    #[doc = "Bits 12:23 - to set saradc timer target"]
    #[inline(always)]
    pub fn timer_target(&mut self) -> TimerTargetW<'_, Ctrl2Spec> {
        TimerTargetW::new(self, 12)
    }
    #[doc = "Bit 24 - to enable saradc timer trigger"]
    #[inline(always)]
    pub fn timer_en(&mut self) -> TimerEnW<'_, Ctrl2Spec> {
        TimerEnW::new(self, 24)
    }
}

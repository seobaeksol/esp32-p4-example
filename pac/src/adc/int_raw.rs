...
impl W {
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
    pub fn thres1_low(&mut self) -> Thres1LowW<'_, IntRawSpec> {
        Thres1LowW::new(self, 26)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    pub fn thres0_low(&mut self) -> Thres0LowW<'_, IntRawSpec> {
        Thres0LowW::new(self, 27)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    pub fn thres1_high(&mut self) -> Thres1HighW<'_, IntRawSpec> {
        Thres1HighW::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    pub fn thres0_high(&mut self) -> Thres0HighW<'_, IntRawSpec> {
        Thres0HighW::new(self, 29)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn adc2_done(&mut self) -> Adc2DoneW<'_, IntRawSpec> {
        Adc2DoneW::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn adc1_done(&mut self) -> Adc1DoneW<'_, IntRawSpec> {

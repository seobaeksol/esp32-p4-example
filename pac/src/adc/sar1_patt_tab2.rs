...
pub type R = crate::R<Sar1PattTab2Spec>;
#[doc = "Register `SAR1_PATT_TAB2` writer"]
pub type W = crate::W<Sar1PattTab2Spec>;
#[doc = "Field `SAR1_PATT_TAB2` reader - Item 4 ~ 7 for pattern table 1 (each item one byte)"]
pub type Sar1PattTab2R = crate::FieldReader<u32>;
#[doc = "Field `SAR1_PATT_TAB2` writer - Item 4 ~ 7 for pattern table 1 (each item one byte)"]
pub type Sar1PattTab2W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    #[doc = "Bits 0:23 - Item 4 ~ 7 for pattern table 1 (each item one byte)"]
    #[inline(always)]
    pub fn sar1_patt_tab2(&self) -> Sar1PattTab2R {
        Sar1PattTab2R::new(self.bits & 0x00ff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:23 - Item 4 ~ 7 for pattern table 1 (each item one byte)"]
    #[inline(always)]
    pub fn sar1_patt_tab2(&mut self) -> Sar1PattTab2W<'_, Sar1PattTab2Spec> {
        Sar1PattTab2W::new(self, 0)
    }
}
...
pub struct Sar1PattTab2Spec;
impl crate::RegisterSpec for Sar1PattTab2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sar1_patt_tab2::R`](R) reader structure"]
impl crate::Readable for Sar1PattTab2Spec {}
#[doc = "`write(|w| ..)` method takes [`sar1_patt_tab2::W`](W) writer structure"]
impl crate::Writable for Sar1PattTab2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SAR1_PATT_TAB2 to value 0"]
impl crate::Resettable for Sar1PattTab2Spec {}

...
pub type R = crate::R<CtrlDateSpec>;
#[doc = "Register `CTRL_DATE` writer"]
pub type W = crate::W<CtrlDateSpec>;
#[doc = "Field `CTRL_DATE` reader - need_des"]
pub type CtrlDateR = crate::FieldReader<u32>;
#[doc = "Field `CTRL_DATE` writer - need_des"]
pub type CtrlDateW<'a, REG> = crate::FieldWriter<'a, REG, 31, u32>;
...
impl R {
    ...
    #[inline(always)]
    pub fn ctrl_date(&self) -> CtrlDateR {
        CtrlDateR::new(self.bits & 0x7fff_ffff)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:30 - need_des"]
    #[inline(always)]
    pub fn ctrl_date(&mut self) -> CtrlDateW<'_, CtrlDateSpec> {
        CtrlDateW::new(self, 0)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn clk_en(&mut self) -> ClkEnW<'_, CtrlDateSpec> {
        ClkEnW::new(self, 31)
    }
}
...
pub struct CtrlDateSpec;
impl crate::RegisterSpec for CtrlDateSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctrl_date::R`](R) reader structure"]
impl crate::Readable for CtrlDateSpec {}
#[doc = "`write(|w| ..)` method takes [`ctrl_date::W`](W) writer structure"]
impl crate::Writable for CtrlDateSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CTRL_DATE to value 0x0221_2260"]
impl crate::Resettable for CtrlDateSpec {

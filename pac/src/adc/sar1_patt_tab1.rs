...
pub type R = crate::R<Sar1PattTab1Spec>;
#[doc = "Register `SAR1_PATT_TAB1` writer"]
pub type W = crate::W<Sar1PattTab1Spec>;
#[doc = "Field `SAR1_PATT_TAB1` reader - item 0 ~ 3 for pattern table 1 (each item one byte)"]
pub type Sar1PattTab1R = crate::FieldReader<u32>;
#[doc = "Field `SAR1_PATT_TAB1` writer - item 0 ~ 3 for pattern table 1 (each item one byte)"]
pub type Sar1PattTab1W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    #[doc = "Bits 0:23 - item 0 ~ 3 for pattern table 1 (each item one byte)"]
    #[inline(always)]
    pub fn sar1_patt_tab1(&self) -> Sar1PattTab1R {
        Sar1PattTab1R::new(self.bits & 0x00ff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:23 - item 0 ~ 3 for pattern table 1 (each item one byte)"]
    #[inline(always)]
    pub fn sar1_patt_tab1(&mut self) -> Sar1PattTab1W<'_, Sar1PattTab1Spec> {
        Sar1PattTab1W::new(self, 0)
    }
}
...
pub struct Sar1PattTab1Spec;
impl crate::RegisterSpec for Sar1PattTab1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sar1_patt_tab1::R`](R) reader structure"]
impl crate::Readable for Sar1PattTab1Spec {}
#[doc = "`write(|w| ..)` method takes [`sar1_patt_tab1::W`](W) writer structure"]
impl crate::Writable for Sar1PattTab1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SAR1_PATT_TAB1 to value 0"]
impl crate::Resettable for Sar1PattTab1Spec {}

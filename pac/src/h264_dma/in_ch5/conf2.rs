...
pub type BlockRowLength12lineR = crate::FieldReader<u16>;
#[doc = "Field `BLOCK_ROW_LENGTH_12LINE` writer - The number of bytes contained in a row block 12line in RX channel 5"]
pub type BlockRowLength12lineW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `BLOCK_ROW_LENGTH_4LINE` reader - The number of bytes contained in a row block 4line in RX channel 5"]
pub type BlockRowLength4lineR = crate::FieldReader<u16>;
#[doc = "Field `BLOCK_ROW_LENGTH_4LINE` writer - The number of bytes contained in a row block 4line in RX channel 5"]
pub type BlockRowLength4lineW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - The number of bytes contained in a row block 12line in RX channel 5"]
    #[inline(always)]
    pub fn block_row_length_12line(&self) -> BlockRowLength12lineR {
        BlockRowLength12lineR::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - The number of bytes contained in a row block 4line in RX channel 5"]
    #[inline(always)]
    pub fn block_row_length_4line(&self) -> BlockRowLength4lineR {
        BlockRowLength4lineR::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - The number of bytes contained in a row block 12line in RX channel 5"]
    #[inline(always)]
    pub fn block_row_length_12line(&mut self) -> BlockRowLength12lineW<'_, Conf2Spec> {
        BlockRowLength12lineW::new(self, 0)
    }
    #[doc = "Bits 16:31 - The number of bytes contained in a row block 4line in RX channel 5"]
    #[inline(always)]
    pub fn block_row_length_4line(&mut self) -> BlockRowLength4lineW<'_, Conf2Spec> {
        BlockRowLength4lineW::new(self, 16)
    }
}

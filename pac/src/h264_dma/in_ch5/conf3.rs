...
pub type R = crate::R<Conf3Spec>;
#[doc = "Register `CONF3` writer"]
pub type W = crate::W<Conf3Spec>;
#[doc = "Field `BLOCK_LENGTH_12LINE` reader - The number of bytes contained in a block 12line"]
pub type BlockLength12lineR = crate::FieldReader<u16>;
#[doc = "Field `BLOCK_LENGTH_12LINE` writer - The number of bytes contained in a block 12line"]
pub type BlockLength12lineW<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
#[doc = "Field `BLOCK_LENGTH_4LINE` reader - The number of bytes contained in a block 4line"]
pub type BlockLength4lineR = crate::FieldReader<u16>;
#[doc = "Field `BLOCK_LENGTH_4LINE` writer - The number of bytes contained in a block 4line"]
pub type BlockLength4lineW<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    #[doc = "Bits 0:13 - The number of bytes contained in a block 12line"]
    #[inline(always)]
    pub fn block_length_12line(&self) -> BlockLength12lineR {
        BlockLength12lineR::new((self.bits & 0x3fff) as u16)
    }
    #[doc = "Bits 14:27 - The number of bytes contained in a block 4line"]
    #[inline(always)]
    pub fn block_length_4line(&self) -> BlockLength4lineR {
        BlockLength4lineR::new(((self.bits >> 14) & 0x3fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:13 - The number of bytes contained in a block 12line"]
    #[inline(always)]
    pub fn block_length_12line(&mut self) -> BlockLength12lineW<'_, Conf3Spec> {
        BlockLength12lineW::new(self, 0)
    }
    #[doc = "Bits 14:27 - The number of bytes contained in a block 4line"]
    #[inline(always)]
    pub fn block_length_4line(&mut self) -> BlockLength4lineW<'_, Conf3Spec> {
        BlockLength4lineW::new(self, 14)
    }
}
...
pub struct Conf3Spec;
impl crate::RegisterSpec for Conf3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`conf3::R`](R) reader structure"]
impl crate::Readable for Conf3Spec {}
#[doc = "`write(|w| ..)` method takes [`conf3::W`](W) writer structure"]
impl crate::Writable for Conf3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CONF3 to value 0x0020_0100"]
impl crate::Resettable for Conf3Spec {

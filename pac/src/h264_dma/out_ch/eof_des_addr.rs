...
pub type R = crate::R<EofDesAddrSpec>;
...
pub struct EofDesAddrSpec;
impl crate::RegisterSpec for EofDesAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eof_des_addr::R`](R) reader structure"]
impl crate::Readable for EofDesAddrSpec {}
#[doc = "`reset()` method sets EOF_DES_ADDR to value 0"]
impl crate::Resettable for EofDesAddrSpec {}

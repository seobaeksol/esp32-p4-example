...
pub type R = crate::R<BlockBufLenSpec>;
#[doc = "Field `OUT_BLOCK_BUF_LEN` reader - only for debug"]
pub type OutBlockBufLenR = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:27 - only for debug"]
    #[inline(always)]
    pub fn out_block_buf_len(&self) -> OutBlockBufLenR {
        OutBlockBufLenR::new(self.bits & 0x0fff_ffff)
    }
}
...
pub struct BlockBufLenSpec;
impl crate::RegisterSpec for BlockBufLenSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`block_buf_len::R`](R) reader structure"]
impl crate::Readable for BlockBufLenSpec {}
#[doc = "`reset()` method sets BLOCK_BUF_LEN to value 0"]
impl crate::Resettable for BlockBufLenSpec {}

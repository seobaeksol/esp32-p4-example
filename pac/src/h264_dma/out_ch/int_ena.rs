...
impl W {
    #[doc = "Bit 0 - The interrupt enable bit for the OUT_DONE_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_done(&mut self) -> OutDoneW<'_, IntEnaSpec> {
        OutDoneW::new(self, 0)
    }
    #[doc = "Bit 1 - The interrupt enable bit for the OUT_EOF_CH_INT interrupt."]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - The interrupt enable bit for the OUT_DSCR_ERR_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_dscr_err(&mut self) -> OutDscrErrW<'_, IntEnaSpec> {
        OutDscrErrW::new(self, 2)
    }
    #[doc = "Bit 3 - The interrupt enable bit for the OUT_TOTAL_EOF_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_total_eof(&mut self) -> OutTotalEofW<'_, IntEnaSpec> {
        OutTotalEofW::new(self, 3)
    }
    #[doc = "Bit 4 - The interrupt enable bit for the OUTFIFO_OVF_L1_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_ovf_l1(&mut self) -> OutfifoOvfL1W<'_, IntEnaSpec> {
        OutfifoOvfL1W::new(self, 4)
    }
    #[doc = "Bit 5 - The interrupt enable bit for the OUTFIFO_UDF_L1_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_udf_l1(&mut self) -> OutfifoUdfL1W<'_, IntEnaSpec> {
        OutfifoUdfL1W::new(self, 5)
    }
    #[doc = "Bit 6 - The interrupt enable bit for the OUTFIFO_OVF_L2_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_ovf_l2(&mut self) -> OutfifoOvfL2W<'_, IntEnaSpec> {
        OutfifoOvfL2W::new(self, 6)
    }
    #[doc = "Bit 7 - The interrupt enable bit for the OUTFIFO_UDF_L2_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_udf_l2(&mut self) -> OutfifoUdfL2W<'_, IntEnaSpec> {
        OutfifoUdfL2W::new(self, 7)
    }
    #[doc = "Bit 8 - The interrupt enable bit for the OUT_DSCR_TASK_OVF_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_dscr_task_ovf(&mut self) -> OutDscrTaskOvfW<'_, IntEnaSpec> {

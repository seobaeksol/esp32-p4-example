...
pub type R = crate::R<ExterMemStartAddr0Spec>;
#[doc = "Register `EXTER_MEM_START_ADDR0` writer"]
pub type W = crate::W<ExterMemStartAddr0Spec>;
#[doc = "Field `ACCESS_EXTER_MEM_START_ADDR0` reader - The start address of accessible address space."]
pub type AccessExterMemStartAddr0R = crate::FieldReader<u32>;
#[doc = "Field `ACCESS_EXTER_MEM_START_ADDR0` writer - The start address of accessible address space."]
pub type AccessExterMemStartAddr0W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - The start address of accessible address space."]
    #[inline(always)]
    pub fn access_exter_mem_start_addr0(&self) -> AccessExterMemStartAddr0R {
        AccessExterMemStartAddr0R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - The start address of accessible address space."]
    ...
    pub fn access_exter_mem_start_addr0(
        &mut self,
    ) -> AccessExterMemStartAddr0W<'_, ExterMemStartAddr0Spec> {
        AccessExterMemStartAddr0W::new(self, 0)
    }
}
...
pub struct ExterMemStartAddr0Spec;
impl crate::RegisterSpec for ExterMemStartAddr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`exter_mem_start_addr0::R`](R) reader structure"]
impl crate::Readable for ExterMemStartAddr0Spec {}
#[doc = "`write(|w| ..)` method takes [`exter_mem_start_addr0::W`](W) writer structure"]
impl crate::Writable for ExterMemStartAddr0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EXTER_MEM_START_ADDR0 to value 0x3010_0000"]
impl crate::Resettable for ExterMemStartAddr0Spec {

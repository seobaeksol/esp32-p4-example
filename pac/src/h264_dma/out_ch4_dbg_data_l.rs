...
pub type R = crate::R<OutCh4DbgDataLSpec>;
#[doc = "Register `OUT_CH4_DBG_DATA_L` writer"]
pub type W = crate::W<OutCh4DbgDataLSpec>;
#[doc = "Field `H264_OUT_CH4_DBG_DATA_L` reader - configures out channel 4 debug data bit 31-0"]
pub type H264OutCh4DbgDataLR = crate::FieldReader<u32>;
#[doc = "Field `H264_OUT_CH4_DBG_DATA_L` writer - configures out channel 4 debug data bit 31-0"]
pub type H264OutCh4DbgDataLW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - configures out channel 4 debug data bit 31-0"]
    #[inline(always)]
    pub fn h264_out_ch4_dbg_data_l(&self) -> H264OutCh4DbgDataLR {
        H264OutCh4DbgDataLR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - configures out channel 4 debug data bit 31-0"]
    #[inline(always)]
    pub fn h264_out_ch4_dbg_data_l(&mut self) -> H264OutCh4DbgDataLW<'_, OutCh4DbgDataLSpec> {
        H264OutCh4DbgDataLW::new(self, 0)
    }
}
...
pub struct OutCh4DbgDataLSpec;
impl crate::RegisterSpec for OutCh4DbgDataLSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`out_ch4_dbg_data_l::R`](R) reader structure"]
impl crate::Readable for OutCh4DbgDataLSpec {}
#[doc = "`write(|w| ..)` method takes [`out_ch4_dbg_data_l::W`](W) writer structure"]
impl crate::Writable for OutCh4DbgDataLSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OUT_CH4_DBG_DATA_L to value 0"]
impl crate::Resettable for OutCh4DbgDataLSpec {}

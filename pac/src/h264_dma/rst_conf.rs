...
impl R {
    ...
    #[inline(always)]
    pub fn inter_axim_rd_rst(&self) -> InterAximRdRstR {
        InterAximRdRstR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Write 1 then write 0 to this bit to reset axi master write data FIFO."]
    #[inline(always)]
    pub fn inter_axim_wr_rst(&self) -> InterAximWrRstR {
        InterAximWrRstR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Write 1 then write 0 to this bit to reset axi master read data FIFO."]
    #[inline(always)]
    pub fn exter_axim_rd_rst(&self) -> ExterAximRdRstR {
        ExterAximRdRstR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Write 1 then write 0 to this bit to reset axi master write data FIFO."]
    #[inline(always)]
    pub fn exter_axim_wr_rst(&self) -> ExterAximWrRstR {
        ExterAximWrRstR::new(((self.bits >> 3) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - Write 1 then write 0 to this bit to reset axi master read data FIFO."]
    #[inline(always)]
    pub fn inter_axim_rd_rst(&mut self) -> InterAximRdRstW<'_, RstConfSpec> {
        InterAximRdRstW::new(self, 0)
    }
    #[doc = "Bit 1 - Write 1 then write 0 to this bit to reset axi master write data FIFO."]
    #[inline(always)]
    pub fn inter_axim_wr_rst(&mut self) -> InterAximWrRstW<'_, RstConfSpec> {
        InterAximWrRstW::new(self, 1)
    }
    #[doc = "Bit 2 - Write 1 then write 0 to this bit to reset axi master read data FIFO."]
    #[inline(always)]
    pub fn exter_axim_rd_rst(&mut self) -> ExterAximRdRstW<'_, RstConfSpec> {
        ExterAximRdRstW::new(self, 2)
    }
    #[doc = "Bit 3 - Write 1 then write 0 to this bit to reset axi master write data FIFO."]
    #[inline(always)]
    pub fn exter_axim_wr_rst(&mut self) -> ExterAximWrRstW<'_, RstConfSpec> {
        ExterAximWrRstW::new(self, 3)
    }
    #[doc = "Bit 4 - 1'h1: Force clock on for register. 1'h0: Support clock only when application writes registers."]
    #[inline(always)]
    pub fn clk_en(&mut self) -> ClkEnW<'_, RstConfSpec> {
        ClkEnW::new(self, 4)
    }
}
...
impl crate::Resettable for RstConfSpec {}

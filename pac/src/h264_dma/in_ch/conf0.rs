...
pub type InEccAesEnR = crate::BitReader;
...
pub type InEccAesEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type InPageBoundEnR = crate::BitReader;
...
pub type InPageBoundEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    pub fn indscr_burst_en(&self) -> IndscrBurstEnR {
        IndscrBurstEnR::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn in_ecc_aes_en(&self) -> InEccAesEnR {
        InEccAesEnR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    pub fn in_check_owner(&self) -> InCheckOwnerR {
        InCheckOwnerR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bits 6:8 - Block size of Rx channel 0. 0: single 1: 16 bytes 2: 32 bytes 3: 64 bytes 4: 128 bytes"]
    #[inline(always)]
    pub fn in_mem_burst_length(&self) -> InMemBurstLengthR {
        InMemBurstLengthR::new(((self.bits >> 6) & 7) as u8)
    }
    ...
    #[inline(always)]
    pub fn in_page_bound_en(&self) -> InPageBoundEnR {
        InPageBoundEnR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 24 - Write 1 then write 0 to this bit to reset Rx channel"]
    #[inline(always)]
    pub fn in_rst(&self) -> InRstR {
        InRstR::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - Write 1 before reset and write 0 after reset"]
    #[inline(always)]
    pub fn in_cmd_disable(&self) -> InCmdDisableR {
        InCmdDisableR::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - Set this bit to 1 to disable arbiter optimum weight function."]
    #[inline(always)]
    pub fn in_arb_weight_opt_dis(&self) -> InArbWeightOptDisR {
        InArbWeightOptDisR::new(((self.bits >> 26) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 2 - Set this bit to 1 to enable INCR burst transfer for Rx transmitting link descriptor when accessing SRAM."]
    #[inline(always)]
    pub fn indscr_burst_en(&mut self) -> IndscrBurstEnW<'_, Conf0Spec> {
        IndscrBurstEnW::new(self, 2)
    }
    #[doc = "Bit 3 - When access address space is ecc/aes area, this bit should be set to 1. In this case, the start address of square should be 16-bit aligned. The width of square multiply byte number of one pixel should be 16-bit aligned."]
    #[inline(always)]
    pub fn in_ecc_aes_en(&mut self) -> InEccAesEnW<'_, Conf0Spec> {
        InEccAesEnW::new(self, 3)
    }
    #[doc = "Bit 4 - Set this bit to enable checking the owner attribute of the link descriptor."]
    #[inline(always)]
    pub fn in_check_owner(&mut self) -> InCheckOwnerW<'_, Conf0Spec> {
        InCheckOwnerW::new(self, 4)
    }
    #[doc = "Bits 6:8 - Block size of Rx channel 0. 0: single 1: 16 bytes 2: 32 bytes 3: 64 bytes 4: 128 bytes"]
    #[inline(always)]
    pub fn in_mem_burst_length(&mut self) -> InMemBurstLengthW<'_, Conf0Spec> {
        InMemBurstLengthW::new(self, 6)
    }
    #[doc = "Bit 12 - Set this bit to 1 to make sure AXI write data don't cross the address boundary which define by mem_burst_length"]
    #[inline(always)]
    pub fn in_page_bound_en(&mut self) -> InPageBoundEnW<'_, Conf0Spec> {
        InPageBoundEnW::new(self, 12)
    }
    #[doc = "Bit 24 - Write 1 then write 0 to this bit to reset Rx channel"]
    #[inline(always)]
    pub fn in_rst(&mut self) -> InRstW<'_, Conf0Spec> {
        InRstW::new(self, 24)
    }
    #[doc = "Bit 25 - Write 1 before reset and write 0 after reset"]
    #[inline(always)]
    pub fn in_cmd_disable(&mut self) -> InCmdDisableW<'_, Conf0Spec> {
        InCmdDisableW::new(self, 25)
    }
    #[doc = "Bit 26 - Set this bit to 1 to disable arbiter optimum weight function."]
    #[inline(always)]
    pub fn in_arb_weight_opt_dis(&mut self) -> InArbWeightOptDisW<'_, Conf0Spec> {
        InArbWeightOptDisW::new(self, 26)
    }
}

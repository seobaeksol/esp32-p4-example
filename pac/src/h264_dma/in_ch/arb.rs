...
pub type ExterInArbPriorityR = crate::FieldReader;
#[doc = "Field `EXTER_IN_ARB_PRIORITY` writer - Set the priority of channel"]
pub type ExterInArbPriorityW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl R {
    ...
    #[inline(always)]
    pub fn exter_in_arb_priority(&self) -> ExterInArbPriorityR {
        ExterInArbPriorityR::new(((self.bits >> 4) & 3) as u8)
    }
...
impl W {
    ...
    #[doc = "Bits 4:5 - Set the priority of channel"]
    #[inline(always)]
    pub fn exter_in_arb_priority(&mut self) -> ExterInArbPriorityW<'_, ArbSpec> {
        ExterInArbPriorityW::new(self, 4)
    }
    #[doc = "Bits 6:8 - Set the priority of channel"]
    #[inline(always)]

...
pub struct OutCh {
    ...
    buf_len: BufLen,
    fifo_bcnt: FifoBcnt,
    push_bytecnt: PushBytecnt,
    xaddr: Xaddr,
    block_buf_len: BlockBufLen,
}
impl OutCh {
    ...
    #[inline(always)]
    pub const fn eof_des_addr(&self) -> &EofDesAddr {
        &self.eof_des_addr
    }
    ...
    #[inline(always)]
    pub const fn ro_status(&self) -> &RoStatus {
        &self.ro_status
    }
    ...
    #[inline(always)]
    pub const fn mode_enable(&self) -> &ModeEnable {
        &self.mode_enable
    }
    #[doc = "0x54 - TX CHx test mode yuv value register. Available on CH0"]
    #[inline(always)]
    pub const fn mode_yuv(&self) -> &ModeYuv {
        &self.mode_yuv
    }
    ...
    #[inline(always)]
    pub const fn buf_len(&self) -> &BufLen {
        &self.buf_len
    }
    #[doc = "0x74 - TX CHx fifo byte cnt register"]
    #[inline(always)]
    pub const fn fifo_bcnt(&self) -> &FifoBcnt {
        &self.fifo_bcnt
    }
    #[doc = "0x78 - TX CHx push byte cnt register"]
    #[inline(always)]
    pub const fn push_bytecnt(&self) -> &PushBytecnt {
        &self.push_bytecnt
    }
    ...
    #[inline(always)]
    pub const fn block_buf_len(&self) -> &BlockBufLen {
        &self.block_buf_len
    }
}
...
#[doc(alias = "PUSH")]
pub type Push = crate::Reg<push::PushSpec>;
...
#[doc(alias = "EOF_DES_ADDR")]
pub type EofDesAddr = crate::Reg<eof_des_addr::EofDesAddrSpec>;
...
#[doc(alias = "RO_STATUS")]
pub type RoStatus = crate::Reg<ro_status::RoStatusSpec>;
...
#[doc(alias = "MODE_ENABLE")]
pub type ModeEnable = crate::Reg<mode_enable::ModeEnableSpec>;
...
#[doc(alias = "MODE_YUV")]
pub type ModeYuv = crate::Reg<mode_yuv::ModeYuvSpec>;
...
#[doc(alias = "BUF_LEN")]
pub type BufLen = crate::Reg<buf_len::BufLenSpec>;
...
#[doc(alias = "FIFO_BCNT")]
pub type FifoBcnt = crate::Reg<fifo_bcnt::FifoBcntSpec>;
...
#[doc(alias = "PUSH_BYTECNT")]
pub type PushBytecnt = crate::Reg<push_bytecnt::PushBytecntSpec>;
...
#[doc(alias = "BLOCK_BUF_LEN")]
pub type BlockBufLen = crate::Reg<block_buf_len::BlockBufLenSpec>;

...
pub type R = crate::R<InterMemStartAddr1Spec>;
#[doc = "Register `INTER_MEM_START_ADDR1` writer"]
pub type W = crate::W<InterMemStartAddr1Spec>;
#[doc = "Field `ACCESS_INTER_MEM_START_ADDR1` reader - The start address of accessible address space."]
pub type AccessInterMemStartAddr1R = crate::FieldReader<u32>;
#[doc = "Field `ACCESS_INTER_MEM_START_ADDR1` writer - The start address of accessible address space."]
pub type AccessInterMemStartAddr1W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - The start address of accessible address space."]
    #[inline(always)]
    pub fn access_inter_mem_start_addr1(&self) -> AccessInterMemStartAddr1R {
        AccessInterMemStartAddr1R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - The start address of accessible address space."]
    ...
    pub fn access_inter_mem_start_addr1(
        &mut self,
    ) -> AccessInterMemStartAddr1W<'_, InterMemStartAddr1Spec> {
        AccessInterMemStartAddr1W::new(self, 0)
    }
}
...
pub struct InterMemStartAddr1Spec;
impl crate::RegisterSpec for InterMemStartAddr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`inter_mem_start_addr1::R`](R) reader structure"]
impl crate::Readable for InterMemStartAddr1Spec {}
#[doc = "`write(|w| ..)` method takes [`inter_mem_start_addr1::W`](W) writer structure"]
impl crate::Writable for InterMemStartAddr1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets INTER_MEM_START_ADDR1 to value 0x3010_0000"]
impl crate::Resettable for InterMemStartAddr1Spec {

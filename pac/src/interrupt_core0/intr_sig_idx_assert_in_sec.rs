...
pub type Core0IntrSigIdxAssertInSecR = crate::FieldReader;
#[doc = "Field `CORE0_INTR_SIG_IDX_ASSERT_IN_SEC` writer - NA"]
pub type Core0IntrSigIdxAssertInSecW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - NA"]
    #[inline(always)]
    pub fn core0_intr_sig_idx_assert_in_sec(&self) -> Core0IntrSigIdxAssertInSecR {
        Core0IntrSigIdxAssertInSecR::new((self.bits & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5 - NA"]
    ...
    pub fn core0_intr_sig_idx_assert_in_sec(
        &mut self,
    ) -> Core0IntrSigIdxAssertInSecW<'_, IntrSigIdxAssertInSecSpec> {
        Core0IntrSigIdxAssertInSecW::new(self, 0)
    }
}

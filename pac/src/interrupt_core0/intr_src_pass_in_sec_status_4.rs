...
pub type Core0IntrSrcPassInSecStatus4R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - NA"]
    #[inline(always)]
    pub fn core0_intr_src_pass_in_sec_status_4(&self) -> Core0IntrSrcPassInSecStatus4R {
        Core0IntrSrcPassInSecStatus4R::new(self.bits)
    }
}

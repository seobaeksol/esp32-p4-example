...
pub type Core0IntrSrcPassInSecStatus2R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - NA"]
    #[inline(always)]
    pub fn core0_intr_src_pass_in_sec_status_2(&self) -> Core0IntrSrcPassInSecStatus2R {
        Core0IntrSrcPassInSecStatus2R::new(self.bits)
    }
}

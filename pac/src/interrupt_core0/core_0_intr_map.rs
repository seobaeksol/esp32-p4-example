...
pub type R = crate::R<Core0IntrMapSpec>;
#[doc = "Register `CORE_0_INTR_MAP%s` writer"]
pub type W = crate::W<Core0IntrMapSpec>;
...
pub struct Core0IntrMapSpec;
impl crate::RegisterSpec for Core0IntrMapSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`core_0_intr_map::R`](R) reader structure"]
impl crate::Readable for Core0IntrMapSpec {}
#[doc = "`write(|w| ..)` method takes [`core_0_intr_map::W`](W) writer structure"]
impl crate::Writable for Core0IntrMapSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CORE_0_INTR_MAP%s to value 0"]
impl crate::Resettable for Core0IntrMapSpec {}

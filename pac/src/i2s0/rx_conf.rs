...
impl R {
    ...
    pub fn rx_msb_shift(&self) -> RxMsbShiftR {
        RxMsbShiftR::new(((self.bits >> 13) & 1) != 0)
    }
    ...
    pub fn rx_bck_div_num(&self) -> RxBckDivNumR {
        RxBckDivNumR::new(((self.bits >> 21) & 0x3f) as u8)
    }
}
impl W {
    ...
    #[doc = "Bit 13 - Set this bit to enable receiver in Phillips standard mode"]
    #[inline(always)]
    pub fn rx_msb_shift(&mut self) -> RxMsbShiftW<'_, RxConfSpec> {
        RxMsbShiftW::new(self, 13)
    }
    #[doc = "Bit 15 - 1: I2S RX left alignment mode. 0: I2S RX right alignment mode."]
    #[inline(always)]
    ...
    #[doc = "Bits 21:26 - Bit clock configuration bits in receiver mode."]
    #[inline(always)]
    pub fn rx_bck_div_num(&mut self) -> RxBckDivNumW<'_, RxConfSpec> {
        RxBckDivNumW::new(self, 21)
    }
}

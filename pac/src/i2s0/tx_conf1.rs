...
pub type TxBitsModR = crate::FieldReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn tx_bits_mod(&self) -> TxBitsModR {
        TxBitsModR::new(((self.bits >> 14) & 0x1f) as u8)
    }
    #[doc = "Bits 19:26 - I2S Tx half sample bits -1."]
    #[inline(always)]
    pub fn tx_half_sample_bits(&self) -> TxHalfSampleBitsR {
        TxHalfSampleBitsR::new(((self.bits >> 19) & 0xff) as u8)
    }
    #[doc = "Bits 27:31 - The Tx bit number for each channel minus 1in TDM mode."]
    #[inline(always)]
    pub fn tx_tdm_chan_bits(&self) -> TxTdmChanBitsR {
        TxTdmChanBitsR::new(((self.bits >> 27) & 0x1f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:8 - The width of tx_ws_out at idle level in TDM mode is (I2S_TX_TDM_WS_WIDTH\\[8:0\\] +1) * T_bck"]
    #[inline(always)]
    pub fn tx_tdm_ws_width(&mut self) -> TxTdmWsWidthW<'_, TxConf1Spec> {
        TxTdmWsWidthW::new(self, 0)
    }
    #[doc = "Bits 14:18 - Set the bits to configure the valid data bit length of I2S transmitter channel. 7: all the valid channel data is in 8-bit-mode. 15: all the valid channel data is in 16-bit-mode. 23: all the valid channel data is in 24-bit-mode. 31:all the valid channel data is in 32-bit-mode."]
    #[inline(always)]
    pub fn tx_bits_mod(&mut self) -> TxBitsModW<'_, TxConf1Spec> {
        TxBitsModW::new(self, 14)
    }
    #[doc = "Bits 19:26 - I2S Tx half sample bits -1."]
    #[inline(always)]
    pub fn tx_half_sample_bits(&mut self) -> TxHalfSampleBitsW<'_, TxConf1Spec> {
        TxHalfSampleBitsW::new(self, 19)
    }
    #[doc = "Bits 27:31 - The Tx bit number for each channel minus 1in TDM mode."]
    #[inline(always)]
    pub fn tx_tdm_chan_bits(&mut self) -> TxTdmChanBitsW<'_, TxConf1Spec> {
        TxTdmChanBitsW::new(self, 27)
    }
}
...
pub struct TxConf1Spec;
impl crate::RegisterSpec for TxConf1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tx_conf1::R`](R) reader structure"]
impl crate::Readable for TxConf1Spec {}
#[doc = "`write(|w| ..)` method takes [`tx_conf1::W`](W) writer structure"]
impl crate::Writable for TxConf1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TX_CONF1 to value 0x787b_c000"]
impl crate::Resettable for TxConf1Spec {

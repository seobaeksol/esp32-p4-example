...
pub type EtmTxSendWordNumR = crate::FieldReader<u16>;
...
pub type EtmTxSendWordNumW<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
...
pub type EtmRxReceiveWordNumR = crate::FieldReader<u16>;
...
pub type EtmRxReceiveWordNumW<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    ...
    #[inline(always)]
    pub fn etm_tx_send_word_num(&self) -> EtmTxSendWordNumR {
        EtmTxSendWordNumR::new((self.bits & 0x03ff) as u16)
    }
    ...
    #[inline(always)]
    pub fn etm_rx_receive_word_num(&self) -> EtmRxReceiveWordNumR {
        EtmRxReceiveWordNumR::new(((self.bits >> 10) & 0x03ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:9 - I2S ETM send x words event. When sending word number of reg_etm_tx_send_word_num\\[9:0\\], i2s will trigger an etm event."]
    #[inline(always)]
    pub fn etm_tx_send_word_num(&mut self) -> EtmTxSendWordNumW<'_, EtmConfSpec> {
        EtmTxSendWordNumW::new(self, 0)
    }
    #[doc = "Bits 10:19 - I2S ETM receive x words event. When receiving word number of reg_etm_rx_receive_word_num\\[9:0\\], i2s will trigger an etm event."]
    #[inline(always)]
    pub fn etm_rx_receive_word_num(&mut self) -> EtmRxReceiveWordNumW<'_, EtmConfSpec> {
        EtmRxReceiveWordNumW::new(self, 10)
    }
}

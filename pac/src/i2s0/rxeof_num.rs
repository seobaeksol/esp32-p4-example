...
pub type R = crate::R<RxeofNumSpec>;
#[doc = "Register `RXEOF_NUM` writer"]
pub type W = crate::W<RxeofNumSpec>;
...
pub type RxEofNumR = crate::FieldReader<u16>;
...
pub type RxEofNumW<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ...
    #[inline(always)]
    pub fn rx_eof_num(&self) -> RxEofNumR {
        RxEofNumR::new((self.bits & 0x0fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:11 - The receive data bit length is (I2S_RX_BITS_MOD\\[4:0\\] + 1) * (REG_RX_EOF_NUM\\[11:0\\] + 1) . It will trigger in_suc_eof interrupt in the configured DMA RX channel."]
    #[inline(always)]
    pub fn rx_eof_num(&mut self) -> RxEofNumW<'_, RxeofNumSpec> {
        RxEofNumW::new(self, 0)
    }
}
...
pub struct RxeofNumSpec;
impl crate::RegisterSpec for RxeofNumSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rxeof_num::R`](R) reader structure"]
impl crate::Readable for RxeofNumSpec {}
#[doc = "`write(|w| ..)` method takes [`rxeof_num::W`](W) writer structure"]
impl crate::Writable for RxeofNumSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RXEOF_NUM to value 0x40"]
impl crate::Resettable for RxeofNumSpec {

...
pub type TxFifoCntRstW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:30 - tx fifo counter value."]
    #[inline(always)]
    pub fn tx_fifo_cnt(&self) -> TxFifoCntR {
        TxFifoCntR::new(self.bits & 0x7fff_ffff)
    }
}
impl W {
    #[doc = "Bit 31 - Set this bit to reset tx fifo counter."]
    #[inline(always)]
    pub fn tx_fifo_cnt_rst(&mut self) -> TxFifoCntRstW<'_, FifoCntSpec> {
        TxFifoCntRstW::new(self, 31)
    }
}

...
pub type RxHalfSampleBitsW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
impl R {
    ...
    pub fn rx_tdm_ws_width(&self) -> RxTdmWsWidthR {
        RxTdmWsWidthR::new((self.bits & 0x01ff) as u16)
    }

...
pub type R = crate::R<RxPdm2pcmConfSpec>;
#[doc = "Register `RX_PDM2PCM_CONF` writer"]
pub type W = crate::W<RxPdm2pcmConfSpec>;
...
impl W {
    #[doc = "Bit 19 - 1: Enable PDM2PCM RX mode. 0: DIsable."]
    #[inline(always)]
    pub fn rx_pdm2pcm_en(&mut self) -> RxPdm2pcmEnW<'_, RxPdm2pcmConfSpec> {
        RxPdm2pcmEnW::new(self, 19)
    }
    #[doc = "Bit 20 - Configure the down sampling rate of PDM RX filter group1 module. 1: The down sampling rate is 128. 0: down sampling rate is 64."]
    #[inline(always)]
    pub fn rx_pdm_sinc_dsr_16_en(&mut self) -> RxPdmSincDsr16EnW<'_, RxPdm2pcmConfSpec> {
        RxPdmSincDsr16EnW::new(self, 20)
    }
    #[doc = "Bits 21:24 - Configure PDM RX amplify number."]
    #[inline(always)]
    pub fn rx_pdm2pcm_amplify_num(&mut self) -> RxPdm2pcmAmplifyNumW<'_, RxPdm2pcmConfSpec> {
        RxPdm2pcmAmplifyNumW::new(self, 21)
    }
    #[doc = "Bit 25 - I2S PDM RX bypass hp filter or not."]
    #[inline(always)]
    pub fn rx_pdm_hp_bypass(&mut self) -> RxPdmHpBypassW<'_, RxPdm2pcmConfSpec> {
        RxPdmHpBypassW::new(self, 25)
    }
    #[doc = "Bits 26:28 - The fourth parameter of PDM RX IIR_HP filter stage 2 is (504 + LP_I2S_RX_IIR_HP_MULT12_5\\[2:0\\])"]
    #[inline(always)]
    pub fn rx_iir_hp_mult12_5(&mut self) -> RxIirHpMult12_5W<'_, RxPdm2pcmConfSpec> {
        RxIirHpMult12_5W::new(self, 26)
    }
    #[doc = "Bits 29:31 - The fourth parameter of PDM RX IIR_HP filter stage 1 is (504 + LP_I2S_RX_IIR_HP_MULT12_0\\[2:0\\])"]
    #[inline(always)]
    pub fn rx_iir_hp_mult12_0(&mut self) -> RxIirHpMult12_0W<'_, RxPdm2pcmConfSpec> {
...
pub struct RxPdm2pcmConfSpec;
impl crate::RegisterSpec for RxPdm2pcmConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rx_pdm2pcm_conf::R`](R) reader structure"]
impl crate::Readable for RxPdm2pcmConfSpec {}
#[doc = "`write(|w| ..)` method takes [`rx_pdm2pcm_conf::W`](W) writer structure"]
impl crate::Writable for RxPdm2pcmConfSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RX_PDM2PCM_CONF to value 0xf820_0000"]
impl crate::Resettable for RxPdm2pcmConfSpec {

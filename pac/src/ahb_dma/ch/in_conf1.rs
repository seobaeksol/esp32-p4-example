...
pub type InCheckOwnerCh0R = crate::BitReader;
#[doc = "Field `IN_CHECK_OWNER_CH0` writer - Configures whether to enable owner bit check for RX channel 0.\\\\0: Disable\\\\1: Enable\\\\"]
pub type InCheckOwnerCh0W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 12 - Configures whether to enable owner bit check for RX channel 0.\\\\0: Disable\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn in_check_owner_ch0(&self) -> InCheckOwnerCh0R {
        InCheckOwnerCh0R::new(((self.bits >> 12) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 12 - Configures whether to enable owner bit check for RX channel 0.\\\\0: Disable\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn in_check_owner_ch0(&mut self) -> InCheckOwnerCh0W<'_, InConf1Spec> {
        InCheckOwnerCh0W::new(self, 12)
    }
}

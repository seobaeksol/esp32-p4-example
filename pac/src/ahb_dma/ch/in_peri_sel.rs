...
pub type PeriInSelCh0R = crate::FieldReader;
...
pub type PeriInSelCh0W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ...
    #[inline(always)]
    pub fn peri_in_sel_ch0(&self) -> PeriInSelCh0R {
        PeriInSelCh0R::new((self.bits & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5 - Configures the peripheral connected to RX channel 0.\\\\ 0: I3C\\\\ 1: Dummy\\\\ 2: UHCI0\\\\ 3: I2S0\\\\ 4: I2S1\\\\ 5: I2S2\\\\ 6: Dummy\\\\ 7: Dummy\\\\ 8: ADC_DAC\\\\ 9: Dummy\\\\ 10: RMT\\\\ 11~15: Dummy\\\\"]
    #[inline(always)]
    pub fn peri_in_sel_ch0(&mut self) -> PeriInSelCh0W<'_, InPeriSelSpec> {
        PeriInSelCh0W::new(self, 0)
    }
}

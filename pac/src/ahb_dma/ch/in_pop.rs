...
pub struct InPopSpec;
impl crate::RegisterSpec for InPopSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`in_pop::R`](R) reader structure"]
impl crate::Readable for InPopSpec {}
#[doc = "`write(|w| ..)` method takes [`in_pop::W`](W) writer structure"]
impl crate::Writable for InPopSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets IN_POP to value 0x0800"]
impl crate::Resettable for InPopSpec {

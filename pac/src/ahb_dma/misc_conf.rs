...
pub type AhbmRstInterR = crate::BitReader;
#[doc = "Field `AHBM_RST_INTER` writer - Write 1 and then 0 to reset the internal AHB FSM"]
pub type AhbmRstInterW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn ahbm_rst_inter(&self) -> AhbmRstInterR {
        AhbmRstInterR::new((self.bits & 1) != 0)
    }
    ...
    pub fn arb_pri_dis(&self) -> ArbPriDisR {
        ArbPriDisR::new(((self.bits >> 2) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - Write 1 and then 0 to reset the internal AHB FSM"]
    #[inline(always)]
    pub fn ahbm_rst_inter(&mut self) -> AhbmRstInterW<'_, MiscConfSpec> {
        AhbmRstInterW::new(self, 0)
    }
    #[doc = "Bit 2 - Configures whether to disable the fixed-priority channel arbitration.\\\\0: Enable\\\\1: Disable\\\\"]
    #[inline(always)]
    pub fn arb_pri_dis(&mut self) -> ArbPriDisW<'_, MiscConfSpec> {
        ArbPriDisW::new(self, 2)
    }
    #[doc = "Bit 3 - Configures clock gating.\\\\0: Support clock only when the application writes registers.\\\\ 1: Always force the clock on for registers.\\\\"]
    #[inline(always)]

...
impl Ch {
    ...
    #[inline(always)]
    pub const fn in_link(&self) -> &InLink {
        &self.in_link
    }
    ...
    #[inline(always)]
    pub const fn in_peri(&self) -> &InPeri {
        &self.in_peri
    }
    ...
    #[inline(always)]
    pub const fn out_link(&self) -> &OutLink {
        &self.out_link
    }
    ...
    #[inline(always)]
    pub const fn out_peri(&self) -> &OutPeri {
        &self.out_peri
    }
...
#[doc(alias = "IN_LINK")]
pub type InLink = crate::Reg<in_link::InLinkSpec>;
#[doc = "Receive FIFO status of RX channel 0"]
pub mod in_link;
...
#[doc(alias = "IN_PERI")]
pub type InPeri = crate::Reg<in_peri::InPeriSpec>;
...
#[doc(alias = "OUT_LINK")]
pub type OutLink = crate::Reg<out_link::OutLinkSpec>;
#[doc = "Push control register of TX channel 0"]
pub mod out_link;
...
#[doc(alias = "OUT_PERI")]
pub type OutPeri = crate::Reg<out_peri::OutPeriSpec>;

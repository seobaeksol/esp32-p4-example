...
pub type R = crate::R<OutDoneDesAddrCh0Spec>;
...
pub type OutDoneDesAddrCh0R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Represents the address of the outlink descriptor when this descriptor is completed."]
    #[inline(always)]
    pub fn out_done_des_addr_ch0(&self) -> OutDoneDesAddrCh0R {
        OutDoneDesAddrCh0R::new(self.bits)
    }
}
...
pub struct OutDoneDesAddrCh0Spec;
impl crate::RegisterSpec for OutDoneDesAddrCh0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`out_done_des_addr_ch0::R`](R) reader structure"]
impl crate::Readable for OutDoneDesAddrCh0Spec {}
#[doc = "`reset()` method sets OUT_DONE_DES_ADDR_CH0 to value 0"]
impl crate::Resettable for OutDoneDesAddrCh0Spec {}

...
pub type R = crate::R<TxCrcEnAddrChSpec>;
#[doc = "Register `TX_CRC_EN_ADDR_CH%s` writer"]
pub type W = crate::W<TxCrcEnAddrChSpec>;
#[doc = "Field `TX_CRC_EN_ADDR_CH` reader - reserved"]
pub type TxCrcEnAddrChR = crate::FieldReader<u32>;
#[doc = "Field `TX_CRC_EN_ADDR_CH` writer - reserved"]
pub type TxCrcEnAddrChW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - reserved"]
    #[inline(always)]
    pub fn tx_crc_en_addr_ch(&self) -> TxCrcEnAddrChR {
        TxCrcEnAddrChR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - reserved"]
    #[inline(always)]
    pub fn tx_crc_en_addr_ch(&mut self) -> TxCrcEnAddrChW<'_, TxCrcEnAddrChSpec> {
        TxCrcEnAddrChW::new(self, 0)
    }
}
...
pub struct TxCrcEnAddrChSpec;
impl crate::RegisterSpec for TxCrcEnAddrChSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tx_crc_en_addr_ch::R`](R) reader structure"]
impl crate::Readable for TxCrcEnAddrChSpec {}
#[doc = "`write(|w| ..)` method takes [`tx_crc_en_addr_ch::W`](W) writer structure"]
impl crate::Writable for TxCrcEnAddrChSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TX_CRC_EN_ADDR_CH%s to value 0"]
impl crate::Resettable for TxCrcEnAddrChSpec {}

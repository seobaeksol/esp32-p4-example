...
pub type R = crate::R<RxArbWeightOptDirCh1Spec>;
#[doc = "Register `RX_ARB_WEIGHT_OPT_DIR_CH1` writer"]
pub type W = crate::W<RxArbWeightOptDirCh1Spec>;
#[doc = "Field `RX_ARB_WEIGHT_OPT_DIS_CH1` reader - reserved"]
pub type RxArbWeightOptDisCh1R = crate::BitReader;
#[doc = "Field `RX_ARB_WEIGHT_OPT_DIS_CH1` writer - reserved"]
pub type RxArbWeightOptDisCh1W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - reserved"]
    #[inline(always)]
    pub fn rx_arb_weight_opt_dis_ch1(&self) -> RxArbWeightOptDisCh1R {
        RxArbWeightOptDisCh1R::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - reserved"]
    ...
    pub fn rx_arb_weight_opt_dis_ch1(
        &mut self,
    ) -> RxArbWeightOptDisCh1W<'_, RxArbWeightOptDirCh1Spec> {
        RxArbWeightOptDisCh1W::new(self, 0)
    }
}
...
pub struct RxArbWeightOptDirCh1Spec;
impl crate::RegisterSpec for RxArbWeightOptDirCh1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rx_arb_weight_opt_dir_ch1::R`](R) reader structure"]
impl crate::Readable for RxArbWeightOptDirCh1Spec {}
#[doc = "`write(|w| ..)` method takes [`rx_arb_weight_opt_dir_ch1::W`](W) writer structure"]
impl crate::Writable for RxArbWeightOptDirCh1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RX_ARB_WEIGHT_OPT_DIR_CH1 to value 0"]
impl crate::Resettable for RxArbWeightOptDirCh1Spec {}

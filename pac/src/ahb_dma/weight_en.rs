...
pub struct WeightEnSpec;
impl crate::RegisterSpec for WeightEnSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`weight_en::R`](R) reader structure"]
impl crate::Readable for WeightEnSpec {}
#[doc = "`write(|w| ..)` method takes [`weight_en::W`](W) writer structure"]
impl crate::Writable for WeightEnSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WEIGHT_EN to value 0"]
impl crate::Resettable for WeightEnSpec {}

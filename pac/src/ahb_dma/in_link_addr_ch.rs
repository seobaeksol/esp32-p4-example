...
#[doc(alias = "IN_LINK_ADDR_CH")]
pub struct InLinkAddrCh {
    in_link_addr: InLinkAddr,
}
impl InLinkAddrCh {
    #[doc = "0x00 - Link list descriptor address configuration of RX channel 0"]
    #[inline(always)]
    pub const fn in_link_addr(&self) -> &InLinkAddr {
        &self.in_link_addr
    }
}
...
#[doc(alias = "IN_LINK_ADDR")]
pub type InLinkAddr = crate::Reg<in_link_addr::InLinkAddrSpec>;

...
pub type R = crate::R<ArbTimeoutTxSpec>;
#[doc = "Register `ARB_TIMEOUT_TX` writer"]
pub type W = crate::W<ArbTimeoutTxSpec>;
#[doc = "Field `ARB_TIMEOUT_TX` reader - Configures the time slot for TX. Measurement unit: AHB bus clock cycle."]
pub type ArbTimeoutTxR = crate::FieldReader<u16>;
#[doc = "Field `ARB_TIMEOUT_TX` writer - Configures the time slot for TX. Measurement unit: AHB bus clock cycle."]
pub type ArbTimeoutTxW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - Configures the time slot for TX. Measurement unit: AHB bus clock cycle."]
    #[inline(always)]
    pub fn arb_timeout_tx(&self) -> ArbTimeoutTxR {
        ArbTimeoutTxR::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Configures the time slot for TX. Measurement unit: AHB bus clock cycle."]
    #[inline(always)]
    pub fn arb_timeout_tx(&mut self) -> ArbTimeoutTxW<'_, ArbTimeoutTxSpec> {
        ArbTimeoutTxW::new(self, 0)
    }
}
...
pub struct ArbTimeoutTxSpec;
impl crate::RegisterSpec for ArbTimeoutTxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`arb_timeout_tx::R`](R) reader structure"]
impl crate::Readable for ArbTimeoutTxSpec {}
#[doc = "`write(|w| ..)` method takes [`arb_timeout_tx::W`](W) writer structure"]
impl crate::Writable for ArbTimeoutTxSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ARB_TIMEOUT_TX to value 0"]
impl crate::Resettable for ArbTimeoutTxSpec {}

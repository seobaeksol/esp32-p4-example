...
pub type R = crate::R<TxChArbWeightCh0Spec>;
#[doc = "Register `TX_CH_ARB_WEIGHT_CH0` writer"]
pub type W = crate::W<TxChArbWeightCh0Spec>;
#[doc = "Field `TX_ARB_WEIGHT_VALUE_CH0` reader - Configures the weight(i.e the number of tokens) of TX channel0"]
pub type TxArbWeightValueCh0R = crate::FieldReader;
#[doc = "Field `TX_ARB_WEIGHT_VALUE_CH0` writer - Configures the weight(i.e the number of tokens) of TX channel0"]
pub type TxArbWeightValueCh0W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bits 0:3 - Configures the weight(i.e the number of tokens) of TX channel0"]
    #[inline(always)]
    pub fn tx_arb_weight_value_ch0(&self) -> TxArbWeightValueCh0R {
        TxArbWeightValueCh0R::new((self.bits & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3 - Configures the weight(i.e the number of tokens) of TX channel0"]
    #[inline(always)]
    pub fn tx_arb_weight_value_ch0(&mut self) -> TxArbWeightValueCh0W<'_, TxChArbWeightCh0Spec> {
        TxArbWeightValueCh0W::new(self, 0)
    }
}
...
pub struct TxChArbWeightCh0Spec;
impl crate::RegisterSpec for TxChArbWeightCh0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tx_ch_arb_weight_ch0::R`](R) reader structure"]
impl crate::Readable for TxChArbWeightCh0Spec {}
#[doc = "`write(|w| ..)` method takes [`tx_ch_arb_weight_ch0::W`](W) writer structure"]
impl crate::Writable for TxChArbWeightCh0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TX_CH_ARB_WEIGHT_CH0 to value 0"]
impl crate::Resettable for TxChArbWeightCh0Spec {}

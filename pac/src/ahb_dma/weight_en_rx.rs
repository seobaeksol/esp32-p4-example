...
pub struct WeightEnRxSpec;
impl crate::RegisterSpec for WeightEnRxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`weight_en_rx::R`](R) reader structure"]
impl crate::Readable for WeightEnRxSpec {}
#[doc = "`write(|w| ..)` method takes [`weight_en_rx::W`](W) writer structure"]
impl crate::Writable for WeightEnRxSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WEIGHT_EN_RX to value 0"]
impl crate::Resettable for WeightEnRxSpec {}

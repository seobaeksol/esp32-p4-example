...
pub struct InDoneDesAddrCh0Spec;
impl crate::RegisterSpec for InDoneDesAddrCh0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`in_done_des_addr_ch0::R`](R) reader structure"]
impl crate::Readable for InDoneDesAddrCh0Spec {}
#[doc = "`reset()` method sets IN_DONE_DES_ADDR_CH0 to value 0"]
impl crate::Resettable for InDoneDesAddrCh0Spec {}

...
pub type R = crate::R<TxCrcDataEnWrDataChSpec>;
#[doc = "Register `TX_CRC_DATA_EN_WR_DATA_CH%s` writer"]
pub type W = crate::W<TxCrcDataEnWrDataChSpec>;
#[doc = "Field `TX_CRC_DATA_EN_WR_DATA_CH` reader - reserved"]
pub type TxCrcDataEnWrDataChR = crate::FieldReader;
#[doc = "Field `TX_CRC_DATA_EN_WR_DATA_CH` writer - reserved"]
pub type TxCrcDataEnWrDataChW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - reserved"]
    #[inline(always)]
    pub fn tx_crc_data_en_wr_data_ch(&self) -> TxCrcDataEnWrDataChR {
        TxCrcDataEnWrDataChR::new((self.bits & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7 - reserved"]
    ...
    pub fn tx_crc_data_en_wr_data_ch(
        &mut self,
    ) -> TxCrcDataEnWrDataChW<'_, TxCrcDataEnWrDataChSpec> {
        TxCrcDataEnWrDataChW::new(self, 0)
    }
}
...
pub struct TxCrcDataEnWrDataChSpec;
impl crate::RegisterSpec for TxCrcDataEnWrDataChSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tx_crc_data_en_wr_data_ch::R`](R) reader structure"]
impl crate::Readable for TxCrcDataEnWrDataChSpec {}
#[doc = "`write(|w| ..)` method takes [`tx_crc_data_en_wr_data_ch::W`](W) writer structure"]
impl crate::Writable for TxCrcDataEnWrDataChSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TX_CRC_DATA_EN_WR_DATA_CH%s to value 0"]
impl crate::Resettable for TxCrcDataEnWrDataChSpec {}

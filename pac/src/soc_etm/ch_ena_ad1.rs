...
pub type R = crate::R<ChEnaAd1Spec>;
#[doc = "Register `CH_ENA_AD1` writer"]
pub type W = crate::W<ChEnaAd1Spec>;
...
impl W {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `CH_ENA32` field.</div>"]
    #[inline(always)]
    pub fn ch_ena(&mut self, n: u8) -> ChEnaW<'_, ChEnaAd1Spec> {
        #[allow(clippy::no_effect)]
        [(); 18][n as usize];
        ChEnaW::new(self, n)
    }
    #[doc = "Bit 0 - Represents ch32 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena32(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 0)
    }
    #[doc = "Bit 1 - Represents ch33 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena33(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 1)
    }
    #[doc = "Bit 2 - Represents ch34 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena34(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 2)
    }
    #[doc = "Bit 3 - Represents ch35 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena35(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 3)
    }
    #[doc = "Bit 4 - Represents ch36 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena36(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 4)
    }
    #[doc = "Bit 5 - Represents ch37 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena37(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 5)
    }
    #[doc = "Bit 6 - Represents ch38 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena38(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 6)
    }
    #[doc = "Bit 7 - Represents ch39 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena39(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 7)
    }
    #[doc = "Bit 8 - Represents ch40 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena40(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 8)
    }
    #[doc = "Bit 9 - Represents ch41 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena41(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 9)
    }
    #[doc = "Bit 10 - Represents ch42 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena42(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 10)
    }
    #[doc = "Bit 11 - Represents ch43 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena43(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 11)
    }
    #[doc = "Bit 12 - Represents ch44 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena44(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 12)
    }
    #[doc = "Bit 13 - Represents ch45 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena45(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 13)
    }
    #[doc = "Bit 14 - Represents ch46 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena46(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 14)
    }
    #[doc = "Bit 15 - Represents ch47 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena47(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 15)
    }
    #[doc = "Bit 16 - Represents ch48 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena48(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 16)
    }
    #[doc = "Bit 17 - Represents ch49 enable status.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ch_ena49(&mut self) -> ChEnaW<'_, ChEnaAd1Spec> {
        ChEnaW::new(self, 17)
    }
}
...
pub struct ChEnaAd1Spec;
impl crate::RegisterSpec for ChEnaAd1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch_ena_ad1::R`](R) reader structure"]
impl crate::Readable for ChEnaAd1Spec {}
#[doc = "`write(|w| ..)` method takes [`ch_ena_ad1::W`](W) writer structure"]
impl crate::Writable for ChEnaAd1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH_ENA_AD1 to value 0"]
impl crate::Resettable for ChEnaAd1Spec {}

...
pub type W = crate::W<ChEnaAd0SetSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn ch_set(&mut self, n: u8) -> ChSetW<'_, ChEnaAd0SetSpec> {
...
pub struct ChEnaAd0SetSpec;
impl crate::RegisterSpec for ChEnaAd0SetSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`ch_ena_ad0_set::W`](W) writer structure"]
impl crate::Writable for ChEnaAd0SetSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH_ENA_AD0_SET to value 0"]
impl crate::Resettable for ChEnaAd0SetSpec {}

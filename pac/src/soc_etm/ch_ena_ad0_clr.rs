...
impl W {
    ...
    #[inline(always)]
    pub fn ch_clr(&mut self, n: u8) -> ChClrW<'_, ChEnaAd0ClrSpec> {
...
pub struct ChEnaAd0ClrSpec;
impl crate::RegisterSpec for ChEnaAd0ClrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`ch_ena_ad0_clr::W`](W) writer structure"]
impl crate::Writable for ChEnaAd0ClrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH_ENA_AD0_CLR to value 0"]
impl crate::Resettable for ChEnaAd0ClrSpec {}

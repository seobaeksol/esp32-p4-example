...
pub type W = crate::W<ChEnaAd1ClrSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn ch_clr(&mut self, n: u8) -> ChClrW<'_, ChEnaAd1ClrSpec> {
...
pub struct ChEnaAd1ClrSpec;
impl crate::RegisterSpec for ChEnaAd1ClrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`ch_ena_ad1_clr::W`](W) writer structure"]
impl crate::Writable for ChEnaAd1ClrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH_ENA_AD1_CLR to value 0"]
impl crate::Resettable for ChEnaAd1ClrSpec {}

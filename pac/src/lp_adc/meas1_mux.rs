...
pub type R = crate::R<Meas1MuxSpec>;
#[doc = "Register `MEAS1_MUX` writer"]
pub type W = crate::W<Meas1MuxSpec>;
#[doc = "Field `SAR1_DIG_FORCE` reader - 1: SAR ADC1 controlled by DIG ADC1 CTRL."]
pub type Sar1DigForceR = crate::BitReader;
#[doc = "Field `SAR1_DIG_FORCE` writer - 1: SAR ADC1 controlled by DIG ADC1 CTRL."]
pub type Sar1DigForceW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 31 - 1: SAR ADC1 controlled by DIG ADC1 CTRL."]
    #[inline(always)]
    pub fn sar1_dig_force(&self) -> Sar1DigForceR {
        Sar1DigForceR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 31 - 1: SAR ADC1 controlled by DIG ADC1 CTRL."]
    #[inline(always)]
    pub fn sar1_dig_force(&mut self) -> Sar1DigForceW<'_, Meas1MuxSpec> {
        Sar1DigForceW::new(self, 31)
    }
}
...
pub struct Meas1MuxSpec;
impl crate::RegisterSpec for Meas1MuxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`meas1_mux::R`](R) reader structure"]
impl crate::Readable for Meas1MuxSpec {}
#[doc = "`write(|w| ..)` method takes [`meas1_mux::W`](W) writer structure"]
impl crate::Writable for Meas1MuxSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MEAS1_MUX to value 0"]
impl crate::Resettable for Meas1MuxSpec {}

...
pub struct ForceWpdSarSpec;
impl crate::RegisterSpec for ForceWpdSarSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`force_wpd_sar::R`](R) reader structure"]
impl crate::Readable for ForceWpdSarSpec {}
#[doc = "`write(|w| ..)` method takes [`force_wpd_sar::W`](W) writer structure"]
impl crate::Writable for ForceWpdSarSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FORCE_WPD_SAR to value 0"]
impl crate::Resettable for ForceWpdSarSpec {}

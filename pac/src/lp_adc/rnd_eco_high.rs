...
pub type RndEcoHighR = crate::FieldReader<u32>;
#[doc = "Field `RND_ECO_HIGH` writer - N/A"]
pub type RndEcoHighW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - N/A"]
    #[inline(always)]
    pub fn rnd_eco_high(&self) -> RndEcoHighR {
        RndEcoHighR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - N/A"]
    #[inline(always)]
    pub fn rnd_eco_high(&mut self) -> RndEcoHighW<'_, RndEcoHighSpec> {
        RndEcoHighW::new(self, 0)
    }
}

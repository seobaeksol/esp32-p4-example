...
pub type R = crate::R<Atten2Spec>;
#[doc = "Register `ATTEN2` writer"]
pub type W = crate::W<Atten2Spec>;
#[doc = "Field `SAR2_ATTEN` reader - 2-bit attenuation for each pad."]
pub type Sar2AttenR = crate::FieldReader<u32>;
#[doc = "Field `SAR2_ATTEN` writer - 2-bit attenuation for each pad."]
pub type Sar2AttenW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - 2-bit attenuation for each pad."]
    #[inline(always)]
    pub fn sar2_atten(&self) -> Sar2AttenR {
        Sar2AttenR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - 2-bit attenuation for each pad."]
    #[inline(always)]
    pub fn sar2_atten(&mut self) -> Sar2AttenW<'_, Atten2Spec> {
        Sar2AttenW::new(self, 0)
    }
}
...
pub struct Atten2Spec;
impl crate::RegisterSpec for Atten2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`atten2::R`](R) reader structure"]
impl crate::Readable for Atten2Spec {}
#[doc = "`write(|w| ..)` method takes [`atten2::W`](W) writer structure"]
impl crate::Writable for Atten2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ATTEN2 to value 0xffff_ffff"]
impl crate::Resettable for Atten2Spec {

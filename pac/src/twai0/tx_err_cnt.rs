...
pub type R = crate::R<TxErrCntSpec>;
#[doc = "Register `TX_ERR_CNT` writer"]
pub type W = crate::W<TxErrCntSpec>;
...
impl R {
    ...
    #[inline(always)]
    pub fn tx_err_cnt(&self) -> TxErrCntR {
...
impl W {
    #[doc = "Bits 0:7 - The TX error counter register reflects the current value of the transmit error counter. Software has R/W permission in reset mode and RO in operation mode."]
    #[inline(always)]
    pub fn tx_err_cnt(&mut self) -> TxErrCntW<'_, TxErrCntSpec> {
...
pub struct TxErrCntSpec;
impl crate::RegisterSpec for TxErrCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tx_err_cnt::R`](R) reader structure"]
impl crate::Readable for TxErrCntSpec {}
#[doc = "`write(|w| ..)` method takes [`tx_err_cnt::W`](W) writer structure"]
impl crate::Writable for TxErrCntSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TX_ERR_CNT to value 0"]
impl crate::Resettable for TxErrCntSpec {}

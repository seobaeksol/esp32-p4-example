...
pub type W = crate::W<HwCfgSpec>;
#[doc = "Field `HW_STANDBY_EN` reader - Enable function that hardware control standby pin."]
pub type HwStandbyEnR = crate::BitReader;
#[doc = "Field `HW_STANDBY_EN` writer - Enable function that hardware control standby pin."]
pub type HwStandbyEnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Enable function that hardware control standby pin."]
    #[inline(always)]
    pub fn hw_standby_en(&self) -> HwStandbyEnR {
        HwStandbyEnR::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Enable function that hardware control standby pin."]
    #[inline(always)]
    pub fn hw_standby_en(&mut self) -> HwStandbyEnW<'_, HwCfgSpec> {
        HwStandbyEnW::new(self, 0)
    }
}
...
impl crate::Writable for HwCfgSpec {

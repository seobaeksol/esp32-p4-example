...
pub type R = crate::R<RxMessageCounterSpec>;
...
pub type RxMessageCounterR = crate::FieldReader;
impl R {
    ...
    #[inline(always)]
    pub fn rx_message_counter(&self) -> RxMessageCounterR {
        RxMessageCounterR::new((self.bits & 0x7f) as u8)
    }
}
...
pub struct RxMessageCounterSpec;
impl crate::RegisterSpec for RxMessageCounterSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rx_message_counter::R`](R) reader structure"]
impl crate::Readable for RxMessageCounterSpec {}
#[doc = "`reset()` method sets RX_MESSAGE_COUNTER to value 0"]
impl crate::Resettable for RxMessageCounterSpec {}

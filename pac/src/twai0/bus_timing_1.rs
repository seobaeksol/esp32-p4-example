...
pub type R = crate::R<BusTiming1Spec>;
#[doc = "Register `BUS_TIMING_1` writer"]
pub type W = crate::W<BusTiming1Spec>;
...
pub type TimeSegment1R = crate::FieldReader;
...
pub type TimeSegment1W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
pub type TimeSegment2R = crate::FieldReader;
...
pub type TimeSegment2W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type TimeSamplingR = crate::BitReader;
...
pub type TimeSamplingW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn time_segment1(&self) -> TimeSegment1R {
        TimeSegment1R::new((self.bits & 0x0f) as u8)
    }
    ...
    #[inline(always)]
    pub fn time_segment2(&self) -> TimeSegment2R {
        TimeSegment2R::new(((self.bits >> 4) & 7) as u8)
    }
    ...
    #[inline(always)]
    pub fn time_sampling(&self) -> TimeSamplingR {
        TimeSamplingR::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:3 - The number of clock cycles in TSEG1 per bit timing. Software has R/W permission in reset mode and RO in operation mode."]
    #[inline(always)]
    pub fn time_segment1(&mut self) -> TimeSegment1W<'_, BusTiming1Spec> {
        TimeSegment1W::new(self, 0)
    }
    #[doc = "Bits 4:6 - The number of clock cycles in TSEG2 per bit timing. Software has R/W permission in reset mode and RO in operation mode."]
    #[inline(always)]
    pub fn time_segment2(&mut self) -> TimeSegment2W<'_, BusTiming1Spec> {
        TimeSegment2W::new(self, 4)
    }
    #[doc = "Bit 7 - 1: triple, the bus is sampled three times. 0: single, the bus is sampled once. Software has R/W permission in reset mode and RO in operation mode."]
    #[inline(always)]
    pub fn time_sampling(&mut self) -> TimeSamplingW<'_, BusTiming1Spec> {
        TimeSamplingW::new(self, 7)
    }
}
...
pub struct BusTiming1Spec;
impl crate::RegisterSpec for BusTiming1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bus_timing_1::R`](R) reader structure"]
impl crate::Readable for BusTiming1Spec {}
#[doc = "`write(|w| ..)` method takes [`bus_timing_1::W`](W) writer structure"]
impl crate::Writable for BusTiming1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BUS_TIMING_1 to value 0"]
impl crate::Resettable for BusTiming1Spec {}

...
pub type R = crate::R<EcoCfgSpec>;
#[doc = "Register `ECO_CFG` writer"]
pub type W = crate::W<EcoCfgSpec>;
...
impl W {
    #[doc = "Bit 0 - Enable eco module."]
    #[inline(always)]
    pub fn rdn_ena(&mut self) -> RdnEnaW<'_, EcoCfgSpec> {
        RdnEnaW::new(self, 0)
    }
}
...
pub struct EcoCfgSpec;
impl crate::RegisterSpec for EcoCfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eco_cfg::R`](R) reader structure"]
impl crate::Readable for EcoCfgSpec {}
#[doc = "`write(|w| ..)` method takes [`eco_cfg::W`](W) writer structure"]
impl crate::Writable for EcoCfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ECO_CFG to value 0x02"]
impl crate::Resettable for EcoCfgSpec {

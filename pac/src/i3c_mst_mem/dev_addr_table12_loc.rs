...
pub type R = crate::R<DevAddrTable12LocSpec>;
#[doc = "Register `DEV_ADDR_TABLE12_LOC` writer"]
pub type W = crate::W<DevAddrTable12LocSpec>;
#[doc = "Field `REG_DAT_DEV12_STATIC_ADDR` reader - NA"]
pub type RegDatDev12StaticAddrR = crate::FieldReader;
#[doc = "Field `REG_DAT_DEV12_STATIC_ADDR` writer - NA"]
pub type RegDatDev12StaticAddrW<'a, REG> = crate::FieldWriter<'a, REG, 7>;
...
pub type RegDatDev12DynamicAddrR = crate::FieldReader;
...
pub type RegDatDev12DynamicAddrW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
pub type RegDatDev12NackRetryCntR = crate::FieldReader;
...
pub type RegDatDev12NackRetryCntW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type RegDatDev12I2cR = crate::BitReader;
...
pub type RegDatDev12I2cW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:6 - NA"]
    #[inline(always)]
    pub fn reg_dat_dev12_static_addr(&self) -> RegDatDev12StaticAddrR {
        RegDatDev12StaticAddrR::new((self.bits & 0x7f) as u8)
    }
    #[doc = "Bits 16:23 - Device Dynamic Address with parity, The MSB,bit\\[23\\], should be programmed with parity of dynamic address."]
    #[inline(always)]
    pub fn reg_dat_dev12_dynamic_addr(&self) -> RegDatDev12DynamicAddrR {
        RegDatDev12DynamicAddrR::new(((self.bits >> 16) & 0xff) as u8)
    }
    ...
    #[inline(always)]
    pub fn reg_dat_dev12_nack_retry_cnt(&self) -> RegDatDev12NackRetryCntR {
        RegDatDev12NackRetryCntR::new(((self.bits >> 29) & 3) as u8)
    }
    #[doc = "Bit 31 - Legacy I2C device or not. This bit should be set to 1 if the device is a legacy I2C device."]
    #[inline(always)]
    pub fn reg_dat_dev12_i2c(&self) -> RegDatDev12I2cR {
        RegDatDev12I2cR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:6 - NA"]
    ...
    pub fn reg_dat_dev12_static_addr(
        &mut self,
    ) -> RegDatDev12StaticAddrW<'_, DevAddrTable12LocSpec> {
        RegDatDev12StaticAddrW::new(self, 0)
    }
    #[doc = "Bits 16:23 - Device Dynamic Address with parity, The MSB,bit\\[23\\], should be programmed with parity of dynamic address."]
    #[inline(always)]
    pub fn reg_dat_dev12_dynamic_addr(
        &mut self,
    ) -> RegDatDev12DynamicAddrW<'_, DevAddrTable12LocSpec> {
        RegDatDev12DynamicAddrW::new(self, 16)
    }
    #[doc = "Bits 29:30 - This field is used to set the Device NACK Retry count for the particular device. If the Device NACK's for the device address, the controller automatically retries the same device until this count expires. If the Slave does not ACK for the mentioned number of retries, then controller generates an error response and move to the Halt state."]
    #[inline(always)]
    pub fn reg_dat_dev12_nack_retry_cnt(
        &mut self,
    ) -> RegDatDev12NackRetryCntW<'_, DevAddrTable12LocSpec> {
        RegDatDev12NackRetryCntW::new(self, 29)
    }
    #[doc = "Bit 31 - Legacy I2C device or not. This bit should be set to 1 if the device is a legacy I2C device."]
    #[inline(always)]
    pub fn reg_dat_dev12_i2c(&mut self) -> RegDatDev12I2cW<'_, DevAddrTable12LocSpec> {
        RegDatDev12I2cW::new(self, 31)
    }
}
...
pub struct DevAddrTable12LocSpec;
impl crate::RegisterSpec for DevAddrTable12LocSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dev_addr_table12_loc::R`](R) reader structure"]
impl crate::Readable for DevAddrTable12LocSpec {}
#[doc = "`write(|w| ..)` method takes [`dev_addr_table12_loc::W`](W) writer structure"]
impl crate::Writable for DevAddrTable12LocSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DEV_ADDR_TABLE12_LOC to value 0"]
impl crate::Resettable for DevAddrTable12LocSpec {}

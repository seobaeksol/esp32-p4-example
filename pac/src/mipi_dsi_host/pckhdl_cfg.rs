...
pub type EotpTxLpEnR = crate::BitReader;
#[doc = "Field `EOTP_TX_LP_EN` writer - NA"]
pub type EotpTxLpEnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - NA"]
    #[inline(always)]
    ...
    #[doc = "Bit 5 - NA"]
    #[inline(always)]
    pub fn eotp_tx_lp_en(&self) -> EotpTxLpEnR {
        EotpTxLpEnR::new(((self.bits >> 5) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - NA"]
    #[inline(always)]
    pub fn eotp_tx_en(&mut self) -> EotpTxEnW<'_, PckhdlCfgSpec> {
        EotpTxEnW::new(self, 0)
    }
    #[doc = "Bit 1 - NA"]
    #[inline(always)]
    pub fn eotp_rx_en(&mut self) -> EotpRxEnW<'_, PckhdlCfgSpec> {
        EotpRxEnW::new(self, 1)
    }
    #[doc = "Bit 2 - NA"]
    #[inline(always)]
    pub fn bta_en(&mut self) -> BtaEnW<'_, PckhdlCfgSpec> {
        BtaEnW::new(self, 2)
    }
    #[doc = "Bit 3 - NA"]
    #[inline(always)]
    pub fn ecc_rx_en(&mut self) -> EccRxEnW<'_, PckhdlCfgSpec> {
        EccRxEnW::new(self, 3)
    }
    #[doc = "Bit 4 - NA"]
    #[inline(always)]
    pub fn crc_rx_en(&mut self) -> CrcRxEnW<'_, PckhdlCfgSpec> {
        CrcRxEnW::new(self, 4)
    }
    #[doc = "Bit 5 - NA"]
    #[inline(always)]
    pub fn eotp_tx_lp_en(&mut self) -> EotpTxLpEnW<'_, PckhdlCfgSpec> {
        EotpTxLpEnW::new(self, 5)
    }
}

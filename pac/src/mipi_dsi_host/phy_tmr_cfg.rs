...
pub type PhyLp2hsTimeR = crate::FieldReader<u16>;
#[doc = "Field `PHY_LP2HS_TIME` writer - NA"]
pub type PhyLp2hsTimeW<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
#[doc = "Field `PHY_HS2LP_TIME` reader - NA"]
pub type PhyHs2lpTimeR = crate::FieldReader<u16>;
#[doc = "Field `PHY_HS2LP_TIME` writer - NA"]
pub type PhyHs2lpTimeW<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    #[doc = "Bits 0:9 - NA"]
    #[inline(always)]
    pub fn phy_lp2hs_time(&self) -> PhyLp2hsTimeR {
        PhyLp2hsTimeR::new((self.bits & 0x03ff) as u16)
    }
    #[doc = "Bits 16:25 - NA"]
    #[inline(always)]
    pub fn phy_hs2lp_time(&self) -> PhyHs2lpTimeR {
        PhyHs2lpTimeR::new(((self.bits >> 16) & 0x03ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:9 - NA"]
    #[inline(always)]
    pub fn phy_lp2hs_time(&mut self) -> PhyLp2hsTimeW<'_, PhyTmrCfgSpec> {
        PhyLp2hsTimeW::new(self, 0)
    }
    #[doc = "Bits 16:25 - NA"]
    #[inline(always)]
    pub fn phy_hs2lp_time(&mut self) -> PhyHs2lpTimeW<'_, PhyTmrCfgSpec> {
        PhyHs2lpTimeW::new(self, 16)
    }
}

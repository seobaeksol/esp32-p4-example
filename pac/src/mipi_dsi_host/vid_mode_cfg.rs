...
pub type VidModeTypeR = crate::FieldReader;
#[doc = "Field `VID_MODE_TYPE` writer - NA"]
pub type VidModeTypeW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type VpgModeR = crate::BitReader;
#[doc = "Field `VPG_MODE` writer - NA"]
pub type VpgModeW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `VPG_ORIENTATION` reader - NA"]
pub type VpgOrientationR = crate::BitReader;
#[doc = "Field `VPG_ORIENTATION` writer - NA"]
pub type VpgOrientationW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:1 - NA"]
    #[inline(always)]
    pub fn vid_mode_type(&self) -> VidModeTypeR {
        VidModeTypeR::new((self.bits & 3) as u8)
    }
    #[doc = "Bit 8 - NA"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:1 - NA"]
    #[inline(always)]
    pub fn vid_mode_type(&mut self) -> VidModeTypeW<'_, VidModeCfgSpec> {
        VidModeTypeW::new(self, 0)
    }
    #[doc = "Bit 8 - NA"]
    #[inline(always)]
    pub fn lp_vsa_en(&mut self) -> LpVsaEnW<'_, VidModeCfgSpec> {
        LpVsaEnW::new(self, 8)
    }
    #[doc = "Bit 9 - NA"]
    #[inline(always)]
    pub fn lp_vbp_en(&mut self) -> LpVbpEnW<'_, VidModeCfgSpec> {
        LpVbpEnW::new(self, 9)
    }
    #[doc = "Bit 10 - NA"]
    #[inline(always)]
    pub fn lp_vfp_en(&mut self) -> LpVfpEnW<'_, VidModeCfgSpec> {
        LpVfpEnW::new(self, 10)
    }
    #[doc = "Bit 11 - NA"]
    #[inline(always)]
    pub fn lp_vact_en(&mut self) -> LpVactEnW<'_, VidModeCfgSpec> {
        LpVactEnW::new(self, 11)
    }
    #[doc = "Bit 12 - NA"]
    #[inline(always)]
    pub fn lp_hbp_en(&mut self) -> LpHbpEnW<'_, VidModeCfgSpec> {
        LpHbpEnW::new(self, 12)
    }
    #[doc = "Bit 13 - NA"]
    #[inline(always)]
    pub fn lp_hfp_en(&mut self) -> LpHfpEnW<'_, VidModeCfgSpec> {
        LpHfpEnW::new(self, 13)
    }
    #[doc = "Bit 14 - NA"]
    #[inline(always)]
    pub fn frame_bta_ack_en(&mut self) -> FrameBtaAckEnW<'_, VidModeCfgSpec> {
        FrameBtaAckEnW::new(self, 14)
    }
    #[doc = "Bit 15 - NA"]
    #[inline(always)]
    pub fn lp_cmd_en(&mut self) -> LpCmdEnW<'_, VidModeCfgSpec> {
        LpCmdEnW::new(self, 15)
    }
    #[doc = "Bit 16 - NA"]
    #[inline(always)]
    pub fn vpg_en(&mut self) -> VpgEnW<'_, VidModeCfgSpec> {
        VpgEnW::new(self, 16)
    }
    #[doc = "Bit 20 - NA"]
    #[inline(always)]
    pub fn vpg_mode(&mut self) -> VpgModeW<'_, VidModeCfgSpec> {
        VpgModeW::new(self, 20)
    }
    #[doc = "Bit 24 - NA"]
    #[inline(always)]
    pub fn vpg_orientation(&mut self) -> VpgOrientationW<'_, VidModeCfgSpec> {

...
pub type InDbiConfR = crate::FieldReader;
#[doc = "Field `IN_DBI_CONF` writer - NA"]
pub type InDbiConfW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `OUT_DBI_CONF` reader - NA"]
pub type OutDbiConfR = crate::FieldReader;
#[doc = "Field `OUT_DBI_CONF` writer - NA"]
pub type OutDbiConfW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `LUT_SIZE_CONF` reader - NA"]
pub type LutSizeConfR = crate::FieldReader;
#[doc = "Field `LUT_SIZE_CONF` writer - NA"]
pub type LutSizeConfW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Bits 0:3 - NA"]
    #[inline(always)]
    pub fn in_dbi_conf(&self) -> InDbiConfR {
        InDbiConfR::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bits 8:11 - NA"]
    #[inline(always)]
    pub fn out_dbi_conf(&self) -> OutDbiConfR {
        OutDbiConfR::new(((self.bits >> 8) & 0x0f) as u8)
    }
    #[doc = "Bits 16:17 - NA"]
    #[inline(always)]
    pub fn lut_size_conf(&self) -> LutSizeConfR {
        LutSizeConfR::new(((self.bits >> 16) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3 - NA"]
    #[inline(always)]
    pub fn in_dbi_conf(&mut self) -> InDbiConfW<'_, DbiCfgSpec> {
        InDbiConfW::new(self, 0)
    }
    #[doc = "Bits 8:11 - NA"]
    #[inline(always)]
    pub fn out_dbi_conf(&mut self) -> OutDbiConfW<'_, DbiCfgSpec> {
        OutDbiConfW::new(self, 8)
    }
    #[doc = "Bits 16:17 - NA"]
    #[inline(always)]
    pub fn lut_size_conf(&mut self) -> LutSizeConfW<'_, DbiCfgSpec> {
        LutSizeConfW::new(self, 16)
    }
}

...
pub type GenBuffCmdEmptyR = crate::BitReader;
#[doc = "Field `GEN_BUFF_CMD_FULL` reader - NA"]
pub type GenBuffCmdFullR = crate::BitReader;
#[doc = "Field `GEN_BUFF_PLD_EMPTY` reader - NA"]
pub type GenBuffPldEmptyR = crate::BitReader;
#[doc = "Field `GEN_BUFF_PLD_FULL` reader - NA"]
pub type GenBuffPldFullR = crate::BitReader;
impl R {
    #[doc = "Bit 0 - NA"]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - NA"]
    #[inline(always)]
    pub fn gen_buff_cmd_empty(&self) -> GenBuffCmdEmptyR {
        GenBuffCmdEmptyR::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - NA"]
    #[inline(always)]
    pub fn gen_buff_cmd_full(&self) -> GenBuffCmdFullR {
        GenBuffCmdFullR::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - NA"]
    #[inline(always)]
    pub fn gen_buff_pld_empty(&self) -> GenBuffPldEmptyR {
        GenBuffPldEmptyR::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - NA"]
    #[inline(always)]
    pub fn gen_buff_pld_full(&self) -> GenBuffPldFullR {
        GenBuffPldFullR::new(((self.bits >> 19) & 1) != 0)
    }
}

...
pub type PhyStopstate1laneR = crate::BitReader;
#[doc = "Field `PHY_ULPSACTIVENOT1LANE` reader - NA"]
pub type PhyUlpsactivenot1laneR = crate::BitReader;
impl R {
    #[doc = "Bit 0 - NA"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - NA"]
    #[inline(always)]
    pub fn phy_stopstate1lane(&self) -> PhyStopstate1laneR {
        PhyStopstate1laneR::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - NA"]
    #[inline(always)]
    pub fn phy_ulpsactivenot1lane(&self) -> PhyUlpsactivenot1laneR {
        PhyUlpsactivenot1laneR::new(((self.bits >> 8) & 1) != 0)
    }
}

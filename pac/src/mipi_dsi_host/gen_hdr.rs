...
impl W {
    #[doc = "Bits 0:5 - NA"]
    #[inline(always)]
    pub fn gen_dt(&mut self) -> GenDtW<'_, GenHdrSpec> {
        GenDtW::new(self, 0)
    }
    #[doc = "Bits 6:7 - NA"]
    #[inline(always)]
    pub fn gen_vc(&mut self) -> GenVcW<'_, GenHdrSpec> {
        GenVcW::new(self, 6)
    }
    #[doc = "Bits 8:15 - NA"]
    #[inline(always)]
    pub fn gen_wc_lsbyte(&mut self) -> GenWcLsbyteW<'_, GenHdrSpec> {
        GenWcLsbyteW::new(self, 8)
    }
    #[doc = "Bits 16:23 - NA"]
    #[inline(always)]
    pub fn gen_wc_msbyte(&mut self) -> GenWcMsbyteW<'_, GenHdrSpec> {

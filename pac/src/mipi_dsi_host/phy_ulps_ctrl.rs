...
impl W {
    #[doc = "Bit 0 - NA"]
    #[inline(always)]
    pub fn phy_txrequlpsclk(&mut self) -> PhyTxrequlpsclkW<'_, PhyUlpsCtrlSpec> {
        PhyTxrequlpsclkW::new(self, 0)
    }
    #[doc = "Bit 1 - NA"]
    #[inline(always)]
    pub fn phy_txexitulpsclk(&mut self) -> PhyTxexitulpsclkW<'_, PhyUlpsCtrlSpec> {
        PhyTxexitulpsclkW::new(self, 1)
    }
    #[doc = "Bit 2 - NA"]
    #[inline(always)]
    pub fn phy_txrequlpslan(&mut self) -> PhyTxrequlpslanW<'_, PhyUlpsCtrlSpec> {
        PhyTxrequlpslanW::new(self, 2)
    }
    #[doc = "Bit 3 - NA"]
    #[inline(always)]
    pub fn phy_txexitulpslan(&mut self) -> PhyTxexitulpslanW<'_, PhyUlpsCtrlSpec> {

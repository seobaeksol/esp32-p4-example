...
pub type R = crate::R<PhyTmrRdCfgSpec>;
#[doc = "Register `PHY_TMR_RD_CFG` writer"]
pub type W = crate::W<PhyTmrRdCfgSpec>;
...
impl W {
    #[doc = "Bits 0:14 - NA"]
    #[inline(always)]
    pub fn max_rd_time(&mut self) -> MaxRdTimeW<'_, PhyTmrRdCfgSpec> {
...
pub struct PhyTmrRdCfgSpec;
impl crate::RegisterSpec for PhyTmrRdCfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`phy_tmr_rd_cfg::R`](R) reader structure"]
impl crate::Readable for PhyTmrRdCfgSpec {}
#[doc = "`write(|w| ..)` method takes [`phy_tmr_rd_cfg::W`](W) writer structure"]
impl crate::Writable for PhyTmrRdCfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PHY_TMR_RD_CFG to value 0"]
impl crate::Resettable for PhyTmrRdCfgSpec {}

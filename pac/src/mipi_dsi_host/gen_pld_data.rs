...
impl W {
    #[doc = "Bits 0:7 - NA"]
    #[inline(always)]
    pub fn gen_pld_b1(&mut self) -> GenPldB1W<'_, GenPldDataSpec> {
        GenPldB1W::new(self, 0)
    }
    #[doc = "Bits 8:15 - NA"]
    #[inline(always)]
    pub fn gen_pld_b2(&mut self) -> GenPldB2W<'_, GenPldDataSpec> {
        GenPldB2W::new(self, 8)
    }
    #[doc = "Bits 16:23 - NA"]
    #[inline(always)]
    pub fn gen_pld_b3(&mut self) -> GenPldB3W<'_, GenPldDataSpec> {
        GenPldB3W::new(self, 16)
    }
    #[doc = "Bits 24:31 - NA"]
    #[inline(always)]
    pub fn gen_pld_b4(&mut self) -> GenPldB4W<'_, GenPldDataSpec> {

...
pub struct RegisterBlock {
    ...
    _reserved1: [u8; 0x18],
    buffer_thld_ctrl: BufferThldCtrl,
    data_buffer_thld_ctrl: DataBufferThldCtrl,
    ibi_notify_ctrl: IbiNotifyCtrl,
    ibi_sir_req_payload: IbiSirReqPayload,
    ibi_sir_req_reject: IbiSirReqReject,
    int_clr: IntClr,
    int_raw: IntRaw,
    int_st: IntSt,
    int_ena: IntEna,
    ...
    buffer_status_level: BufferStatusLevel,
    data_buffer_status_level: DataBufferStatusLevel,
    present_state0: PresentState0,
    present_state1: PresentState1,
    device_table: DeviceTable,
    time_out_value: TimeOutValue,
    scl_i3c_mst_od_time: SclI3cMstOdTime,
    scl_i3c_mst_pp_time: SclI3cMstPpTime,
    scl_i2c_fm_time: SclI2cFmTime,
    scl_i2c_fmp_time: SclI2cFmpTime,
    scl_ext_low_time: SclExtLowTime,
    sda_sample_time: SdaSampleTime,
    sda_hold_time: SdaHoldTime,
    scl_start_hold: SclStartHold,
    scl_rstart_setup: SclRstartSetup,
    scl_stop_hold: SclStopHold,
    scl_stop_setup: SclStopSetup,
    _reserved28: [u8; 0x04],
    bus_free_time: BusFreeTime,
    scl_termn_t_ext_low_time: SclTermnTExtLowTime,
    _reserved30: [u8; 0x08],
    ver_id: VerId,
    ver_type: VerType,
    _reserved32: [u8; 0x04],
    fpga_debug_probe: FpgaDebugProbe,
    rnd_eco_cs: RndEcoCs,
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn device_ctrl(&self) -> &DeviceCtrl {
        &self.device_ctrl
    }
    ...
    #[inline(always)]
    pub const fn buffer_thld_ctrl(&self) -> &BufferThldCtrl {
        &self.buffer_thld_ctrl
    }
    #[doc = "0x20 - NA"]
    #[inline(always)]
    pub const fn data_buffer_thld_ctrl(&self) -> &DataBufferThldCtrl {
        &self.data_buffer_thld_ctrl
    }
    #[doc = "0x24 - NA"]
    #[inline(always)]
    pub const fn ibi_notify_ctrl(&self) -> &IbiNotifyCtrl {
        &self.ibi_notify_ctrl
    }
    #[doc = "0x28 - NA"]
    #[inline(always)]
    pub const fn ibi_sir_req_payload(&self) -> &IbiSirReqPayload {
        &self.ibi_sir_req_payload
    }
    #[doc = "0x2c - NA"]
    #[inline(always)]
    pub const fn ibi_sir_req_reject(&self) -> &IbiSirReqReject {
    ...
    #[inline(always)]
    pub const fn buffer_status_level(&self) -> &BufferStatusLevel {
        &self.buffer_status_level
    }
    #[doc = "0x4c - DATA_BUFFER_STATUS_LEVEL reflects the status level of the Buffers in the controller."]
    #[inline(always)]
    pub const fn data_buffer_status_level(&self) -> &DataBufferStatusLevel {
        &self.data_buffer_status_level
    }
    #[doc = "0x50 - NA"]
    #[inline(always)]
    pub const fn present_state0(&self) -> &PresentState0 {
        &self.present_state0
    }
    #[doc = "0x54 - NA"]
    #[inline(always)]
    pub const fn present_state1(&self) -> &PresentState1 {
        &self.present_state1
    }
    #[doc = "0x58 - Pointer for Device Address Table"]
    #[inline(always)]
    pub const fn device_table(&self) -> &DeviceTable {
        &self.device_table
    }
    #[doc = "0x5c - NA"]
    #[inline(always)]
    pub const fn time_out_value(&self) -> &TimeOutValue {
        &self.time_out_value
    }
    #[doc = "0x60 - NA"]
    #[inline(always)]
    pub const fn scl_i3c_mst_od_time(&self) -> &SclI3cMstOdTime {
        &self.scl_i3c_mst_od_time
    }
    #[doc = "0x64 - NA"]
    #[inline(always)]
    pub const fn scl_i3c_mst_pp_time(&self) -> &SclI3cMstPpTime {
        &self.scl_i3c_mst_pp_time
    }
    #[doc = "0x68 - NA"]
    #[inline(always)]
    pub const fn scl_i2c_fm_time(&self) -> &SclI2cFmTime {
        &self.scl_i2c_fm_time
    }
    #[doc = "0x6c - NA"]
    #[inline(always)]
    pub const fn scl_i2c_fmp_time(&self) -> &SclI2cFmpTime {
        &self.scl_i2c_fmp_time
    }
    #[doc = "0x70 - NA"]
    #[inline(always)]
    pub const fn scl_ext_low_time(&self) -> &SclExtLowTime {
        &self.scl_ext_low_time
    }
    #[doc = "0x74 - NA"]
    #[inline(always)]
    pub const fn sda_sample_time(&self) -> &SdaSampleTime {
        &self.sda_sample_time
    }
    #[doc = "0x78 - NA"]
    #[inline(always)]
    pub const fn sda_hold_time(&self) -> &SdaHoldTime {
        &self.sda_hold_time
    }
    #[doc = "0x7c - NA"]
    #[inline(always)]
    ...
    #[doc = "0x90 - NA"]
    #[inline(always)]
    pub const fn bus_free_time(&self) -> &BusFreeTime {
        &self.bus_free_time
    }
    #[doc = "0x94 - NA"]
    #[inline(always)]
    pub const fn scl_termn_t_ext_low_time(&self) -> &SclTermnTExtLowTime {
        &self.scl_termn_t_ext_low_time
    }
    #[doc = "0xa0 - NA"]
    #[inline(always)]
    pub const fn ver_id(&self) -> &VerId {
        &self.ver_id
    }
    #[doc = "0xa4 - NA"]
    #[inline(always)]
    pub const fn ver_type(&self) -> &VerType {
        &self.ver_type
    }
    #[doc = "0xac - NA"]
    #[inline(always)]
    pub const fn fpga_debug_probe(&self) -> &FpgaDebugProbe {
...
#[doc(alias = "DEVICE_CTRL")]
pub type DeviceCtrl = crate::Reg<device_ctrl::DeviceCtrlSpec>;
...
#[doc(alias = "BUFFER_THLD_CTRL")]
pub type BufferThldCtrl = crate::Reg<buffer_thld_ctrl::BufferThldCtrlSpec>;
...
#[doc(alias = "DATA_BUFFER_THLD_CTRL")]
pub type DataBufferThldCtrl = crate::Reg<data_buffer_thld_ctrl::DataBufferThldCtrlSpec>;
#[doc = "NA"]
...
#[doc(alias = "IBI_NOTIFY_CTRL")]
pub type IbiNotifyCtrl = crate::Reg<ibi_notify_ctrl::IbiNotifyCtrlSpec>;
#[doc = "NA"]
...
#[doc(alias = "IBI_SIR_REQ_PAYLOAD")]
pub type IbiSirReqPayload = crate::Reg<ibi_sir_req_payload::IbiSirReqPayloadSpec>;
#[doc = "NA"]
...
#[doc(alias = "IBI_SIR_REQ_REJECT")]
pub type IbiSirReqReject = crate::Reg<ibi_sir_req_reject::IbiSirReqRejectSpec>;
#[doc = "NA"]
...
#[doc(alias = "BUFFER_STATUS_LEVEL")]
pub type BufferStatusLevel = crate::Reg<buffer_status_level::BufferStatusLevelSpec>;
...
#[doc(alias = "DATA_BUFFER_STATUS_LEVEL")]
pub type DataBufferStatusLevel = crate::Reg<data_buffer_status_level::DataBufferStatusLevelSpec>;
...
#[doc(alias = "PRESENT_STATE0")]
pub type PresentState0 = crate::Reg<present_state0::PresentState0Spec>;
#[doc = "NA"]
...
#[doc(alias = "PRESENT_STATE1")]
pub type PresentState1 = crate::Reg<present_state1::PresentState1Spec>;
#[doc = "NA"]
...
#[doc(alias = "DEVICE_TABLE")]
pub type DeviceTable = crate::Reg<device_table::DeviceTableSpec>;
...
#[doc(alias = "TIME_OUT_VALUE")]
pub type TimeOutValue = crate::Reg<time_out_value::TimeOutValueSpec>;
#[doc = "NA"]
...
#[doc(alias = "SCL_I3C_MST_OD_TIME")]
pub type SclI3cMstOdTime = crate::Reg<scl_i3c_mst_od_time::SclI3cMstOdTimeSpec>;
#[doc = "NA"]
...
#[doc(alias = "SCL_I3C_MST_PP_TIME")]
pub type SclI3cMstPpTime = crate::Reg<scl_i3c_mst_pp_time::SclI3cMstPpTimeSpec>;
#[doc = "NA"]
...
#[doc(alias = "SCL_I2C_FM_TIME")]
pub type SclI2cFmTime = crate::Reg<scl_i2c_fm_time::SclI2cFmTimeSpec>;
#[doc = "NA"]
...
#[doc(alias = "SCL_I2C_FMP_TIME")]
pub type SclI2cFmpTime = crate::Reg<scl_i2c_fmp_time::SclI2cFmpTimeSpec>;
#[doc = "NA"]
...
#[doc(alias = "SCL_EXT_LOW_TIME")]
pub type SclExtLowTime = crate::Reg<scl_ext_low_time::SclExtLowTimeSpec>;
#[doc = "NA"]
...
#[doc(alias = "SDA_SAMPLE_TIME")]
pub type SdaSampleTime = crate::Reg<sda_sample_time::SdaSampleTimeSpec>;
#[doc = "NA"]
...
#[doc(alias = "SDA_HOLD_TIME")]
pub type SdaHoldTime = crate::Reg<sda_hold_time::SdaHoldTimeSpec>;
#[doc = "NA"]
...
#[doc(alias = "BUS_FREE_TIME")]
pub type BusFreeTime = crate::Reg<bus_free_time::BusFreeTimeSpec>;
#[doc = "NA"]
...
#[doc(alias = "SCL_TERMN_T_EXT_LOW_TIME")]
pub type SclTermnTExtLowTime = crate::Reg<scl_termn_t_ext_low_time::SclTermnTExtLowTimeSpec>;
#[doc = "NA"]
...
#[doc(alias = "VER_ID")]
pub type VerId = crate::Reg<ver_id::VerIdSpec>;
#[doc = "NA"]
pub mod ver_id;
...
#[doc(alias = "VER_TYPE")]
pub type VerType = crate::Reg<ver_type::VerTypeSpec>;
#[doc = "NA"]
pub mod ver_type;
...
#[doc(alias = "FPGA_DEBUG_PROBE")]
pub type FpgaDebugProbe = crate::Reg<fpga_debug_probe::FpgaDebugProbeSpec>;
#[doc = "NA"]

...
impl RegisterBlock {
    #[doc = "0x00 - "]
    #[inline(always)]
    pub const fn int_config(&self) -> &IntConfig {
        &self.int_config
    }
    #[doc = "0x04 - "]
    #[inline(always)]
    pub const fn int_info(&self) -> &IntInfo {
        &self.int_info
    }
    #[doc = "0x1000..0x1030 - Interrupt pending register."]
    #[inline(always)]
    pub const fn int_ip(&self, n: usize) -> &IntIp {
    ...
    #[doc = "0x1000..0x1030 - Interrupt pending register."]
    #[inline(always)]
    pub fn int_ip_iter(&self) -> impl Iterator<Item = &IntIp> {
    ...
    #[inline(always)]
    pub const fn int_ie(&self, n: usize) -> &IntIe {
        #[allow(clippy::no_effect)]
        [(); 48][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x1001..0x1031 - Interrupt enable register."]
    #[inline(always)]
    pub fn int_ie_iter(&self) -> impl Iterator<Item = &IntIe> {
        (0..48).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(4097)
    ...
    #[inline(always)]
    pub const fn int_attr(&self, n: usize) -> &IntAttr {
        #[allow(clippy::no_effect)]
        [(); 48][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x1002..0x1032 - Interrupt attribute register."]
    #[inline(always)]
    pub fn int_attr_iter(&self) -> impl Iterator<Item = &IntAttr> {
        (0..48).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(4098)
    ...
    #[inline(always)]
    pub const fn int_ctl(&self, n: usize) -> &IntCtl {
        #[allow(clippy::no_effect)]
        [(); 48][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x1003..0x1033 - Interrupt level control register."]
    #[inline(always)]
    pub fn int_ctl_iter(&self) -> impl Iterator<Item = &IntCtl> {
        (0..48).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(4099)
...
#[doc(alias = "INT_CONFIG")]
pub type IntConfig = crate::Reg<int_config::IntConfigSpec>;
#[doc = ""]
pub mod int_config;
...
#[doc(alias = "INT_INFO")]
pub type IntInfo = crate::Reg<int_info::IntInfoSpec>;
#[doc = ""]
pub mod int_info;
...
#[doc(alias = "INT_IP")]
pub type IntIp = crate::Reg<int_ip::IntIpSpec>;
...
#[doc(alias = "INT_IE")]
pub type IntIe = crate::Reg<int_ie::IntIeSpec>;
...
#[doc(alias = "INT_ATTR")]
pub type IntAttr = crate::Reg<int_attr::IntAttrSpec>;

...
pub type R = crate::R<OpTstmpE2Spec>;
#[doc = "Register `OP%s_TSTMP_E2` writer"]
pub type W = crate::W<OpTstmpE2Spec>;
#[doc = "Field `OP_TSTMP_E2` reader - Configures generator%s timer stamp E2 value register"]
pub type OpTstmpE2R = crate::FieldReader<u16>;
#[doc = "Field `OP_TSTMP_E2` writer - Configures generator%s timer stamp E2 value register"]
pub type OpTstmpE2W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - Configures generator%s timer stamp E2 value register"]
    #[inline(always)]
    pub fn op_tstmp_e2(&self) -> OpTstmpE2R {
        OpTstmpE2R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Configures generator%s timer stamp E2 value register"]
    #[inline(always)]
    pub fn op_tstmp_e2(&mut self) -> OpTstmpE2W<'_, OpTstmpE2Spec> {
        OpTstmpE2W::new(self, 0)
    }
}
...
pub struct OpTstmpE2Spec;
impl crate::RegisterSpec for OpTstmpE2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`op_tstmp_e2::R`](R) reader structure"]
impl crate::Readable for OpTstmpE2Spec {}
#[doc = "`write(|w| ..)` method takes [`op_tstmp_e2::W`](W) writer structure"]
impl crate::Writable for OpTstmpE2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OP%s_TSTMP_E2 to value 0"]
impl crate::Resettable for OpTstmpE2Spec {}

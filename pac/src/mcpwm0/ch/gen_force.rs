...
pub type R = crate::R<GenForceSpec>;
#[doc = "Register `GEN_FORCE` writer"]
pub type W = crate::W<GenForceSpec>;
...
pub type CntuforceUpmethodR = crate::FieldReader;
#[doc = "Field `CNTUFORCE_UPMETHOD` writer - Configures update method for continuous software force of PWM generator%s.\\\\0: Immediately\\\\Bit0 is set to 1: TEZ\\\\Bit1 is set to 1: TEP\\\\Bit2 is set to 1: TEA\\\\Bit3 is set to 1: TEB\\\\Bit4 is set to 1: Sync\\\\Bit5 is set to 1: Disable update. TEA/B here and below means an event generated when the timer's value equals to that of register A/B."]
pub type CntuforceUpmethodW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
pub type ACntuforceModeR = crate::FieldReader;
...
pub type ACntuforceModeW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type BCntuforceModeR = crate::FieldReader;
...
pub type BCntuforceModeW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type ANciforceR = crate::BitReader;
...
pub type ANciforceW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type ANciforceModeR = crate::FieldReader;
...
pub type ANciforceModeW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type BNciforceR = crate::BitReader;
...
pub type BNciforceW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type BNciforceModeR = crate::FieldReader;
...
pub type BNciforceModeW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Bits 0:5 - Configures update method for continuous software force of PWM generator%s.\\\\0: Immediately\\\\Bit0 is set to 1: TEZ\\\\Bit1 is set to 1: TEP\\\\Bit2 is set to 1: TEA\\\\Bit3 is set to 1: TEB\\\\Bit4 is set to 1: Sync\\\\Bit5 is set to 1: Disable update. TEA/B here and below means an event generated when the timer's value equals to that of register A/B."]
    #[inline(always)]
    pub fn cntuforce_upmethod(&self) -> CntuforceUpmethodR {
        CntuforceUpmethodR::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 6:7 - Configures continuous software force mode for PWM%s A.\\\\0: Disabled\\\\1: Low\\\\2: High\\\\3: Disabled"]
    #[inline(always)]
    pub fn a_cntuforce_mode(&self) -> ACntuforceModeR {
        ACntuforceModeR::new(((self.bits >> 6) & 3) as u8)
    }
    #[doc = "Bits 8:9 - Configures continuous software force mode for PWM%s B.\\\\0: Disabled\\\\1: Low\\\\2: High\\\\3: Disabled"]
    #[inline(always)]
    pub fn b_cntuforce_mode(&self) -> BCntuforceModeR {
        BCntuforceModeR::new(((self.bits >> 8) & 3) as u8)
    }
    ...
    #[inline(always)]
    pub fn a_nciforce(&self) -> ANciforceR {
        ANciforceR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bits 11:12 - Configures non-continuous immediate software force mode for PWM%s A.\\\\0: Disabled\\\\1: Low\\\\2: High\\\\3: Disabled"]
    #[inline(always)]
    pub fn a_nciforce_mode(&self) -> ANciforceModeR {
        ANciforceModeR::new(((self.bits >> 11) & 3) as u8)
    }
    ...
    #[inline(always)]
    pub fn b_nciforce(&self) -> BNciforceR {
        BNciforceR::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bits 14:15 - Configures non-continuous immediate software force mode for PWM%s B.\\\\0: Disabled\\\\1: Low\\\\2: High\\\\3: Disabled"]
    #[inline(always)]
    pub fn b_nciforce_mode(&self) -> BNciforceModeR {
        BNciforceModeR::new(((self.bits >> 14) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5 - Configures update method for continuous software force of PWM generator%s.\\\\0: Immediately\\\\Bit0 is set to 1: TEZ\\\\Bit1 is set to 1: TEP\\\\Bit2 is set to 1: TEA\\\\Bit3 is set to 1: TEB\\\\Bit4 is set to 1: Sync\\\\Bit5 is set to 1: Disable update. TEA/B here and below means an event generated when the timer's value equals to that of register A/B."]
    #[inline(always)]
    pub fn cntuforce_upmethod(&mut self) -> CntuforceUpmethodW<'_, GenForceSpec> {
        CntuforceUpmethodW::new(self, 0)
    }
    #[doc = "Bits 6:7 - Configures continuous software force mode for PWM%s A.\\\\0: Disabled\\\\1: Low\\\\2: High\\\\3: Disabled"]
    #[inline(always)]
    pub fn a_cntuforce_mode(&mut self) -> ACntuforceModeW<'_, GenForceSpec> {
        ACntuforceModeW::new(self, 6)
    }
    #[doc = "Bits 8:9 - Configures continuous software force mode for PWM%s B.\\\\0: Disabled\\\\1: Low\\\\2: High\\\\3: Disabled"]
    #[inline(always)]
    pub fn b_cntuforce_mode(&mut self) -> BCntuforceModeW<'_, GenForceSpec> {
        BCntuforceModeW::new(self, 8)
    }
    #[doc = "Bit 10 - Configures the generation of non-continuous immediate software-force event for PWM%s A, a toggle will trigger a force event."]
    #[inline(always)]
    pub fn a_nciforce(&mut self) -> ANciforceW<'_, GenForceSpec> {
        ANciforceW::new(self, 10)
    }
    #[doc = "Bits 11:12 - Configures non-continuous immediate software force mode for PWM%s A.\\\\0: Disabled\\\\1: Low\\\\2: High\\\\3: Disabled"]
    #[inline(always)]
    pub fn a_nciforce_mode(&mut self) -> ANciforceModeW<'_, GenForceSpec> {
        ANciforceModeW::new(self, 11)
    }
    #[doc = "Bit 13 - Configures the generation of non-continuous immediate software-force event for PWM%s B, a toggle will trigger a force event."]
    #[inline(always)]
    pub fn b_nciforce(&mut self) -> BNciforceW<'_, GenForceSpec> {
        BNciforceW::new(self, 13)
    }
    #[doc = "Bits 14:15 - Configures non-continuous immediate software force mode for PWM%s B.\\\\0: Disabled\\\\1: Low\\\\2: High\\\\3: Disabled"]
    #[inline(always)]
    pub fn b_nciforce_mode(&mut self) -> BNciforceModeW<'_, GenForceSpec> {
        BNciforceModeW::new(self, 14)
    }
}
...
pub struct GenForceSpec;
impl crate::RegisterSpec for GenForceSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gen_force::R`](R) reader structure"]
impl crate::Readable for GenForceSpec {}
#[doc = "`write(|w| ..)` method takes [`gen_force::W`](W) writer structure"]
impl crate::Writable for GenForceSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GEN_FORCE to value 0x20"]
impl crate::Resettable for GenForceSpec {

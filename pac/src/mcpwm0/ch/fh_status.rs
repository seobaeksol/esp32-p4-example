...
pub struct FhStatusSpec;
impl crate::RegisterSpec for FhStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fh_status::R`](R) reader structure"]
impl crate::Readable for FhStatusSpec {}
#[doc = "`reset()` method sets FH_STATUS to value 0"]
impl crate::Resettable for FhStatusSpec {}

...
pub struct RegisterBlock {
    ...
    int_ena: IntEna,
    int_clr: IntClr,
    clkdiv_sync: ClkdivSync,
    rx_filt: RxFilt,
    status: Status,
    conf0_sync: Conf0Sync,
    conf1: Conf1,
    _reserved10: [u8; 0x04],
    hwfc_conf_sync: HwfcConfSync,
    sleep_conf0: SleepConf0,
    sleep_conf1: SleepConf1,
    sleep_conf2: SleepConf2,
    swfc_conf0_sync: SwfcConf0Sync,
    swfc_conf1: SwfcConf1,
    txbrk_conf_sync: TxbrkConfSync,
    idle_conf_sync: IdleConfSync,
    rs485_conf_sync: Rs485ConfSync,
    at_cmd_precnt_sync: AtCmdPrecntSync,
    at_cmd_postcnt_sync: AtCmdPostcntSync,
    at_cmd_gaptout_sync: AtCmdGaptoutSync,
    at_cmd_char_sync: AtCmdCharSync,
    mem_conf: MemConf,
    tout_conf_sync: ToutConfSync,
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn clkdiv_sync(&self) -> &ClkdivSync {
        &self.clkdiv_sync
    }
    ...
    #[inline(always)]
    pub const fn conf0_sync(&self) -> &Conf0Sync {
        &self.conf0_sync
    }
    ...
    #[inline(always)]
    pub const fn hwfc_conf_sync(&self) -> &HwfcConfSync {
        &self.hwfc_conf_sync
    }
    ...
    #[inline(always)]
    pub const fn swfc_conf0_sync(&self) -> &SwfcConf0Sync {
    ...
    #[inline(always)]
    pub const fn txbrk_conf_sync(&self) -> &TxbrkConfSync {
        &self.txbrk_conf_sync
    }
    #[doc = "0x48 - Frame-end idle configuration"]
    #[inline(always)]
    pub const fn idle_conf_sync(&self) -> &IdleConfSync {
        &self.idle_conf_sync
    }
    #[doc = "0x4c - RS485 mode configuration"]
    #[inline(always)]
    pub const fn rs485_conf_sync(&self) -> &Rs485ConfSync {
        &self.rs485_conf_sync
    }
    #[doc = "0x50 - Pre-sequence timing configuration"]
    #[inline(always)]
    pub const fn at_cmd_precnt_sync(&self) -> &AtCmdPrecntSync {
        &self.at_cmd_precnt_sync
    }
    #[doc = "0x54 - Post-sequence timing configuration"]
    #[inline(always)]
    pub const fn at_cmd_postcnt_sync(&self) -> &AtCmdPostcntSync {
        &self.at_cmd_postcnt_sync
    }
    #[doc = "0x58 - Timeout configuration"]
    #[inline(always)]
    pub const fn at_cmd_gaptout_sync(&self) -> &AtCmdGaptoutSync {
        &self.at_cmd_gaptout_sync
    }
    #[doc = "0x5c - AT escape sequence detection configuration"]
    #[inline(always)]
    pub const fn at_cmd_char_sync(&self) -> &AtCmdCharSync {
    ...
    #[inline(always)]
    pub const fn tout_conf_sync(&self) -> &ToutConfSync {
        &self.tout_conf_sync
    }
...
#[doc(alias = "CLKDIV_SYNC")]
pub type ClkdivSync = crate::Reg<clkdiv_sync::ClkdivSyncSpec>;
...
#[doc(alias = "CONF0_SYNC")]
pub type Conf0Sync = crate::Reg<conf0_sync::Conf0SyncSpec>;
...
#[doc(alias = "HWFC_CONF_SYNC")]
pub type HwfcConfSync = crate::Reg<hwfc_conf_sync::HwfcConfSyncSpec>;
...
#[doc(alias = "SWFC_CONF0_SYNC")]
pub type SwfcConf0Sync = crate::Reg<swfc_conf0_sync::SwfcConf0SyncSpec>;
...
#[doc(alias = "TXBRK_CONF_SYNC")]
pub type TxbrkConfSync = crate::Reg<txbrk_conf_sync::TxbrkConfSyncSpec>;
...
#[doc(alias = "IDLE_CONF_SYNC")]
pub type IdleConfSync = crate::Reg<idle_conf_sync::IdleConfSyncSpec>;
...
#[doc(alias = "RS485_CONF_SYNC")]
pub type Rs485ConfSync = crate::Reg<rs485_conf_sync::Rs485ConfSyncSpec>;
...
#[doc(alias = "AT_CMD_PRECNT_SYNC")]
pub type AtCmdPrecntSync = crate::Reg<at_cmd_precnt_sync::AtCmdPrecntSyncSpec>;
...
#[doc(alias = "AT_CMD_POSTCNT_SYNC")]
pub type AtCmdPostcntSync = crate::Reg<at_cmd_postcnt_sync::AtCmdPostcntSyncSpec>;
...
#[doc(alias = "AT_CMD_GAPTOUT_SYNC")]
pub type AtCmdGaptoutSync = crate::Reg<at_cmd_gaptout_sync::AtCmdGaptoutSyncSpec>;
...
#[doc(alias = "AT_CMD_CHAR_SYNC")]
pub type AtCmdCharSync = crate::Reg<at_cmd_char_sync::AtCmdCharSyncSpec>;
...
#[doc(alias = "TOUT_CONF_SYNC")]
pub type ToutConfSync = crate::Reg<tout_conf_sync::ToutConfSyncSpec>;

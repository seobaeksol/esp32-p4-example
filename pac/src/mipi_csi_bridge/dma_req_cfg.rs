...
pub type DmaCfgUpdByBlkR = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn dma_cfg_upd_by_blk(&self) -> DmaCfgUpdByBlkR {
        DmaCfgUpdByBlkR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 16 - 1: mask dma request when reading frame info. 0: disable mask."]
    #[inline(always)]
    pub fn dma_force_rd_status(&self) -> DmaForceRdStatusR {
        DmaForceRdStatusR::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - 0: dma as flow controller. 1: csi_bridge as flow controller"]
    #[inline(always)]
    pub fn csi_dma_flow_controller(&self) -> CsiDmaFlowControllerR {
        CsiDmaFlowControllerR::new(((self.bits >> 17) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:11 - DMA burst length."]
    ...
    #[doc = "Bit 12 - 1: reg_dma_burst_len & reg_dma_burst_len will be updated by dma block finish. 0: updated by frame."]
    #[inline(always)]
    pub fn dma_cfg_upd_by_blk(&mut self) -> DmaCfgUpdByBlkW<'_, DmaReqCfgSpec> {
        DmaCfgUpdByBlkW::new(self, 12)
    }
    #[doc = "Bit 16 - 1: mask dma request when reading frame info. 0: disable mask."]
    #[inline(always)]
    pub fn dma_force_rd_status(&mut self) -> DmaForceRdStatusW<'_, DmaReqCfgSpec> {
        DmaForceRdStatusW::new(self, 16)
    }
    #[doc = "Bit 17 - 0: dma as flow controller. 1: csi_bridge as flow controller"]
    #[inline(always)]
    pub fn csi_dma_flow_controller(&mut self) -> CsiDmaFlowControllerW<'_, DmaReqCfgSpec> {
        CsiDmaFlowControllerW::new(self, 17)
    }
}

...
impl R {
    ...
    #[inline(always)]
    pub fn has_hsync_e(&self) -> HasHsyncER {
        HasHsyncER::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - 0: disable vadr check. 1: enable vadr check."]
    #[inline(always)]
    pub fn vadr_num_check(&self) -> VadrNumCheckR {
        VadrNumCheckR::new(((self.bits >> 25) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:11 - vadr of frame data."]
    ...
    #[doc = "Bit 24 - 0: frame data doesn't contain hsync. 1: frame data contains hsync."]
    #[inline(always)]
    pub fn has_hsync_e(&mut self) -> HasHsyncEW<'_, FrameCfgSpec> {
        HasHsyncEW::new(self, 24)
    }
    #[doc = "Bit 25 - 0: disable vadr check. 1: enable vadr check."]
    #[inline(always)]
    pub fn vadr_num_check(&mut self) -> VadrNumCheckW<'_, FrameCfgSpec> {
        VadrNumCheckW::new(self, 25)
    }
}

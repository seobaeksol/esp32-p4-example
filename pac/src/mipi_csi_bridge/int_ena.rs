...
impl W {
    #[doc = "Bit 0 - reg_vadr_num is greater than real interrupt enable."]
    #[inline(always)]
    pub fn vadr_num_gt(&mut self) -> VadrNumGtW<'_, IntEnaSpec> {
        VadrNumGtW::new(self, 0)
    }
    #[doc = "Bit 1 - reg_vadr_num is less than real interrupt enable."]
    #[inline(always)]
    pub fn vadr_num_lt(&mut self) -> VadrNumLtW<'_, IntEnaSpec> {
        VadrNumLtW::new(self, 1)
    }
    #[doc = "Bit 2 - an incomplete frame of data was sent interrupt enable."]
    #[inline(always)]
    pub fn discard(&mut self) -> DiscardW<'_, IntEnaSpec> {
        DiscardW::new(self, 2)
    }
    #[doc = "Bit 3 - buffer overrun interrupt enable."]
    #[inline(always)]
    pub fn csi_buf_overrun(&mut self) -> CsiBufOverrunW<'_, IntEnaSpec> {
        CsiBufOverrunW::new(self, 3)
    }
    #[doc = "Bit 4 - buffer overflow interrupt enable."]
    #[inline(always)]
    pub fn csi_async_fifo_ovf(&mut self) -> CsiAsyncFifoOvfW<'_, IntEnaSpec> {
        CsiAsyncFifoOvfW::new(self, 4)
    }
    #[doc = "Bit 5 - dma configuration update complete interrupt enable."]
    #[inline(always)]
    pub fn dma_cfg_has_updated(&mut self) -> DmaCfgHasUpdatedW<'_, IntEnaSpec> {

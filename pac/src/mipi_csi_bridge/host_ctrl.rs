...
pub type CsiEnableclkR = crate::BitReader;
#[doc = "Field `CSI_ENABLECLK` writer - enable clock lane module of csi phy."]
pub type CsiEnableclkW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CSI_CFG_CLK_EN` reader - enable cfg_clk of csi host module."]
pub type CsiCfgClkEnR = crate::BitReader;
#[doc = "Field `CSI_CFG_CLK_EN` writer - enable cfg_clk of csi host module."]
pub type CsiCfgClkEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LOOPBK_TEST_EN` reader - for phy test by loopback dsi phy to csi phy."]
pub type LoopbkTestEnR = crate::BitReader;
#[doc = "Field `LOOPBK_TEST_EN` writer - for phy test by loopback dsi phy to csi phy."]
pub type LoopbkTestEnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - enable clock lane module of csi phy."]
    #[inline(always)]
    pub fn csi_enableclk(&self) -> CsiEnableclkR {
        CsiEnableclkR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - enable cfg_clk of csi host module."]
    #[inline(always)]
    pub fn csi_cfg_clk_en(&self) -> CsiCfgClkEnR {
        CsiCfgClkEnR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - for phy test by loopback dsi phy to csi phy."]
    #[inline(always)]
    pub fn loopbk_test_en(&self) -> LoopbkTestEnR {
        LoopbkTestEnR::new(((self.bits >> 2) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - enable clock lane module of csi phy."]
    #[inline(always)]
    pub fn csi_enableclk(&mut self) -> CsiEnableclkW<'_, HostCtrlSpec> {
        CsiEnableclkW::new(self, 0)
    }
    #[doc = "Bit 1 - enable cfg_clk of csi host module."]
    #[inline(always)]
    pub fn csi_cfg_clk_en(&mut self) -> CsiCfgClkEnW<'_, HostCtrlSpec> {
        CsiCfgClkEnW::new(self, 1)
    }
    #[doc = "Bit 2 - for phy test by loopback dsi phy to csi phy."]
    #[inline(always)]
    pub fn loopbk_test_en(&mut self) -> LoopbkTestEnW<'_, HostCtrlSpec> {
        LoopbkTestEnW::new(self, 2)
    }
}

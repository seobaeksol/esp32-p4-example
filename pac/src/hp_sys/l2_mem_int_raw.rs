...
pub type RegL2MemExceedAddrIntRawR = crate::BitReader;
...
pub type RegL2MemExceedAddrIntRawW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `REG_L2_MEM_ERR_RESP_INT_RAW` reader - intr triggered when err response occurs"]
pub type RegL2MemErrRespIntRawR = crate::BitReader;
#[doc = "Field `REG_L2_MEM_ERR_RESP_INT_RAW` writer - intr triggered when err response occurs"]
pub type RegL2MemErrRespIntRawW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - intr triggered when two bit error detected and corrected from ecc"]
    #[inline(always)]
    pub fn reg_l2_mem_ecc_err_int_raw(&self) -> RegL2MemEccErrIntRawR {
        RegL2MemEccErrIntRawR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn reg_l2_mem_exceed_addr_int_raw(&self) -> RegL2MemExceedAddrIntRawR {
        RegL2MemExceedAddrIntRawR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - intr triggered when err response occurs"]
    #[inline(always)]
    pub fn reg_l2_mem_err_resp_int_raw(&self) -> RegL2MemErrRespIntRawR {
        RegL2MemErrRespIntRawR::new(((self.bits >> 2) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - intr triggered when two bit error detected and corrected from ecc"]
    #[inline(always)]
    pub fn reg_l2_mem_ecc_err_int_raw(&mut self) -> RegL2MemEccErrIntRawW<'_, L2MemIntRawSpec> {
        RegL2MemEccErrIntRawW::new(self, 0)
    }
    #[doc = "Bit 1 - intr triggered when access addr exceeds 0xff9ffff at bypass mode or exceeds 0xff80000 at l2cache 128kb mode or exceeds 0xff60000 at l2cache 256kb mode"]
    #[inline(always)]
    pub fn reg_l2_mem_exceed_addr_int_raw(
        &mut self,
    ) -> RegL2MemExceedAddrIntRawW<'_, L2MemIntRawSpec> {
        RegL2MemExceedAddrIntRawW::new(self, 1)
    }
    #[doc = "Bit 2 - intr triggered when err response occurs"]
    #[inline(always)]
    pub fn reg_l2_mem_err_resp_int_raw(&mut self) -> RegL2MemErrRespIntRawW<'_, L2MemIntRawSpec> {
        RegL2MemErrRespIntRawW::new(self, 2)
    }
}
...
pub struct L2MemIntRawSpec;
impl crate::RegisterSpec for L2MemIntRawSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_mem_int_raw::R`](R) reader structure"]
impl crate::Readable for L2MemIntRawSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_mem_int_raw::W`](W) writer structure"]
impl crate::Writable for L2MemIntRawSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_MEM_INT_RAW to value 0"]
impl crate::Resettable for L2MemIntRawSpec {}

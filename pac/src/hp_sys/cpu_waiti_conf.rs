...
pub type CpuWaitiDelayNumR = crate::FieldReader;
...
pub type CpuWaitiDelayNumW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bit 0 - Set 1 to force cpu_waiti_clk enable."]
    #[inline(always)]
    pub fn cpu_wait_mode_force_on(&self) -> CpuWaitModeForceOnR {
        CpuWaitModeForceOnR::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 1:4 - This field used to set delay cycle when cpu enter waiti mode, after delay waiti_clk will close"]
    #[inline(always)]
    pub fn cpu_waiti_delay_num(&self) -> CpuWaitiDelayNumR {
        CpuWaitiDelayNumR::new(((self.bits >> 1) & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - Set 1 to force cpu_waiti_clk enable."]
    #[inline(always)]
    pub fn cpu_wait_mode_force_on(&mut self) -> CpuWaitModeForceOnW<'_, CpuWaitiConfSpec> {
        CpuWaitModeForceOnW::new(self, 0)
    }
    #[doc = "Bits 1:4 - This field used to set delay cycle when cpu enter waiti mode, after delay waiti_clk will close"]
    #[inline(always)]
    pub fn cpu_waiti_delay_num(&mut self) -> CpuWaitiDelayNumW<'_, CpuWaitiConfSpec> {
        CpuWaitiDelayNumW::new(self, 1)
    }
}
...
pub struct CpuWaitiConfSpec;
impl crate::RegisterSpec for CpuWaitiConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpu_waiti_conf::R`](R) reader structure"]
impl crate::Readable for CpuWaitiConfSpec {}
#[doc = "`write(|w| ..)` method takes [`cpu_waiti_conf::W`](W) writer structure"]
impl crate::Writable for CpuWaitiConfSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CPU_WAITI_CONF to value 0x01"]
impl crate::Resettable for CpuWaitiConfSpec {

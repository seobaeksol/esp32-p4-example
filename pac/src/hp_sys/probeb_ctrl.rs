...
pub type R = crate::R<ProbebCtrlSpec>;
#[doc = "Register `PROBEB_CTRL` writer"]
pub type W = crate::W<ProbebCtrlSpec>;
...
pub type RegProbeBModSelR = crate::FieldReader<u16>;
...
impl R {
    ...
    #[inline(always)]
    pub fn reg_probe_b_mod_sel(&self) -> RegProbeBModSelR {
        RegProbeBModSelR::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:23 - Tihs field is used to select module's probe_out\\[31:0\\] as probe_out in b mode"]
    #[inline(always)]
    pub fn reg_probe_b_top_sel(&self) -> RegProbeBTopSelR {
        RegProbeBTopSelR::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bit 24 - Set this bit to enable b mode for debug probe. 1: b mode, 0: a mode."]
    #[inline(always)]
    pub fn reg_probe_b_en(&self) -> RegProbeBEnR {
        RegProbeBEnR::new(((self.bits >> 24) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:15 - Tihs field is used to selec probe_group from probe_group0 to probe_group15 for module's probe_out\\[31:0\\] in b mode."]
    #[inline(always)]
    pub fn reg_probe_b_mod_sel(&mut self) -> RegProbeBModSelW<'_, ProbebCtrlSpec> {
        RegProbeBModSelW::new(self, 0)
    }
    #[doc = "Bits 16:23 - Tihs field is used to select module's probe_out\\[31:0\\] as probe_out in b mode"]
    #[inline(always)]
    pub fn reg_probe_b_top_sel(&mut self) -> RegProbeBTopSelW<'_, ProbebCtrlSpec> {
        RegProbeBTopSelW::new(self, 16)
    }
    #[doc = "Bit 24 - Set this bit to enable b mode for debug probe. 1: b mode, 0: a mode."]
    #[inline(always)]
    pub fn reg_probe_b_en(&mut self) -> RegProbeBEnW<'_, ProbebCtrlSpec> {
        RegProbeBEnW::new(self, 24)
    }
}
...
pub struct ProbebCtrlSpec;
impl crate::RegisterSpec for ProbebCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`probeb_ctrl::R`](R) reader structure"]
impl crate::Readable for ProbebCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`probeb_ctrl::W`](W) writer structure"]
impl crate::Writable for ProbebCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PROBEB_CTRL to value 0"]
impl crate::Resettable for ProbebCtrlSpec {}

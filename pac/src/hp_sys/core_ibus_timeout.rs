...
pub type R = crate::R<CoreIbusTimeoutSpec>;
#[doc = "Register `CORE_IBUS_TIMEOUT` writer"]
pub type W = crate::W<CoreIbusTimeoutSpec>;
...
impl W {
    #[doc = "Bit 0 - set this field to 1 to enable hp core0&1 ibus timeout handle"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, CoreIbusTimeoutSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bits 1:16 - This field used to set hp core0&1 ibus timeout threshold"]
    #[inline(always)]
    pub fn thres(&mut self) -> ThresW<'_, CoreIbusTimeoutSpec> {
        ThresW::new(self, 1)
    }
}
...
pub struct CoreIbusTimeoutSpec;
impl crate::RegisterSpec for CoreIbusTimeoutSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`core_ibus_timeout::R`](R) reader structure"]
impl crate::Readable for CoreIbusTimeoutSpec {}
#[doc = "`write(|w| ..)` method takes [`core_ibus_timeout::W`](W) writer structure"]
impl crate::Writable for CoreIbusTimeoutSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CORE_IBUS_TIMEOUT to value 0x0001_ffff"]
impl crate::Resettable for CoreIbusTimeoutSpec {

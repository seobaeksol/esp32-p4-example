...
pub struct Hp2lpIntrGroup1StSpec;
impl crate::RegisterSpec for Hp2lpIntrGroup1StSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hp2lp_intr_group1_st::R`](R) reader structure"]
impl crate::Readable for Hp2lpIntrGroup1StSpec {}
#[doc = "`reset()` method sets HP2LP_INTR_GROUP1_ST to value 0"]
impl crate::Resettable for Hp2lpIntrGroup1StSpec {}

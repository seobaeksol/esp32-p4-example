...
pub type R = crate::R<L2MemSwEccBweMaskSpec>;
#[doc = "Register `L2_MEM_SW_ECC_BWE_MASK` writer"]
pub type W = crate::W<L2MemSwEccBweMaskSpec>;
#[doc = "Field `REG_L2_MEM_SW_ECC_BWE_MASK_CTRL` reader - Set 1 to mask bwe hamming code bit"]
pub type RegL2MemSwEccBweMaskCtrlR = crate::BitReader;
#[doc = "Field `REG_L2_MEM_SW_ECC_BWE_MASK_CTRL` writer - Set 1 to mask bwe hamming code bit"]
pub type RegL2MemSwEccBweMaskCtrlW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Set 1 to mask bwe hamming code bit"]
    #[inline(always)]
    pub fn reg_l2_mem_sw_ecc_bwe_mask_ctrl(&self) -> RegL2MemSwEccBweMaskCtrlR {
        RegL2MemSwEccBweMaskCtrlR::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Set 1 to mask bwe hamming code bit"]
    ...
    pub fn reg_l2_mem_sw_ecc_bwe_mask_ctrl(
        &mut self,
    ) -> RegL2MemSwEccBweMaskCtrlW<'_, L2MemSwEccBweMaskSpec> {
        RegL2MemSwEccBweMaskCtrlW::new(self, 0)
    }
}
...
pub struct L2MemSwEccBweMaskSpec;
impl crate::RegisterSpec for L2MemSwEccBweMaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_mem_sw_ecc_bwe_mask::R`](R) reader structure"]
impl crate::Readable for L2MemSwEccBweMaskSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_mem_sw_ecc_bwe_mask::W`](W) writer structure"]
impl crate::Writable for L2MemSwEccBweMaskSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_MEM_SW_ECC_BWE_MASK to value 0"]
impl crate::Resettable for L2MemSwEccBweMaskSpec {}

...
pub type R = crate::R<CoreDbusTimeoutSpec>;
#[doc = "Register `CORE_DBUS_TIMEOUT` writer"]
pub type W = crate::W<CoreDbusTimeoutSpec>;
...
impl W {
    #[doc = "Bit 0 - set this field to 1 to enable hp core0&1 dbus timeout handle"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, CoreDbusTimeoutSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bits 1:16 - This field used to set hp core0&1 dbus timeout threshold"]
    #[inline(always)]
    pub fn thres(&mut self) -> ThresW<'_, CoreDbusTimeoutSpec> {
        ThresW::new(self, 1)
    }
}
...
pub struct CoreDbusTimeoutSpec;
impl crate::RegisterSpec for CoreDbusTimeoutSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`core_dbus_timeout::R`](R) reader structure"]
impl crate::Readable for CoreDbusTimeoutSpec {}
#[doc = "`write(|w| ..)` method takes [`core_dbus_timeout::W`](W) writer structure"]
impl crate::Writable for CoreDbusTimeoutSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CORE_DBUS_TIMEOUT to value 0x0001_ffff"]
impl crate::Resettable for CoreDbusTimeoutSpec {

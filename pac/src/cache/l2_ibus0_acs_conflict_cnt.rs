...
pub type R = crate::R<L2Ibus0AcsConflictCntSpec>;
...
pub type L2Ibus0ConflictCntR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_ibus0_conflict_cnt(&self) -> L2Ibus0ConflictCntR {
        L2Ibus0ConflictCntR::new(self.bits)
    }
}
...
pub struct L2Ibus0AcsConflictCntSpec;
impl crate::RegisterSpec for L2Ibus0AcsConflictCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_ibus0_acs_conflict_cnt::R`](R) reader structure"]
impl crate::Readable for L2Ibus0AcsConflictCntSpec {}
#[doc = "`reset()` method sets L2_IBUS0_ACS_CONFLICT_CNT to value 0"]
impl crate::Resettable for L2Ibus0AcsConflictCntSpec {}

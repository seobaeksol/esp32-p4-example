...
pub type W = crate::W<L2CacheAcsFailIntClrSpec>;
...
pub type L2CacheFailIntClrW<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    #[doc = "Bit 5 - The bit is used to clear interrupt of access fail that occurs in L2-Cache due to l1 cache accesses L2-Cache."]
    #[inline(always)]
    pub fn l2_cache_fail_int_clr(&mut self) -> L2CacheFailIntClrW<'_, L2CacheAcsFailIntClrSpec> {
        L2CacheFailIntClrW::new(self, 5)
    }
}
...
pub struct L2CacheAcsFailIntClrSpec;
impl crate::RegisterSpec for L2CacheAcsFailIntClrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`l2_cache_acs_fail_int_clr::W`](W) writer structure"]
impl crate::Writable for L2CacheAcsFailIntClrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_CACHE_ACS_FAIL_INT_CLR to value 0"]
impl crate::Resettable for L2CacheAcsFailIntClrSpec {}

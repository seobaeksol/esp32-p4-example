...
pub type R = crate::R<L2Ibus2AcsConflictCntSpec>;
...
pub type L2Ibus2ConflictCntR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_ibus2_conflict_cnt(&self) -> L2Ibus2ConflictCntR {
        L2Ibus2ConflictCntR::new(self.bits)
    }
}
...
pub struct L2Ibus2AcsConflictCntSpec;
impl crate::RegisterSpec for L2Ibus2AcsConflictCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_ibus2_acs_conflict_cnt::R`](R) reader structure"]
impl crate::Readable for L2Ibus2AcsConflictCntSpec {}
#[doc = "`reset()` method sets L2_IBUS2_ACS_CONFLICT_CNT to value 0"]
impl crate::Resettable for L2Ibus2AcsConflictCntSpec {}

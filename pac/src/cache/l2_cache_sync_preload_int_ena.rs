...
impl W {
    ...
    pub fn l2_cache_pld_done_int_ena(
        &mut self,
    ) -> L2CachePldDoneIntEnaW<'_, L2CacheSyncPreloadIntEnaSpec> {
        L2CachePldDoneIntEnaW::new(self, 5)
    }
    #[doc = "Bit 12 - The bit is used to enable interrupt of L2-Cache preload-operation error."]
    #[inline(always)]
    pub fn l2_cache_pld_err_int_ena(
        &mut self,
    ) -> L2CachePldErrIntEnaW<'_, L2CacheSyncPreloadIntEnaSpec> {
        L2CachePldErrIntEnaW::new(self, 12)
    }
}
...
pub struct L2CacheSyncPreloadIntEnaSpec;
impl crate::RegisterSpec for L2CacheSyncPreloadIntEnaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_sync_preload_int_ena::R`](R) reader structure"]
impl crate::Readable for L2CacheSyncPreloadIntEnaSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_cache_sync_preload_int_ena::W`](W) writer structure"]
impl crate::Writable for L2CacheSyncPreloadIntEnaSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_CACHE_SYNC_PRELOAD_INT_ENA to value 0"]
impl crate::Resettable for L2CacheSyncPreloadIntEnaSpec {}

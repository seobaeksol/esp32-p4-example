...
pub type R = crate::R<L2CacheObjectCtrlSpec>;
#[doc = "Register `L2_CACHE_OBJECT_CTRL` writer"]
pub type W = crate::W<L2CacheObjectCtrlSpec>;
...
pub type L2CacheTagObjectR = crate::BitReader;
...
pub type L2CacheTagObjectW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L2CacheMemObjectR = crate::BitReader;
...
pub type L2CacheMemObjectW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_cache_tag_object(&self) -> L2CacheTagObjectR {
        L2CacheTagObjectR::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l2_cache_mem_object(&self) -> L2CacheMemObjectR {
        L2CacheMemObjectR::new(((self.bits >> 11) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 5 - Set this bit to set L2-Cache tag memory as object. This bit should be onehot with the others fields inside this register."]
    #[inline(always)]
    pub fn l2_cache_tag_object(&mut self) -> L2CacheTagObjectW<'_, L2CacheObjectCtrlSpec> {
        L2CacheTagObjectW::new(self, 5)
    }
    #[doc = "Bit 11 - Set this bit to set L2-Cache data memory as object. This bit should be onehot with the others fields inside this register."]
    #[inline(always)]
    pub fn l2_cache_mem_object(&mut self) -> L2CacheMemObjectW<'_, L2CacheObjectCtrlSpec> {
        L2CacheMemObjectW::new(self, 11)
    }
}
...
pub struct L2CacheObjectCtrlSpec;
impl crate::RegisterSpec for L2CacheObjectCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_object_ctrl::R`](R) reader structure"]
impl crate::Readable for L2CacheObjectCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_cache_object_ctrl::W`](W) writer structure"]
impl crate::Writable for L2CacheObjectCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_CACHE_OBJECT_CTRL to value 0"]
impl crate::Resettable for L2CacheObjectCtrlSpec {}

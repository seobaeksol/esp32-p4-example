...
pub type R = crate::R<L1DcacheAutoloadCtrlSpec>;
#[doc = "Register `L1_DCACHE_AUTOLOAD_CTRL` writer"]
pub type W = crate::W<L1DcacheAutoloadCtrlSpec>;
...
pub type L1DcacheAutoloadEnaR = crate::BitReader;
...
pub type L1DcacheAutoloadEnaW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L1DcacheAutoloadDoneR = crate::BitReader;
...
pub type L1DcacheAutoloadOrderR = crate::BitReader;
...
pub type L1DcacheAutoloadOrderW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L1DcacheAutoloadTriggerModeR = crate::FieldReader;
...
pub type L1DcacheAutoloadTriggerModeW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type L1DcacheAutoloadSct0EnaR = crate::BitReader;
...
pub type L1DcacheAutoloadSct0EnaW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L1DcacheAutoloadSct1EnaR = crate::BitReader;
...
pub type L1DcacheAutoloadSct1EnaW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L1DcacheAutoloadSct2EnaR = crate::BitReader;
...
pub type L1DcacheAutoloadSct2EnaW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L1DcacheAutoloadSct3EnaR = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn l1_dcache_autoload_done(&self) -> L1DcacheAutoloadDoneR {
        L1DcacheAutoloadDoneR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - The bit is used to configure the direction of autoload operation on L1-DCache. 0: ascending. 1: descending."]
    #[inline(always)]
    pub fn l1_dcache_autoload_order(&self) -> L1DcacheAutoloadOrderR {
        L1DcacheAutoloadOrderR::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_dcache_autoload_trigger_mode(&self) -> L1DcacheAutoloadTriggerModeR {
        L1DcacheAutoloadTriggerModeR::new(((self.bits >> 3) & 3) as u8)
    }
    #[doc = "Bit 8 - The bit is used to enable the first section for autoload operation on L1-DCache."]
    #[inline(always)]
    pub fn l1_dcache_autoload_sct0_ena(&self) -> L1DcacheAutoloadSct0EnaR {
        L1DcacheAutoloadSct0EnaR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - The bit is used to enable the second section for autoload operation on L1-DCache."]
    #[inline(always)]
    pub fn l1_dcache_autoload_sct1_ena(&self) -> L1DcacheAutoloadSct1EnaR {
        L1DcacheAutoloadSct1EnaR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - The bit is used to enable the third section for autoload operation on L1-DCache."]
    #[inline(always)]
    pub fn l1_dcache_autoload_sct2_ena(&self) -> L1DcacheAutoloadSct2EnaR {
        L1DcacheAutoloadSct2EnaR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - The bit is used to enable the fourth section for autoload operation on L1-DCache."]
    #[inline(always)]
    pub fn l1_dcache_autoload_sct3_ena(&self) -> L1DcacheAutoloadSct3EnaR {
        L1DcacheAutoloadSct3EnaR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bits 12:15 - The bit is used to set the gid of l1 dcache autoload."]
    #[inline(always)]
    pub fn l1_dcache_autoload_rgid(&self) -> L1DcacheAutoloadRgidR {
        L1DcacheAutoloadRgidR::new(((self.bits >> 12) & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - The bit is used to enable and disable autoload operation on L1-DCache. 1: enable, 0: disable."]
    #[inline(always)]
    pub fn l1_dcache_autoload_ena(&mut self) -> L1DcacheAutoloadEnaW<'_, L1DcacheAutoloadCtrlSpec> {
        L1DcacheAutoloadEnaW::new(self, 0)
    }
    #[doc = "Bit 2 - The bit is used to configure the direction of autoload operation on L1-DCache. 0: ascending. 1: descending."]
    #[inline(always)]
    pub fn l1_dcache_autoload_order(
        &mut self,
    ) -> L1DcacheAutoloadOrderW<'_, L1DcacheAutoloadCtrlSpec> {
        L1DcacheAutoloadOrderW::new(self, 2)
    }
    #[doc = "Bits 3:4 - The field is used to configure trigger mode of autoload operation on L1-DCache. 0/3: miss-trigger, 1: hit-trigger, 2: miss-hit-trigger."]
    #[inline(always)]
    pub fn l1_dcache_autoload_trigger_mode(
        &mut self,
    ) -> L1DcacheAutoloadTriggerModeW<'_, L1DcacheAutoloadCtrlSpec> {
        L1DcacheAutoloadTriggerModeW::new(self, 3)
    }
    #[doc = "Bit 8 - The bit is used to enable the first section for autoload operation on L1-DCache."]
    #[inline(always)]
    pub fn l1_dcache_autoload_sct0_ena(
        &mut self,
    ) -> L1DcacheAutoloadSct0EnaW<'_, L1DcacheAutoloadCtrlSpec> {
        L1DcacheAutoloadSct0EnaW::new(self, 8)
    }
    #[doc = "Bit 9 - The bit is used to enable the second section for autoload operation on L1-DCache."]
    #[inline(always)]
    pub fn l1_dcache_autoload_sct1_ena(
        &mut self,
    ) -> L1DcacheAutoloadSct1EnaW<'_, L1DcacheAutoloadCtrlSpec> {
        L1DcacheAutoloadSct1EnaW::new(self, 9)
    }
    #[doc = "Bit 10 - The bit is used to enable the third section for autoload operation on L1-DCache."]
    #[inline(always)]
    pub fn l1_dcache_autoload_sct2_ena(
        &mut self,
    ) -> L1DcacheAutoloadSct2EnaW<'_, L1DcacheAutoloadCtrlSpec> {
        L1DcacheAutoloadSct2EnaW::new(self, 10)
    }
    #[doc = "Bit 11 - The bit is used to enable the fourth section for autoload operation on L1-DCache."]
    #[inline(always)]
    pub fn l1_dcache_autoload_sct3_ena(
        &mut self,
    ) -> L1DcacheAutoloadSct3EnaW<'_, L1DcacheAutoloadCtrlSpec> {
        L1DcacheAutoloadSct3EnaW::new(self, 11)
    }
    #[doc = "Bits 12:15 - The bit is used to set the gid of l1 dcache autoload."]
    #[inline(always)]
    pub fn l1_dcache_autoload_rgid(
        &mut self,
    ) -> L1DcacheAutoloadRgidW<'_, L1DcacheAutoloadCtrlSpec> {
        L1DcacheAutoloadRgidW::new(self, 12)
    }
}
...
pub struct L1DcacheAutoloadCtrlSpec;
impl crate::RegisterSpec for L1DcacheAutoloadCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_dcache_autoload_ctrl::R`](R) reader structure"]
impl crate::Readable for L1DcacheAutoloadCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`l1_dcache_autoload_ctrl::W`](W) writer structure"]
impl crate::Writable for L1DcacheAutoloadCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L1_DCACHE_AUTOLOAD_CTRL to value 0x02"]
impl crate::Resettable for L1DcacheAutoloadCtrlSpec {

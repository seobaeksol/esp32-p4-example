...
pub type R = crate::R<L2CachePreloadAddrSpec>;
#[doc = "Register `L2_CACHE_PRELOAD_ADDR` writer"]
pub type W = crate::W<L2CachePreloadAddrSpec>;
...
pub type L2CachePreloadAddrR = crate::FieldReader<u32>;
...
pub type L2CachePreloadAddrW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_cache_preload_addr(&self) -> L2CachePreloadAddrR {
        L2CachePreloadAddrR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Those bits are used to configure the start virtual address of preload on L2-Cache, which should be used together with L2_CACHE_PRELOAD_SIZE_REG"]
    #[inline(always)]
    pub fn l2_cache_preload_addr(&mut self) -> L2CachePreloadAddrW<'_, L2CachePreloadAddrSpec> {
        L2CachePreloadAddrW::new(self, 0)
    }
}
...
pub struct L2CachePreloadAddrSpec;
impl crate::RegisterSpec for L2CachePreloadAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_preload_addr::R`](R) reader structure"]
impl crate::Readable for L2CachePreloadAddrSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_cache_preload_addr::W`](W) writer structure"]
impl crate::Writable for L2CachePreloadAddrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_CACHE_PRELOAD_ADDR to value 0"]
impl crate::Resettable for L2CachePreloadAddrSpec {}

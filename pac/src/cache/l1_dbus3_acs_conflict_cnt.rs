...
pub struct L1Dbus3AcsConflictCntSpec;
impl crate::RegisterSpec for L1Dbus3AcsConflictCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_dbus3_acs_conflict_cnt::R`](R) reader structure"]
impl crate::Readable for L1Dbus3AcsConflictCntSpec {}
#[doc = "`reset()` method sets L1_DBUS3_ACS_CONFLICT_CNT to value 0"]
impl crate::Resettable for L1Dbus3AcsConflictCntSpec {}

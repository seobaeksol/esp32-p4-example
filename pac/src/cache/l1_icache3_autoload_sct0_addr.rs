...
pub type R = crate::R<L1Icache3AutoloadSct0AddrSpec>;
...
pub type L1Icache3AutoloadSct0AddrR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l1_icache3_autoload_sct0_addr(&self) -> L1Icache3AutoloadSct0AddrR {
        L1Icache3AutoloadSct0AddrR::new(self.bits)
    }
}
...
pub struct L1Icache3AutoloadSct0AddrSpec;
impl crate::RegisterSpec for L1Icache3AutoloadSct0AddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache3_autoload_sct0_addr::R`](R) reader structure"]
impl crate::Readable for L1Icache3AutoloadSct0AddrSpec {}
#[doc = "`reset()` method sets L1_ICACHE3_AUTOLOAD_SCT0_ADDR to value 0"]
impl crate::Resettable for L1Icache3AutoloadSct0AddrSpec {}

...
pub struct L1DcacheAcsFailAddrSpec;
impl crate::RegisterSpec for L1DcacheAcsFailAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_dcache_acs_fail_addr::R`](R) reader structure"]
impl crate::Readable for L1DcacheAcsFailAddrSpec {}
#[doc = "`reset()` method sets L1_DCACHE_ACS_FAIL_ADDR to value 0"]
impl crate::Resettable for L1DcacheAcsFailAddrSpec {}

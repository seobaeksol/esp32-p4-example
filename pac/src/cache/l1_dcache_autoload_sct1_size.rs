...
pub type R = crate::R<L1DcacheAutoloadSct1SizeSpec>;
#[doc = "Register `L1_DCACHE_AUTOLOAD_SCT1_SIZE` writer"]
pub type W = crate::W<L1DcacheAutoloadSct1SizeSpec>;
...
pub type L1DcacheAutoloadSct1SizeR = crate::FieldReader<u32>;
...
pub type L1DcacheAutoloadSct1SizeW<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l1_dcache_autoload_sct1_size(&self) -> L1DcacheAutoloadSct1SizeR {
        L1DcacheAutoloadSct1SizeR::new(self.bits & 0x0fff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:27 - Those bits are used to configure the size of the second section for autoload operation on L1-DCache. Note that it should be used together with L1_DCACHE_AUTOLOAD_SCT1_ADDR and L1_DCACHE_AUTOLOAD_SCT1_ENA."]
    ...
    pub fn l1_dcache_autoload_sct1_size(
        &mut self,
    ) -> L1DcacheAutoloadSct1SizeW<'_, L1DcacheAutoloadSct1SizeSpec> {
        L1DcacheAutoloadSct1SizeW::new(self, 0)
    }
}
...
pub struct L1DcacheAutoloadSct1SizeSpec;
impl crate::RegisterSpec for L1DcacheAutoloadSct1SizeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_dcache_autoload_sct1_size::R`](R) reader structure"]
impl crate::Readable for L1DcacheAutoloadSct1SizeSpec {}
#[doc = "`write(|w| ..)` method takes [`l1_dcache_autoload_sct1_size::W`](W) writer structure"]
impl crate::Writable for L1DcacheAutoloadSct1SizeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L1_DCACHE_AUTOLOAD_SCT1_SIZE to value 0"]
impl crate::Resettable for L1DcacheAutoloadSct1SizeSpec {}

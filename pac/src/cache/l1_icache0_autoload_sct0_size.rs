...
pub type R = crate::R<L1Icache0AutoloadSct0SizeSpec>;
#[doc = "Register `L1_ICACHE0_AUTOLOAD_SCT0_SIZE` writer"]
pub type W = crate::W<L1Icache0AutoloadSct0SizeSpec>;
...
pub type L1Icache0AutoloadSct0SizeR = crate::FieldReader<u32>;
...
pub type L1Icache0AutoloadSct0SizeW<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l1_icache0_autoload_sct0_size(&self) -> L1Icache0AutoloadSct0SizeR {
        L1Icache0AutoloadSct0SizeR::new(self.bits & 0x0fff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:27 - Those bits are used to configure the size of the first section for autoload operation on L1-ICache0. Note that it should be used together with L1_ICACHE0_AUTOLOAD_SCT0_ADDR and L1_ICACHE_AUTOLOAD_SCT0_ENA."]
    ...
    pub fn l1_icache0_autoload_sct0_size(
        &mut self,
    ) -> L1Icache0AutoloadSct0SizeW<'_, L1Icache0AutoloadSct0SizeSpec> {
        L1Icache0AutoloadSct0SizeW::new(self, 0)
    }
}
...
pub struct L1Icache0AutoloadSct0SizeSpec;
impl crate::RegisterSpec for L1Icache0AutoloadSct0SizeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache0_autoload_sct0_size::R`](R) reader structure"]
impl crate::Readable for L1Icache0AutoloadSct0SizeSpec {}
#[doc = "`write(|w| ..)` method takes [`l1_icache0_autoload_sct0_size::W`](W) writer structure"]
impl crate::Writable for L1Icache0AutoloadSct0SizeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L1_ICACHE0_AUTOLOAD_SCT0_SIZE to value 0"]
impl crate::Resettable for L1Icache0AutoloadSct0SizeSpec {}

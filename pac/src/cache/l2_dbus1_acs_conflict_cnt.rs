...
pub type R = crate::R<L2Dbus1AcsConflictCntSpec>;
...
pub type L2Dbus1ConflictCntR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_dbus1_conflict_cnt(&self) -> L2Dbus1ConflictCntR {
        L2Dbus1ConflictCntR::new(self.bits)
    }
}
...
pub struct L2Dbus1AcsConflictCntSpec;
impl crate::RegisterSpec for L2Dbus1AcsConflictCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_dbus1_acs_conflict_cnt::R`](R) reader structure"]
impl crate::Readable for L2Dbus1AcsConflictCntSpec {}
#[doc = "`reset()` method sets L2_DBUS1_ACS_CONFLICT_CNT to value 0"]
impl crate::Resettable for L2Dbus1AcsConflictCntSpec {}

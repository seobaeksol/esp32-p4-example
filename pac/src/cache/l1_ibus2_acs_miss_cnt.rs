...
pub struct L1Ibus2AcsMissCntSpec;
impl crate::RegisterSpec for L1Ibus2AcsMissCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_ibus2_acs_miss_cnt::R`](R) reader structure"]
impl crate::Readable for L1Ibus2AcsMissCntSpec {}
#[doc = "`reset()` method sets L1_IBUS2_ACS_MISS_CNT to value 0"]
impl crate::Resettable for L1Ibus2AcsMissCntSpec {}

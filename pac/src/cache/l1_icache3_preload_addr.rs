...
pub type R = crate::R<L1Icache3PreloadAddrSpec>;
...
pub type L1Icache3PreloadAddrR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l1_icache3_preload_addr(&self) -> L1Icache3PreloadAddrR {
        L1Icache3PreloadAddrR::new(self.bits)
    }
}
...
pub struct L1Icache3PreloadAddrSpec;
impl crate::RegisterSpec for L1Icache3PreloadAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache3_preload_addr::R`](R) reader structure"]
impl crate::Readable for L1Icache3PreloadAddrSpec {}
#[doc = "`reset()` method sets L1_ICACHE3_PRELOAD_ADDR to value 0"]
impl crate::Resettable for L1Icache3PreloadAddrSpec {}

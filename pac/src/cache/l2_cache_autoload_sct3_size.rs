...
pub type R = crate::R<L2CacheAutoloadSct3SizeSpec>;
#[doc = "Register `L2_CACHE_AUTOLOAD_SCT3_SIZE` writer"]
pub type W = crate::W<L2CacheAutoloadSct3SizeSpec>;
...
pub type L2CacheAutoloadSct3SizeR = crate::FieldReader<u32>;
...
pub type L2CacheAutoloadSct3SizeW<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_cache_autoload_sct3_size(&self) -> L2CacheAutoloadSct3SizeR {
        L2CacheAutoloadSct3SizeR::new(self.bits & 0x0fff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:27 - Those bits are used to configure the size of the fourth section for autoload operation on L2-Cache. Note that it should be used together with L2_CACHE_AUTOLOAD_SCT3_ADDR and L2_CACHE_AUTOLOAD_SCT3_ENA."]
    ...
    pub fn l2_cache_autoload_sct3_size(
        &mut self,
    ) -> L2CacheAutoloadSct3SizeW<'_, L2CacheAutoloadSct3SizeSpec> {
        L2CacheAutoloadSct3SizeW::new(self, 0)
    }
}
...
pub struct L2CacheAutoloadSct3SizeSpec;
impl crate::RegisterSpec for L2CacheAutoloadSct3SizeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_autoload_sct3_size::R`](R) reader structure"]
impl crate::Readable for L2CacheAutoloadSct3SizeSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_cache_autoload_sct3_size::W`](W) writer structure"]
impl crate::Writable for L2CacheAutoloadSct3SizeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_CACHE_AUTOLOAD_SCT3_SIZE to value 0"]
impl crate::Resettable for L2CacheAutoloadSct3SizeSpec {}

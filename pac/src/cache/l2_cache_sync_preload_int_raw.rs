...
pub type R = crate::R<L2CacheSyncPreloadIntRawSpec>;
#[doc = "Register `L2_CACHE_SYNC_PRELOAD_INT_RAW` writer"]
pub type W = crate::W<L2CacheSyncPreloadIntRawSpec>;
...
pub type L2CachePldDoneIntRawR = crate::BitReader;
...
pub type L2CachePldDoneIntRawW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L2CachePldErrIntRawR = crate::BitReader;
...
pub type L2CachePldErrIntRawW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 5 - The raw bit of the interrupt that occurs only when L2-Cache preload-operation is done."]
    #[inline(always)]
    pub fn l2_cache_pld_done_int_raw(&self) -> L2CachePldDoneIntRawR {
        L2CachePldDoneIntRawR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 12 - The raw bit of the interrupt that occurs only when L2-Cache preload-operation error occurs."]
    #[inline(always)]
    pub fn l2_cache_pld_err_int_raw(&self) -> L2CachePldErrIntRawR {
        L2CachePldErrIntRawR::new(((self.bits >> 12) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 5 - The raw bit of the interrupt that occurs only when L2-Cache preload-operation is done."]
    ...
    pub fn l2_cache_pld_done_int_raw(
        &mut self,
    ) -> L2CachePldDoneIntRawW<'_, L2CacheSyncPreloadIntRawSpec> {
        L2CachePldDoneIntRawW::new(self, 5)
    }
    #[doc = "Bit 12 - The raw bit of the interrupt that occurs only when L2-Cache preload-operation error occurs."]
    #[inline(always)]
    pub fn l2_cache_pld_err_int_raw(
        &mut self,
    ) -> L2CachePldErrIntRawW<'_, L2CacheSyncPreloadIntRawSpec> {
        L2CachePldErrIntRawW::new(self, 12)
    }
}
...
pub struct L2CacheSyncPreloadIntRawSpec;
impl crate::RegisterSpec for L2CacheSyncPreloadIntRawSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_sync_preload_int_raw::R`](R) reader structure"]
impl crate::Readable for L2CacheSyncPreloadIntRawSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_cache_sync_preload_int_raw::W`](W) writer structure"]
impl crate::Writable for L2CacheSyncPreloadIntRawSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_CACHE_SYNC_PRELOAD_INT_RAW to value 0"]
impl crate::Resettable for L2CacheSyncPreloadIntRawSpec {}

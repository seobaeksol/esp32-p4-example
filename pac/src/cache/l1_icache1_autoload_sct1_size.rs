...
pub type R = crate::R<L1Icache1AutoloadSct1SizeSpec>;
#[doc = "Register `L1_ICACHE1_AUTOLOAD_SCT1_SIZE` writer"]
pub type W = crate::W<L1Icache1AutoloadSct1SizeSpec>;
...
pub type L1Icache1AutoloadSct1SizeR = crate::FieldReader<u32>;
...
pub type L1Icache1AutoloadSct1SizeW<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l1_icache1_autoload_sct1_size(&self) -> L1Icache1AutoloadSct1SizeR {
        L1Icache1AutoloadSct1SizeR::new(self.bits & 0x0fff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:27 - Those bits are used to configure the size of the second section for autoload operation on L1-ICache1. Note that it should be used together with L1_ICACHE1_AUTOLOAD_SCT1_ADDR and L1_ICACHE_AUTOLOAD_SCT1_ENA."]
    ...
    pub fn l1_icache1_autoload_sct1_size(
        &mut self,
    ) -> L1Icache1AutoloadSct1SizeW<'_, L1Icache1AutoloadSct1SizeSpec> {
        L1Icache1AutoloadSct1SizeW::new(self, 0)
    }
}
...
pub struct L1Icache1AutoloadSct1SizeSpec;
impl crate::RegisterSpec for L1Icache1AutoloadSct1SizeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache1_autoload_sct1_size::R`](R) reader structure"]
impl crate::Readable for L1Icache1AutoloadSct1SizeSpec {}
#[doc = "`write(|w| ..)` method takes [`l1_icache1_autoload_sct1_size::W`](W) writer structure"]
impl crate::Writable for L1Icache1AutoloadSct1SizeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L1_ICACHE1_AUTOLOAD_SCT1_SIZE to value 0"]
impl crate::Resettable for L1Icache1AutoloadSct1SizeSpec {}

...
pub struct L1Ibus2AcsHitCntSpec;
impl crate::RegisterSpec for L1Ibus2AcsHitCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_ibus2_acs_hit_cnt::R`](R) reader structure"]
impl crate::Readable for L1Ibus2AcsHitCntSpec {}
#[doc = "`reset()` method sets L1_IBUS2_ACS_HIT_CNT to value 0"]
impl crate::Resettable for L1Ibus2AcsHitCntSpec {}

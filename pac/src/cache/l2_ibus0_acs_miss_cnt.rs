...
pub type R = crate::R<L2Ibus0AcsMissCntSpec>;
...
pub type L2Ibus0MissCntR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_ibus0_miss_cnt(&self) -> L2Ibus0MissCntR {
        L2Ibus0MissCntR::new(self.bits)
    }
}
...
pub struct L2Ibus0AcsMissCntSpec;
impl crate::RegisterSpec for L2Ibus0AcsMissCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_ibus0_acs_miss_cnt::R`](R) reader structure"]
impl crate::Readable for L2Ibus0AcsMissCntSpec {}
#[doc = "`reset()` method sets L2_IBUS0_ACS_MISS_CNT to value 0"]
impl crate::Resettable for L2Ibus0AcsMissCntSpec {}

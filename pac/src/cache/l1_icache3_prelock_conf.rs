...
pub type R = crate::R<L1Icache3PrelockConfSpec>;
...
pub type L1Icache3PrelockSct0EnR = crate::BitReader;
...
pub type L1Icache3PrelockSct1EnR = crate::BitReader;
#[doc = "Field `L1_ICACHE3_PRELOCK_RGID` reader - The bit is used to set the gid of l1 icache3 prelock."]
pub type L1Icache3PrelockRgidR = crate::FieldReader;
impl R {
    #[doc = "Bit 0 - The bit is used to enable the first section of prelock function on L1-ICache3."]
    #[inline(always)]
    pub fn l1_icache3_prelock_sct0_en(&self) -> L1Icache3PrelockSct0EnR {
        L1Icache3PrelockSct0EnR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - The bit is used to enable the second section of prelock function on L1-ICache3."]
    #[inline(always)]
    pub fn l1_icache3_prelock_sct1_en(&self) -> L1Icache3PrelockSct1EnR {
        L1Icache3PrelockSct1EnR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 2:5 - The bit is used to set the gid of l1 icache3 prelock."]
    #[inline(always)]
    pub fn l1_icache3_prelock_rgid(&self) -> L1Icache3PrelockRgidR {
        L1Icache3PrelockRgidR::new(((self.bits >> 2) & 0x0f) as u8)
    }
}
...
pub struct L1Icache3PrelockConfSpec;
impl crate::RegisterSpec for L1Icache3PrelockConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache3_prelock_conf::R`](R) reader structure"]
impl crate::Readable for L1Icache3PrelockConfSpec {}
#[doc = "`reset()` method sets L1_ICACHE3_PRELOCK_CONF to value 0"]
impl crate::Resettable for L1Icache3PrelockConfSpec {}

...
pub type R = crate::R<L2Dbus3AcsNxtlvlWrCntSpec>;
...
pub type L2Dbus3NxtlvlWrCntR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_dbus3_nxtlvl_wr_cnt(&self) -> L2Dbus3NxtlvlWrCntR {
        L2Dbus3NxtlvlWrCntR::new(self.bits)
    }
}
...
pub struct L2Dbus3AcsNxtlvlWrCntSpec;
impl crate::RegisterSpec for L2Dbus3AcsNxtlvlWrCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_dbus3_acs_nxtlvl_wr_cnt::R`](R) reader structure"]
impl crate::Readable for L2Dbus3AcsNxtlvlWrCntSpec {}
#[doc = "`reset()` method sets L2_DBUS3_ACS_NXTLVL_WR_CNT to value 0"]
impl crate::Resettable for L2Dbus3AcsNxtlvlWrCntSpec {}

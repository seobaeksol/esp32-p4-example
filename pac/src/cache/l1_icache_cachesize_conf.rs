...
pub type R = crate::R<L1IcacheCachesizeConfSpec>;
...
pub type L1IcacheCachesize256R = crate::BitReader;
...
pub type L1IcacheCachesize512R = crate::BitReader;
...
pub type L1IcacheCachesize1kR = crate::BitReader;
...
pub type L1IcacheCachesize2kR = crate::BitReader;
...
pub type L1IcacheCachesize4kR = crate::BitReader;
...
pub type L1IcacheCachesize8kR = crate::BitReader;
...
pub type L1IcacheCachesize16kR = crate::BitReader;
...
pub type L1IcacheCachesize32kR = crate::BitReader;
...
pub type L1IcacheCachesize64kR = crate::BitReader;
...
pub type L1IcacheCachesize128kR = crate::BitReader;
...
pub type L1IcacheCachesize256kR = crate::BitReader;
...
pub type L1IcacheCachesize512kR = crate::BitReader;
...
pub type L1IcacheCachesize1024kR = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn l1_icache_cachesize_256(&self) -> L1IcacheCachesize256R {
        L1IcacheCachesize256R::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache_cachesize_512(&self) -> L1IcacheCachesize512R {
        L1IcacheCachesize512R::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache_cachesize_1k(&self) -> L1IcacheCachesize1kR {
        L1IcacheCachesize1kR::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache_cachesize_2k(&self) -> L1IcacheCachesize2kR {
        L1IcacheCachesize2kR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache_cachesize_4k(&self) -> L1IcacheCachesize4kR {
        L1IcacheCachesize4kR::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache_cachesize_8k(&self) -> L1IcacheCachesize8kR {
        L1IcacheCachesize8kR::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache_cachesize_16k(&self) -> L1IcacheCachesize16kR {
        L1IcacheCachesize16kR::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache_cachesize_32k(&self) -> L1IcacheCachesize32kR {
        L1IcacheCachesize32kR::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache_cachesize_64k(&self) -> L1IcacheCachesize64kR {
        L1IcacheCachesize64kR::new(((self.bits >> 8) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache_cachesize_128k(&self) -> L1IcacheCachesize128kR {
        L1IcacheCachesize128kR::new(((self.bits >> 9) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache_cachesize_256k(&self) -> L1IcacheCachesize256kR {
        L1IcacheCachesize256kR::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache_cachesize_512k(&self) -> L1IcacheCachesize512kR {
        L1IcacheCachesize512kR::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache_cachesize_1024k(&self) -> L1IcacheCachesize1024kR {
        L1IcacheCachesize1024kR::new(((self.bits >> 12) & 1) != 0)
    }
}
...
pub struct L1IcacheCachesizeConfSpec;
impl crate::RegisterSpec for L1IcacheCachesizeConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache_cachesize_conf::R`](R) reader structure"]
impl crate::Readable for L1IcacheCachesizeConfSpec {}
#[doc = "`reset()` method sets L1_ICACHE_CACHESIZE_CONF to value 0x40"]
impl crate::Resettable for L1IcacheCachesizeConfSpec {

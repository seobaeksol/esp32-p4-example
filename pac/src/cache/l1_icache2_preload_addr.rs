...
pub type R = crate::R<L1Icache2PreloadAddrSpec>;
...
pub type L1Icache2PreloadAddrR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l1_icache2_preload_addr(&self) -> L1Icache2PreloadAddrR {
        L1Icache2PreloadAddrR::new(self.bits)
    }
}
...
pub struct L1Icache2PreloadAddrSpec;
impl crate::RegisterSpec for L1Icache2PreloadAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache2_preload_addr::R`](R) reader structure"]
impl crate::Readable for L1Icache2PreloadAddrSpec {}
#[doc = "`reset()` method sets L1_ICACHE2_PRELOAD_ADDR to value 0"]
impl crate::Resettable for L1Icache2PreloadAddrSpec {}

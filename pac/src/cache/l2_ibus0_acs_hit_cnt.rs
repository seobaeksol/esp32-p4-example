...
pub type R = crate::R<L2Ibus0AcsHitCntSpec>;
...
pub struct L2Ibus0AcsHitCntSpec;
impl crate::RegisterSpec for L2Ibus0AcsHitCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_ibus0_acs_hit_cnt::R`](R) reader structure"]
impl crate::Readable for L2Ibus0AcsHitCntSpec {}
#[doc = "`reset()` method sets L2_IBUS0_ACS_HIT_CNT to value 0"]
impl crate::Resettable for L2Ibus0AcsHitCntSpec {}

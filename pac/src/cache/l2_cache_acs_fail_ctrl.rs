...
pub type R = crate::R<L2CacheAcsFailCtrlSpec>;
#[doc = "Register `L2_CACHE_ACS_FAIL_CTRL` writer"]
pub type W = crate::W<L2CacheAcsFailCtrlSpec>;
...
pub type L2CacheAcsFailCheckModeR = crate::BitReader;
...
pub type L2CacheAcsFailCheckModeW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_cache_acs_fail_check_mode(&self) -> L2CacheAcsFailCheckModeR {
        L2CacheAcsFailCheckModeR::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - The bit is used to configure l2 cache access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
    ...
    pub fn l2_cache_acs_fail_check_mode(
        &mut self,
    ) -> L2CacheAcsFailCheckModeW<'_, L2CacheAcsFailCtrlSpec> {
        L2CacheAcsFailCheckModeW::new(self, 0)
    }
}
...
pub struct L2CacheAcsFailCtrlSpec;
impl crate::RegisterSpec for L2CacheAcsFailCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_acs_fail_ctrl::R`](R) reader structure"]
impl crate::Readable for L2CacheAcsFailCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_cache_acs_fail_ctrl::W`](W) writer structure"]
impl crate::Writable for L2CacheAcsFailCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_CACHE_ACS_FAIL_CTRL to value 0"]
impl crate::Resettable for L2CacheAcsFailCtrlSpec {}

...
pub type R = crate::R<L2Ibus3AcsConflictCntSpec>;
...
pub type L2Ibus3ConflictCntR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_ibus3_conflict_cnt(&self) -> L2Ibus3ConflictCntR {
        L2Ibus3ConflictCntR::new(self.bits)
    }
}
...
pub struct L2Ibus3AcsConflictCntSpec;
impl crate::RegisterSpec for L2Ibus3AcsConflictCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_ibus3_acs_conflict_cnt::R`](R) reader structure"]
impl crate::Readable for L2Ibus3AcsConflictCntSpec {}
#[doc = "`reset()` method sets L2_IBUS3_ACS_CONFLICT_CNT to value 0"]
impl crate::Resettable for L2Ibus3AcsConflictCntSpec {}

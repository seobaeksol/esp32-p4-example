...
pub struct L1Icache1AcsFailAddrSpec;
impl crate::RegisterSpec for L1Icache1AcsFailAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache1_acs_fail_addr::R`](R) reader structure"]
impl crate::Readable for L1Icache1AcsFailAddrSpec {}
#[doc = "`reset()` method sets L1_ICACHE1_ACS_FAIL_ADDR to value 0"]
impl crate::Resettable for L1Icache1AcsFailAddrSpec {}

...
pub type R = crate::R<L2Dbus0AcsHitCntSpec>;
...
pub struct L2Dbus0AcsHitCntSpec;
impl crate::RegisterSpec for L2Dbus0AcsHitCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_dbus0_acs_hit_cnt::R`](R) reader structure"]
impl crate::Readable for L2Dbus0AcsHitCntSpec {}
#[doc = "`reset()` method sets L2_DBUS0_ACS_HIT_CNT to value 0"]
impl crate::Resettable for L2Dbus0AcsHitCntSpec {}

...
pub type R = crate::R<L1Icache3AutoloadCtrlSpec>;
...
pub type L1Icache3AutoloadEnaR = crate::BitReader;
...
pub type L1Icache3AutoloadDoneR = crate::BitReader;
...
pub type L1Icache3AutoloadOrderR = crate::BitReader;
...
pub type L1Icache3AutoloadTriggerModeR = crate::FieldReader;
...
pub type L1Icache3AutoloadSct0EnaR = crate::BitReader;
...
pub type L1Icache3AutoloadSct1EnaR = crate::BitReader;
#[doc = "Field `L1_ICACHE3_AUTOLOAD_RGID` reader - The bit is used to set the gid of l1 icache3 autoload."]
pub type L1Icache3AutoloadRgidR = crate::FieldReader;
impl R {
    #[doc = "Bit 0 - The bit is used to enable and disable autoload operation on L1-ICache3. 1: enable, 0: disable."]
    #[inline(always)]
    pub fn l1_icache3_autoload_ena(&self) -> L1Icache3AutoloadEnaR {
        L1Icache3AutoloadEnaR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache3_autoload_done(&self) -> L1Icache3AutoloadDoneR {
        L1Icache3AutoloadDoneR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - The bit is used to configure the direction of autoload operation on L1-ICache3. 0: ascending. 1: descending."]
    #[inline(always)]
    pub fn l1_icache3_autoload_order(&self) -> L1Icache3AutoloadOrderR {
        L1Icache3AutoloadOrderR::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l1_icache3_autoload_trigger_mode(&self) -> L1Icache3AutoloadTriggerModeR {
        L1Icache3AutoloadTriggerModeR::new(((self.bits >> 3) & 3) as u8)
    }
    #[doc = "Bit 8 - The bit is used to enable the first section for autoload operation on L1-ICache3."]
    #[inline(always)]
    pub fn l1_icache3_autoload_sct0_ena(&self) -> L1Icache3AutoloadSct0EnaR {
        L1Icache3AutoloadSct0EnaR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - The bit is used to enable the second section for autoload operation on L1-ICache3."]
    #[inline(always)]
    pub fn l1_icache3_autoload_sct1_ena(&self) -> L1Icache3AutoloadSct1EnaR {
        L1Icache3AutoloadSct1EnaR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bits 10:13 - The bit is used to set the gid of l1 icache3 autoload."]
    #[inline(always)]
    pub fn l1_icache3_autoload_rgid(&self) -> L1Icache3AutoloadRgidR {
        L1Icache3AutoloadRgidR::new(((self.bits >> 10) & 0x0f) as u8)
    }
}
...
pub struct L1Icache3AutoloadCtrlSpec;
impl crate::RegisterSpec for L1Icache3AutoloadCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache3_autoload_ctrl::R`](R) reader structure"]
impl crate::Readable for L1Icache3AutoloadCtrlSpec {}
#[doc = "`reset()` method sets L1_ICACHE3_AUTOLOAD_CTRL to value 0x02"]
impl crate::Resettable for L1Icache3AutoloadCtrlSpec {

...
pub struct L1Ibus0AcsConflictCntSpec;
impl crate::RegisterSpec for L1Ibus0AcsConflictCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_ibus0_acs_conflict_cnt::R`](R) reader structure"]
impl crate::Readable for L1Ibus0AcsConflictCntSpec {}
#[doc = "`reset()` method sets L1_IBUS0_ACS_CONFLICT_CNT to value 0"]
impl crate::Resettable for L1Ibus0AcsConflictCntSpec {}

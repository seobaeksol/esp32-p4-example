...
pub type R = crate::R<L1Icache0PreloadAddrSpec>;
#[doc = "Register `L1_ICACHE0_PRELOAD_ADDR` writer"]
pub type W = crate::W<L1Icache0PreloadAddrSpec>;
...
pub type L1Icache0PreloadAddrR = crate::FieldReader<u32>;
...
pub type L1Icache0PreloadAddrW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l1_icache0_preload_addr(&self) -> L1Icache0PreloadAddrR {
        L1Icache0PreloadAddrR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Those bits are used to configure the start virtual address of preload on L1-ICache0, which should be used together with L1_ICACHE0_PRELOAD_SIZE_REG"]
    ...
    pub fn l1_icache0_preload_addr(
        &mut self,
    ) -> L1Icache0PreloadAddrW<'_, L1Icache0PreloadAddrSpec> {
        L1Icache0PreloadAddrW::new(self, 0)
    }
}
...
pub struct L1Icache0PreloadAddrSpec;
impl crate::RegisterSpec for L1Icache0PreloadAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache0_preload_addr::R`](R) reader structure"]
impl crate::Readable for L1Icache0PreloadAddrSpec {}
#[doc = "`write(|w| ..)` method takes [`l1_icache0_preload_addr::W`](W) writer structure"]
impl crate::Writable for L1Icache0PreloadAddrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L1_ICACHE0_PRELOAD_ADDR to value 0"]
impl crate::Resettable for L1Icache0PreloadAddrSpec {}

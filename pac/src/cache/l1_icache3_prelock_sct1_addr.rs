...
pub type R = crate::R<L1Icache3PrelockSct1AddrSpec>;
...
pub type L1Icache3PrelockSct1AddrR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l1_icache3_prelock_sct1_addr(&self) -> L1Icache3PrelockSct1AddrR {
        L1Icache3PrelockSct1AddrR::new(self.bits)
    }
}
...
pub struct L1Icache3PrelockSct1AddrSpec;
impl crate::RegisterSpec for L1Icache3PrelockSct1AddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache3_prelock_sct1_addr::R`](R) reader structure"]
impl crate::Readable for L1Icache3PrelockSct1AddrSpec {}
#[doc = "`reset()` method sets L1_ICACHE3_PRELOCK_SCT1_ADDR to value 0"]
impl crate::Resettable for L1Icache3PrelockSct1AddrSpec {}

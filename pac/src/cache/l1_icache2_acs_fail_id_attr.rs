...
pub struct L1Icache2AcsFailIdAttrSpec;
impl crate::RegisterSpec for L1Icache2AcsFailIdAttrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache2_acs_fail_id_attr::R`](R) reader structure"]
impl crate::Readable for L1Icache2AcsFailIdAttrSpec {}
#[doc = "`reset()` method sets L1_ICACHE2_ACS_FAIL_ID_ATTR to value 0"]
impl crate::Resettable for L1Icache2AcsFailIdAttrSpec {}

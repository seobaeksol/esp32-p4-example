...
pub struct L1Icache0AcsFailAddrSpec;
impl crate::RegisterSpec for L1Icache0AcsFailAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache0_acs_fail_addr::R`](R) reader structure"]
impl crate::Readable for L1Icache0AcsFailAddrSpec {}
#[doc = "`reset()` method sets L1_ICACHE0_ACS_FAIL_ADDR to value 0"]
impl crate::Resettable for L1Icache0AcsFailAddrSpec {}

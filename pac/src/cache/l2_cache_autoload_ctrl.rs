...
pub type R = crate::R<L2CacheAutoloadCtrlSpec>;
#[doc = "Register `L2_CACHE_AUTOLOAD_CTRL` writer"]
pub type W = crate::W<L2CacheAutoloadCtrlSpec>;
...
pub type L2CacheAutoloadEnaR = crate::BitReader;
...
pub type L2CacheAutoloadEnaW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L2CacheAutoloadDoneR = crate::BitReader;
...
pub type L2CacheAutoloadOrderR = crate::BitReader;
...
pub type L2CacheAutoloadOrderW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L2CacheAutoloadTriggerModeR = crate::FieldReader;
...
pub type L2CacheAutoloadTriggerModeW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type L2CacheAutoloadSct0EnaR = crate::BitReader;
...
pub type L2CacheAutoloadSct0EnaW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L2CacheAutoloadSct1EnaR = crate::BitReader;
...
pub type L2CacheAutoloadSct1EnaW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L2CacheAutoloadSct2EnaR = crate::BitReader;
...
pub type L2CacheAutoloadSct2EnaW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L2CacheAutoloadSct3EnaR = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn l2_cache_autoload_done(&self) -> L2CacheAutoloadDoneR {
        L2CacheAutoloadDoneR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - The bit is used to configure the direction of autoload operation on L2-Cache. 0: ascending. 1: descending."]
    #[inline(always)]
    pub fn l2_cache_autoload_order(&self) -> L2CacheAutoloadOrderR {
        L2CacheAutoloadOrderR::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l2_cache_autoload_trigger_mode(&self) -> L2CacheAutoloadTriggerModeR {
        L2CacheAutoloadTriggerModeR::new(((self.bits >> 3) & 3) as u8)
    }
    #[doc = "Bit 8 - The bit is used to enable the first section for autoload operation on L2-Cache."]
    #[inline(always)]
    pub fn l2_cache_autoload_sct0_ena(&self) -> L2CacheAutoloadSct0EnaR {
        L2CacheAutoloadSct0EnaR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - The bit is used to enable the second section for autoload operation on L2-Cache."]
    #[inline(always)]
    pub fn l2_cache_autoload_sct1_ena(&self) -> L2CacheAutoloadSct1EnaR {
        L2CacheAutoloadSct1EnaR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - The bit is used to enable the third section for autoload operation on L2-Cache."]
    #[inline(always)]
    pub fn l2_cache_autoload_sct2_ena(&self) -> L2CacheAutoloadSct2EnaR {
        L2CacheAutoloadSct2EnaR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - The bit is used to enable the fourth section for autoload operation on L2-Cache."]
    #[inline(always)]
    pub fn l2_cache_autoload_sct3_ena(&self) -> L2CacheAutoloadSct3EnaR {
        L2CacheAutoloadSct3EnaR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bits 12:15 - The bit is used to set the gid of l2 cache autoload."]
    #[inline(always)]
    pub fn l2_cache_autoload_rgid(&self) -> L2CacheAutoloadRgidR {
        L2CacheAutoloadRgidR::new(((self.bits >> 12) & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - The bit is used to enable and disable autoload operation on L2-Cache. 1: enable, 0: disable."]
    #[inline(always)]
    pub fn l2_cache_autoload_ena(&mut self) -> L2CacheAutoloadEnaW<'_, L2CacheAutoloadCtrlSpec> {
        L2CacheAutoloadEnaW::new(self, 0)
    }
    #[doc = "Bit 2 - The bit is used to configure the direction of autoload operation on L2-Cache. 0: ascending. 1: descending."]
    #[inline(always)]
    pub fn l2_cache_autoload_order(
        &mut self,
    ) -> L2CacheAutoloadOrderW<'_, L2CacheAutoloadCtrlSpec> {
        L2CacheAutoloadOrderW::new(self, 2)
    }
    #[doc = "Bits 3:4 - The field is used to configure trigger mode of autoload operation on L2-Cache. 0/3: miss-trigger, 1: hit-trigger, 2: miss-hit-trigger."]
    #[inline(always)]
    pub fn l2_cache_autoload_trigger_mode(
        &mut self,
    ) -> L2CacheAutoloadTriggerModeW<'_, L2CacheAutoloadCtrlSpec> {
        L2CacheAutoloadTriggerModeW::new(self, 3)
    }
    #[doc = "Bit 8 - The bit is used to enable the first section for autoload operation on L2-Cache."]
    #[inline(always)]
    pub fn l2_cache_autoload_sct0_ena(
        &mut self,
    ) -> L2CacheAutoloadSct0EnaW<'_, L2CacheAutoloadCtrlSpec> {
        L2CacheAutoloadSct0EnaW::new(self, 8)
    }
    #[doc = "Bit 9 - The bit is used to enable the second section for autoload operation on L2-Cache."]
    #[inline(always)]
    pub fn l2_cache_autoload_sct1_ena(
        &mut self,
    ) -> L2CacheAutoloadSct1EnaW<'_, L2CacheAutoloadCtrlSpec> {
        L2CacheAutoloadSct1EnaW::new(self, 9)
    }
    #[doc = "Bit 10 - The bit is used to enable the third section for autoload operation on L2-Cache."]
    #[inline(always)]
    pub fn l2_cache_autoload_sct2_ena(
        &mut self,
    ) -> L2CacheAutoloadSct2EnaW<'_, L2CacheAutoloadCtrlSpec> {
        L2CacheAutoloadSct2EnaW::new(self, 10)
    }
    #[doc = "Bit 11 - The bit is used to enable the fourth section for autoload operation on L2-Cache."]
    #[inline(always)]
    pub fn l2_cache_autoload_sct3_ena(
        &mut self,
    ) -> L2CacheAutoloadSct3EnaW<'_, L2CacheAutoloadCtrlSpec> {
        L2CacheAutoloadSct3EnaW::new(self, 11)
    }
    #[doc = "Bits 12:15 - The bit is used to set the gid of l2 cache autoload."]
    #[inline(always)]
    pub fn l2_cache_autoload_rgid(&mut self) -> L2CacheAutoloadRgidW<'_, L2CacheAutoloadCtrlSpec> {
        L2CacheAutoloadRgidW::new(self, 12)
    }
}
...
pub struct L2CacheAutoloadCtrlSpec;
impl crate::RegisterSpec for L2CacheAutoloadCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_autoload_ctrl::R`](R) reader structure"]
impl crate::Readable for L2CacheAutoloadCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_cache_autoload_ctrl::W`](W) writer structure"]
impl crate::Writable for L2CacheAutoloadCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_CACHE_AUTOLOAD_CTRL to value 0x02"]
impl crate::Resettable for L2CacheAutoloadCtrlSpec {

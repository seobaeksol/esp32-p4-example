...
pub type R = crate::R<L1DcacheAutoloadSct2SizeSpec>;
#[doc = "Register `L1_DCACHE_AUTOLOAD_SCT2_SIZE` writer"]
pub type W = crate::W<L1DcacheAutoloadSct2SizeSpec>;
...
pub type L1DcacheAutoloadSct2SizeR = crate::FieldReader<u32>;
...
pub type L1DcacheAutoloadSct2SizeW<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l1_dcache_autoload_sct2_size(&self) -> L1DcacheAutoloadSct2SizeR {
        L1DcacheAutoloadSct2SizeR::new(self.bits & 0x0fff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:27 - Those bits are used to configure the size of the third section for autoload operation on L1-DCache. Note that it should be used together with L1_DCACHE_AUTOLOAD_SCT2_ADDR and L1_DCACHE_AUTOLOAD_SCT2_ENA."]
    ...
    pub fn l1_dcache_autoload_sct2_size(
        &mut self,
    ) -> L1DcacheAutoloadSct2SizeW<'_, L1DcacheAutoloadSct2SizeSpec> {
        L1DcacheAutoloadSct2SizeW::new(self, 0)
    }
}
...
pub struct L1DcacheAutoloadSct2SizeSpec;
impl crate::RegisterSpec for L1DcacheAutoloadSct2SizeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_dcache_autoload_sct2_size::R`](R) reader structure"]
impl crate::Readable for L1DcacheAutoloadSct2SizeSpec {}
#[doc = "`write(|w| ..)` method takes [`l1_dcache_autoload_sct2_size::W`](W) writer structure"]
impl crate::Writable for L1DcacheAutoloadSct2SizeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L1_DCACHE_AUTOLOAD_SCT2_SIZE to value 0"]
impl crate::Resettable for L1DcacheAutoloadSct2SizeSpec {}

...
pub type R = crate::R<LockAddrSpec>;
#[doc = "Register `LOCK_ADDR` writer"]
pub type W = crate::W<LockAddrSpec>;
...
pub type LockAddrR = crate::FieldReader<u32>;
...
pub type LockAddrW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ...
    #[inline(always)]
    pub fn lock_addr(&self) -> LockAddrR {
        LockAddrR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Those bits are used to configure the start virtual address of the lock/unlock operation, which should be used together with CACHE_LOCK_SIZE_REG"]
    #[inline(always)]
    pub fn lock_addr(&mut self) -> LockAddrW<'_, LockAddrSpec> {
        LockAddrW::new(self, 0)
    }
}
...
pub struct LockAddrSpec;
impl crate::RegisterSpec for LockAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lock_addr::R`](R) reader structure"]
impl crate::Readable for LockAddrSpec {}
#[doc = "`write(|w| ..)` method takes [`lock_addr::W`](W) writer structure"]
impl crate::Writable for LockAddrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LOCK_ADDR to value 0"]
impl crate::Resettable for LockAddrSpec {}

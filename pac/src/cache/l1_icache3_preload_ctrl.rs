...
pub type R = crate::R<L1Icache3PreloadCtrlSpec>;
...
pub type L1Icache3PreloadEnaR = crate::BitReader;
...
pub type L1Icache3PreloadDoneR = crate::BitReader;
...
pub type L1Icache3PreloadOrderR = crate::BitReader;
#[doc = "Field `L1_ICACHE3_PRELOAD_RGID` reader - The bit is used to set the gid of l1 icache3 preload."]
pub type L1Icache3PreloadRgidR = crate::FieldReader;
...
pub type L1Icache3PreloadModeR = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn l1_icache3_preload_ena(&self) -> L1Icache3PreloadEnaR {
        L1Icache3PreloadEnaR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - The bit is used to indicate whether preload operation is finished or not. 0: not finished. 1: finished."]
    #[inline(always)]
    pub fn l1_icache3_preload_done(&self) -> L1Icache3PreloadDoneR {
        L1Icache3PreloadDoneR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - The bit is used to configure the direction of preload operation. 0: ascending, 1: descending."]
    #[inline(always)]
    pub fn l1_icache3_preload_order(&self) -> L1Icache3PreloadOrderR {
        L1Icache3PreloadOrderR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bits 3:6 - The bit is used to set the gid of l1 icache3 preload."]
    #[inline(always)]
    pub fn l1_icache3_preload_rgid(&self) -> L1Icache3PreloadRgidR {
        L1Icache3PreloadRgidR::new(((self.bits >> 3) & 0x0f) as u8)
    }
    ...
    #[inline(always)]
    pub fn l1_icache3_preload_mode(&self) -> L1Icache3PreloadModeR {
        L1Icache3PreloadModeR::new(((self.bits >> 7) & 1) != 0)
    }
}
...
pub struct L1Icache3PreloadCtrlSpec;
impl crate::RegisterSpec for L1Icache3PreloadCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_icache3_preload_ctrl::R`](R) reader structure"]
impl crate::Readable for L1Icache3PreloadCtrlSpec {}
#[doc = "`reset()` method sets L1_ICACHE3_PRELOAD_CTRL to value 0x02"]
impl crate::Resettable for L1Icache3PreloadCtrlSpec {

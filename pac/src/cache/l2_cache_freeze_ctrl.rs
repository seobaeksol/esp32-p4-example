...
pub type L2CacheFreezeModeR = crate::BitReader;
...
pub type L2CacheFreezeModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L2CacheFreezeDoneR = crate::BitReader;
impl R {
    #[doc = "Bit 20 - The bit is used to enable freeze operation on L2-Cache. It can be cleared by software."]
    #[inline(always)]
    pub fn l2_cache_freeze_en(&self) -> L2CacheFreezeEnR {
        L2CacheFreezeEnR::new(((self.bits >> 20) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l2_cache_freeze_mode(&self) -> L2CacheFreezeModeR {
        L2CacheFreezeModeR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - The bit is used to indicate whether freeze operation on L2-Cache is finished or not. 0: not finished. 1: finished."]
    #[inline(always)]
    pub fn l2_cache_freeze_done(&self) -> L2CacheFreezeDoneR {
        L2CacheFreezeDoneR::new(((self.bits >> 22) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 20 - The bit is used to enable freeze operation on L2-Cache. It can be cleared by software."]
    #[inline(always)]
    pub fn l2_cache_freeze_en(&mut self) -> L2CacheFreezeEnW<'_, L2CacheFreezeCtrlSpec> {
        L2CacheFreezeEnW::new(self, 20)
    }
    #[doc = "Bit 21 - The bit is used to configure mode of freeze operation L2-Cache. 0: a miss-access will not stuck. 1: a miss-access will stuck."]
    #[inline(always)]
    pub fn l2_cache_freeze_mode(&mut self) -> L2CacheFreezeModeW<'_, L2CacheFreezeCtrlSpec> {
        L2CacheFreezeModeW::new(self, 21)
    }
}
...
pub struct L2CacheFreezeCtrlSpec;
impl crate::RegisterSpec for L2CacheFreezeCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_freeze_ctrl::R`](R) reader structure"]
impl crate::Readable for L2CacheFreezeCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_cache_freeze_ctrl::W`](W) writer structure"]
impl crate::Writable for L2CacheFreezeCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_CACHE_FREEZE_CTRL to value 0"]
impl crate::Resettable for L2CacheFreezeCtrlSpec {}

...
pub type R = crate::R<L2CachePrelockSct0AddrSpec>;
#[doc = "Register `L2_CACHE_PRELOCK_SCT0_ADDR` writer"]
pub type W = crate::W<L2CachePrelockSct0AddrSpec>;
...
pub type L2CachePrelockSct0AddrR = crate::FieldReader<u32>;
...
pub type L2CachePrelockSct0AddrW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_cache_prelock_sct0_addr(&self) -> L2CachePrelockSct0AddrR {
        L2CachePrelockSct0AddrR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Those bits are used to configure the start virtual address of the first section of prelock on L2-Cache, which should be used together with L2_CACHE_PRELOCK_SCT0_SIZE_REG"]
    ...
    pub fn l2_cache_prelock_sct0_addr(
        &mut self,
    ) -> L2CachePrelockSct0AddrW<'_, L2CachePrelockSct0AddrSpec> {
        L2CachePrelockSct0AddrW::new(self, 0)
    }
}
...
pub struct L2CachePrelockSct0AddrSpec;
impl crate::RegisterSpec for L2CachePrelockSct0AddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_prelock_sct0_addr::R`](R) reader structure"]
impl crate::Readable for L2CachePrelockSct0AddrSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_cache_prelock_sct0_addr::W`](W) writer structure"]
impl crate::Writable for L2CachePrelockSct0AddrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_CACHE_PRELOCK_SCT0_ADDR to value 0"]
impl crate::Resettable for L2CachePrelockSct0AddrSpec {}

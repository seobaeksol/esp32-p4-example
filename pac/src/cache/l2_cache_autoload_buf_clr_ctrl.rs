...
pub type R = crate::R<L2CacheAutoloadBufClrCtrlSpec>;
#[doc = "Register `L2_CACHE_AUTOLOAD_BUF_CLR_CTRL` writer"]
pub type W = crate::W<L2CacheAutoloadBufClrCtrlSpec>;
...
pub type L2CacheAldBufClrR = crate::BitReader;
...
pub type L2CacheAldBufClrW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_cache_ald_buf_clr(&self) -> L2CacheAldBufClrR {
        L2CacheAldBufClrR::new(((self.bits >> 5) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 5 - set this bit to clear autoload-buffer inside L2-Cache. If this bit is active, autoload will not work in L2-Cache. This bit should not be active when autoload works in L2-Cache."]
    #[inline(always)]
    pub fn l2_cache_ald_buf_clr(&mut self) -> L2CacheAldBufClrW<'_, L2CacheAutoloadBufClrCtrlSpec> {
        L2CacheAldBufClrW::new(self, 5)
    }
}
...
pub struct L2CacheAutoloadBufClrCtrlSpec;
impl crate::RegisterSpec for L2CacheAutoloadBufClrCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_autoload_buf_clr_ctrl::R`](R) reader structure"]
impl crate::Readable for L2CacheAutoloadBufClrCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_cache_autoload_buf_clr_ctrl::W`](W) writer structure"]
impl crate::Writable for L2CacheAutoloadBufClrCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_CACHE_AUTOLOAD_BUF_CLR_CTRL to value 0"]
impl crate::Resettable for L2CacheAutoloadBufClrCtrlSpec {}

...
pub type R = crate::R<L2Dbus0AcsNxtlvlRdCntSpec>;
...
pub type L2Dbus0NxtlvlRdCntR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_dbus0_nxtlvl_rd_cnt(&self) -> L2Dbus0NxtlvlRdCntR {
        L2Dbus0NxtlvlRdCntR::new(self.bits)
    }
}
...
pub struct L2Dbus0AcsNxtlvlRdCntSpec;
impl crate::RegisterSpec for L2Dbus0AcsNxtlvlRdCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_dbus0_acs_nxtlvl_rd_cnt::R`](R) reader structure"]
impl crate::Readable for L2Dbus0AcsNxtlvlRdCntSpec {}
#[doc = "`reset()` method sets L2_DBUS0_ACS_NXTLVL_RD_CNT to value 0"]
impl crate::Resettable for L2Dbus0AcsNxtlvlRdCntSpec {}

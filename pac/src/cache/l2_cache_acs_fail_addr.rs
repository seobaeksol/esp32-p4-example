...
pub struct L2CacheAcsFailAddrSpec;
impl crate::RegisterSpec for L2CacheAcsFailAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_acs_fail_addr::R`](R) reader structure"]
impl crate::Readable for L2CacheAcsFailAddrSpec {}
#[doc = "`reset()` method sets L2_CACHE_ACS_FAIL_ADDR to value 0"]
impl crate::Resettable for L2CacheAcsFailAddrSpec {}

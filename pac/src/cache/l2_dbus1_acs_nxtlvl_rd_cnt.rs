...
pub type R = crate::R<L2Dbus1AcsNxtlvlRdCntSpec>;
...
pub type L2Dbus1NxtlvlRdCntR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_dbus1_nxtlvl_rd_cnt(&self) -> L2Dbus1NxtlvlRdCntR {
        L2Dbus1NxtlvlRdCntR::new(self.bits)
    }
}
...
pub struct L2Dbus1AcsNxtlvlRdCntSpec;
impl crate::RegisterSpec for L2Dbus1AcsNxtlvlRdCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_dbus1_acs_nxtlvl_rd_cnt::R`](R) reader structure"]
impl crate::Readable for L2Dbus1AcsNxtlvlRdCntSpec {}
#[doc = "`reset()` method sets L2_DBUS1_ACS_NXTLVL_RD_CNT to value 0"]
impl crate::Resettable for L2Dbus1AcsNxtlvlRdCntSpec {}

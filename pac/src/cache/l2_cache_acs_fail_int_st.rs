...
pub type R = crate::R<L2CacheAcsFailIntStSpec>;
...
pub type L2CacheFailIntStR = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn l2_cache_fail_int_st(&self) -> L2CacheFailIntStR {
        L2CacheFailIntStR::new(((self.bits >> 5) & 1) != 0)
    }
}
...
pub struct L2CacheAcsFailIntStSpec;
impl crate::RegisterSpec for L2CacheAcsFailIntStSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_acs_fail_int_st::R`](R) reader structure"]
impl crate::Readable for L2CacheAcsFailIntStSpec {}
#[doc = "`reset()` method sets L2_CACHE_ACS_FAIL_INT_ST to value 0"]
impl crate::Resettable for L2CacheAcsFailIntStSpec {}

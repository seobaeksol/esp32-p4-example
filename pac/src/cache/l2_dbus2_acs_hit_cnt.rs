...
pub type R = crate::R<L2Dbus2AcsHitCntSpec>;
...
pub struct L2Dbus2AcsHitCntSpec;
impl crate::RegisterSpec for L2Dbus2AcsHitCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_dbus2_acs_hit_cnt::R`](R) reader structure"]
impl crate::Readable for L2Dbus2AcsHitCntSpec {}
#[doc = "`reset()` method sets L2_DBUS2_ACS_HIT_CNT to value 0"]
impl crate::Resettable for L2Dbus2AcsHitCntSpec {}

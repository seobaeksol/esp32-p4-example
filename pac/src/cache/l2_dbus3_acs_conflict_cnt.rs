...
pub type R = crate::R<L2Dbus3AcsConflictCntSpec>;
...
pub type L2Dbus3ConflictCntR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_dbus3_conflict_cnt(&self) -> L2Dbus3ConflictCntR {
        L2Dbus3ConflictCntR::new(self.bits)
    }
}
...
pub struct L2Dbus3AcsConflictCntSpec;
impl crate::RegisterSpec for L2Dbus3AcsConflictCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_dbus3_acs_conflict_cnt::R`](R) reader structure"]
impl crate::Readable for L2Dbus3AcsConflictCntSpec {}
#[doc = "`reset()` method sets L2_DBUS3_ACS_CONFLICT_CNT to value 0"]
impl crate::Resettable for L2Dbus3AcsConflictCntSpec {}

...
pub type R = crate::R<RedundancySig1Spec>;
#[doc = "Register `REDUNDANCY_SIG1` writer"]
pub type W = crate::W<RedundancySig1Spec>;
#[doc = "Field `REDCY_SIG1` reader - Those bits are prepared for ECO."]
pub type RedcySig1R = crate::FieldReader<u32>;
#[doc = "Field `REDCY_SIG1` writer - Those bits are prepared for ECO."]
pub type RedcySig1W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Those bits are prepared for ECO."]
    #[inline(always)]
    pub fn redcy_sig1(&self) -> RedcySig1R {
        RedcySig1R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Those bits are prepared for ECO."]
    #[inline(always)]
    pub fn redcy_sig1(&mut self) -> RedcySig1W<'_, RedundancySig1Spec> {
        RedcySig1W::new(self, 0)
    }
}
...
pub struct RedundancySig1Spec;
impl crate::RegisterSpec for RedundancySig1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`redundancy_sig1::R`](R) reader structure"]
impl crate::Readable for RedundancySig1Spec {}
#[doc = "`write(|w| ..)` method takes [`redundancy_sig1::W`](W) writer structure"]
impl crate::Writable for RedundancySig1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets REDUNDANCY_SIG1 to value 0"]
impl crate::Resettable for RedundancySig1Spec {}

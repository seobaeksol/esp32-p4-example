...
pub struct L1Ibus0AcsHitCntSpec;
impl crate::RegisterSpec for L1Ibus0AcsHitCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_ibus0_acs_hit_cnt::R`](R) reader structure"]
impl crate::Readable for L1Ibus0AcsHitCntSpec {}
#[doc = "`reset()` method sets L1_IBUS0_ACS_HIT_CNT to value 0"]
impl crate::Resettable for L1Ibus0AcsHitCntSpec {}

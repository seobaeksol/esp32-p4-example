...
pub type R = crate::R<L1CacheDebugBusSpec>;
#[doc = "Register `L1_CACHE_DEBUG_BUS` writer"]
pub type W = crate::W<L1CacheDebugBusSpec>;
...
pub type L1CacheDebugBusR = crate::FieldReader<u32>;
...
pub type L1CacheDebugBusW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l1_cache_debug_bus(&self) -> L1CacheDebugBusR {
        L1CacheDebugBusR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - This is a constant place where we can write data to or read data from the tag/data memory on the specified cache."]
    #[inline(always)]
    pub fn l1_cache_debug_bus(&mut self) -> L1CacheDebugBusW<'_, L1CacheDebugBusSpec> {
        L1CacheDebugBusW::new(self, 0)
    }
}
...
pub struct L1CacheDebugBusSpec;
impl crate::RegisterSpec for L1CacheDebugBusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_cache_debug_bus::R`](R) reader structure"]
impl crate::Readable for L1CacheDebugBusSpec {}
#[doc = "`write(|w| ..)` method takes [`l1_cache_debug_bus::W`](W) writer structure"]
impl crate::Writable for L1CacheDebugBusSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L1_CACHE_DEBUG_BUS to value 0x0268"]
impl crate::Resettable for L1CacheDebugBusSpec {

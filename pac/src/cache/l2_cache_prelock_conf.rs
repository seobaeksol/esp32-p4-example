...
impl W {
    ...
    pub fn l2_cache_prelock_sct0_en(
        &mut self,
    ) -> L2CachePrelockSct0EnW<'_, L2CachePrelockConfSpec> {
        L2CachePrelockSct0EnW::new(self, 0)
    }
    #[doc = "Bit 1 - The bit is used to enable the second section of prelock function on L2-Cache."]
    #[inline(always)]
    pub fn l2_cache_prelock_sct1_en(
        &mut self,
    ) -> L2CachePrelockSct1EnW<'_, L2CachePrelockConfSpec> {
        L2CachePrelockSct1EnW::new(self, 1)
    }
    #[doc = "Bits 2:5 - The bit is used to set the gid of l2 cache prelock."]
    #[inline(always)]
    pub fn l2_cache_prelock_rgid(&mut self) -> L2CachePrelockRgidW<'_, L2CachePrelockConfSpec> {
        L2CachePrelockRgidW::new(self, 2)
    }
}
...
pub struct L2CachePrelockConfSpec;
impl crate::RegisterSpec for L2CachePrelockConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_prelock_conf::R`](R) reader structure"]
impl crate::Readable for L2CachePrelockConfSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_cache_prelock_conf::W`](W) writer structure"]
impl crate::Writable for L2CachePrelockConfSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_CACHE_PRELOCK_CONF to value 0"]
impl crate::Resettable for L2CachePrelockConfSpec {}

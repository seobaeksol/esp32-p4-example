...
pub struct L1Ibus3AcsConflictCntSpec;
impl crate::RegisterSpec for L1Ibus3AcsConflictCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_ibus3_acs_conflict_cnt::R`](R) reader structure"]
impl crate::Readable for L1Ibus3AcsConflictCntSpec {}
#[doc = "`reset()` method sets L1_IBUS3_ACS_CONFLICT_CNT to value 0"]
impl crate::Resettable for L1Ibus3AcsConflictCntSpec {}

...
pub type R = crate::R<L2CacheBlocksizeConfSpec>;
#[doc = "Register `L2_CACHE_BLOCKSIZE_CONF` writer"]
pub type W = crate::W<L2CacheBlocksizeConfSpec>;
...
pub type L2CacheBlocksize8R = crate::BitReader;
...
pub type L2CacheBlocksize16R = crate::BitReader;
...
pub type L2CacheBlocksize32R = crate::BitReader;
...
pub type L2CacheBlocksize64R = crate::BitReader;
...
pub type L2CacheBlocksize64W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L2CacheBlocksize128R = crate::BitReader;
...
pub type L2CacheBlocksize128W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L2CacheBlocksize256R = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn l2_cache_blocksize_8(&self) -> L2CacheBlocksize8R {
        L2CacheBlocksize8R::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l2_cache_blocksize_16(&self) -> L2CacheBlocksize16R {
        L2CacheBlocksize16R::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l2_cache_blocksize_32(&self) -> L2CacheBlocksize32R {
        L2CacheBlocksize32R::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l2_cache_blocksize_64(&self) -> L2CacheBlocksize64R {
        L2CacheBlocksize64R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l2_cache_blocksize_128(&self) -> L2CacheBlocksize128R {
        L2CacheBlocksize128R::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l2_cache_blocksize_256(&self) -> L2CacheBlocksize256R {
        L2CacheBlocksize256R::new(((self.bits >> 5) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 3 - The field is used to configureblocksize of L2-Cache as 64 bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l2_cache_blocksize_64(&mut self) -> L2CacheBlocksize64W<'_, L2CacheBlocksizeConfSpec> {
        L2CacheBlocksize64W::new(self, 3)
    }
    #[doc = "Bit 4 - The field is used to configureblocksize of L2-Cache as 128 bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l2_cache_blocksize_128(&mut self) -> L2CacheBlocksize128W<'_, L2CacheBlocksizeConfSpec> {
        L2CacheBlocksize128W::new(self, 4)
    }
}
...
pub struct L2CacheBlocksizeConfSpec;
impl crate::RegisterSpec for L2CacheBlocksizeConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_cache_blocksize_conf::R`](R) reader structure"]
impl crate::Readable for L2CacheBlocksizeConfSpec {}
#[doc = "`write(|w| ..)` method takes [`l2_cache_blocksize_conf::W`](W) writer structure"]
impl crate::Writable for L2CacheBlocksizeConfSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets L2_CACHE_BLOCKSIZE_CONF to value 0x08"]
impl crate::Resettable for L2CacheBlocksizeConfSpec {

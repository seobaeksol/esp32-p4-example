...
pub type R = crate::R<L2Dbus1AcsMissCntSpec>;
...
pub type L2Dbus1MissCntR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn l2_dbus1_miss_cnt(&self) -> L2Dbus1MissCntR {
        L2Dbus1MissCntR::new(self.bits)
    }
}
...
pub struct L2Dbus1AcsMissCntSpec;
impl crate::RegisterSpec for L2Dbus1AcsMissCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l2_dbus1_acs_miss_cnt::R`](R) reader structure"]
impl crate::Readable for L2Dbus1AcsMissCntSpec {}
#[doc = "`reset()` method sets L2_DBUS1_ACS_MISS_CNT to value 0"]
impl crate::Resettable for L2Dbus1AcsMissCntSpec {}

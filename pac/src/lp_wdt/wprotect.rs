...
pub type R = crate::R<WprotectSpec>;
#[doc = "Register `WPROTECT` writer"]
pub type W = crate::W<WprotectSpec>;
...
impl W {
    #[doc = "Bits 0:31 - need_des"]
    #[inline(always)]
    pub fn wdt_wkey(&mut self) -> WdtWkeyW<'_, WprotectSpec> {
        WdtWkeyW::new(self, 0)
    }
}
...
pub struct WprotectSpec;
impl crate::RegisterSpec for WprotectSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wprotect::R`](R) reader structure"]
impl crate::Readable for WprotectSpec {}
#[doc = "`write(|w| ..)` method takes [`wprotect::W`](W) writer structure"]
impl crate::Writable for WprotectSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WPROTECT to value 0"]
impl crate::Resettable for WprotectSpec {}

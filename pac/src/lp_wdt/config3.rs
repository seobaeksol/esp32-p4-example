...
pub type WdtStg2HoldR = crate::FieldReader<u32>;
#[doc = "Field `WDT_STG2_HOLD` writer - need_des"]
pub type WdtStg2HoldW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - need_des"]
    #[inline(always)]
    pub fn wdt_stg2_hold(&self) -> WdtStg2HoldR {
        WdtStg2HoldR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - need_des"]
    #[inline(always)]
    pub fn wdt_stg2_hold(&mut self) -> WdtStg2HoldW<'_, Config3Spec> {
        WdtStg2HoldW::new(self, 0)
    }
}

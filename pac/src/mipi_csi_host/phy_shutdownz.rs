...
pub type R = crate::R<PhyShutdownzSpec>;
#[doc = "Register `PHY_SHUTDOWNZ` writer"]
pub type W = crate::W<PhyShutdownzSpec>;
...
impl W {
    #[doc = "Bit 0 - NA"]
    #[inline(always)]
    pub fn phy_shutdownz(&mut self) -> PhyShutdownzW<'_, PhyShutdownzSpec> {
...
pub struct PhyShutdownzSpec;
impl crate::RegisterSpec for PhyShutdownzSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`phy_shutdownz::R`](R) reader structure"]
impl crate::Readable for PhyShutdownzSpec {}
#[doc = "`write(|w| ..)` method takes [`phy_shutdownz::W`](W) writer structure"]
impl crate::Writable for PhyShutdownzSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PHY_SHUTDOWNZ to value 0"]
impl crate::Resettable for PhyShutdownzSpec {}

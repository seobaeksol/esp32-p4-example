...
pub type RegGpioOutDataW1tsW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl W {
    #[doc = "Bits 0:15 - Reserved"]
    #[inline(always)]
    pub fn reg_gpio_out_data_w1ts(&mut self) -> RegGpioOutDataW1tsW<'_, OutW1tsSpec> {
        RegGpioOutDataW1tsW::new(self, 0)
    }
}

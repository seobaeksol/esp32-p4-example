...
pub type RegGpioEnableDataW1tcW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl W {
    #[doc = "Bits 0:15 - Reserved"]
    #[inline(always)]
    pub fn reg_gpio_enable_data_w1tc(&mut self) -> RegGpioEnableDataW1tcW<'_, EnableW1tcSpec> {
        RegGpioEnableDataW1tcW::new(self, 0)
    }
}

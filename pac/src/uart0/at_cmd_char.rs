...
pub type R = crate::R<AtCmdCharSpec>;
#[doc = "Register `AT_CMD_CHAR` writer"]
pub type W = crate::W<AtCmdCharSpec>;
...
impl W {
    #[doc = "Bits 0:7 - This register is used to configure the content of at_cmd char."]
    #[inline(always)]
    pub fn at_cmd_char(&mut self) -> AtCmdCharW<'_, AtCmdCharSpec> {
        AtCmdCharW::new(self, 0)
    }
    #[doc = "Bits 8:15 - This register is used to configure the num of continuous at_cmd chars received by receiver."]
    #[inline(always)]
    pub fn char_num(&mut self) -> CharNumW<'_, AtCmdCharSpec> {
        CharNumW::new(self, 8)
    }
}
...
pub struct AtCmdCharSpec;
impl crate::RegisterSpec for AtCmdCharSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`at_cmd_char::R`](R) reader structure"]
impl crate::Readable for AtCmdCharSpec {}
#[doc = "`write(|w| ..)` method takes [`at_cmd_char::W`](W) writer structure"]
impl crate::Writable for AtCmdCharSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AT_CMD_CHAR to value 0x032b"]
impl crate::Resettable for AtCmdCharSpec {

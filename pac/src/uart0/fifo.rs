...
pub type RxfifoRdByteR = crate::FieldReader;
#[doc = "Field `RXFIFO_RD_BYTE` writer - UART 0 accesses FIFO via this register."]
pub type RxfifoRdByteW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - UART 0 accesses FIFO via this register."]
    #[inline(always)]
    pub fn rxfifo_rd_byte(&self) -> RxfifoRdByteR {
        RxfifoRdByteR::new((self.bits & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7 - UART 0 accesses FIFO via this register."]
    #[inline(always)]
    pub fn rxfifo_rd_byte(&mut self) -> RxfifoRdByteW<'_, FifoSpec> {
        RxfifoRdByteW::new(self, 0)
    }
}

...
pub type R = crate::R<AtCmdPrecntSpec>;
#[doc = "Register `AT_CMD_PRECNT` writer"]
pub type W = crate::W<AtCmdPrecntSpec>;
...
impl W {
    #[doc = "Bits 0:15 - This register is used to configure the idle duration time before the first at_cmd is received by receiver."]
    #[inline(always)]
    pub fn pre_idle_num(&mut self) -> PreIdleNumW<'_, AtCmdPrecntSpec> {
...
pub struct AtCmdPrecntSpec;
impl crate::RegisterSpec for AtCmdPrecntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`at_cmd_precnt::R`](R) reader structure"]
impl crate::Readable for AtCmdPrecntSpec {}
#[doc = "`write(|w| ..)` method takes [`at_cmd_precnt::W`](W) writer structure"]
impl crate::Writable for AtCmdPrecntSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AT_CMD_PRECNT to value 0x0901"]
impl crate::Resettable for AtCmdPrecntSpec {

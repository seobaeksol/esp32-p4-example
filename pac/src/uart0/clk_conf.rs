...
pub type RstCoreR = crate::BitReader;
#[doc = "Field `RST_CORE` writer - Write 1 then write 0 to this bit, reset UART Tx/Rx."]
pub type RstCoreW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn rst_core(&self) -> RstCoreR {
        RstCoreR::new(((self.bits >> 23) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 23 - Write 1 then write 0 to this bit, reset UART Tx/Rx."]
    #[inline(always)]
    pub fn rst_core(&mut self) -> RstCoreW<'_, ClkConfSpec> {
        RstCoreW::new(self, 23)
    }
    #[doc = "Bit 24 - Set this bit to enable UART Tx clock."]
    #[inline(always)]

...
pub type RxfifoFullThrhdW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
pub type TxfifoEmptyThrhdW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
impl R {
    ...
    pub fn rxfifo_full_thrhd(&self) -> RxfifoFullThrhdR {
        RxfifoFullThrhdR::new((self.bits & 0xff) as u8)
    }
    ...
    pub fn txfifo_empty_thrhd(&self) -> TxfifoEmptyThrhdR {
        TxfifoEmptyThrhdR::new(((self.bits >> 8) & 0xff) as u8)
    }

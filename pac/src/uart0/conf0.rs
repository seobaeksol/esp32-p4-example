...
pub type IrdaWctlR = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn irda_dplx(&self) -> IrdaDplxR {
        IrdaDplxR::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - This is the start enable bit for IrDA transmitter."]
    #[inline(always)]
    pub fn irda_tx_en(&self) -> IrdaTxEnR {
        IrdaTxEnR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - 1'h1: The IrDA transmitter's 11th bit is the same as 10th bit. 1'h0: Set IrDA transmitter's 11th bit to 0."]
    #[inline(always)]
    pub fn irda_wctl(&self) -> IrdaWctlR {
        IrdaWctlR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - Set this bit to invert the level of IrDA transmitter."]
    #[inline(always)]
    pub fn irda_tx_inv(&self) -> IrdaTxInvR {
        IrdaTxInvR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - Set this bit to invert the level of IrDA receiver."]
    #[inline(always)]
    pub fn irda_rx_inv(&self) -> IrdaRxInvR {
        IrdaRxInvR::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn irda_en(&self) -> IrdaEnR {
        IrdaEnR::new(((self.bits >> 14) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn autobaud_en(&self) -> AutobaudEnR {
        AutobaudEnR::new(((self.bits >> 19) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - This register is used to configure the parity check mode."]
    #[inline(always)]
    pub fn parity(&mut self) -> ParityW<'_, Conf0Spec> {
        ParityW::new(self, 0)
    }
    #[doc = "Bit 1 - Set this bit to enable uart parity check."]
    #[inline(always)]
    pub fn parity_en(&mut self) -> ParityEnW<'_, Conf0Spec> {
        ParityEnW::new(self, 1)
    }
    #[doc = "Bits 2:3 - This register is used to set the length of data."]
    #[inline(always)]
    pub fn bit_num(&mut self) -> BitNumW<'_, Conf0Spec> {
        BitNumW::new(self, 2)
    }
    #[doc = "Bits 4:5 - This register is used to set the length of stop bit."]
    #[inline(always)]
    pub fn stop_bit_num(&mut self) -> StopBitNumW<'_, Conf0Spec> {
        StopBitNumW::new(self, 4)
    }
    #[doc = "Bit 6 - Set this bit to enbale transmitter to send NULL when the process of sending data is done."]
    #[inline(always)]
    pub fn txd_brk(&mut self) -> TxdBrkW<'_, Conf0Spec> {
        TxdBrkW::new(self, 6)
    }
    #[doc = "Bit 7 - Set this bit to enable IrDA loopback mode."]
    #[inline(always)]
    pub fn irda_dplx(&mut self) -> IrdaDplxW<'_, Conf0Spec> {
        IrdaDplxW::new(self, 7)
    }
    #[doc = "Bit 8 - This is the start enable bit for IrDA transmitter."]
    #[inline(always)]
    pub fn irda_tx_en(&mut self) -> IrdaTxEnW<'_, Conf0Spec> {
        IrdaTxEnW::new(self, 8)
    }
    #[doc = "Bit 9 - 1'h1: The IrDA transmitter's 11th bit is the same as 10th bit. 1'h0: Set IrDA transmitter's 11th bit to 0."]
    #[inline(always)]
    pub fn irda_wctl(&mut self) -> IrdaWctlW<'_, Conf0Spec> {
        IrdaWctlW::new(self, 9)
    }
    #[doc = "Bit 10 - Set this bit to invert the level of IrDA transmitter."]
    #[inline(always)]
    pub fn irda_tx_inv(&mut self) -> IrdaTxInvW<'_, Conf0Spec> {
        IrdaTxInvW::new(self, 10)
    }
    #[doc = "Bit 11 - Set this bit to invert the level of IrDA receiver."]
    #[inline(always)]
    pub fn irda_rx_inv(&mut self) -> IrdaRxInvW<'_, Conf0Spec> {
        IrdaRxInvW::new(self, 11)
    }
    #[doc = "Bit 12 - Set this bit to enable uart loopback test mode."]
    #[inline(always)]
    pub fn loopback(&mut self) -> LoopbackW<'_, Conf0Spec> {
        LoopbackW::new(self, 12)
    }
    #[doc = "Bit 13 - Set this bit to enable flow control function for transmitter."]
    #[inline(always)]
    pub fn tx_flow_en(&mut self) -> TxFlowEnW<'_, Conf0Spec> {
        TxFlowEnW::new(self, 13)
    }
    #[doc = "Bit 14 - Set this bit to enable IrDA protocol."]
    #[inline(always)]
    pub fn irda_en(&mut self) -> IrdaEnW<'_, Conf0Spec> {
        IrdaEnW::new(self, 14)
    }
    #[doc = "Bit 15 - Set this bit to inverse the level value of uart rxd signal."]
    #[inline(always)]
    pub fn rxd_inv(&mut self) -> RxdInvW<'_, Conf0Spec> {
        RxdInvW::new(self, 15)
    }
    #[doc = "Bit 16 - Set this bit to inverse the level value of uart txd signal."]
    #[inline(always)]
    pub fn txd_inv(&mut self) -> TxdInvW<'_, Conf0Spec> {
        TxdInvW::new(self, 16)
    }
    #[doc = "Bit 17 - Disable UART Rx data overflow detect."]
    #[inline(always)]
    pub fn dis_rx_dat_ovf(&mut self) -> DisRxDatOvfW<'_, Conf0Spec> {
        DisRxDatOvfW::new(self, 17)
    }
    #[doc = "Bit 18 - 1'h1: Receiver stops storing data into FIFO when data is wrong. 1'h0: Receiver stores the data even if the received data is wrong."]
    #[inline(always)]
    pub fn err_wr_mask(&mut self) -> ErrWrMaskW<'_, Conf0Spec> {
        ErrWrMaskW::new(self, 18)
    }
    #[doc = "Bit 19 - This is the enable bit for detecting baudrate."]
    #[inline(always)]
    pub fn autobaud_en(&mut self) -> AutobaudEnW<'_, Conf0Spec> {
        AutobaudEnW::new(self, 19)
    }
    #[doc = "Bit 20 - UART memory clock gate enable signal."]
    #[inline(always)]
    pub fn mem_clk_en(&mut self) -> MemClkEnW<'_, Conf0Spec> {
        MemClkEnW::new(self, 20)
    }
    #[doc = "Bit 21 - This register is used to configure the software rts signal which is used in software flow control."]
    #[inline(always)]
    pub fn sw_rts(&mut self) -> SwRtsW<'_, Conf0Spec> {
        SwRtsW::new(self, 21)
    }
    #[doc = "Bit 22 - Set this bit to reset the uart receive-FIFO."]
    #[inline(always)]
    pub fn rxfifo_rst(&mut self) -> RxfifoRstW<'_, Conf0Spec> {
        RxfifoRstW::new(self, 22)
    }
    #[doc = "Bit 23 - Set this bit to reset the uart transmit-FIFO."]
    #[inline(always)]
    pub fn txfifo_rst(&mut self) -> TxfifoRstW<'_, Conf0Spec> {

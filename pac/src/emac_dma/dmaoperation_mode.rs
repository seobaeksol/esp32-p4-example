...
pub type R = crate::R<DmaoperationModeSpec>;
#[doc = "Register `DMAOPERATION_MODE` writer"]
pub type W = crate::W<DmaoperationModeSpec>;
...
pub type StartStopRxR = crate::BitReader;
...
pub type StartStopRxW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OptSecondFrameR = crate::BitReader;
...
pub type OptSecondFrameW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RxThreshCtrlR = crate::FieldReader;
...
pub type RxThreshCtrlW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type DropGfrmR = crate::BitReader;
...
pub type DropGfrmW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FwdUnderGfR = crate::BitReader;
...
pub type FwdUnderGfW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FwdErrFrameR = crate::BitReader;
...
pub type FwdErrFrameW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type StartStopTransmissionCommandR = crate::BitReader;
#[doc = "Field `START_STOP_TRANSMISSION_COMMAND` writer - When this bit is set transmission is placed in the Running state and the DMA checks the Transmit List at the current position for a frame to be transmitted.When this bit is reset the transmission process is placed in the Stopped state after completing the transmission of the current frame."]
pub type StartStopTransmissionCommandW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TxThreshCtrlR = crate::FieldReader;
...
pub type TxThreshCtrlW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type FlushTxFifoR = crate::BitReader;
...
pub type FlushTxFifoW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TxStrFwdR = crate::BitReader;
...
pub type TxStrFwdW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DisFlushRecvFramesR = crate::BitReader;
...
pub type DisFlushRecvFramesW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RxStoreForwardR = crate::BitReader;
...
pub type RxStoreForwardW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DisDropTcpipErrFramR = crate::BitReader;
...
pub type DisDropTcpipErrFramW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn start_stop_rx(&self) -> StartStopRxR {
        StartStopRxR::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn opt_second_frame(&self) -> OptSecondFrameR {
        OptSecondFrameR::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn rx_thresh_ctrl(&self) -> RxThreshCtrlR {
        RxThreshCtrlR::new(((self.bits >> 3) & 3) as u8)
    }
    ...
    #[inline(always)]
    pub fn drop_gfrm(&self) -> DropGfrmR {
        DropGfrmR::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn fwd_under_gf(&self) -> FwdUnderGfR {
        FwdUnderGfR::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn fwd_err_frame(&self) -> FwdErrFrameR {
        FwdErrFrameR::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn start_stop_transmission_command(&self) -> StartStopTransmissionCommandR {
        StartStopTransmissionCommandR::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bits 14:16 - These bits control the threshold level of the MTL Transmit FIFO. Transmission starts when the frame size within the MTL Transmit FIFO is larger than the threshold. In addition full frames with a length less than the threshold are also transmitted. These bits are used only when Tx_Str_fwd is reset. 3'b000: 64 3'b001: 128 3'b010: 192 3'b011: 256 3'b100: 40 3'b101: 32 3'b110: 24 3'b111: 16 ."]
    #[inline(always)]
    pub fn tx_thresh_ctrl(&self) -> TxThreshCtrlR {
        TxThreshCtrlR::new(((self.bits >> 14) & 7) as u8)
    }
    ...
    #[inline(always)]
    pub fn flush_tx_fifo(&self) -> FlushTxFifoR {
        FlushTxFifoR::new(((self.bits >> 20) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn tx_str_fwd(&self) -> TxStrFwdR {
        TxStrFwdR::new(((self.bits >> 21) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn dis_flush_recv_frames(&self) -> DisFlushRecvFramesR {
        DisFlushRecvFramesR::new(((self.bits >> 24) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn rx_store_forward(&self) -> RxStoreForwardR {
        RxStoreForwardR::new(((self.bits >> 25) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn dis_drop_tcpip_err_fram(&self) -> DisDropTcpipErrFramR {
        DisDropTcpipErrFramR::new(((self.bits >> 26) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 1 - When this bit is set the Receive process is placed in the Running state. The DMA attempts to acquire the descriptor from the Receive list and processes the incoming frames.When this bit is cleared the Rx DMA operation is stopped after the transfer of the current frame."]
    #[inline(always)]
    pub fn start_stop_rx(&mut self) -> StartStopRxW<'_, DmaoperationModeSpec> {
        StartStopRxW::new(self, 1)
    }
    #[doc = "Bit 2 - When this bit is set it instructs the DMA to process the second frame of the Transmit data even before the status for the first frame is obtained."]
    #[inline(always)]
    pub fn opt_second_frame(&mut self) -> OptSecondFrameW<'_, DmaoperationModeSpec> {
        OptSecondFrameW::new(self, 2)
    }
    #[doc = "Bits 3:4 - These two bits control the threshold level of the MTL Receive FIFO. Transfer (request) to DMA starts when the frame size within the MTL Receive FIFO is larger than the threshold. 2'b00: 64， 2'b01: 32， 2'b10: 96， 2'b11: 128 ."]
    #[inline(always)]
    pub fn rx_thresh_ctrl(&mut self) -> RxThreshCtrlW<'_, DmaoperationModeSpec> {
        RxThreshCtrlW::new(self, 3)
    }
    #[doc = "Bit 5 - When set the MAC drops the received giant frames in the Rx FIFO that is frames that are larger than the computed giant frame limit."]
    #[inline(always)]
    pub fn drop_gfrm(&mut self) -> DropGfrmW<'_, DmaoperationModeSpec> {
        DropGfrmW::new(self, 5)
    }
    #[doc = "Bit 6 - When set the Rx FIFO forwards Undersized frames (that is frames with no Error and length less than 64 bytes) including pad-bytes and CRC."]
    #[inline(always)]
    pub fn fwd_under_gf(&mut self) -> FwdUnderGfW<'_, DmaoperationModeSpec> {
        FwdUnderGfW::new(self, 6)
    }
    #[doc = "Bit 7 - When this bit is reset the Rx FIFO drops frames with error status (CRC error collision error giant frame watchdog timeout or overflow)."]
    #[inline(always)]
    pub fn fwd_err_frame(&mut self) -> FwdErrFrameW<'_, DmaoperationModeSpec> {
        FwdErrFrameW::new(self, 7)
    }
    #[doc = "Bit 13 - When this bit is set transmission is placed in the Running state and the DMA checks the Transmit List at the current position for a frame to be transmitted.When this bit is reset the transmission process is placed in the Stopped state after completing the transmission of the current frame."]
    #[inline(always)]
    pub fn start_stop_transmission_command(
        &mut self,
    ) -> StartStopTransmissionCommandW<'_, DmaoperationModeSpec> {
        StartStopTransmissionCommandW::new(self, 13)
    }
    #[doc = "Bits 14:16 - These bits control the threshold level of the MTL Transmit FIFO. Transmission starts when the frame size within the MTL Transmit FIFO is larger than the threshold. In addition full frames with a length less than the threshold are also transmitted. These bits are used only when Tx_Str_fwd is reset. 3'b000: 64 3'b001: 128 3'b010: 192 3'b011: 256 3'b100: 40 3'b101: 32 3'b110: 24 3'b111: 16 ."]
    #[inline(always)]
    pub fn tx_thresh_ctrl(&mut self) -> TxThreshCtrlW<'_, DmaoperationModeSpec> {
        TxThreshCtrlW::new(self, 14)
    }
    #[doc = "Bit 20 - When this bit is set the transmit FIFO controller logic is reset to its default values and thus all data in the Tx FIFO is lost or flushed. This bit is cleared internally when the flushing operation is complete."]
    #[inline(always)]
    pub fn flush_tx_fifo(&mut self) -> FlushTxFifoW<'_, DmaoperationModeSpec> {
        FlushTxFifoW::new(self, 20)
    }
    #[doc = "Bit 21 - When this bit is set transmission starts when a full frame resides in the MTL Transmit FIFO. When this bit is set the Tx_Thresh_Ctrl values specified in Tx_Thresh_Ctrl are ignored."]
    #[inline(always)]
    pub fn tx_str_fwd(&mut self) -> TxStrFwdW<'_, DmaoperationModeSpec> {
        TxStrFwdW::new(self, 21)
    }
    #[doc = "Bit 24 - When this bit is set the Rx DMA does not flush any frames because of the unavailability of receive descriptors or buffers."]
    #[inline(always)]
    pub fn dis_flush_recv_frames(&mut self) -> DisFlushRecvFramesW<'_, DmaoperationModeSpec> {
        DisFlushRecvFramesW::new(self, 24)
    }
    #[doc = "Bit 25 - When this bit is set the MTL reads a frame from the Rx FIFO only after the complete frame has been written to it."]
    #[inline(always)]
    pub fn rx_store_forward(&mut self) -> RxStoreForwardW<'_, DmaoperationModeSpec> {
        RxStoreForwardW::new(self, 25)
    }
    #[doc = "Bit 26 - When this bit is set the MAC does not drop the frames which only have errors detected by the Receive Checksum engine.When this bit is reset all error frames are dropped if the Fwd_Err_Frame bit is reset."]
    #[inline(always)]
    pub fn dis_drop_tcpip_err_fram(&mut self) -> DisDropTcpipErrFramW<'_, DmaoperationModeSpec> {
        DisDropTcpipErrFramW::new(self, 26)
    }
}
...
pub struct DmaoperationModeSpec;
impl crate::RegisterSpec for DmaoperationModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dmaoperation_mode::R`](R) reader structure"]
impl crate::Readable for DmaoperationModeSpec {}
#[doc = "`write(|w| ..)` method takes [`dmaoperation_mode::W`](W) writer structure"]
impl crate::Writable for DmaoperationModeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DMAOPERATION_MODE to value 0"]
impl crate::Resettable for DmaoperationModeSpec {}

...
pub type R = crate::R<DmatxcurrdescSpec>;
...
pub struct DmatxcurrdescSpec;
impl crate::RegisterSpec for DmatxcurrdescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dmatxcurrdesc::R`](R) reader structure"]
impl crate::Readable for DmatxcurrdescSpec {}
#[doc = "`reset()` method sets DMATXCURRDESC to value 0"]
impl crate::Resettable for DmatxcurrdescSpec {}

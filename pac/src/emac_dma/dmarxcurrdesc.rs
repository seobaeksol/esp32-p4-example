...
pub type R = crate::R<DmarxcurrdescSpec>;
...
pub struct DmarxcurrdescSpec;
impl crate::RegisterSpec for DmarxcurrdescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dmarxcurrdesc::R`](R) reader structure"]
impl crate::Readable for DmarxcurrdescSpec {}
#[doc = "`reset()` method sets DMARXCURRDESC to value 0"]
impl crate::Resettable for DmarxcurrdescSpec {}

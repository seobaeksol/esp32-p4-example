...
pub type R = crate::R<PseudoSpec>;
#[doc = "Register `PSEUDO` writer"]
pub type W = crate::W<PseudoSpec>;
...
impl R {
    ...
    pub fn base(&self) -> BaseR {
        BaseR::new(((self.bits >> 1) & 0x0f) as u8)
    }
    #[doc = "Bits 5:6 - Those bits decides the increment number of pseudo round number"]
    #[inline(always)]
    pub fn inc(&self) -> IncR {
        IncR::new(((self.bits >> 5) & 3) as u8)
    }
    #[doc = "Bits 7:9 - Those bits decides the update frequency of the pseudo-key."]
    #[inline(always)]
    pub fn rng_cnt(&self) -> RngCntR {
        RngCntR::new(((self.bits >> 7) & 7) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - This bit decides whether the pseudo round function is enable or not."]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, PseudoSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bits 1:4 - Those bits decides the basic number of pseudo round number."]
    #[inline(always)]
    pub fn base(&mut self) -> BaseW<'_, PseudoSpec> {
        BaseW::new(self, 1)
    }
    #[doc = "Bits 5:6 - Those bits decides the increment number of pseudo round number"]
    #[inline(always)]
    pub fn inc(&mut self) -> IncW<'_, PseudoSpec> {
        IncW::new(self, 5)
    }
    #[doc = "Bits 7:9 - Those bits decides the update frequency of the pseudo-key."]
    #[inline(always)]
    pub fn rng_cnt(&mut self) -> RngCntW<'_, PseudoSpec> {
        RngCntW::new(self, 7)
    }
}

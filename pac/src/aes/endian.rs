...
pub type EndianR = crate::FieldReader;
...
pub type EndianW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ...
    pub fn endian(&self) -> EndianR {
        EndianR::new((self.bits & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5 - endian. \\[1:0\\] key endian, \\[3:2\\] text_in endian or in_stream endian, \\[5:4\\] text_out endian or out_stream endian"]
    #[inline(always)]
    pub fn endian(&mut self) -> EndianW<'_, EndianSpec> {
        EndianW::new(self, 0)
    }
}

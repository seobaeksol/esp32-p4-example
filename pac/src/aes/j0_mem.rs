...
pub type R = crate::R<J0MemSpec>;
#[doc = "Register `J0_MEM[%s]` writer"]
pub type W = crate::W<J0MemSpec>;
...
pub struct J0MemSpec;
impl crate::RegisterSpec for J0MemSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`j0_mem::R`](R) reader structure"]
impl crate::Readable for J0MemSpec {}
#[doc = "`write(|w| ..)` method takes [`j0_mem::W`](W) writer structure"]
impl crate::Writable for J0MemSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets J0_MEM[%s] to value 0"]
impl crate::Resettable for J0MemSpec {}

...
pub type R = crate::R<T0MemSpec>;
#[doc = "Register `T0_MEM[%s]` writer"]
pub type W = crate::W<T0MemSpec>;
...
pub struct T0MemSpec;
impl crate::RegisterSpec for T0MemSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`t0_mem::R`](R) reader structure"]
impl crate::Readable for T0MemSpec {}
#[doc = "`write(|w| ..)` method takes [`t0_mem::W`](W) writer structure"]
impl crate::Writable for T0MemSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets T0_MEM[%s] to value 0"]
impl crate::Resettable for T0MemSpec {}

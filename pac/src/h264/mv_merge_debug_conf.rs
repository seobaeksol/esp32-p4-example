...
impl W {
    ...
    pub fn dbg_replace_mv_merge_data_en(
        &mut self,
    ) -> DbgReplaceMvMergeDataEnW<'_, MvMergeDebugConfSpec> {
        DbgReplaceMvMergeDataEnW::new(self, 0)
    }
    #[doc = "Bits 1:8 - Configures mv merge data to be replaced."]
    #[inline(always)]
    pub fn dbg_replace_mv_merge_data(
        &mut self,
    ) -> DbgReplaceMvMergeDataW<'_, MvMergeDebugConfSpec> {
        DbgReplaceMvMergeDataW::new(self, 1)
    }
}
...
pub struct MvMergeDebugConfSpec;
impl crate::RegisterSpec for MvMergeDebugConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mv_merge_debug_conf::R`](R) reader structure"]
impl crate::Readable for MvMergeDebugConfSpec {}
#[doc = "`write(|w| ..)` method takes [`mv_merge_debug_conf::W`](W) writer structure"]
impl crate::Writable for MvMergeDebugConfSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MV_MERGE_DEBUG_CONF to value 0"]
impl crate::Resettable for MvMergeDebugConfSpec {}

...
pub type R = crate::R<ANoRoiRegionQpOffsetSpec>;
#[doc = "Register `A_NO_ROI_REGION_QP_OFFSET` writer"]
pub type W = crate::W<ANoRoiRegionQpOffsetSpec>;
#[doc = "Field `A_NO_ROI_REGION_QP` reader - Configure H264 no region qp in video A, delta qp."]
pub type ANoRoiRegionQpR = crate::FieldReader;
#[doc = "Field `A_NO_ROI_REGION_QP` writer - Configure H264 no region qp in video A, delta qp."]
pub type ANoRoiRegionQpW<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    #[doc = "Bits 0:6 - Configure H264 no region qp in video A, delta qp."]
    #[inline(always)]
    pub fn a_no_roi_region_qp(&self) -> ANoRoiRegionQpR {
        ANoRoiRegionQpR::new((self.bits & 0x7f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:6 - Configure H264 no region qp in video A, delta qp."]
    #[inline(always)]
    pub fn a_no_roi_region_qp(&mut self) -> ANoRoiRegionQpW<'_, ANoRoiRegionQpOffsetSpec> {
        ANoRoiRegionQpW::new(self, 0)
    }
}
...
pub struct ANoRoiRegionQpOffsetSpec;
impl crate::RegisterSpec for ANoRoiRegionQpOffsetSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`a_no_roi_region_qp_offset::R`](R) reader structure"]
impl crate::Readable for ANoRoiRegionQpOffsetSpec {}
#[doc = "`write(|w| ..)` method takes [`a_no_roi_region_qp_offset::W`](W) writer structure"]
impl crate::Writable for ANoRoiRegionQpOffsetSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets A_NO_ROI_REGION_QP_OFFSET to value 0"]
impl crate::Resettable for ANoRoiRegionQpOffsetSpec {}

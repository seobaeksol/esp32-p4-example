...
pub type R = crate::R<BDbBypassSpec>;
#[doc = "Register `B_DB_BYPASS` writer"]
pub type W = crate::W<BDbBypassSpec>;
...
pub type BBypassDbFilterR = crate::BitReader;
...
pub type BBypassDbFilterW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn b_bypass_db_filter(&self) -> BBypassDbFilterR {
        BBypassDbFilterR::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Configures whether or not to bypass video B deblcoking filter. \\\\0: Open the deblock filter\\\\1: Close the deblock filter"]
    #[inline(always)]
    pub fn b_bypass_db_filter(&mut self) -> BBypassDbFilterW<'_, BDbBypassSpec> {
        BBypassDbFilterW::new(self, 0)
    }
}
...
pub struct BDbBypassSpec;
impl crate::RegisterSpec for BDbBypassSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`b_db_bypass::R`](R) reader structure"]
impl crate::Readable for BDbBypassSpec {}
#[doc = "`write(|w| ..)` method takes [`b_db_bypass::W`](W) writer structure"]
impl crate::Writable for BDbBypassSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets B_DB_BYPASS to value 0"]
impl crate::Resettable for BDbBypassSpec {}

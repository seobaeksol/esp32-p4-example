...
pub type R = crate::R<ASysConfSpec>;
#[doc = "Register `A_SYS_CONF` writer"]
pub type W = crate::W<ASysConfSpec>;
...
pub type ADbTmpReadyTriggerMbNumR = crate::FieldReader;
...
pub type ADbTmpReadyTriggerMbNumW<'a, REG> = crate::FieldWriter<'a, REG, 7>;
...
pub type ARecReadyTriggerMbLinesR = crate::FieldReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn a_db_tmp_ready_trigger_mb_num(&self) -> ADbTmpReadyTriggerMbNumR {
        ADbTmpReadyTriggerMbNumR::new((self.bits & 0x7f) as u8)
    }
    ...
    #[inline(always)]
    pub fn a_rec_ready_trigger_mb_lines(&self) -> ARecReadyTriggerMbLinesR {
        ARecReadyTriggerMbLinesR::new(((self.bits >> 7) & 0x7f) as u8)
    }
    #[doc = "Bits 14:29 - Configures video A intra cost offset when I MB compared with P MB."]
    #[inline(always)]
    pub fn a_intra_cost_cmp_offset(&self) -> AIntraCostCmpOffsetR {
        AIntraCostCmpOffsetR::new(((self.bits >> 14) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:6 - Configures when to trigger video A H264_DB_TMP_READY_INT. When the (MB number of written db temp+1) is greater than this filed in first MB line, trigger H264_DB_TMP_READY_INT. Min is 3."]
    #[inline(always)]
    pub fn a_db_tmp_ready_trigger_mb_num(&mut self) -> ADbTmpReadyTriggerMbNumW<'_, ASysConfSpec> {
        ADbTmpReadyTriggerMbNumW::new(self, 0)
    }
    #[doc = "Bits 7:13 - Configures when to trigger video A H264_REC_READY_INT. When the MB line number of generated reconstruct pixel is greater than this filed, trigger H264_REC_READY_INT. Min is 4."]
    #[inline(always)]
    pub fn a_rec_ready_trigger_mb_lines(&mut self) -> ARecReadyTriggerMbLinesW<'_, ASysConfSpec> {
        ARecReadyTriggerMbLinesW::new(self, 7)
    }
    #[doc = "Bits 14:29 - Configures video A intra cost offset when I MB compared with P MB."]
    #[inline(always)]
    pub fn a_intra_cost_cmp_offset(&mut self) -> AIntraCostCmpOffsetW<'_, ASysConfSpec> {
        AIntraCostCmpOffsetW::new(self, 14)
    }
}
...
pub struct ASysConfSpec;
impl crate::RegisterSpec for ASysConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`a_sys_conf::R`](R) reader structure"]
impl crate::Readable for ASysConfSpec {}
#[doc = "`write(|w| ..)` method takes [`a_sys_conf::W`](W) writer structure"]
impl crate::Writable for ASysConfSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets A_SYS_CONF to value 0x0203"]
impl crate::Resettable for ASysConfSpec {

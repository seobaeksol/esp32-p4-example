...
pub type R = crate::R<DbWrDebugCongSpec>;
#[doc = "Register `DB_WR_DEBUG_CONG` writer"]
pub type W = crate::W<DbWrDebugCongSpec>;
...
pub type DbgReplaceWrDbDataEnR = crate::BitReader;
...
pub type DbgReplaceWrDbDataEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DBG_REPLACE_WR_DB_DATA` reader - Configure deblocking filter write data to be replaced.byte0~2 is VUY"]
pub type DbgReplaceWrDbDataR = crate::FieldReader<u32>;
#[doc = "Field `DBG_REPLACE_WR_DB_DATA` writer - Configure deblocking filter write data to be replaced.byte0~2 is VUY"]
pub type DbgReplaceWrDbDataW<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    #[doc = "Bit 0 - Configure deblocking fliter whether or not to replace write data.\\\\0: not replace\\\\1: replace"]
    #[inline(always)]
    pub fn dbg_replace_wr_db_data_en(&self) -> DbgReplaceWrDbDataEnR {
        DbgReplaceWrDbDataEnR::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 1:24 - Configure deblocking filter write data to be replaced.byte0~2 is VUY"]
    #[inline(always)]
    pub fn dbg_replace_wr_db_data(&self) -> DbgReplaceWrDbDataR {
        DbgReplaceWrDbDataR::new((self.bits >> 1) & 0x00ff_ffff)
    }
}
impl W {
    #[doc = "Bit 0 - Configure deblocking fliter whether or not to replace write data.\\\\0: not replace\\\\1: replace"]
    #[inline(always)]
    pub fn dbg_replace_wr_db_data_en(&mut self) -> DbgReplaceWrDbDataEnW<'_, DbWrDebugCongSpec> {
        DbgReplaceWrDbDataEnW::new(self, 0)
    }
    #[doc = "Bits 1:24 - Configure deblocking filter write data to be replaced.byte0~2 is VUY"]
    #[inline(always)]
    pub fn dbg_replace_wr_db_data(&mut self) -> DbgReplaceWrDbDataW<'_, DbWrDebugCongSpec> {
        DbgReplaceWrDbDataW::new(self, 1)
    }
}
...
pub struct DbWrDebugCongSpec;
impl crate::RegisterSpec for DbWrDebugCongSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`db_wr_debug_cong::R`](R) reader structure"]
impl crate::Readable for DbWrDebugCongSpec {}
#[doc = "`write(|w| ..)` method takes [`db_wr_debug_cong::W`](W) writer structure"]
impl crate::Writable for DbWrDebugCongSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DB_WR_DEBUG_CONG to value 0"]
impl crate::Resettable for DbWrDebugCongSpec {}

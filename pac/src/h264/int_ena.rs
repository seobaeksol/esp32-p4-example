...
impl W {
    #[doc = "Bit 0 - Enable bit: Write 1 to enable H264_DB_TMP_READY_INT."]
    #[inline(always)]
    pub fn db_tmp_ready(&mut self) -> DbTmpReadyW<'_, IntEnaSpec> {
        DbTmpReadyW::new(self, 0)
    }
    #[doc = "Bit 1 - Enable bit: Write 1 to enable H264_REC_READY_INT."]
    #[inline(always)]
    pub fn rec_ready(&mut self) -> RecReadyW<'_, IntEnaSpec> {
        RecReadyW::new(self, 1)
    }
    #[doc = "Bit 2 - Enable bit: Write 1 to enable H264_FRAME_DONE_INT."]
    #[inline(always)]
    pub fn frame_done(&mut self) -> FrameDoneW<'_, IntEnaSpec> {
        FrameDoneW::new(self, 2)
    }
    #[doc = "Bit 3 - Enable bit: Write 1 to enable H264_DMA_MOVE_2MB_LINE_DONE_INT."]
    #[inline(always)]
    pub fn dma_move_2mb_line_done(&mut self) -> DmaMove2mbLineDoneW<'_, IntEnaSpec> {
        DmaMove2mbLineDoneW::new(self, 3)
    }
    #[doc = "Bit 4 - Enable bit: Write 1 to enable H264_BS_BUFFER_OVERFLOW_INT."]
    #[inline(always)]
    pub fn bs_buffer_overflow(&mut self) -> BsBufferOverflowW<'_, IntEnaSpec> {

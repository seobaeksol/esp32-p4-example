...
pub type R = crate::R<ADbBypassSpec>;
#[doc = "Register `A_DB_BYPASS` writer"]
pub type W = crate::W<ADbBypassSpec>;
...
pub type ABypassDbFilterR = crate::BitReader;
...
pub type ABypassDbFilterW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn a_bypass_db_filter(&self) -> ABypassDbFilterR {
        ABypassDbFilterR::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Configures whether or not to bypass video A deblcoking filter. \\\\0: Open the deblock filter\\\\1: Close the deblock filter"]
    #[inline(always)]
    pub fn a_bypass_db_filter(&mut self) -> ABypassDbFilterW<'_, ADbBypassSpec> {
        ABypassDbFilterW::new(self, 0)
    }
}
...
pub struct ADbBypassSpec;
impl crate::RegisterSpec for ADbBypassSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`a_db_bypass::R`](R) reader structure"]
impl crate::Readable for ADbBypassSpec {}
#[doc = "`write(|w| ..)` method takes [`a_db_bypass::W`](W) writer structure"]
impl crate::Writable for ADbBypassSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets A_DB_BYPASS to value 0"]
impl crate::Resettable for ADbBypassSpec {}

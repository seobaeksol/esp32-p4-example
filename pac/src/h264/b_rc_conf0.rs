...
pub type BMbRateCtrlEnR = crate::BitReader;
...
pub type BMbRateCtrlEnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:5 - Configures video B frame level initial luma QP value."]
    #[inline(always)]
    pub fn b_qp(&self) -> BQpR {
        BQpR::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 6:21 - Configures video B parameter U value. U = int((float) u << 8)."]
    #[inline(always)]
    pub fn b_rate_ctrl_u(&self) -> BRateCtrlUR {
        BRateCtrlUR::new(((self.bits >> 6) & 0xffff) as u16)
    }
    ...
    #[inline(always)]
    pub fn b_mb_rate_ctrl_en(&self) -> BMbRateCtrlEnR {
        BMbRateCtrlEnR::new(((self.bits >> 22) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:5 - Configures video B frame level initial luma QP value."]
    #[inline(always)]
    pub fn b_qp(&mut self) -> BQpW<'_, BRcConf0Spec> {
        BQpW::new(self, 0)
    }
    #[doc = "Bits 6:21 - Configures video B parameter U value. U = int((float) u << 8)."]
    #[inline(always)]
    pub fn b_rate_ctrl_u(&mut self) -> BRateCtrlUW<'_, BRcConf0Spec> {
        BRateCtrlUW::new(self, 6)
    }
    #[doc = "Bit 22 - Configures video A whether or not to open macro block rate ctrl.\\\\1:Open the macro block rate ctrl\\\\1:Close the macro block rate ctrl."]
    #[inline(always)]
    pub fn b_mb_rate_ctrl_en(&mut self) -> BMbRateCtrlEnW<'_, BRcConf0Spec> {
        BMbRateCtrlEnW::new(self, 22)
    }
}
...
pub struct BRcConf0Spec;
impl crate::RegisterSpec for BRcConf0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`b_rc_conf0::R`](R) reader structure"]
impl crate::Readable for BRcConf0Spec {}
#[doc = "`write(|w| ..)` method takes [`b_rc_conf0::W`](W) writer structure"]
impl crate::Writable for BRcConf0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets B_RC_CONF0 to value 0"]
impl crate::Resettable for BRcConf0Spec {}

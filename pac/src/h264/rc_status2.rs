...
pub struct RcStatus2Spec;
impl crate::RegisterSpec for RcStatus2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rc_status2::R`](R) reader structure"]
impl crate::Readable for RcStatus2Spec {}
#[doc = "`reset()` method sets RC_STATUS2 to value 0"]
impl crate::Resettable for RcStatus2Spec {}

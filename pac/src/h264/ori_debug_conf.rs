...
pub type DbgReplaceOriDataR = crate::FieldReader<u32>;
...
pub type DbgReplaceOriDataW<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    #[doc = "Bit 0 - Configures whether to replace original picture pixels.\\\\0: not replace\\\\1: replace"]
    #[inline(always)]
    pub fn dbg_replace_ori_data_en(&self) -> DbgReplaceOriDataEnR {
        DbgReplaceOriDataEnR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn dbg_replace_ori_data(&self) -> DbgReplaceOriDataR {
        DbgReplaceOriDataR::new((self.bits >> 1) & 0x00ff_ffff)
    }
}
impl W {
    #[doc = "Bit 0 - Configures whether to replace original picture pixels.\\\\0: not replace\\\\1: replace"]
    #[inline(always)]
    pub fn dbg_replace_ori_data_en(&mut self) -> DbgReplaceOriDataEnW<'_, OriDebugConfSpec> {
        DbgReplaceOriDataEnW::new(self, 0)
    }
    #[doc = "Bits 1:24 - Configures original picture pixels to be replaced. When the original picture color space is RGB, byte0~2 is BGR. When the original picture color space is YUV, byte0~2 is VUY. When the original picture color space is GRAY, byte0 is GRAY."]
    #[inline(always)]
    pub fn dbg_replace_ori_data(&mut self) -> DbgReplaceOriDataW<'_, OriDebugConfSpec> {
        DbgReplaceOriDataW::new(self, 1)
    }
}
...
pub struct OriDebugConfSpec;
impl crate::RegisterSpec for OriDebugConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ori_debug_conf::R`](R) reader structure"]
impl crate::Readable for OriDebugConfSpec {}
#[doc = "`write(|w| ..)` method takes [`ori_debug_conf::W`](W) writer structure"]
impl crate::Writable for OriDebugConfSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ORI_DEBUG_CONF to value 0"]
impl crate::Resettable for OriDebugConfSpec {}

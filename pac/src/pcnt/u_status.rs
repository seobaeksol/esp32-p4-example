...
pub type R = crate::R<UStatusSpec>;
...
pub type ZeroModeR = crate::FieldReader;
...
pub type Thres1R = crate::BitReader;
...
pub type Thres0R = crate::BitReader;
...
pub type LLimR = crate::BitReader;
...
pub type HLimR = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn zero_mode(&self) -> ZeroModeR {
        ZeroModeR::new((self.bits & 3) as u8)
    }
    ...
    #[inline(always)]
    pub fn thres1(&self) -> Thres1R {
        Thres1R::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn thres0(&self) -> Thres0R {
        Thres0R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l_lim(&self) -> LLimR {
        LLimR::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn h_lim(&self) -> HLimR {
        HLimR::new(((self.bits >> 5) & 1) != 0)
    }
...
pub struct UStatusSpec;
impl crate::RegisterSpec for UStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`u_status::R`](R) reader structure"]
impl crate::Readable for UStatusSpec {}
#[doc = "`reset()` method sets U%s_STATUS to value 0"]
impl crate::Resettable for UStatusSpec {}

...
pub type CntThres0R = crate::FieldReader<u16>;
#[doc = "Field `CNT_THRES0` writer - This register is used to configure the thres0 value for unit %s."]
pub type CntThres0W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `CNT_THRES1` reader - This register is used to configure the thres1 value for unit %s."]
pub type CntThres1R = crate::FieldReader<u16>;
#[doc = "Field `CNT_THRES1` writer - This register is used to configure the thres1 value for unit %s."]
pub type CntThres1W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - This register is used to configure the thres0 value for unit %s."]
    #[inline(always)]
    pub fn cnt_thres0(&self) -> CntThres0R {
        CntThres0R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - This register is used to configure the thres1 value for unit %s."]
    #[inline(always)]
    pub fn cnt_thres1(&self) -> CntThres1R {
        CntThres1R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - This register is used to configure the thres0 value for unit %s."]
    #[inline(always)]
    pub fn cnt_thres0(&mut self) -> CntThres0W<'_, Conf1Spec> {
        CntThres0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - This register is used to configure the thres1 value for unit %s."]
    #[inline(always)]
    pub fn cnt_thres1(&mut self) -> CntThres1W<'_, Conf1Spec> {
        CntThres1W::new(self, 16)
    }
}

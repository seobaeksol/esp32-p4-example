...
pub type HwI2cSclPulseDurR = crate::FieldReader;
#[doc = "Field `HW_I2C_SCL_PULSE_DUR` writer - need des"]
pub type HwI2cSclPulseDurW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Field `HW_I2C_SDA_SIDE_GUARD` reader - need des"]
pub type HwI2cSdaSideGuardR = crate::FieldReader;
#[doc = "Field `HW_I2C_SDA_SIDE_GUARD` writer - need des"]
pub type HwI2cSdaSideGuardW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `ARBITER_DIS` reader - need des"]
pub type ArbiterDisR = crate::BitReader;
#[doc = "Field `ARBITER_DIS` writer - need des"]
pub type ArbiterDisW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:5 - need des"]
    #[inline(always)]
    pub fn hw_i2c_scl_pulse_dur(&self) -> HwI2cSclPulseDurR {
        HwI2cSclPulseDurR::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 6:10 - need des"]
    #[inline(always)]
    pub fn hw_i2c_sda_side_guard(&self) -> HwI2cSdaSideGuardR {
        HwI2cSdaSideGuardR::new(((self.bits >> 6) & 0x1f) as u8)
    }
    #[doc = "Bit 11 - need des"]
    #[inline(always)]
    pub fn arbiter_dis(&self) -> ArbiterDisR {
        ArbiterDisR::new(((self.bits >> 11) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:5 - need des"]
    #[inline(always)]
    pub fn hw_i2c_scl_pulse_dur(&mut self) -> HwI2cSclPulseDurW<'_, HwI2cCtrlSpec> {
        HwI2cSclPulseDurW::new(self, 0)
    }
    #[doc = "Bits 6:10 - need des"]
    #[inline(always)]
    pub fn hw_i2c_sda_side_guard(&mut self) -> HwI2cSdaSideGuardW<'_, HwI2cCtrlSpec> {
        HwI2cSdaSideGuardW::new(self, 6)
    }
    #[doc = "Bit 11 - need des"]
    #[inline(always)]
    pub fn arbiter_dis(&mut self) -> ArbiterDisW<'_, HwI2cCtrlSpec> {
        ArbiterDisW::new(self, 11)
    }
}

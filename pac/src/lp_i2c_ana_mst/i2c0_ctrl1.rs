...
pub type I2c0SclPulseDurR = crate::FieldReader;
#[doc = "Field `I2C0_SCL_PULSE_DUR` writer - need des"]
pub type I2c0SclPulseDurW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Field `I2C0_SDA_SIDE_GUARD` reader - need des"]
pub type I2c0SdaSideGuardR = crate::FieldReader;
#[doc = "Field `I2C0_SDA_SIDE_GUARD` writer - need des"]
pub type I2c0SdaSideGuardW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    #[doc = "Bits 0:5 - need des"]
    #[inline(always)]
    pub fn i2c0_scl_pulse_dur(&self) -> I2c0SclPulseDurR {
        I2c0SclPulseDurR::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 6:10 - need des"]
    #[inline(always)]
    pub fn i2c0_sda_side_guard(&self) -> I2c0SdaSideGuardR {
        I2c0SdaSideGuardR::new(((self.bits >> 6) & 0x1f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5 - need des"]
    #[inline(always)]
    pub fn i2c0_scl_pulse_dur(&mut self) -> I2c0SclPulseDurW<'_, I2c0Ctrl1Spec> {
        I2c0SclPulseDurW::new(self, 0)
    }
    #[doc = "Bits 6:10 - need des"]
    #[inline(always)]
    pub fn i2c0_sda_side_guard(&mut self) -> I2c0SdaSideGuardW<'_, I2c0Ctrl1Spec> {
        I2c0SdaSideGuardW::new(self, 6)
    }
}

...
pub type AnaConf1R = crate::FieldReader<u32>;
#[doc = "Field `ANA_CONF1` writer - need des"]
pub type AnaConf1W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
#[doc = "Field `ANA_STATUS1` reader - need des"]
pub type AnaStatus1R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:23 - need des"]
    #[inline(always)]
    pub fn ana_conf1(&self) -> AnaConf1R {
        AnaConf1R::new(self.bits & 0x00ff_ffff)
    }
    #[doc = "Bits 24:31 - need des"]
    #[inline(always)]
    pub fn ana_status1(&self) -> AnaStatus1R {
        AnaStatus1R::new(((self.bits >> 24) & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 0:23 - need des"]
    #[inline(always)]
    pub fn ana_conf1(&mut self) -> AnaConf1W<'_, AnaConf1Spec> {
        AnaConf1W::new(self, 0)
    }
}

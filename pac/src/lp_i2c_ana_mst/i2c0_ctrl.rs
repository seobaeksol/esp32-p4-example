...
pub type I2c0CtrlR = crate::FieldReader<u32>;
#[doc = "Field `I2C0_CTRL` writer - need des"]
pub type I2c0CtrlW<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
#[doc = "Field `I2C0_BUSY` reader - need des"]
pub type I2c0BusyR = crate::BitReader;
impl R {
    #[doc = "Bits 0:24 - need des"]
    #[inline(always)]
    pub fn i2c0_ctrl(&self) -> I2c0CtrlR {
        I2c0CtrlR::new(self.bits & 0x01ff_ffff)
    }
    #[doc = "Bit 25 - need des"]
    #[inline(always)]
    pub fn i2c0_busy(&self) -> I2c0BusyR {
        I2c0BusyR::new(((self.bits >> 25) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:24 - need des"]
    #[inline(always)]
    pub fn i2c0_ctrl(&mut self) -> I2c0CtrlW<'_, I2c0CtrlSpec> {
        I2c0CtrlW::new(self, 0)
    }
}

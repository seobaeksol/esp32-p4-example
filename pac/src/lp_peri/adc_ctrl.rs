...
pub type LpadcFuncDivNumR = crate::FieldReader;
#[doc = "Field `LPADC_FUNC_DIV_NUM` writer - need_des"]
pub type LpadcFuncDivNumW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `LPADC_SAR2_DIV_NUM` reader - need_des"]
pub type LpadcSar2DivNumR = crate::FieldReader;
#[doc = "Field `LPADC_SAR2_DIV_NUM` writer - need_des"]
pub type LpadcSar2DivNumW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `LPADC_SAR1_DIV_NUM` reader - need_des"]
pub type LpadcSar1DivNumR = crate::FieldReader;
#[doc = "Field `LPADC_SAR1_DIV_NUM` writer - need_des"]
pub type LpadcSar1DivNumW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bit 6 - need_des"]
    #[inline(always)]
    pub fn sar2_clk_force_on(&self) -> Sar2ClkForceOnR {
        Sar2ClkForceOnR::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - need_des"]
    #[inline(always)]
    pub fn sar1_clk_force_on(&self) -> Sar1ClkForceOnR {
        Sar1ClkForceOnR::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bits 8:15 - need_des"]
    #[inline(always)]
    pub fn lpadc_func_div_num(&self) -> LpadcFuncDivNumR {
        LpadcFuncDivNumR::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - need_des"]
    #[inline(always)]
    pub fn lpadc_sar2_div_num(&self) -> LpadcSar2DivNumR {
        LpadcSar2DivNumR::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - need_des"]
    #[inline(always)]
    pub fn lpadc_sar1_div_num(&self) -> LpadcSar1DivNumR {
        LpadcSar1DivNumR::new(((self.bits >> 24) & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bit 6 - need_des"]
    #[inline(always)]
    pub fn sar2_clk_force_on(&mut self) -> Sar2ClkForceOnW<'_, AdcCtrlSpec> {
        Sar2ClkForceOnW::new(self, 6)
    }
    #[doc = "Bit 7 - need_des"]
    #[inline(always)]
    pub fn sar1_clk_force_on(&mut self) -> Sar1ClkForceOnW<'_, AdcCtrlSpec> {
        Sar1ClkForceOnW::new(self, 7)
    }
    #[doc = "Bits 8:15 - need_des"]
    #[inline(always)]
    pub fn lpadc_func_div_num(&mut self) -> LpadcFuncDivNumW<'_, AdcCtrlSpec> {
        LpadcFuncDivNumW::new(self, 8)
    }
    #[doc = "Bits 16:23 - need_des"]
    #[inline(always)]
    pub fn lpadc_sar2_div_num(&mut self) -> LpadcSar2DivNumW<'_, AdcCtrlSpec> {
        LpadcSar2DivNumW::new(self, 16)
    }
    #[doc = "Bits 24:31 - need_des"]
    #[inline(always)]
    pub fn lpadc_sar1_div_num(&mut self) -> LpadcSar1DivNumW<'_, AdcCtrlSpec> {
        LpadcSar1DivNumW::new(self, 24)
    }
}

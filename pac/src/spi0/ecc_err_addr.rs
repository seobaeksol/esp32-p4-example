...
pub type R = crate::R<EccErrAddrSpec>;
...
pub struct EccErrAddrSpec;
impl crate::RegisterSpec for EccErrAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ecc_err_addr::R`](R) reader structure"]
impl crate::Readable for EccErrAddrSpec {}
#[doc = "`reset()` method sets ECC_ERR_ADDR to value 0"]
impl crate::Resettable for EccErrAddrSpec {}

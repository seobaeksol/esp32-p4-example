...
pub type R = crate::R<XtsLinesizeSpec>;
#[doc = "Register `XTS_LINESIZE` writer"]
pub type W = crate::W<XtsLinesizeSpec>;
...
pub type SpiXtsLinesizeR = crate::FieldReader;
...
pub type SpiXtsLinesizeW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ...
    #[inline(always)]
    pub fn spi_xts_linesize(&self) -> SpiXtsLinesizeR {
        SpiXtsLinesizeR::new((self.bits & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - This bits stores the line-size parameter which will be used in manual encryption calculation. It decides how many bytes will be encrypted one time. 0: 16-bytes, 1: 32-bytes, 2: 64-bytes, 3:reserved."]
    #[inline(always)]
    pub fn spi_xts_linesize(&mut self) -> SpiXtsLinesizeW<'_, XtsLinesizeSpec> {
        SpiXtsLinesizeW::new(self, 0)
    }
}
...
pub struct XtsLinesizeSpec;
impl crate::RegisterSpec for XtsLinesizeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`xts_linesize::R`](R) reader structure"]
impl crate::Readable for XtsLinesizeSpec {}
#[doc = "`write(|w| ..)` method takes [`xts_linesize::W`](W) writer structure"]
impl crate::Writable for XtsLinesizeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets XTS_LINESIZE to value 0"]
impl crate::Resettable for XtsLinesizeSpec {}

...
pub type R = crate::R<SpiFmemPmsAddrSpec>;
#[doc = "Register `SPI_FMEM_PMS%s_ADDR` writer"]
pub type W = crate::W<SpiFmemPmsAddrSpec>;
...
impl W {
    #[doc = "Bits 0:26 - SPI1 flash PMS section %s start address value"]
    #[inline(always)]
    pub fn s(&mut self) -> SW<'_, SpiFmemPmsAddrSpec> {
        SW::new(self, 0)
    }
}
...
pub struct SpiFmemPmsAddrSpec;
impl crate::RegisterSpec for SpiFmemPmsAddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi_fmem_pms_addr::R`](R) reader structure"]
impl crate::Readable for SpiFmemPmsAddrSpec {}
#[doc = "`write(|w| ..)` method takes [`spi_fmem_pms_addr::W`](W) writer structure"]
impl crate::Writable for SpiFmemPmsAddrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI_FMEM_PMS%s_ADDR to value 0"]
impl crate::Resettable for SpiFmemPmsAddrSpec {}

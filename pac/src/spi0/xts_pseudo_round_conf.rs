...
pub type R = crate::R<XtsPseudoRoundConfSpec>;
#[doc = "Register `XTS_PSEUDO_ROUND_CONF` writer"]
pub type W = crate::W<XtsPseudoRoundConfSpec>;
...
pub type ModePseudoR = crate::FieldReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn mode_pseudo(&self) -> ModePseudoR {
        ModePseudoR::new((self.bits & 3) as u8)
    }
    #[doc = "Bits 2:4 - xts aes peseudo function base round that must be peformed."]
    #[inline(always)]
    pub fn pseudo_rng_cnt(&self) -> PseudoRngCntR {
        PseudoRngCntR::new(((self.bits >> 2) & 7) as u8)
    }
    #[doc = "Bits 5:8 - xts aes peseudo function base round that must be peformed."]
    #[inline(always)]
    pub fn pseudo_base(&self) -> PseudoBaseR {
        PseudoBaseR::new(((self.bits >> 5) & 0x0f) as u8)
    }
    #[doc = "Bits 9:10 - xts aes peseudo function increment round that will be peformed randomly between 0 & 2**(inc+1)."]
    #[inline(always)]
    pub fn pseudo_inc(&self) -> PseudoIncR {
        PseudoIncR::new(((self.bits >> 9) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - Set the mode of pseudo. 2'b00: crypto without pseudo. 2'b01: state T with pseudo and state D without pseudo. 2'b10: state T with pseudo and state D with few pseudo. 2'b11: crypto with pseudo."]
    #[inline(always)]
    pub fn mode_pseudo(&mut self) -> ModePseudoW<'_, XtsPseudoRoundConfSpec> {
        ModePseudoW::new(self, 0)
    }
    #[doc = "Bits 2:4 - xts aes peseudo function base round that must be peformed."]
    #[inline(always)]
    pub fn pseudo_rng_cnt(&mut self) -> PseudoRngCntW<'_, XtsPseudoRoundConfSpec> {
        PseudoRngCntW::new(self, 2)
    }
    #[doc = "Bits 5:8 - xts aes peseudo function base round that must be peformed."]
    #[inline(always)]
    pub fn pseudo_base(&mut self) -> PseudoBaseW<'_, XtsPseudoRoundConfSpec> {
        PseudoBaseW::new(self, 5)
    }
    #[doc = "Bits 9:10 - xts aes peseudo function increment round that will be peformed randomly between 0 & 2**(inc+1)."]
    #[inline(always)]
    pub fn pseudo_inc(&mut self) -> PseudoIncW<'_, XtsPseudoRoundConfSpec> {
        PseudoIncW::new(self, 9)
    }
}
...
pub struct XtsPseudoRoundConfSpec;
impl crate::RegisterSpec for XtsPseudoRoundConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`xts_pseudo_round_conf::R`](R) reader structure"]
impl crate::Readable for XtsPseudoRoundConfSpec {}
#[doc = "`write(|w| ..)` method takes [`xts_pseudo_round_conf::W`](W) writer structure"]
impl crate::Writable for XtsPseudoRoundConfSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets XTS_PSEUDO_ROUND_CONF to value 0x045c"]
impl crate::Resettable for XtsPseudoRoundConfSpec {

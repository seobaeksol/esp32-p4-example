...
pub type W = crate::W<XtsDestroySpec>;
...
pub type SpiXtsDestroyW<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    ...
    #[inline(always)]
    pub fn spi_xts_destroy(&mut self) -> SpiXtsDestroyW<'_, XtsDestroySpec> {
        SpiXtsDestroyW::new(self, 0)
    }
}
...
pub struct XtsDestroySpec;
impl crate::RegisterSpec for XtsDestroySpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`xts_destroy::W`](W) writer structure"]
impl crate::Writable for XtsDestroySpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets XTS_DESTROY to value 0"]
impl crate::Resettable for XtsDestroySpec {}

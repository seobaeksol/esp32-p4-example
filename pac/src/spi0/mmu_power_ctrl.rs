...
pub type SpiMmuMemForcePuR = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn spi_mmu_mem_force_on(&self) -> SpiMmuMemForceOnR {
        SpiMmuMemForceOnR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Set this bit to force mmu-memory powerdown"]
    #[inline(always)]
    pub fn spi_mmu_mem_force_pd(&self) -> SpiMmuMemForcePdR {
        SpiMmuMemForcePdR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Set this bit to force mmu-memory powerup, in this case, the power should also be controlled by rtc."]
    #[inline(always)]
    pub fn spi_mmu_mem_force_pu(&self) -> SpiMmuMemForcePuR {
        SpiMmuMemForcePuR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bits 3:4 - 0: Max page size , 1: Max page size/2 , 2: Max page size/4, 3: Max page size/8"]
    #[inline(always)]
    pub fn spi_mmu_page_size(&self) -> SpiMmuPageSizeR {
        SpiMmuPageSizeR::new(((self.bits >> 3) & 3) as u8)
    }
    #[doc = "Bits 16:29 - MMU PSRAM aux control register"]
    #[inline(always)]
    pub fn aux_ctrl(&self) -> AuxCtrlR {
        AuxCtrlR::new(((self.bits >> 16) & 0x3fff) as u16)
    }
    ...
    pub fn rdn_result(&self) -> RdnResultR {
        RdnResultR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Set this bit to enable mmu-memory clock force on"]
    #[inline(always)]
    pub fn spi_mmu_mem_force_on(&mut self) -> SpiMmuMemForceOnW<'_, MmuPowerCtrlSpec> {
        SpiMmuMemForceOnW::new(self, 0)
    }
    #[doc = "Bit 1 - Set this bit to force mmu-memory powerdown"]
    #[inline(always)]
    pub fn spi_mmu_mem_force_pd(&mut self) -> SpiMmuMemForcePdW<'_, MmuPowerCtrlSpec> {
        SpiMmuMemForcePdW::new(self, 1)
    }
    #[doc = "Bit 2 - Set this bit to force mmu-memory powerup, in this case, the power should also be controlled by rtc."]
    #[inline(always)]
    pub fn spi_mmu_mem_force_pu(&mut self) -> SpiMmuMemForcePuW<'_, MmuPowerCtrlSpec> {
        SpiMmuMemForcePuW::new(self, 2)
    }
    #[doc = "Bits 3:4 - 0: Max page size , 1: Max page size/2 , 2: Max page size/4, 3: Max page size/8"]
    #[inline(always)]
    pub fn spi_mmu_page_size(&mut self) -> SpiMmuPageSizeW<'_, MmuPowerCtrlSpec> {
        SpiMmuPageSizeW::new(self, 3)
    }
    #[doc = "Bits 16:29 - MMU PSRAM aux control register"]
    #[inline(always)]
    pub fn aux_ctrl(&mut self) -> AuxCtrlW<'_, MmuPowerCtrlSpec> {
        AuxCtrlW::new(self, 16)
    }
    #[doc = "Bit 30 - ECO register enable bit"]
    #[inline(always)]
    pub fn rdn_ena(&mut self) -> RdnEnaW<'_, MmuPowerCtrlSpec> {
        RdnEnaW::new(self, 30)
    }
}
...
pub struct MmuPowerCtrlSpec;
impl crate::RegisterSpec for MmuPowerCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mmu_power_ctrl::R`](R) reader structure"]
impl crate::Readable for MmuPowerCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`mmu_power_ctrl::W`](W) writer structure"]
impl crate::Writable for MmuPowerCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MMU_POWER_CTRL to value 0x1320_0004"]
impl crate::Resettable for MmuPowerCtrlSpec {

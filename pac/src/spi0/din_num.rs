...
pub type DinsNumR = crate::FieldReader;
...
pub type DinsNumW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ...
    #[inline(always)]
    pub fn dins_num(&self) -> DinsNumR {
        DinsNumR::new(((self.bits >> 16) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    ...
    #[doc = "Bits 16:17 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    #[inline(always)]
    pub fn dins_num(&mut self) -> DinsNumW<'_, DinNumSpec> {
        DinsNumW::new(self, 16)
    }
}

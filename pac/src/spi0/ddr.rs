...
pub type SpiFmemTxDdrMskEnR = crate::BitReader;
...
pub type SpiFmemTxDdrMskEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SpiFmemRxDdrMskEnR = crate::BitReader;
...
pub type SpiFmemDdrDqsLoopR = crate::BitReader;
...
pub type SpiFmemHyperbusDummy2xR = crate::BitReader;
...
pub type SpiFmemOctaRamAddrR = crate::BitReader;
...
pub type SpiFmemOctaRamAddrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SpiFmemHyperbusCaR = crate::BitReader;
...
pub type SpiFmemHyperbusCaW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - 1: in DDR mode, 0 in SDR mode"]
    #[inline(always)]
    pub fn spi_fmem_ddr_en(&self) -> SpiFmemDdrEnR {
        SpiFmemDdrEnR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Set the bit to enable variable dummy cycle in spi DDR mode."]
    #[inline(always)]
    pub fn spi_fmem_var_dummy(&self) -> SpiFmemVarDummyR {
        SpiFmemVarDummyR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Set the bit to reorder rx data of the word in spi DDR mode."]
    #[inline(always)]
    pub fn spi_fmem_ddr_rdat_swp(&self) -> SpiFmemDdrRdatSwpR {
        SpiFmemDdrRdatSwpR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Set the bit to reorder tx data of the word in spi DDR mode."]
    #[inline(always)]
    pub fn spi_fmem_ddr_wdat_swp(&self) -> SpiFmemDdrWdatSwpR {
        SpiFmemDdrWdatSwpR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - the bit is used to disable dual edge in command phase when DDR mode."]
    #[inline(always)]
    pub fn spi_fmem_ddr_cmd_dis(&self) -> SpiFmemDdrCmdDisR {
        SpiFmemDdrCmdDisR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bits 5:11 - It is the minimum output data length in the panda device."]
    #[inline(always)]
    pub fn spi_fmem_outminbytelen(&self) -> SpiFmemOutminbytelenR {
        SpiFmemOutminbytelenR::new(((self.bits >> 5) & 0x7f) as u8)
    }
    #[doc = "Bit 12 - Set this bit to mask the first or the last byte in SPI0 ECC DDR write mode, when accesses to flash."]
    #[inline(always)]
    pub fn spi_fmem_tx_ddr_msk_en(&self) -> SpiFmemTxDdrMskEnR {
        SpiFmemTxDdrMskEnR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Set this bit to mask the first or the last byte in SPI0 ECC DDR read mode, when accesses to flash."]
    #[inline(always)]
    pub fn spi_fmem_rx_ddr_msk_en(&self) -> SpiFmemRxDdrMskEnR {
        SpiFmemRxDdrMskEnR::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bits 14:20 - The delay number of data strobe which from memory based on SPI clock."]
    #[inline(always)]
    pub fn spi_fmem_usr_ddr_dqs_thd(&self) -> SpiFmemUsrDdrDqsThdR {
        SpiFmemUsrDdrDqsThdR::new(((self.bits >> 14) & 0x7f) as u8)
    }
    ...
    #[inline(always)]
    pub fn spi_fmem_ddr_dqs_loop(&self) -> SpiFmemDdrDqsLoopR {
        SpiFmemDdrDqsLoopR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 24 - Set this bit to enable the differential SPI_CLK#."]
    #[inline(always)]
    pub fn spi_fmem_clk_diff_en(&self) -> SpiFmemClkDiffEnR {
        SpiFmemClkDiffEnR::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 26 - Set this bit to enable the input of SPI_DQS signal in SPI phases of CMD and ADDR."]
    #[inline(always)]
    pub fn spi_fmem_dqs_ca_in(&self) -> SpiFmemDqsCaInR {
        SpiFmemDqsCaInR::new(((self.bits >> 26) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_fmem_hyperbus_dummy_2x(&self) -> SpiFmemHyperbusDummy2xR {
        SpiFmemHyperbusDummy2xR::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - Set this bit to invert SPI_DIFF when accesses to flash. ."]
    #[inline(always)]
    pub fn spi_fmem_clk_diff_inv(&self) -> SpiFmemClkDiffInvR {
        SpiFmemClkDiffInvR::new(((self.bits >> 28) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_fmem_octa_ram_addr(&self) -> SpiFmemOctaRamAddrR {
        SpiFmemOctaRamAddrR::new(((self.bits >> 29) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_fmem_hyperbus_ca(&self) -> SpiFmemHyperbusCaR {
        SpiFmemHyperbusCaR::new(((self.bits >> 30) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - 1: in DDR mode, 0 in SDR mode"]
    #[inline(always)]
    pub fn spi_fmem_ddr_en(&mut self) -> SpiFmemDdrEnW<'_, DdrSpec> {
        SpiFmemDdrEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Set the bit to enable variable dummy cycle in spi DDR mode."]
    #[inline(always)]
    pub fn spi_fmem_var_dummy(&mut self) -> SpiFmemVarDummyW<'_, DdrSpec> {
        SpiFmemVarDummyW::new(self, 1)
    }
    #[doc = "Bit 2 - Set the bit to reorder rx data of the word in spi DDR mode."]
    #[inline(always)]
    pub fn spi_fmem_ddr_rdat_swp(&mut self) -> SpiFmemDdrRdatSwpW<'_, DdrSpec> {
        SpiFmemDdrRdatSwpW::new(self, 2)
    }
    #[doc = "Bit 3 - Set the bit to reorder tx data of the word in spi DDR mode."]
    #[inline(always)]
    pub fn spi_fmem_ddr_wdat_swp(&mut self) -> SpiFmemDdrWdatSwpW<'_, DdrSpec> {
        SpiFmemDdrWdatSwpW::new(self, 3)
    }
    #[doc = "Bit 4 - the bit is used to disable dual edge in command phase when DDR mode."]
    #[inline(always)]
    pub fn spi_fmem_ddr_cmd_dis(&mut self) -> SpiFmemDdrCmdDisW<'_, DdrSpec> {
        SpiFmemDdrCmdDisW::new(self, 4)
    }
    #[doc = "Bits 5:11 - It is the minimum output data length in the panda device."]
    #[inline(always)]
    pub fn spi_fmem_outminbytelen(&mut self) -> SpiFmemOutminbytelenW<'_, DdrSpec> {
        SpiFmemOutminbytelenW::new(self, 5)
    }
    #[doc = "Bit 12 - Set this bit to mask the first or the last byte in SPI0 ECC DDR write mode, when accesses to flash."]
    #[inline(always)]
    pub fn spi_fmem_tx_ddr_msk_en(&mut self) -> SpiFmemTxDdrMskEnW<'_, DdrSpec> {
        SpiFmemTxDdrMskEnW::new(self, 12)
    }
    #[doc = "Bit 13 - Set this bit to mask the first or the last byte in SPI0 ECC DDR read mode, when accesses to flash."]
    #[inline(always)]
    pub fn spi_fmem_rx_ddr_msk_en(&mut self) -> SpiFmemRxDdrMskEnW<'_, DdrSpec> {
        SpiFmemRxDdrMskEnW::new(self, 13)
    }
    #[doc = "Bits 14:20 - The delay number of data strobe which from memory based on SPI clock."]
    #[inline(always)]
    pub fn spi_fmem_usr_ddr_dqs_thd(&mut self) -> SpiFmemUsrDdrDqsThdW<'_, DdrSpec> {
        SpiFmemUsrDdrDqsThdW::new(self, 14)
    }
    #[doc = "Bit 21 - 1: Do not need the input of SPI_DQS signal, SPI0 starts to receive data when spi0_slv_st is in SPI_MEM_DIN state. It is used when there is no SPI_DQS signal or SPI_DQS signal is not stable. 0: SPI0 starts to store data at the positive and negative edge of SPI_DQS."]
    #[inline(always)]
    pub fn spi_fmem_ddr_dqs_loop(&mut self) -> SpiFmemDdrDqsLoopW<'_, DdrSpec> {
        SpiFmemDdrDqsLoopW::new(self, 21)
    }
    #[doc = "Bit 24 - Set this bit to enable the differential SPI_CLK#."]
    #[inline(always)]
    pub fn spi_fmem_clk_diff_en(&mut self) -> SpiFmemClkDiffEnW<'_, DdrSpec> {
        SpiFmemClkDiffEnW::new(self, 24)
    }
    #[doc = "Bit 26 - Set this bit to enable the input of SPI_DQS signal in SPI phases of CMD and ADDR."]
    #[inline(always)]
    pub fn spi_fmem_dqs_ca_in(&mut self) -> SpiFmemDqsCaInW<'_, DdrSpec> {
        SpiFmemDqsCaInW::new(self, 26)
    }
    #[doc = "Bit 27 - Set this bit to enable the vary dummy function in SPI HyperBus mode, when SPI0 accesses flash or SPI1 accesses flash or sram."]
    #[inline(always)]
    pub fn spi_fmem_hyperbus_dummy_2x(&mut self) -> SpiFmemHyperbusDummy2xW<'_, DdrSpec> {
        SpiFmemHyperbusDummy2xW::new(self, 27)
    }
    #[doc = "Bit 28 - Set this bit to invert SPI_DIFF when accesses to flash. ."]
    #[inline(always)]
    pub fn spi_fmem_clk_diff_inv(&mut self) -> SpiFmemClkDiffInvW<'_, DdrSpec> {
        SpiFmemClkDiffInvW::new(self, 28)
    }
    #[doc = "Bit 29 - Set this bit to enable octa_ram address out when accesses to flash, which means ADDR_OUT\\[31:0\\] = {spi_usr_addr_value\\[25:4\\], 6'd0, spi_usr_addr_value\\[3:1\\], 1'b0}."]
    #[inline(always)]
    pub fn spi_fmem_octa_ram_addr(&mut self) -> SpiFmemOctaRamAddrW<'_, DdrSpec> {
        SpiFmemOctaRamAddrW::new(self, 29)
    }
    #[doc = "Bit 30 - Set this bit to enable HyperRAM address out when accesses to flash, which means ADDR_OUT\\[31:0\\] = {spi_usr_addr_value\\[19:4\\], 13'd0, spi_usr_addr_value\\[3:1\\]}."]
    #[inline(always)]
    pub fn spi_fmem_hyperbus_ca(&mut self) -> SpiFmemHyperbusCaW<'_, DdrSpec> {
        SpiFmemHyperbusCaW::new(self, 30)
    }
}

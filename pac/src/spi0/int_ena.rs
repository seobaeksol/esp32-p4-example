...
pub type AxiWaddrErrInt_EnaR = crate::BitReader;
#[doc = "Field `AXI_WADDR_ERR_INT__ENA` writer - The enable bit for SPI_MEM_AXI_WADDR_ERR_INT interrupt."]
pub type AxiWaddrErrInt_EnaW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn axi_waddr_err_int__ena(&self) -> AxiWaddrErrInt_EnaR {
        AxiWaddrErrInt_EnaR::new(((self.bits >> 9) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 3 - The enable bit for SPI_MEM_SLV_ST_END_INT interrupt."]
    #[inline(always)]
    pub fn slv_st_end(&mut self) -> SlvStEndW<'_, IntEnaSpec> {
        SlvStEndW::new(self, 3)
    }
    #[doc = "Bit 4 - The enable bit for SPI_MEM_MST_ST_END_INT interrupt."]
    #[inline(always)]
    pub fn mst_st_end(&mut self) -> MstStEndW<'_, IntEnaSpec> {
        MstStEndW::new(self, 4)
    }
    #[doc = "Bit 5 - The enable bit for SPI_MEM_ECC_ERR_INT interrupt."]
    #[inline(always)]
    pub fn ecc_err(&mut self) -> EccErrW<'_, IntEnaSpec> {
        EccErrW::new(self, 5)
    }
    #[doc = "Bit 6 - The enable bit for SPI_MEM_PMS_REJECT_INT interrupt."]
    #[inline(always)]
    pub fn pms_reject(&mut self) -> PmsRejectW<'_, IntEnaSpec> {
        PmsRejectW::new(self, 6)
    }
    #[doc = "Bit 7 - The enable bit for SPI_MEM_AXI_RADDR_ERR_INT interrupt."]
    #[inline(always)]
    pub fn axi_raddr_err(&mut self) -> AxiRaddrErrW<'_, IntEnaSpec> {
        AxiRaddrErrW::new(self, 7)
    }
    #[doc = "Bit 8 - The enable bit for SPI_MEM_AXI_WR_FALSH_ERR_INT interrupt."]
    #[inline(always)]
    pub fn axi_wr_flash_err(&mut self) -> AxiWrFlashErrW<'_, IntEnaSpec> {
        AxiWrFlashErrW::new(self, 8)
    }
    #[doc = "Bit 9 - The enable bit for SPI_MEM_AXI_WADDR_ERR_INT interrupt."]
    #[inline(always)]
    pub fn axi_waddr_err_int__ena(&mut self) -> AxiWaddrErrInt_EnaW<'_, IntEnaSpec> {
        AxiWaddrErrInt_EnaW::new(self, 9)
    }
    #[doc = "Bit 26 - The enable bit for SPI_MEM_RX_TRANS_OVF_INT interrupt."]
    #[inline(always)]
    pub fn rx_trans_ovf(&mut self) -> RxTransOvfW<'_, IntEnaSpec> {
        RxTransOvfW::new(self, 26)
    }
    #[doc = "Bit 27 - The enable bit for SPI_MEM_TX_TRANS_UDF_INT interrupt."]
    #[inline(always)]
    pub fn tx_trans_udf(&mut self) -> TxTransUdfW<'_, IntEnaSpec> {
        TxTransUdfW::new(self, 27)
    }
    #[doc = "Bit 28 - The enable bit for SPI_MEM_DQS0_AFIFO_OVF_INT interrupt."]
    #[inline(always)]
    pub fn dqs0_afifo_ovf(&mut self) -> Dqs0AfifoOvfW<'_, IntEnaSpec> {
        Dqs0AfifoOvfW::new(self, 28)
    }
    #[doc = "Bit 29 - The enable bit for SPI_MEM_DQS1_AFIFO_OVF_INT interrupt."]
    #[inline(always)]
    pub fn dqs1_afifo_ovf(&mut self) -> Dqs1AfifoOvfW<'_, IntEnaSpec> {
        Dqs1AfifoOvfW::new(self, 29)
    }
    #[doc = "Bit 30 - The enable bit for SPI_MEM_BUS_FIFO1_UDF_INT interrupt."]
    #[inline(always)]
    pub fn bus_fifo1_udf(&mut self) -> BusFifo1UdfW<'_, IntEnaSpec> {
        BusFifo1UdfW::new(self, 30)
    }
    #[doc = "Bit 31 - The enable bit for SPI_MEM_BUS_FIFO0_UDF_INT interrupt."]
    #[inline(always)]
    pub fn bus_fifo0_udf(&mut self) -> BusFifo0UdfW<'_, IntEnaSpec> {

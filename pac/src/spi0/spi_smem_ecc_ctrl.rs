...
pub type R = crate::R<SpiSmemEccCtrlSpec>;
#[doc = "Register `SPI_SMEM_ECC_CTRL` writer"]
pub type W = crate::W<SpiSmemEccCtrlSpec>;
...
pub type SpiSmemEccErrIntEnR = crate::BitReader;
...
pub type SpiSmemEccErrIntEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SpiSmemPageSizeR = crate::FieldReader;
...
pub type SpiSmemPageSizeW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type SpiSmemEccAddrEnR = crate::BitReader;
...
pub type SpiSmemEccAddrEnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 17 - Set this bit to calculate the error times of MSPI ECC read when accesses to external RAM."]
    #[inline(always)]
    pub fn spi_smem_ecc_err_int_en(&self) -> SpiSmemEccErrIntEnR {
        SpiSmemEccErrIntEnR::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bits 18:19 - Set the page size of the external RAM accessed by MSPI. 0: 256 bytes. 1: 512 bytes. 2: 1024 bytes. 3: 2048 bytes."]
    #[inline(always)]
    pub fn spi_smem_page_size(&self) -> SpiSmemPageSizeR {
        SpiSmemPageSizeR::new(((self.bits >> 18) & 3) as u8)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_ecc_addr_en(&self) -> SpiSmemEccAddrEnR {
        SpiSmemEccAddrEnR::new(((self.bits >> 20) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 17 - Set this bit to calculate the error times of MSPI ECC read when accesses to external RAM."]
    #[inline(always)]
    pub fn spi_smem_ecc_err_int_en(&mut self) -> SpiSmemEccErrIntEnW<'_, SpiSmemEccCtrlSpec> {
        SpiSmemEccErrIntEnW::new(self, 17)
    }
    #[doc = "Bits 18:19 - Set the page size of the external RAM accessed by MSPI. 0: 256 bytes. 1: 512 bytes. 2: 1024 bytes. 3: 2048 bytes."]
    #[inline(always)]
    pub fn spi_smem_page_size(&mut self) -> SpiSmemPageSizeW<'_, SpiSmemEccCtrlSpec> {
        SpiSmemPageSizeW::new(self, 18)
    }
    #[doc = "Bit 20 - Set this bit to enable MSPI ECC address conversion, no matter MSPI accesses to the ECC region or non-ECC region of external RAM. If there is no ECC region in external RAM, this bit should be 0. Otherwise, this bit should be 1."]
    #[inline(always)]
    pub fn spi_smem_ecc_addr_en(&mut self) -> SpiSmemEccAddrEnW<'_, SpiSmemEccCtrlSpec> {
        SpiSmemEccAddrEnW::new(self, 20)
    }
}
...
pub struct SpiSmemEccCtrlSpec;
impl crate::RegisterSpec for SpiSmemEccCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi_smem_ecc_ctrl::R`](R) reader structure"]
impl crate::Readable for SpiSmemEccCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`spi_smem_ecc_ctrl::W`](W) writer structure"]
impl crate::Writable for SpiSmemEccCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI_SMEM_ECC_CTRL to value 0x0008_0000"]
impl crate::Resettable for SpiSmemEccCtrlSpec {

...
pub type SpiSmemCsSetupTimeR = crate::FieldReader;
...
pub type SpiSmemCsSetupTimeW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub type SpiSmemCsHoldTimeR = crate::FieldReader;
...
pub type SpiSmemCsHoldTimeW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub type SpiSmemEccCsHoldTimeR = crate::FieldReader;
...
pub type SpiSmemEccCsHoldTimeW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type SpiSmemEccSkipPageCornerR = crate::BitReader;
...
pub type SpiSmemEccSkipPageCornerW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SpiSmemEcc16to18ByteEnR = crate::BitReader;
...
pub type SpiSmemEcc16to18ByteEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SpiSmemCsHoldDelayR = crate::FieldReader;
...
pub type SpiSmemCsHoldDelayW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
pub type SpiSmemSplitTransEnR = crate::BitReader;
...
pub type SpiSmemSplitTransEnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - For SPI0 and SPI1, spi cs is enable when spi is in prepare phase. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_smem_cs_setup(&self) -> SpiSmemCsSetupR {
        SpiSmemCsSetupR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - For SPI0 and SPI1, spi cs keep low when spi is in done phase. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_smem_cs_hold(&self) -> SpiSmemCsHoldR {
        SpiSmemCsHoldR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 2:6 - For spi0, (cycles-1) of prepare phase by spi clock this bits are combined with spi_mem_cs_setup bit."]
    #[inline(always)]
    pub fn spi_smem_cs_setup_time(&self) -> SpiSmemCsSetupTimeR {
        SpiSmemCsSetupTimeR::new(((self.bits >> 2) & 0x1f) as u8)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_cs_hold_time(&self) -> SpiSmemCsHoldTimeR {
        SpiSmemCsHoldTimeR::new(((self.bits >> 7) & 0x1f) as u8)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_ecc_cs_hold_time(&self) -> SpiSmemEccCsHoldTimeR {
        SpiSmemEccCsHoldTimeR::new(((self.bits >> 12) & 7) as u8)
    }
    #[doc = "Bit 15 - 1: SPI0 skips page corner when accesses external RAM. 0: Not skip page corner when accesses external RAM."]
    #[inline(always)]
    pub fn spi_smem_ecc_skip_page_corner(&self) -> SpiSmemEccSkipPageCornerR {
        SpiSmemEccSkipPageCornerR::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - Set this bit to enable SPI0 and SPI1 ECC 16 bytes data with 2 ECC bytes mode when accesses external RAM."]
    #[inline(always)]
    pub fn spi_smem_ecc_16to18_byte_en(&self) -> SpiSmemEcc16to18ByteEnR {
        SpiSmemEcc16to18ByteEnR::new(((self.bits >> 16) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_cs_hold_delay(&self) -> SpiSmemCsHoldDelayR {
        SpiSmemCsHoldDelayR::new(((self.bits >> 25) & 0x3f) as u8)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_split_trans_en(&self) -> SpiSmemSplitTransEnR {
        SpiSmemSplitTransEnR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - For SPI0 and SPI1, spi cs is enable when spi is in prepare phase. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_smem_cs_setup(&mut self) -> SpiSmemCsSetupW<'_, SpiSmemAcSpec> {
        SpiSmemCsSetupW::new(self, 0)
    }
    #[doc = "Bit 1 - For SPI0 and SPI1, spi cs keep low when spi is in done phase. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_smem_cs_hold(&mut self) -> SpiSmemCsHoldW<'_, SpiSmemAcSpec> {
        SpiSmemCsHoldW::new(self, 1)
    }
    #[doc = "Bits 2:6 - For spi0, (cycles-1) of prepare phase by spi clock this bits are combined with spi_mem_cs_setup bit."]
    #[inline(always)]
    pub fn spi_smem_cs_setup_time(&mut self) -> SpiSmemCsSetupTimeW<'_, SpiSmemAcSpec> {
        SpiSmemCsSetupTimeW::new(self, 2)
    }
    #[doc = "Bits 7:11 - For SPI0 and SPI1, spi cs signal is delayed to inactive by spi clock this bits are combined with spi_mem_cs_hold bit."]
    #[inline(always)]
    pub fn spi_smem_cs_hold_time(&mut self) -> SpiSmemCsHoldTimeW<'_, SpiSmemAcSpec> {
        SpiSmemCsHoldTimeW::new(self, 7)
    }
    #[doc = "Bits 12:14 - SPI_SMEM_CS_HOLD_TIME + SPI_SMEM_ECC_CS_HOLD_TIME is the SPI0 and SPI1 CS hold cycles in ECC mode when accessed external RAM."]
    #[inline(always)]
    pub fn spi_smem_ecc_cs_hold_time(&mut self) -> SpiSmemEccCsHoldTimeW<'_, SpiSmemAcSpec> {
        SpiSmemEccCsHoldTimeW::new(self, 12)
    }
    #[doc = "Bit 15 - 1: SPI0 skips page corner when accesses external RAM. 0: Not skip page corner when accesses external RAM."]
    #[inline(always)]
    pub fn spi_smem_ecc_skip_page_corner(
        &mut self,
    ) -> SpiSmemEccSkipPageCornerW<'_, SpiSmemAcSpec> {
        SpiSmemEccSkipPageCornerW::new(self, 15)
    }
    #[doc = "Bit 16 - Set this bit to enable SPI0 and SPI1 ECC 16 bytes data with 2 ECC bytes mode when accesses external RAM."]
    #[inline(always)]
    pub fn spi_smem_ecc_16to18_byte_en(&mut self) -> SpiSmemEcc16to18ByteEnW<'_, SpiSmemAcSpec> {
        SpiSmemEcc16to18ByteEnW::new(self, 16)
    }
    #[doc = "Bits 25:30 - These bits are used to set the minimum CS high time tSHSL between SPI burst transfer when accesses to external RAM. tSHSL is (SPI_SMEM_CS_HOLD_DELAY\\[5:0\\] + 1) MSPI core clock cycles."]
    #[inline(always)]
    pub fn spi_smem_cs_hold_delay(&mut self) -> SpiSmemCsHoldDelayW<'_, SpiSmemAcSpec> {
        SpiSmemCsHoldDelayW::new(self, 25)
    }
    #[doc = "Bit 31 - Set this bit to enable SPI0 split one AXI accesses EXT_RAM transfer into two SPI transfers when one transfer will cross flash/EXT_RAM page corner, valid no matter whether there is an ECC region or not."]
    #[inline(always)]
    pub fn spi_smem_split_trans_en(&mut self) -> SpiSmemSplitTransEnW<'_, SpiSmemAcSpec> {
        SpiSmemSplitTransEnW::new(self, 31)
    }
}
...
pub struct SpiSmemAcSpec;
impl crate::RegisterSpec for SpiSmemAcSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi_smem_ac::R`](R) reader structure"]
impl crate::Readable for SpiSmemAcSpec {}
#[doc = "`write(|w| ..)` method takes [`spi_smem_ac::W`](W) writer structure"]
impl crate::Writable for SpiSmemAcSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI_SMEM_AC to value 0x8000_b084"]
impl crate::Resettable for SpiSmemAcSpec {

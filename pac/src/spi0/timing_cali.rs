...
impl R {
    ...
    #[inline(always)]
    pub fn timing_clk_ena(&self) -> TimingClkEnaR {
        TimingClkEnaR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn dll_timing_cali(&self) -> DllTimingCaliR {
        DllTimingCaliR::new(((self.bits >> 5) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - The bit is used to enable timing adjust clock for all reading operations."]
    #[inline(always)]
    pub fn timing_clk_ena(&mut self) -> TimingClkEnaW<'_, TimingCaliSpec> {
        TimingClkEnaW::new(self, 0)
    }
    #[doc = "Bit 1 - The bit is used to enable timing auto-calibration for all reading operations."]
    #[inline(always)]
    ...
    #[doc = "Bit 5 - Set this bit to enable DLL for timing calibration in DDR mode when accessed to flash."]
    #[inline(always)]
    pub fn dll_timing_cali(&mut self) -> DllTimingCaliW<'_, TimingCaliSpec> {
        DllTimingCaliW::new(self, 5)
    }
    #[doc = "Bit 6 - Set this bit to update delay mode, delay num and extra dummy in MSPI."]
    #[inline(always)]
    pub fn update(&mut self) -> UpdateW<'_, TimingCaliSpec> {
        UpdateW::new(self, 6)
    }
}

...
pub type R = crate::R<SpiSmemDoutModeSpec>;
#[doc = "Register `SPI_SMEM_DOUT_MODE` writer"]
pub type W = crate::W<SpiSmemDoutModeSpec>;
...
pub type SpiSmemDout0ModeR = crate::BitReader;
...
pub type SpiSmemDout0ModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SpiSmemDout1ModeR = crate::BitReader;
#[doc = "Field `SPI_SMEM_DOUT1_MODE` writer - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
pub type SpiSmemDout1ModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SpiSmemDout2ModeR = crate::BitReader;
#[doc = "Field `SPI_SMEM_DOUT2_MODE` writer - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
pub type SpiSmemDout2ModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SpiSmemDout3ModeR = crate::BitReader;
#[doc = "Field `SPI_SMEM_DOUT3_MODE` writer - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
pub type SpiSmemDout3ModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SpiSmemDout4ModeR = crate::BitReader;
#[doc = "Field `SPI_SMEM_DOUT4_MODE` writer - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
pub type SpiSmemDout4ModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SpiSmemDout5ModeR = crate::BitReader;
#[doc = "Field `SPI_SMEM_DOUT5_MODE` writer - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
pub type SpiSmemDout5ModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SpiSmemDout6ModeR = crate::BitReader;
#[doc = "Field `SPI_SMEM_DOUT6_MODE` writer - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
pub type SpiSmemDout6ModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SpiSmemDout7ModeR = crate::BitReader;
#[doc = "Field `SPI_SMEM_DOUT7_MODE` writer - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
pub type SpiSmemDout7ModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SpiSmemDoutsModeR = crate::BitReader;
#[doc = "Field `SPI_SMEM_DOUTS_MODE` writer - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
pub type SpiSmemDoutsModeW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn spi_smem_dout0_mode(&self) -> SpiSmemDout0ModeR {
        SpiSmemDout0ModeR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_dout1_mode(&self) -> SpiSmemDout1ModeR {
        SpiSmemDout1ModeR::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_dout2_mode(&self) -> SpiSmemDout2ModeR {
        SpiSmemDout2ModeR::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_dout3_mode(&self) -> SpiSmemDout3ModeR {
        SpiSmemDout3ModeR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_dout4_mode(&self) -> SpiSmemDout4ModeR {
        SpiSmemDout4ModeR::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_dout5_mode(&self) -> SpiSmemDout5ModeR {
        SpiSmemDout5ModeR::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_dout6_mode(&self) -> SpiSmemDout6ModeR {
        SpiSmemDout6ModeR::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_dout7_mode(&self) -> SpiSmemDout7ModeR {
        SpiSmemDout7ModeR::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_douts_mode(&self) -> SpiSmemDoutsModeR {
        SpiSmemDoutsModeR::new(((self.bits >> 8) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
    #[inline(always)]
    pub fn spi_smem_dout0_mode(&mut self) -> SpiSmemDout0ModeW<'_, SpiSmemDoutModeSpec> {
        SpiSmemDout0ModeW::new(self, 0)
    }
    #[doc = "Bit 1 - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
    #[inline(always)]
    pub fn spi_smem_dout1_mode(&mut self) -> SpiSmemDout1ModeW<'_, SpiSmemDoutModeSpec> {
        SpiSmemDout1ModeW::new(self, 1)
    }
    #[doc = "Bit 2 - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
    #[inline(always)]
    pub fn spi_smem_dout2_mode(&mut self) -> SpiSmemDout2ModeW<'_, SpiSmemDoutModeSpec> {
        SpiSmemDout2ModeW::new(self, 2)
    }
    #[doc = "Bit 3 - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
    #[inline(always)]
    pub fn spi_smem_dout3_mode(&mut self) -> SpiSmemDout3ModeW<'_, SpiSmemDoutModeSpec> {
        SpiSmemDout3ModeW::new(self, 3)
    }
    #[doc = "Bit 4 - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
    #[inline(always)]
    pub fn spi_smem_dout4_mode(&mut self) -> SpiSmemDout4ModeW<'_, SpiSmemDoutModeSpec> {
        SpiSmemDout4ModeW::new(self, 4)
    }
    #[doc = "Bit 5 - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
    #[inline(always)]
    pub fn spi_smem_dout5_mode(&mut self) -> SpiSmemDout5ModeW<'_, SpiSmemDoutModeSpec> {
        SpiSmemDout5ModeW::new(self, 5)
    }
    #[doc = "Bit 6 - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
    #[inline(always)]
    pub fn spi_smem_dout6_mode(&mut self) -> SpiSmemDout6ModeW<'_, SpiSmemDoutModeSpec> {
        SpiSmemDout6ModeW::new(self, 6)
    }
    #[doc = "Bit 7 - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
    #[inline(always)]
    pub fn spi_smem_dout7_mode(&mut self) -> SpiSmemDout7ModeW<'_, SpiSmemDoutModeSpec> {
        SpiSmemDout7ModeW::new(self, 7)
    }
    #[doc = "Bit 8 - the output signals are delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the posedge of clk_160,4 output with the negedge of clk_160,5: output with the spi_clk high edge ,6: output with the spi_clk low edge"]
    #[inline(always)]
    pub fn spi_smem_douts_mode(&mut self) -> SpiSmemDoutsModeW<'_, SpiSmemDoutModeSpec> {
        SpiSmemDoutsModeW::new(self, 8)
    }
}
...
pub struct SpiSmemDoutModeSpec;
impl crate::RegisterSpec for SpiSmemDoutModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi_smem_dout_mode::R`](R) reader structure"]
impl crate::Readable for SpiSmemDoutModeSpec {}
#[doc = "`write(|w| ..)` method takes [`spi_smem_dout_mode::W`](W) writer structure"]
impl crate::Writable for SpiSmemDoutModeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI_SMEM_DOUT_MODE to value 0"]
impl crate::Resettable for SpiSmemDoutModeSpec {}

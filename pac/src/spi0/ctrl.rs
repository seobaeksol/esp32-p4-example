...
pub type WdummyDqsAlwaysOutR = crate::BitReader;
...
pub type WdummyDqsAlwaysOutW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type WdummyAlwaysOutR = crate::BitReader;
...
pub type WdummyAlwaysOutW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DqsIeAlwaysOnR = crate::BitReader;
...
pub type DqsIeAlwaysOnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DataIeAlwaysOnR = crate::BitReader;
...
pub type DataIeAlwaysOnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn wdummy_dqs_always_out(&self) -> WdummyDqsAlwaysOutR {
        WdummyDqsAlwaysOutR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn wdummy_always_out(&self) -> WdummyAlwaysOutR {
        WdummyAlwaysOutR::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn dqs_ie_always_on(&self) -> DqsIeAlwaysOnR {
        DqsIeAlwaysOnR::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - When accesses to flash, 1: the IE signals of pads connected to SPI_IO\\[7:0\\] are always 1. 0: Others."]
    #[inline(always)]
    pub fn data_ie_always_on(&self) -> DataIeAlwaysOnR {
        DataIeAlwaysOnR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - In the dummy phase of an MSPI write data transfer when accesses to flash, the level of SPI_DQS is output by the MSPI controller."]
    #[inline(always)]
    pub fn wdummy_dqs_always_out(&mut self) -> WdummyDqsAlwaysOutW<'_, CtrlSpec> {
        WdummyDqsAlwaysOutW::new(self, 0)
    }
    #[doc = "Bit 1 - In the dummy phase of an MSPI write data transfer when accesses to flash, the level of SPI_IO\\[7:0\\] is output by the MSPI controller."]
    #[inline(always)]
    pub fn wdummy_always_out(&mut self) -> WdummyAlwaysOutW<'_, CtrlSpec> {
        WdummyAlwaysOutW::new(self, 1)
    }
    #[doc = "Bit 2 - In an MSPI read data transfer when accesses to flash, the level of SPI_IO\\[7:0\\] is output by the MSPI controller in the first half part of dummy phase. It is used to mask invalid SPI_DQS in the half part of dummy phase."]
    #[inline(always)]
    ...
    #[doc = "Bit 30 - When accesses to flash, 1: the IE signals of pads connected to SPI_DQS are always 1. 0: Others."]
    #[inline(always)]
    pub fn dqs_ie_always_on(&mut self) -> DqsIeAlwaysOnW<'_, CtrlSpec> {
        DqsIeAlwaysOnW::new(self, 30)
    }
    #[doc = "Bit 31 - When accesses to flash, 1: the IE signals of pads connected to SPI_IO\\[7:0\\] are always 1. 0: Others."]
    #[inline(always)]
    pub fn data_ie_always_on(&mut self) -> DataIeAlwaysOnW<'_, CtrlSpec> {
        DataIeAlwaysOnW::new(self, 31)
    }
}

...
pub type UsrDummyCyclelenW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Field `USR_DBYTELEN` reader - SPI0 USR_CMD read or write data byte length -1"]
pub type UsrDbytelenR = crate::FieldReader;
...
pub type UsrAddrBitlenW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ...
    pub fn usr_dummy_cyclelen(&self) -> UsrDummyCyclelenR {
        UsrDummyCyclelenR::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 6:8 - SPI0 USR_CMD read or write data byte length -1"]
    #[inline(always)]
    pub fn usr_dbytelen(&self) -> UsrDbytelenR {
        UsrDbytelenR::new(((self.bits >> 6) & 7) as u8)
    }
    ...
    pub fn usr_addr_bitlen(&self) -> UsrAddrBitlenR {
        UsrAddrBitlenR::new(((self.bits >> 26) & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5 - The length in spi_mem_clk cycles of dummy phase. The register value shall be (cycle_num-1)."]

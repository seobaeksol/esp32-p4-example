...
pub type Core1RegClkEnR = crate::BitReader;
#[doc = "Field `CORE1_REG_CLK_EN` writer - NA"]
pub type Core1RegClkEnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - NA"]
    #[inline(always)]
    pub fn core1_reg_clk_en(&self) -> Core1RegClkEnR {
        Core1RegClkEnR::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - NA"]
    #[inline(always)]
    pub fn core1_reg_clk_en(&mut self) -> Core1RegClkEnW<'_, ClockGateSpec> {
        Core1RegClkEnW::new(self, 0)
    }
}

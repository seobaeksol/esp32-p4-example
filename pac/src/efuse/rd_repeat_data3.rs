...
pub type SecureBootDisableFastWakeR = crate::BitReader;
#[doc = "Field `HYS_EN_PAD` reader - Set bits to enable hysteresis function of PAD0~27"]
pub type HysEnPadR = crate::BitReader;
#[doc = "Field `KEY_PURPOSE_0_H` reader - Purpose of Key0. The 5-th bit."]
pub type KeyPurpose0HR = crate::BitReader;
#[doc = "Field `KEY_PURPOSE_1_H` reader - Purpose of Key1. The 5-th bit."]
pub type KeyPurpose1HR = crate::BitReader;
#[doc = "Field `KEY_PURPOSE_2_H` reader - Purpose of Key2. The 5-th bit."]
pub type KeyPurpose2HR = crate::BitReader;
#[doc = "Field `KEY_PURPOSE_3_H` reader - Purpose of Key3. The 5-th bit."]
pub type KeyPurpose3HR = crate::BitReader;
#[doc = "Field `KEY_PURPOSE_4_H` reader - Purpose of Key4. The 5-th bit."]
pub type KeyPurpose4HR = crate::BitReader;
impl R {
    #[doc = "Bit 0 - Set this bit to disable download mode (boot_mode\\[3:0\\] = 0, 1, 2, 4, 5, 6, 7)."]
    #[inline(always)]
    pub fn dis_download_mode(&self) -> DisDownloadModeR {
        DisDownloadModeR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Set this bit to disable direct boot mode"]
    #[inline(always)]
    pub fn dis_direct_boot(&self) -> DisDirectBootR {
        DisDirectBootR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Set this bit to disable USB-Serial-JTAG print during rom boot."]
    #[inline(always)]
    pub fn dis_usb_serial_jtag_rom_print(&self) -> DisUsbSerialJtagRomPrintR {
        DisUsbSerialJtagRomPrintR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - set this bit to lock the key manager key after deploy"]
    #[inline(always)]
    pub fn lock_km_key(&self) -> LockKmKeyR {
        LockKmKeyR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Set this bit to disable the USB-Serial-JTAG download function."]
    #[inline(always)]
    pub fn dis_usb_serial_jtag_download_mode(&self) -> DisUsbSerialJtagDownloadModeR {
        DisUsbSerialJtagDownloadModeR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Set this bit to enable security download mode."]
    #[inline(always)]
    pub fn enable_security_download(&self) -> EnableSecurityDownloadR {
        EnableSecurityDownloadR::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn uart_print_control(&self) -> UartPrintControlR {
        UartPrintControlR::new(((self.bits >> 6) & 3) as u8)
    }
    #[doc = "Bit 8 - Set this bit to force ROM code to send a resume command during SPI boot."]
    #[inline(always)]
    pub fn force_send_resume(&self) -> ForceSendResumeR {
        ForceSendResumeR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bits 9:24 - Secure version used by ESP-IDF anti-rollback feature."]
    #[inline(always)]
    pub fn secure_version(&self) -> SecureVersionR {
        SecureVersionR::new(((self.bits >> 9) & 0xffff) as u16)
    }
    #[doc = "Bit 25 - Represents whether secure boot do fast verification on wake is disabled. 0: enabled 1: disabled"]
    #[inline(always)]
    pub fn secure_boot_disable_fast_wake(&self) -> SecureBootDisableFastWakeR {
        SecureBootDisableFastWakeR::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - Set bits to enable hysteresis function of PAD0~27"]
    #[inline(always)]
    pub fn hys_en_pad(&self) -> HysEnPadR {
        HysEnPadR::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - Purpose of Key0. The 5-th bit."]
    #[inline(always)]
    pub fn key_purpose_0_h(&self) -> KeyPurpose0HR {
        KeyPurpose0HR::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - Purpose of Key1. The 5-th bit."]
    #[inline(always)]
    pub fn key_purpose_1_h(&self) -> KeyPurpose1HR {
        KeyPurpose1HR::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - Purpose of Key2. The 5-th bit."]
    #[inline(always)]
    pub fn key_purpose_2_h(&self) -> KeyPurpose2HR {
        KeyPurpose2HR::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - Purpose of Key3. The 5-th bit."]
    #[inline(always)]
    pub fn key_purpose_3_h(&self) -> KeyPurpose3HR {
        KeyPurpose3HR::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - Purpose of Key4. The 5-th bit."]
    #[inline(always)]
    pub fn key_purpose_4_h(&self) -> KeyPurpose4HR {
        KeyPurpose4HR::new(((self.bits >> 31) & 1) != 0)
    }
}
...
pub struct RdRepeatData3Spec;
impl crate::RegisterSpec for RdRepeatData3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rd_repeat_data3::R`](R) reader structure"]
impl crate::Readable for RdRepeatData3Spec {}
#[doc = "`reset()` method sets RD_REPEAT_DATA3 to value 0"]
impl crate::Resettable for RdRepeatData3Spec {}

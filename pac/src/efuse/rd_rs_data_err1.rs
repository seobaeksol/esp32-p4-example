...
pub type R = crate::R<RdRsDataErr1Spec>;
...
pub type RdKey5DataErrNumR = crate::FieldReader;
...
pub type RdKey5DataFailR = crate::BitReader;
...
pub type RdSysPart2DataErrNumR = crate::FieldReader;
...
pub type RdSysPart2DataFailR = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn rd_key5_data_err_num(&self) -> RdKey5DataErrNumR {
        RdKey5DataErrNumR::new((self.bits & 7) as u8)
    }
    ...
    #[inline(always)]
    pub fn rd_key5_data_fail(&self) -> RdKey5DataFailR {
        RdKey5DataFailR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn rd_sys_part2_data_err_num(&self) -> RdSysPart2DataErrNumR {
        RdSysPart2DataErrNumR::new(((self.bits >> 4) & 7) as u8)
    }
    ...
    #[inline(always)]
    pub fn rd_sys_part2_data_fail(&self) -> RdSysPart2DataFailR {
        RdSysPart2DataFailR::new(((self.bits >> 7) & 1) != 0)
    }
}
...
pub struct RdRsDataErr1Spec;
impl crate::RegisterSpec for RdRsDataErr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rd_rs_data_err1::R`](R) reader structure"]
impl crate::Readable for RdRsDataErr1Spec {}
#[doc = "`reset()` method sets RD_RS_DATA_ERR1 to value 0"]
impl crate::Resettable for RdRsDataErr1Spec {}

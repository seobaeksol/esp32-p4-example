...
pub type R = crate::R<Apb2otpBlk3W9Spec>;
#[doc = "Field `APB2OTP_BLOCK3_W9` reader - Otp block3 word9 data."]
pub type Apb2otpBlock3W9R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Otp block3 word9 data."]
    #[inline(always)]
    pub fn apb2otp_block3_w9(&self) -> Apb2otpBlock3W9R {
        Apb2otpBlock3W9R::new(self.bits)
    }
}
...
pub struct Apb2otpBlk3W9Spec;
impl crate::RegisterSpec for Apb2otpBlk3W9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb2otp_blk3_w9::R`](R) reader structure"]
impl crate::Readable for Apb2otpBlk3W9Spec {}
#[doc = "`reset()` method sets APB2OTP_BLK3_W9 to value 0"]
impl crate::Resettable for Apb2otpBlk3W9Spec {}

...
pub type R = crate::R<Apb2otpBlk9W2Spec>;
#[doc = "Field `APB2OTP_BLOCK9_W2` reader - Otp block9 word2 data."]
pub type Apb2otpBlock9W2R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Otp block9 word2 data."]
    #[inline(always)]
    pub fn apb2otp_block9_w2(&self) -> Apb2otpBlock9W2R {
        Apb2otpBlock9W2R::new(self.bits)
    }
}
...
pub struct Apb2otpBlk9W2Spec;
impl crate::RegisterSpec for Apb2otpBlk9W2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb2otp_blk9_w2::R`](R) reader structure"]
impl crate::Readable for Apb2otpBlk9W2Spec {}
#[doc = "`reset()` method sets APB2OTP_BLK9_W2 to value 0"]
impl crate::Resettable for Apb2otpBlk9W2Spec {}

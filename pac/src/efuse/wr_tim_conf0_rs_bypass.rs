...
pub type TpgmInactiveR = crate::FieldReader;
#[doc = "Field `TPGM_INACTIVE` writer - Configures the inactive programming time."]
pub type TpgmInactiveW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bit 0 - Set this bit to bypass reed solomon correction step."]
    #[inline(always)]
    pub fn bypass_rs_correction(&self) -> BypassRsCorrectionR {
        BypassRsCorrectionR::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 1:11 - Configures block number of programming twice operation."]
    #[inline(always)]
    pub fn bypass_rs_blk_num(&self) -> BypassRsBlkNumR {
        BypassRsBlkNumR::new(((self.bits >> 1) & 0x07ff) as u16)
    }
    #[doc = "Bits 13:20 - Configures the inactive programming time."]
    #[inline(always)]
    pub fn tpgm_inactive(&self) -> TpgmInactiveR {
        TpgmInactiveR::new(((self.bits >> 13) & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - Set this bit to bypass reed solomon correction step."]
    #[inline(always)]
    pub fn bypass_rs_correction(&mut self) -> BypassRsCorrectionW<'_, WrTimConf0RsBypassSpec> {
        BypassRsCorrectionW::new(self, 0)
    }
    #[doc = "Bits 1:11 - Configures block number of programming twice operation."]
    #[inline(always)]
    pub fn bypass_rs_blk_num(&mut self) -> BypassRsBlkNumW<'_, WrTimConf0RsBypassSpec> {
        BypassRsBlkNumW::new(self, 1)
    }
    #[doc = "Bit 12 - Set this bit to update multi-bit register signals."]
    #[inline(always)]
    pub fn update(&mut self) -> UpdateW<'_, WrTimConf0RsBypassSpec> {
        UpdateW::new(self, 12)
    }
    #[doc = "Bits 13:20 - Configures the inactive programming time."]
    #[inline(always)]
    pub fn tpgm_inactive(&mut self) -> TpgmInactiveW<'_, WrTimConf0RsBypassSpec> {
        TpgmInactiveW::new(self, 13)
    }
}
...
pub struct WrTimConf0RsBypassSpec;
impl crate::RegisterSpec for WrTimConf0RsBypassSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wr_tim_conf0_rs_bypass::R`](R) reader structure"]
impl crate::Readable for WrTimConf0RsBypassSpec {}
#[doc = "`write(|w| ..)` method takes [`wr_tim_conf0_rs_bypass::W`](W) writer structure"]
impl crate::Writable for WrTimConf0RsBypassSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WR_TIM_CONF0_RS_BYPASS to value 0x2000"]
impl crate::Resettable for WrTimConf0RsBypassSpec {

...
pub type R = crate::R<Apb2otpBlk10W4Spec>;
#[doc = "Field `APB2OTP_BLOCK10_W4` reader - Otp block10 word4 data."]
pub type Apb2otpBlock10W4R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Otp block10 word4 data."]
    #[inline(always)]
    pub fn apb2otp_block10_w4(&self) -> Apb2otpBlock10W4R {
        Apb2otpBlock10W4R::new(self.bits)
    }
}
...
pub struct Apb2otpBlk10W4Spec;
impl crate::RegisterSpec for Apb2otpBlk10W4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb2otp_blk10_w4::R`](R) reader structure"]
impl crate::Readable for Apb2otpBlk10W4Spec {}
#[doc = "`reset()` method sets APB2OTP_BLK10_W4 to value 0"]
impl crate::Resettable for Apb2otpBlk10W4Spec {}

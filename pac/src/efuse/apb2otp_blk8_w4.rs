...
pub type R = crate::R<Apb2otpBlk8W4Spec>;
#[doc = "Field `APB2OTP_BLOCK8_W4` reader - Otp block8 word4 data."]
pub type Apb2otpBlock8W4R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Otp block8 word4 data."]
    #[inline(always)]
    pub fn apb2otp_block8_w4(&self) -> Apb2otpBlock8W4R {
        Apb2otpBlock8W4R::new(self.bits)
    }
}
...
pub struct Apb2otpBlk8W4Spec;
impl crate::RegisterSpec for Apb2otpBlk8W4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb2otp_blk8_w4::R`](R) reader structure"]
impl crate::Readable for Apb2otpBlk8W4Spec {}
#[doc = "`reset()` method sets APB2OTP_BLK8_W4 to value 0"]
impl crate::Resettable for Apb2otpBlk8W4Spec {}

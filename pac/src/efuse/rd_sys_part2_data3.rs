...
pub struct RdSysPart2Data3Spec;
impl crate::RegisterSpec for RdSysPart2Data3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rd_sys_part2_data3::R`](R) reader structure"]
impl crate::Readable for RdSysPart2Data3Spec {}
#[doc = "`reset()` method sets RD_SYS_PART2_DATA3 to value 0"]
impl crate::Resettable for RdSysPart2Data3Spec {}

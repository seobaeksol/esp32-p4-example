...
pub type R = crate::R<RdRepeatData1Spec>;
...
pub type RecoveryBootloaderFlashSector8_10R = crate::FieldReader;
...
pub type RecoveryBootloaderFlashSector11_11R = crate::BitReader;
...
pub type KmRndSwitchCycleR = crate::BitReader;
...
pub type KmDeployOnlyOnceR = crate::FieldReader;
...
pub type ForceUseKeyManagerKeyR = crate::FieldReader;
...
pub type ForceDisableSwInitKeyR = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn recovery_bootloader_flash_sector_8_10(&self) -> RecoveryBootloaderFlashSector8_10R {
        RecoveryBootloaderFlashSector8_10R::new((self.bits & 7) as u8)
    }
    ...
    #[inline(always)]
    pub fn recovery_bootloader_flash_sector_11_11(&self) -> RecoveryBootloaderFlashSector11_11R {
        RecoveryBootloaderFlashSector11_11R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn km_rnd_switch_cycle(&self) -> KmRndSwitchCycleR {
        KmRndSwitchCycleR::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn km_deploy_only_once(&self) -> KmDeployOnlyOnceR {
        KmDeployOnlyOnceR::new(((self.bits >> 5) & 0x0f) as u8)
    }
    ...
    #[inline(always)]
    pub fn force_use_key_manager_key(&self) -> ForceUseKeyManagerKeyR {
        ForceUseKeyManagerKeyR::new(((self.bits >> 9) & 0x0f) as u8)
    }
    #[doc = "Bit 13 - Set this bit to disable software written init key, and force use efuse_init_key."]
    #[inline(always)]
    pub fn force_disable_sw_init_key(&self) -> ForceDisableSwInitKeyR {
        ForceDisableSwInitKeyR::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Set this bit to config flash encryption xts-512 key, else use xts-256 key when using the key manager"]
    #[inline(always)]
    pub fn km_xts_key_length_256(&self) -> KmXtsKeyLength256R {
        KmXtsKeyLength256R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - Set this bit to permanently turn on ECC const-time mode."]
    #[inline(always)]
    pub fn ecc_force_const_time(&self) -> EccForceConstTimeR {
        EccForceConstTimeR::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 17 - Select lp wdt timeout threshold at startup = initial timeout value * (2 ^ (EFUSE_WDT_DELAY_SEL + 1))"]
    #[inline(always)]
    pub fn wdt_delay_sel(&self) -> WdtDelaySelR {
        WdtDelaySelR::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bits 18:20 - Set this bit to enable SPI boot encrypt/decrypt. Odd number of 1: enable. even number of 1: disable."]
    #[inline(always)]
    pub fn spi_boot_crypt_cnt(&self) -> SpiBootCryptCntR {
        SpiBootCryptCntR::new(((self.bits >> 18) & 7) as u8)
    }
    #[doc = "Bit 21 - Set this bit to enable revoking first secure boot key."]
    #[inline(always)]
    pub fn secure_boot_key_revoke0(&self) -> SecureBootKeyRevoke0R {
        SecureBootKeyRevoke0R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - Set this bit to enable revoking second secure boot key."]
    #[inline(always)]
    pub fn secure_boot_key_revoke1(&self) -> SecureBootKeyRevoke1R {
        SecureBootKeyRevoke1R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - Set this bit to enable revoking third secure boot key."]
    #[inline(always)]
    pub fn secure_boot_key_revoke2(&self) -> SecureBootKeyRevoke2R {
        SecureBootKeyRevoke2R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bits 24:27 - Purpose of Key0."]
    #[inline(always)]
    pub fn key_purpose_0(&self) -> KeyPurpose0R {
        KeyPurpose0R::new(((self.bits >> 24) & 0x0f) as u8)
    }
    #[doc = "Bits 28:31 - Purpose of Key1."]
    #[inline(always)]
    pub fn key_purpose_1(&self) -> KeyPurpose1R {
        KeyPurpose1R::new(((self.bits >> 28) & 0x0f) as u8)
    }
}
...
pub struct RdRepeatData1Spec;
impl crate::RegisterSpec for RdRepeatData1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rd_repeat_data1::R`](R) reader structure"]
impl crate::Readable for RdRepeatData1Spec {}
#[doc = "`reset()` method sets RD_REPEAT_DATA1 to value 0"]
impl crate::Resettable for RdRepeatData1Spec {}

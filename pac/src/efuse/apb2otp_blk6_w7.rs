...
pub type R = crate::R<Apb2otpBlk6W7Spec>;
#[doc = "Field `APB2OTP_BLOCK6_W7` reader - Otp block6 word7 data."]
pub type Apb2otpBlock6W7R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Otp block6 word7 data."]
    #[inline(always)]
    pub fn apb2otp_block6_w7(&self) -> Apb2otpBlock6W7R {
        Apb2otpBlock6W7R::new(self.bits)
    }
}
...
pub struct Apb2otpBlk6W7Spec;
impl crate::RegisterSpec for Apb2otpBlk6W7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb2otp_blk6_w7::R`](R) reader structure"]
impl crate::Readable for Apb2otpBlk6W7Spec {}
#[doc = "`reset()` method sets APB2OTP_BLK6_W7 to value 0"]
impl crate::Resettable for Apb2otpBlk6W7Spec {}

...
pub type R = crate::R<Apb2otpBlk10W1Spec>;
#[doc = "Field `APB2OTP_BLOCK10_W1` reader - Otp block10 word1 data."]
pub type Apb2otpBlock10W1R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Otp block10 word1 data."]
    #[inline(always)]
    pub fn apb2otp_block10_w1(&self) -> Apb2otpBlock10W1R {
        Apb2otpBlock10W1R::new(self.bits)
    }
}
...
pub struct Apb2otpBlk10W1Spec;
impl crate::RegisterSpec for Apb2otpBlk10W1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb2otp_blk10_w1::R`](R) reader structure"]
impl crate::Readable for Apb2otpBlk10W1Spec {}
#[doc = "`reset()` method sets APB2OTP_BLK10_W1 to value 0"]
impl crate::Resettable for Apb2otpBlk10W1Spec {}

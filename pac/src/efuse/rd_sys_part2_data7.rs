...
pub struct RdSysPart2Data7Spec;
impl crate::RegisterSpec for RdSysPart2Data7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rd_sys_part2_data7::R`](R) reader structure"]
impl crate::Readable for RdSysPart2Data7Spec {}
#[doc = "`reset()` method sets RD_SYS_PART2_DATA7 to value 0"]
impl crate::Resettable for RdSysPart2Data7Spec {}

...
pub type R = crate::R<Apb2otpBlk0Backup4W3Spec>;
#[doc = "Field `APB2OTP_BLOCK0_BACKUP4_W3` reader - Otp block0 backup4 word3 data."]
pub type Apb2otpBlock0Backup4W3R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Otp block0 backup4 word3 data."]
    #[inline(always)]
    pub fn apb2otp_block0_backup4_w3(&self) -> Apb2otpBlock0Backup4W3R {
        Apb2otpBlock0Backup4W3R::new(self.bits)
    }
}
...
pub struct Apb2otpBlk0Backup4W3Spec;
impl crate::RegisterSpec for Apb2otpBlk0Backup4W3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb2otp_blk0_backup4_w3::R`](R) reader structure"]
impl crate::Readable for Apb2otpBlk0Backup4W3Spec {}
#[doc = "`reset()` method sets APB2OTP_BLK0_BACKUP4_W3 to value 0"]
impl crate::Resettable for Apb2otpBlk0Backup4W3Spec {}

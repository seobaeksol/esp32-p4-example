...
pub type R = crate::R<Apb2otpBlk7W5Spec>;
#[doc = "Field `APB2OTP_BLOCK7_W5` reader - Otp block7 word5 data."]
pub type Apb2otpBlock7W5R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Otp block7 word5 data."]
    #[inline(always)]
    pub fn apb2otp_block7_w5(&self) -> Apb2otpBlock7W5R {
        Apb2otpBlock7W5R::new(self.bits)
    }
}
...
pub struct Apb2otpBlk7W5Spec;
impl crate::RegisterSpec for Apb2otpBlk7W5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb2otp_blk7_w5::R`](R) reader structure"]
impl crate::Readable for Apb2otpBlk7W5Spec {}
#[doc = "`reset()` method sets APB2OTP_BLK7_W5 to value 0"]
impl crate::Resettable for Apb2otpBlk7W5Spec {}

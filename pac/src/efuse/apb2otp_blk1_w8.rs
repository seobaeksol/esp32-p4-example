...
pub type R = crate::R<Apb2otpBlk1W8Spec>;
#[doc = "Field `APB2OTP_BLOCK1_W8` reader - Otp block1 word8 data."]
pub type Apb2otpBlock1W8R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Otp block1 word8 data."]
    #[inline(always)]
    pub fn apb2otp_block1_w8(&self) -> Apb2otpBlock1W8R {
        Apb2otpBlock1W8R::new(self.bits)
    }
}
...
pub struct Apb2otpBlk1W8Spec;
impl crate::RegisterSpec for Apb2otpBlk1W8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb2otp_blk1_w8::R`](R) reader structure"]
impl crate::Readable for Apb2otpBlk1W8Spec {}
#[doc = "`reset()` method sets APB2OTP_BLK1_W8 to value 0"]
impl crate::Resettable for Apb2otpBlk1W8Spec {}

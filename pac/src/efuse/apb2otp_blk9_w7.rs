...
pub type R = crate::R<Apb2otpBlk9W7Spec>;
#[doc = "Field `APB2OTP_BLOCK9_W7` reader - Otp block9 word7 data."]
pub type Apb2otpBlock9W7R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Otp block9 word7 data."]
    #[inline(always)]
    pub fn apb2otp_block9_w7(&self) -> Apb2otpBlock9W7R {
        Apb2otpBlock9W7R::new(self.bits)
    }
}
...
pub struct Apb2otpBlk9W7Spec;
impl crate::RegisterSpec for Apb2otpBlk9W7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apb2otp_blk9_w7::R`](R) reader structure"]
impl crate::Readable for Apb2otpBlk9W7Spec {}
#[doc = "`reset()` method sets APB2OTP_BLK9_W7 to value 0"]
impl crate::Resettable for Apb2otpBlk9W7Spec {}

...
pub type R = crate::R<DhtCodeminDc0Spec>;
...
pub type DhtCodeminDc0R = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn dht_codemin_dc0(&self) -> DhtCodeminDc0R {
        DhtCodeminDc0R::new(self.bits)
    }
}
...
pub struct DhtCodeminDc0Spec;
impl crate::RegisterSpec for DhtCodeminDc0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dht_codemin_dc0::R`](R) reader structure"]
impl crate::Readable for DhtCodeminDc0Spec {}
#[doc = "`reset()` method sets DHT_CODEMIN_DC0 to value 0"]
impl crate::Resettable for DhtCodeminDc0Spec {}

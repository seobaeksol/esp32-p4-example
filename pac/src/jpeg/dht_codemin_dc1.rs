...
pub type R = crate::R<DhtCodeminDc1Spec>;
...
pub type DhtCodeminDc1R = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn dht_codemin_dc1(&self) -> DhtCodeminDc1R {
        DhtCodeminDc1R::new(self.bits)
    }
}
...
pub struct DhtCodeminDc1Spec;
impl crate::RegisterSpec for DhtCodeminDc1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dht_codemin_dc1::R`](R) reader structure"]
impl crate::Readable for DhtCodeminDc1Spec {}
#[doc = "`reset()` method sets DHT_CODEMIN_DC1 to value 0"]
impl crate::Resettable for DhtCodeminDc1Spec {}

...
pub type R = crate::R<PicSizeSpec>;
#[doc = "Register `PIC_SIZE` writer"]
pub type W = crate::W<PicSizeSpec>;
...
pub type VaW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
...
pub type HaR = crate::FieldReader<u16>;
...
pub type HaW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ...
    #[inline(always)]
    pub fn va(&self) -> VaR {
        VaR::new((self.bits & 0xffff) as u16)
    }
    ...
    #[inline(always)]
    pub fn ha(&self) -> HaR {
        HaR::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - configure picture's height. when encode, the max configurable bits is 14, when decode, the max configurable bits is 16"]
    #[inline(always)]
    pub fn va(&mut self) -> VaW<'_, PicSizeSpec> {
        VaW::new(self, 0)
    }
    #[doc = "Bits 16:31 - configure picture's width. when encode, the max configurable bits is 14, when decode, the max configurable bits is 16"]
    #[inline(always)]
    pub fn ha(&mut self) -> HaW<'_, PicSizeSpec> {
        HaW::new(self, 16)
    }
}
...
pub struct PicSizeSpec;
impl crate::RegisterSpec for PicSizeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pic_size::R`](R) reader structure"]
impl crate::Readable for PicSizeSpec {}
#[doc = "`write(|w| ..)` method takes [`pic_size::W`](W) writer structure"]
impl crate::Writable for PicSizeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PIC_SIZE to value 0x0280_01e0"]
impl crate::Resettable for PicSizeSpec {

...
impl R {
    ...
    #[inline(always)]
    pub fn dqt_tbl_sel(&self) -> DqtTblSelR {
        DqtTblSelR::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:11 - vertical sampling factor of c0"]
    #[inline(always)]
    pub fn y_factor(&self) -> YFactorR {
        YFactorR::new(((self.bits >> 8) & 0x0f) as u8)
    }
    #[doc = "Bits 12:15 - horizontal sampling factor of c0"]
    #[inline(always)]
    pub fn x_factor(&self) -> XFactorR {
        XFactorR::new(((self.bits >> 12) & 0x0f) as u8)
    }
    #[doc = "Bits 16:23 - the identifier of c0"]
    #[inline(always)]
    pub fn id(&self) -> IdR {
        IdR::new(((self.bits >> 16) & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7 - choose c0 quntization table id (TBD)"]
    #[inline(always)]
    pub fn dqt_tbl_sel(&mut self) -> DqtTblSelW<'_, CSpec> {
        DqtTblSelW::new(self, 0)
    }
    #[doc = "Bits 8:11 - vertical sampling factor of c0"]
    #[inline(always)]
    pub fn y_factor(&mut self) -> YFactorW<'_, CSpec> {
        YFactorW::new(self, 8)
    }
    #[doc = "Bits 12:15 - horizontal sampling factor of c0"]
    #[inline(always)]
    pub fn x_factor(&mut self) -> XFactorW<'_, CSpec> {
        XFactorW::new(self, 12)
    }
    #[doc = "Bits 16:23 - the identifier of c0"]
    #[inline(always)]
    pub fn id(&mut self) -> IdW<'_, CSpec> {
        IdW::new(self, 16)
    }
}

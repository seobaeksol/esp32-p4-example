...
pub struct DhtTotlenDc0Spec;
impl crate::RegisterSpec for DhtTotlenDc0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dht_totlen_dc0::R`](R) reader structure"]
impl crate::Readable for DhtTotlenDc0Spec {}
#[doc = "`reset()` method sets DHT_TOTLEN_DC0 to value 0"]
impl crate::Resettable for DhtTotlenDc0Spec {}

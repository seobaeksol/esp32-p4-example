...
pub type DhtFifoEnR = crate::BitReader;
...
pub type DhtFifoEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DecodeTimeoutThresR = crate::FieldReader;
...
pub type DecodeTimeoutThresW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
pub type DecodeTimeoutTaskSelR = crate::BitReader;
...
pub type DecodeTimeoutTaskSelW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn qnr_precision(&self) -> QnrPrecisionR {
        QnrPrecisionR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - enable whether to add '00' after 'ff'"]
    #[inline(always)]
    pub fn ff_check_en(&self) -> FfCheckEnR {
        FfCheckEnR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bits 4:5 - 0:yuv444,1:yuv422, 2:yuv420"]
    #[inline(always)]
    pub fn sample_sel(&self) -> SampleSelR {
        SampleSelR::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bit 6 - 1:use linklist to configure dma"]
    #[inline(always)]
    pub fn dma_linklist_mode(&self) -> DmaLinklistModeR {
        DmaLinklistModeR::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - 0:normal mode,1:debug mode for direct output from input"]
    #[inline(always)]
    pub fn debug_direct_out_en(&self) -> DebugDirectOutEnR {
        DebugDirectOutEnR::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - 0:use non-fifo way to access qnr ram,1:use fifo way to access qnr ram"]
    #[inline(always)]
    pub fn qnr_fifo_en(&self) -> QnrFifoEnR {
        QnrFifoEnR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bits 9:10 - choose luminance quntization table id(TBD)"]
    #[inline(always)]
    pub fn lqnr_tbl_sel(&self) -> LqnrTblSelR {
        LqnrTblSelR::new(((self.bits >> 9) & 3) as u8)
    }
    #[doc = "Bits 11:12 - choose chrominance quntization table id (TBD)"]
    #[inline(always)]
    pub fn cqnr_tbl_sel(&self) -> CqnrTblSelR {
        CqnrTblSelR::new(((self.bits >> 11) & 3) as u8)
    }
    #[doc = "Bits 13:14 - configure picture's color space:0-rb888,1-yuv422,2-rgb565, 3-gray"]
    #[inline(always)]
    pub fn color_space(&self) -> ColorSpaceR {
        ColorSpaceR::new(((self.bits >> 13) & 3) as u8)
    }
...
impl W {
    #[doc = "Bit 0 - fsm reset"]
    #[inline(always)]
    pub fn fsm_rst(&mut self) -> FsmRstW<'_, ConfigSpec> {
        FsmRstW::new(self, 0)
    }
    #[doc = "Bit 1 - start to compress a new pic(in dma reg mode)"]
    #[inline(always)]
    pub fn jpeg_start(&mut self) -> JpegStartW<'_, ConfigSpec> {
        JpegStartW::new(self, 1)
    }
    #[doc = "Bit 2 - 0:8bit qnr,1:12bit qnr(TBD)"]
    #[inline(always)]
    pub fn qnr_precision(&mut self) -> QnrPrecisionW<'_, ConfigSpec> {
        QnrPrecisionW::new(self, 2)
    }
    #[doc = "Bit 3 - enable whether to add '00' after 'ff'"]
    #[inline(always)]
    pub fn ff_check_en(&mut self) -> FfCheckEnW<'_, ConfigSpec> {
        FfCheckEnW::new(self, 3)
    }
    #[doc = "Bits 4:5 - 0:yuv444,1:yuv422, 2:yuv420"]
    #[inline(always)]
    pub fn sample_sel(&mut self) -> SampleSelW<'_, ConfigSpec> {
        SampleSelW::new(self, 4)
    }
    #[doc = "Bit 7 - 0:normal mode,1:debug mode for direct output from input"]
    #[inline(always)]
    pub fn debug_direct_out_en(&mut self) -> DebugDirectOutEnW<'_, ConfigSpec> {
        DebugDirectOutEnW::new(self, 7)
    }
    #[doc = "Bit 8 - 0:use non-fifo way to access qnr ram,1:use fifo way to access qnr ram"]
    #[inline(always)]
    pub fn qnr_fifo_en(&mut self) -> QnrFifoEnW<'_, ConfigSpec> {
        QnrFifoEnW::new(self, 8)
    }
    #[doc = "Bits 9:10 - choose luminance quntization table id(TBD)"]
    #[inline(always)]
    pub fn lqnr_tbl_sel(&mut self) -> LqnrTblSelW<'_, ConfigSpec> {
        LqnrTblSelW::new(self, 9)
    }
    #[doc = "Bits 11:12 - choose chrominance quntization table id (TBD)"]
    #[inline(always)]
    pub fn cqnr_tbl_sel(&mut self) -> CqnrTblSelW<'_, ConfigSpec> {
        CqnrTblSelW::new(self, 11)
    }
    #[doc = "Bits 13:14 - configure picture's color space:0-rb888,1-yuv422,2-rgb565, 3-gray"]
    #[inline(always)]
    pub fn color_space(&mut self) -> ColorSpaceW<'_, ConfigSpec> {
        ColorSpaceW::new(self, 13)
    }
    #[doc = "Bit 15 - 0:use non-fifo way to write dht len_total/codemin/value table,1:use fifo way to write dht len_total/codemin/value table. Reading dht len_total/codemin/value table only has nonfifo way"]
    #[inline(always)]
    pub fn dht_fifo_en(&mut self) -> DhtFifoEnW<'_, ConfigSpec> {
        DhtFifoEnW::new(self, 15)
    }
    #[doc = "Bit 16 - force memory's clock enabled"]
    #[inline(always)]
    pub fn mem_clk_force_on(&mut self) -> MemClkForceOnW<'_, ConfigSpec> {
        MemClkForceOnW::new(self, 16)
    }
    #[doc = "Bits 17:22 - decode pause period to trigger decode_timeout int, the timeout periods =2 power (reg_decode_timeout_thres) -1"]
    #[inline(always)]
    pub fn decode_timeout_thres(&mut self) -> DecodeTimeoutThresW<'_, ConfigSpec> {
        DecodeTimeoutThresW::new(self, 17)
    }
    #[doc = "Bit 23 - 0: software use reset to abort decode process ,1: decoder abort decode process by itself"]
    #[inline(always)]
    pub fn decode_timeout_task_sel(&mut self) -> DecodeTimeoutTaskSelW<'_, ConfigSpec> {
        DecodeTimeoutTaskSelW::new(self, 23)
    }
    #[doc = "Bit 24 - when set to 1, soft reset JPEG module except jpeg_reg module"]
    #[inline(always)]
    pub fn soft_rst(&mut self) -> SoftRstW<'_, ConfigSpec> {
        SoftRstW::new(self, 24)
    }
    #[doc = "Bit 25 - fifo reset"]
    #[inline(always)]
    pub fn fifo_rst(&mut self) -> FifoRstW<'_, ConfigSpec> {
        FifoRstW::new(self, 25)
    }
    #[doc = "Bit 26 - reverse the source color pixel"]
    #[inline(always)]
    pub fn pixel_rev(&mut self) -> PixelRevW<'_, ConfigSpec> {
        PixelRevW::new(self, 26)
    }
    #[doc = "Bit 27 - set this bit to add EOI of '0xffd9' at the end of bitstream"]
    #[inline(always)]
    pub fn tailer_en(&mut self) -> TailerEnW<'_, ConfigSpec> {
        TailerEnW::new(self, 27)
    }
    #[doc = "Bit 28 - set this bit to pause jpeg encoding"]
    #[inline(always)]
    pub fn pause_en(&mut self) -> PauseEnW<'_, ConfigSpec> {
        PauseEnW::new(self, 28)
    }
    #[doc = "Bit 29 - 0: no operation,1:force jpeg memory to power down"]
    #[inline(always)]
    pub fn mem_force_pd(&mut self) -> MemForcePdW<'_, ConfigSpec> {
        MemForcePdW::new(self, 29)
    }
    #[doc = "Bit 30 - 0: no operation,1:force jpeg memory to power up"]
    #[inline(always)]
    pub fn mem_force_pu(&mut self) -> MemForcePuW<'_, ConfigSpec> {
        MemForcePuW::new(self, 30)
    }
    #[doc = "Bit 31 - 0:encoder mode, 1: decoder mode"]
    #[inline(always)]

...
pub struct DhtValDc1Spec;
impl crate::RegisterSpec for DhtValDc1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dht_val_dc1::R`](R) reader structure"]
impl crate::Readable for DhtValDc1Spec {}
#[doc = "`reset()` method sets DHT_VAl_DC1 to value 0"]
impl crate::Resettable for DhtValDc1Spec {}

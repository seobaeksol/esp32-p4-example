...
pub type CDhtDcIdErrW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type CDhtAcIdErrW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type CDqtIdErrW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type RstUxpErrW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type RstCheckNoneErrW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type RstCheckPosErrW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type EnFrameEofErrW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type EnFrameEofLackW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type DeFrameEofErrW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type DeFrameEofLackW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type SosUnmatchErrW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type MarkerErrFstScanW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type MarkerErrOtherScanW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type UndetW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type DecodeTimeoutW<'a, REG> = crate::BitWriter1C<'a, REG>;
impl W {
    ...
    #[inline(always)]
    pub fn rle_parallel_err(&mut self) -> RleParallelErrW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn cid_err(&mut self) -> CidErrW<'_, IntClrSpec> {
        CidErrW::new(self, 2)
    }
    ...
    #[inline(always)]
    pub fn c_dht_dc_id_err(&mut self) -> CDhtDcIdErrW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn c_dht_ac_id_err(&mut self) -> CDhtAcIdErrW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn c_dqt_id_err(&mut self) -> CDqtIdErrW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn rst_uxp_err(&mut self) -> RstUxpErrW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn rst_check_none_err(&mut self) -> RstCheckNoneErrW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn rst_check_pos_err(&mut self) -> RstCheckPosErrW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn scan_check_none_err(&mut self) -> ScanCheckNoneErrW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn scan_check_pos_err(&mut self) -> ScanCheckPosErrW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn en_frame_eof_lack(&mut self) -> EnFrameEofLackW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn de_frame_eof_err(&mut self) -> DeFrameEofErrW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn de_frame_eof_lack(&mut self) -> DeFrameEofLackW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn sos_unmatch_err(&mut self) -> SosUnmatchErrW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn marker_err_fst_scan(&mut self) -> MarkerErrFstScanW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn marker_err_other_scan(&mut self) -> MarkerErrOtherScanW<'_, IntClrSpec> {
    ...
    #[inline(always)]
    pub fn undet(&mut self) -> UndetW<'_, IntClrSpec> {
        UndetW::new(self, 23)
    }
    ...
    #[inline(always)]
    pub fn decode_timeout(&mut self) -> DecodeTimeoutW<'_, IntClrSpec> {

...
pub type R = crate::R<HpSleepLpRegulator1Spec>;
#[doc = "Register `HP_SLEEP_LP_REGULATOR1` writer"]
pub type W = crate::W<HpSleepLpRegulator1Spec>;
#[doc = "Field `HP_SLEEP_LP_REGULATOR_DRV_B` reader - need_des"]
pub type HpSleepLpRegulatorDrvBR = crate::FieldReader;
#[doc = "Field `HP_SLEEP_LP_REGULATOR_DRV_B` writer - need_des"]
pub type HpSleepLpRegulatorDrvBW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 26:31 - need_des"]
    #[inline(always)]
    pub fn hp_sleep_lp_regulator_drv_b(&self) -> HpSleepLpRegulatorDrvBR {
        HpSleepLpRegulatorDrvBR::new(((self.bits >> 26) & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 26:31 - need_des"]
    ...
    pub fn hp_sleep_lp_regulator_drv_b(
        &mut self,
    ) -> HpSleepLpRegulatorDrvBW<'_, HpSleepLpRegulator1Spec> {
        HpSleepLpRegulatorDrvBW::new(self, 26)
    }
}
...
pub struct HpSleepLpRegulator1Spec;
impl crate::RegisterSpec for HpSleepLpRegulator1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hp_sleep_lp_regulator1::R`](R) reader structure"]
impl crate::Readable for HpSleepLpRegulator1Spec {}
#[doc = "`write(|w| ..)` method takes [`hp_sleep_lp_regulator1::W`](W) writer structure"]
impl crate::Writable for HpSleepLpRegulator1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HP_SLEEP_LP_REGULATOR1 to value 0"]
impl crate::Resettable for HpSleepLpRegulator1Spec {}

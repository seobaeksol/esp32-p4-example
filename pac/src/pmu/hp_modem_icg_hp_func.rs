...
pub type W = crate::W<HpModemIcgHpFuncSpec>;
#[doc = "Field `HP_MODEM_DIG_ICG_FUNC_EN` writer - need_des"]
pub type HpModemDigIcgFuncEnW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl W {
    #[doc = "Bits 0:31 - need_des"]
    #[inline(always)]
    pub fn hp_modem_dig_icg_func_en(&mut self) -> HpModemDigIcgFuncEnW<'_, HpModemIcgHpFuncSpec> {
        HpModemDigIcgFuncEnW::new(self, 0)
    }
}
...
pub struct HpModemIcgHpFuncSpec;
impl crate::RegisterSpec for HpModemIcgHpFuncSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`hp_modem_icg_hp_func::W`](W) writer structure"]
impl crate::Writable for HpModemIcgHpFuncSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HP_MODEM_ICG_HP_FUNC to value 0"]
impl crate::Resettable for HpModemIcgHpFuncSpec {}

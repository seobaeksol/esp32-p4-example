...
impl W {
    #[doc = "Bit 14 - reg_0p1a_0_counter after xpd reach target0"]
    #[inline(always)]
    pub fn _0p1a_cnt_target0_reach_0_hp(&mut self) -> _0p1aCntTarget0Reach0HpW<'_, IntEnaSpec> {
        _0p1aCntTarget0Reach0HpW::new(self, 14)
    }
    #[doc = "Bit 15 - reg_0p1a_1_counter after xpd reach target1"]
    #[inline(always)]
    pub fn _0p1a_cnt_target1_reach_0_hp(&mut self) -> _0p1aCntTarget1Reach0HpW<'_, IntEnaSpec> {
        _0p1aCntTarget1Reach0HpW::new(self, 15)
    }
    #[doc = "Bit 16 - reg_0p1a_0 counter after xpd reach target0"]
    #[inline(always)]
    pub fn _0p1a_cnt_target0_reach_1_hp(&mut self) -> _0p1aCntTarget0Reach1HpW<'_, IntEnaSpec> {
        _0p1aCntTarget0Reach1HpW::new(self, 16)
    }
    #[doc = "Bit 17 - reg_0p1a_1_counter after xpd reach target1"]
    #[inline(always)]
    pub fn _0p1a_cnt_target1_reach_1_hp(&mut self) -> _0p1aCntTarget1Reach1HpW<'_, IntEnaSpec> {
        _0p1aCntTarget1Reach1HpW::new(self, 17)
    }
    #[doc = "Bit 18 - reg_0p2a_0 counter after xpd reach target0"]
    #[inline(always)]
    pub fn _0p2a_cnt_target0_reach_0_hp(&mut self) -> _0p2aCntTarget0Reach0HpW<'_, IntEnaSpec> {
        _0p2aCntTarget0Reach0HpW::new(self, 18)
    }
    #[doc = "Bit 19 - reg_0p2a_1_counter after xpd reach target1"]
    #[inline(always)]
    pub fn _0p2a_cnt_target1_reach_0_hp(&mut self) -> _0p2aCntTarget1Reach0HpW<'_, IntEnaSpec> {
        _0p2aCntTarget1Reach0HpW::new(self, 19)
    }
    #[doc = "Bit 20 - reg_0p2a_0 counter after xpd reach target0"]
    #[inline(always)]
    pub fn _0p2a_cnt_target0_reach_1_hp(&mut self) -> _0p2aCntTarget0Reach1HpW<'_, IntEnaSpec> {
        _0p2aCntTarget0Reach1HpW::new(self, 20)
    }
    #[doc = "Bit 21 - reg_0p2a_1_counter after xpd reach target1"]
    #[inline(always)]
    pub fn _0p2a_cnt_target1_reach_1_hp(&mut self) -> _0p2aCntTarget1Reach1HpW<'_, IntEnaSpec> {
        _0p2aCntTarget1Reach1HpW::new(self, 21)
    }
    #[doc = "Bit 22 - reg_0p3a_0 counter after xpd reach target0"]
    #[inline(always)]
    pub fn _0p3a_cnt_target0_reach_0_hp(&mut self) -> _0p3aCntTarget0Reach0HpW<'_, IntEnaSpec> {
        _0p3aCntTarget0Reach0HpW::new(self, 22)
    }
    #[doc = "Bit 23 - reg_0p3a_1_counter after xpd reach target1"]
    #[inline(always)]
    pub fn _0p3a_cnt_target1_reach_0_hp(&mut self) -> _0p3aCntTarget1Reach0HpW<'_, IntEnaSpec> {
        _0p3aCntTarget1Reach0HpW::new(self, 23)
    }
    #[doc = "Bit 24 - reg_0p3a_0_counter after xpd reach target0"]
    #[inline(always)]
    pub fn _0p3a_cnt_target0_reach_1_hp(&mut self) -> _0p3aCntTarget0Reach1HpW<'_, IntEnaSpec> {
        _0p3aCntTarget0Reach1HpW::new(self, 24)
    }
    #[doc = "Bit 25 - reg_0p3a_1_counter after xpd reach target1"]
    #[inline(always)]
    pub fn _0p3a_cnt_target1_reach_1_hp(&mut self) -> _0p3aCntTarget1Reach1HpW<'_, IntEnaSpec> {
        _0p3aCntTarget1Reach1HpW::new(self, 25)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    pub fn lp_cpu_exc(&mut self) -> LpCpuExcW<'_, IntEnaSpec> {
        LpCpuExcW::new(self, 27)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    pub fn sdio_idle(&mut self) -> SdioIdleW<'_, IntEnaSpec> {
        SdioIdleW::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    pub fn sw(&mut self) -> SwW<'_, IntEnaSpec> {
        SwW::new(self, 29)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn soc_sleep_reject(&mut self) -> SocSleepRejectW<'_, IntEnaSpec> {
        SocSleepRejectW::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn soc_wakeup(&mut self) -> SocWakeupW<'_, IntEnaSpec> {

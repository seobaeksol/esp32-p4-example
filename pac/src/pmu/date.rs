...
pub type PmuDateR = crate::FieldReader<u32>;
#[doc = "Field `PMU_DATE` writer - need_des"]
pub type PmuDateW<'a, REG> = crate::FieldWriter<'a, REG, 31, u32>;
...
impl R {
    ...
    #[inline(always)]
    pub fn pmu_date(&self) -> PmuDateR {
        PmuDateR::new(self.bits & 0x7fff_ffff)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:30 - need_des"]
    #[inline(always)]
    pub fn pmu_date(&mut self) -> PmuDateW<'_, DateSpec> {
        PmuDateW::new(self, 0)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]

...
pub struct RegisterBlock {
    ...
    buf_flow_ctl: BufFlowCtl,
    data_type_cfg: DataTypeCfg,
    frame_cfg: FrameCfg,
    ...
    dmablk_size: DmablkSize,
    rdn_eco_cs: RdnEcoCs,
    rdn_eco_low: RdnEcoLow,
    rdn_eco_high: RdnEcoHigh,
    host_ctrl: HostCtrl,
    mem_ctrl: MemCtrl,
    host_cm_ctrl: HostCmCtrl,
    host_size_ctrl: HostSizeCtrl,
}
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn csi_en(&self) -> &CsiEn {
        &self.csi_en
    }
    ...
    #[inline(always)]
    pub const fn buf_flow_ctl(&self) -> &BufFlowCtl {
        &self.buf_flow_ctl
    }
    #[doc = "0x10 - pixel data type configuration."]
    #[inline(always)]
    pub const fn data_type_cfg(&self) -> &DataTypeCfg {
        &self.data_type_cfg
    }
    ...
    #[inline(always)]
    pub const fn endian_mode(&self) -> &EndianMode {
        &self.endian_mode
    }
    ...
    #[inline(always)]
    pub const fn dmablk_size(&self) -> &DmablkSize {
        &self.dmablk_size
    }
    #[doc = "0x34 - N/A"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn host_cm_ctrl(&self) -> &HostCmCtrl {
        &self.host_cm_ctrl
    }
    #[doc = "0x4c - CSI HOST color mode convert configuration."]
    #[inline(always)]
    pub const fn host_size_ctrl(&self) -> &HostSizeCtrl {
        &self.host_size_ctrl
    }
}
...
#[doc(alias = "CSI_EN")]
pub type CsiEn = crate::Reg<csi_en::CsiEnSpec>;
...
#[doc(alias = "BUF_FLOW_CTL")]
pub type BufFlowCtl = crate::Reg<buf_flow_ctl::BufFlowCtlSpec>;
...
#[doc(alias = "DATA_TYPE_CFG")]
pub type DataTypeCfg = crate::Reg<data_type_cfg::DataTypeCfgSpec>;
...
#[doc(alias = "ENDIAN_MODE")]
pub type EndianMode = crate::Reg<endian_mode::EndianModeSpec>;
...
#[doc(alias = "DMABLK_SIZE")]
pub type DmablkSize = crate::Reg<dmablk_size::DmablkSizeSpec>;
...
#[doc(alias = "HOST_CM_CTRL")]
pub type HostCmCtrl = crate::Reg<host_cm_ctrl::HostCmCtrlSpec>;
...
#[doc(alias = "HOST_SIZE_CTRL")]
pub type HostSizeCtrl = crate::Reg<host_size_ctrl::HostSizeCtrlSpec>;
#[doc = "CSI HOST color mode convert configuration."]

...
pub struct RegisterBlock {
    ...
    _reserved2: [u8; 0x0c],
    core_0_intr_status4: Core0IntrStatus4,
    _reserved3: [u8; 0x04],
...
impl RegisterBlock {
    #[doc = "0x00..0x20c - "]
    #[inline(always)]
    pub const fn core_0_intr_map(&self, n: usize) -> &Core0IntrMap {
    ...
    #[doc = "0x00..0x20c - "]
    #[inline(always)]
    pub fn core_0_intr_map_iter(&self) -> impl Iterator<Item = &Core0IntrMap> {
        (0..131).map(move |n| unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(4 * n).cast() })
    }
    #[doc = "0x200..0x210 - NA"]
    #[inline(always)]
    pub const fn core_0_intr_status(&self, n: usize) -> &Core0IntrStatus {
        #[allow(clippy::no_effect)]
        [(); 4][n];
        unsafe {
    ...
    #[doc = "0x200..0x210 - NA"]
    #[inline(always)]
    pub fn core_0_intr_status_iter(&self) -> impl Iterator<Item = &Core0IntrStatus> {
    ...
    #[doc = "0x220 - NA"]
    #[inline(always)]
    pub const fn core_0_intr_status4(&self) -> &Core0IntrStatus4 {
...
#[doc(alias = "CORE_0_INTR_MAP")]
pub type Core0IntrMap = crate::Reg<core_0_intr_map::Core0IntrMapSpec>;
#[doc = ""]
...
#[doc(alias = "CORE_0_INTR_STATUS")]
pub type Core0IntrStatus = crate::Reg<core_0_intr_status::Core0IntrStatusSpec>;
#[doc = "NA"]
...
#[doc(alias = "CORE_0_INTR_STATUS4")]
pub type Core0IntrStatus4 = crate::Reg<core_0_intr_status4::Core0IntrStatus4Spec>;
#[doc = "NA"]

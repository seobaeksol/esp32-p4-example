...
pub struct RegisterBlock {
    clk_cfg: ClkCfg,
    timer: [Timer; 3],
    timer_synci_cfg: TimerSynciCfg,
    operator_timersel: OperatorTimersel,
    ch: [Ch; 3],
    fault_detect: FaultDetect,
    cap_timer_cfg: CapTimerCfg,
    cap_timer_phase: CapTimerPhase,
    cap_ch_cfg: [CapChCfg; 3],
    cap_ch: [CapCh; 3],
    cap_status: CapStatus,
    update_cfg: UpdateCfg,
    int_ena: IntEna,
    int_raw: IntRaw,
    int_st: IntSt,
    int_clr: IntClr,
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn timer_synci_cfg(&self) -> &TimerSynciCfg {
        &self.timer_synci_cfg
    }
    #[doc = "0x38 - PWM operator's timer select register"]
    #[inline(always)]
    pub const fn operator_timersel(&self) -> &OperatorTimersel {
    ...
    #[inline(always)]
    pub const fn fault_detect(&self) -> &FaultDetect {
        &self.fault_detect
    }
    #[doc = "0xe8 - Capture timer configuration register"]
    #[inline(always)]
    pub const fn cap_timer_cfg(&self) -> &CapTimerCfg {
        &self.cap_timer_cfg
    }
    #[doc = "0xec - Capture timer sync phase register"]
    #[inline(always)]
    pub const fn cap_timer_phase(&self) -> &CapTimerPhase {
        &self.cap_timer_phase
    }
    #[doc = "0xf0..0xfc - Capture channel %s configuration register"]
    #[inline(always)]
    pub const fn cap_ch_cfg(&self, n: usize) -> &CapChCfg {
        &self.cap_ch_cfg[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0xf0..0xfc - Capture channel %s configuration register"]
    #[inline(always)]
    pub fn cap_ch_cfg_iter(&self) -> impl Iterator<Item = &CapChCfg> {
        self.cap_ch_cfg.iter()
    }
    #[doc = "0xf0 - Capture channel 0 configuration register"]
    #[inline(always)]
    pub const fn cap_ch0_cfg(&self) -> &CapChCfg {
        self.cap_ch_cfg(0)
    }
    #[doc = "0xf4 - Capture channel 1 configuration register"]
    #[inline(always)]
    pub const fn cap_ch1_cfg(&self) -> &CapChCfg {
        self.cap_ch_cfg(1)
    }
    #[doc = "0xf8 - Capture channel 2 configuration register"]
    #[inline(always)]
    pub const fn cap_ch2_cfg(&self) -> &CapChCfg {
        self.cap_ch_cfg(2)
    }
    #[doc = "0xfc..0x108 - CAP%s capture value register"]
    #[inline(always)]
    pub const fn cap_ch(&self, n: usize) -> &CapCh {
        &self.cap_ch[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0xfc..0x108 - CAP%s capture value register"]
    #[inline(always)]
    pub fn cap_ch_iter(&self) -> impl Iterator<Item = &CapCh> {
        self.cap_ch.iter()
    }
    #[doc = "0x108 - Last capture trigger edge information register"]
    #[inline(always)]
    pub const fn cap_status(&self) -> &CapStatus {
        &self.cap_status
    }
    #[doc = "0x10c - Generator Update configuration register"]
    #[inline(always)]
    pub const fn update_cfg(&self) -> &UpdateCfg {
        &self.update_cfg
    }
    ...
    #[inline(always)]
    pub const fn evt_en(&self) -> &EvtEn {
        &self.evt_en
    }
    #[doc = "0x124 - Task enable register"]
    #[inline(always)]
    pub const fn task_en(&self) -> &TaskEn {
        &self.task_en
    }
    #[doc = "0x128 - Event enable register2"]
    #[inline(always)]
    pub const fn evt_en2(&self) -> &EvtEn2 {
        &self.evt_en2
    }
    #[doc = "0x12c..0x138 - Generator%s timer stamp E1 value register"]
    #[inline(always)]
    pub const fn op_tstmp_e1(&self, n: usize) -> &OpTstmpE1 {
    ...
    #[doc = "0x12c..0x138 - Generator%s timer stamp E1 value register"]
    #[inline(always)]
    pub fn op_tstmp_e1_iter(&self) -> impl Iterator<Item = &OpTstmpE1> {
    ...
    #[inline(always)]
    pub const fn op0_tstmp_e1(&self) -> &OpTstmpE1 {
        self.op_tstmp_e1(0)
    }
    #[doc = "0x134 - Generator1 timer stamp E1 value register"]
    #[inline(always)]
    pub const fn op1_tstmp_e1(&self) -> &OpTstmpE1 {
        self.op_tstmp_e1(1)
    }
    #[doc = "0x13c - Generator2 timer stamp E1 value register"]
    #[inline(always)]
    pub const fn op2_tstmp_e1(&self) -> &OpTstmpE1 {
        self.op_tstmp_e1(2)
    }
    #[doc = "0x130..0x13c - Generator%s timer stamp E2 value register"]
    #[inline(always)]
    pub const fn op_tstmp_e2(&self, n: usize) -> &OpTstmpE2 {
        #[allow(clippy::no_effect)]
        [(); 3][n];
        unsafe {
            &*core::ptr::from_ref(self)
    ...
    #[doc = "0x130..0x13c - Generator%s timer stamp E2 value register"]
    #[inline(always)]
    pub fn op_tstmp_e2_iter(&self) -> impl Iterator<Item = &OpTstmpE2> {
        (0..3).map(move |n| unsafe {
            &*core::ptr::from_ref(self)
                .cast::<u8>()
                .add(304)
    ...
    #[inline(always)]
    pub const fn op0_tstmp_e2(&self) -> &OpTstmpE2 {
        self.op_tstmp_e2(0)
    }
    #[doc = "0x138 - Generator1 timer stamp E2 value register"]
    #[inline(always)]
    pub const fn op1_tstmp_e2(&self) -> &OpTstmpE2 {
        self.op_tstmp_e2(1)
    }
    #[doc = "0x140 - Generator2 timer stamp E2 value register"]
    #[inline(always)]
    pub const fn op2_tstmp_e2(&self) -> &OpTstmpE2 {
        self.op_tstmp_e2(2)
    }
...
#[doc(alias = "TIMER_SYNCI_CFG")]
pub type TimerSynciCfg = crate::Reg<timer_synci_cfg::TimerSynciCfgSpec>;
...
#[doc(alias = "OPERATOR_TIMERSEL")]
pub type OperatorTimersel = crate::Reg<operator_timersel::OperatorTimerselSpec>;
...
#[doc(alias = "FAULT_DETECT")]
pub type FaultDetect = crate::Reg<fault_detect::FaultDetectSpec>;
...
#[doc(alias = "CAP_TIMER_CFG")]
pub type CapTimerCfg = crate::Reg<cap_timer_cfg::CapTimerCfgSpec>;
...
#[doc(alias = "CAP_TIMER_PHASE")]
pub type CapTimerPhase = crate::Reg<cap_timer_phase::CapTimerPhaseSpec>;
...
#[doc(alias = "CAP_CH_CFG")]
pub type CapChCfg = crate::Reg<cap_ch_cfg::CapChCfgSpec>;
...
#[doc(alias = "CAP_CH")]
pub type CapCh = crate::Reg<cap_ch::CapChSpec>;
...
#[doc(alias = "CAP_STATUS")]
pub type CapStatus = crate::Reg<cap_status::CapStatusSpec>;
...
#[doc(alias = "UPDATE_CFG")]
pub type UpdateCfg = crate::Reg<update_cfg::UpdateCfgSpec>;
...
#[doc(alias = "EVT_EN")]
pub type EvtEn = crate::Reg<evt_en::EvtEnSpec>;
...
#[doc(alias = "TASK_EN")]
pub type TaskEn = crate::Reg<task_en::TaskEnSpec>;
...
#[doc(alias = "EVT_EN2")]
pub type EvtEn2 = crate::Reg<evt_en2::EvtEn2Spec>;
...
#[doc(alias = "OP_TSTMP_E1")]
pub type OpTstmpE1 = crate::Reg<op_tstmp_e1::OpTstmpE1Spec>;
...
#[doc(alias = "OP_TSTMP_E2")]
pub type OpTstmpE2 = crate::Reg<op_tstmp_e2::OpTstmpE2Spec>;

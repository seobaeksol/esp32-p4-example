...
pub type PumpClkDivNumR = crate::FieldReader;
#[doc = "Field `PUMP_CLK_DIV_NUM` writer - needs field desc"]
pub type PumpClkDivNumW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `MONITOR_CLK_PVT_EN` reader - needs field desc"]
pub type MonitorClkPvtEnR = crate::BitReader;
#[doc = "Field `MONITOR_CLK_PVT_EN` writer - needs field desc"]
pub type MonitorClkPvtEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn pump_clk_div_num(&self) -> PumpClkDivNumR {
        PumpClkDivNumR::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bit 8 - needs field desc"]
    #[inline(always)]
    pub fn monitor_clk_pvt_en(&self) -> MonitorClkPvtEnR {
        MonitorClkPvtEnR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 31 - select pvt clk"]
    #[inline(always)]
    pub fn clk_sel(&self) -> ClkSelR {
        ClkSelR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:7 - needs field desc"]
    #[inline(always)]
    pub fn pump_clk_div_num(&mut self) -> PumpClkDivNumW<'_, ClkCfgSpec> {
        PumpClkDivNumW::new(self, 0)
    }
    #[doc = "Bit 8 - needs field desc"]
    #[inline(always)]
    pub fn monitor_clk_pvt_en(&mut self) -> MonitorClkPvtEnW<'_, ClkCfgSpec> {
        MonitorClkPvtEnW::new(self, 8)
    }
    #[doc = "Bit 31 - select pvt clk"]
    #[inline(always)]
    pub fn clk_sel(&mut self) -> ClkSelW<'_, ClkCfgSpec> {
        ClkSelW::new(self, 31)
    }
}

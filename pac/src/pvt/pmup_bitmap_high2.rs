...
pub type R = crate::R<PmupBitmapHigh2Spec>;
#[doc = "Register `PMUP_BITMAP_HIGH2` writer"]
pub type W = crate::W<PmupBitmapHigh2Spec>;
#[doc = "Field `PUMP_BITMAP_HIGH2` reader - select valid high channel2"]
pub type PumpBitmapHigh2R = crate::FieldReader<u32>;
#[doc = "Field `PUMP_BITMAP_HIGH2` writer - select valid high channel2"]
pub type PumpBitmapHigh2W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - select valid high channel2"]
    #[inline(always)]
    pub fn pump_bitmap_high2(&self) -> PumpBitmapHigh2R {
        PumpBitmapHigh2R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - select valid high channel2"]
    #[inline(always)]
    pub fn pump_bitmap_high2(&mut self) -> PumpBitmapHigh2W<'_, PmupBitmapHigh2Spec> {
        PumpBitmapHigh2W::new(self, 0)
    }
}
...
pub struct PmupBitmapHigh2Spec;
impl crate::RegisterSpec for PmupBitmapHigh2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmup_bitmap_high2::R`](R) reader structure"]
impl crate::Readable for PmupBitmapHigh2Spec {}
#[doc = "`write(|w| ..)` method takes [`pmup_bitmap_high2::W`](W) writer structure"]
impl crate::Writable for PmupBitmapHigh2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PMUP_BITMAP_HIGH2 to value 0"]
impl crate::Resettable for PmupBitmapHigh2Spec {}

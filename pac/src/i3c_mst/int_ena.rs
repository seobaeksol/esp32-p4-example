...
impl W {
    #[doc = "Bit 0 - Transmit Buffer threshold status enable."]
    #[inline(always)]
    pub fn tx_data_buf_thld(&mut self) -> TxDataBufThldW<'_, IntEnaSpec> {
        TxDataBufThldW::new(self, 0)
    }
    #[doc = "Bit 1 - Receive Buffer threshold status enable."]
    #[inline(always)]
    pub fn rx_data_buf_thld(&mut self) -> RxDataBufThldW<'_, IntEnaSpec> {
        RxDataBufThldW::new(self, 1)
    }
    #[doc = "Bit 2 - Only used in master mode. IBI Buffer threshold status enable."]
    #[inline(always)]
    pub fn ibi_status_thld(&mut self) -> IbiStatusThldW<'_, IntEnaSpec> {
        IbiStatusThldW::new(self, 2)
    }
    #[doc = "Bit 3 - Command buffer ready status enable."]
    #[inline(always)]
    pub fn cmd_buf_empty_thld(&mut self) -> CmdBufEmptyThldW<'_, IntEnaSpec> {
        CmdBufEmptyThldW::new(self, 3)
    }
    #[doc = "Bit 4 - Response buffer ready status enable."]
    #[inline(always)]
    pub fn resp_ready(&mut self) -> RespReadyW<'_, IntEnaSpec> {
        RespReadyW::new(self, 4)
    }
    #[doc = "Bit 5 - next command request error status enable"]
    #[inline(always)]
    pub fn nxt_cmd_req_err(&mut self) -> NxtCmdReqErrW<'_, IntEnaSpec> {
        NxtCmdReqErrW::new(self, 5)
    }
    #[doc = "Bit 6 - Transfer error status enable"]
    #[inline(always)]
    pub fn transfer_err(&mut self) -> TransferErrW<'_, IntEnaSpec> {
        TransferErrW::new(self, 6)
    }
    #[doc = "Bit 7 - NA"]
    #[inline(always)]
    pub fn transfer_complete(&mut self) -> TransferCompleteW<'_, IntEnaSpec> {
        TransferCompleteW::new(self, 7)
    }
    #[doc = "Bit 8 - NA"]
    #[inline(always)]
    pub fn command_done(&mut self) -> CommandDoneW<'_, IntEnaSpec> {
        CommandDoneW::new(self, 8)
    }
    #[doc = "Bit 9 - NA"]
    #[inline(always)]
    pub fn detect_start(&mut self) -> DetectStartW<'_, IntEnaSpec> {
        DetectStartW::new(self, 9)
    }
    #[doc = "Bit 10 - NA"]
    #[inline(always)]
    pub fn resp_buf_ovf(&mut self) -> RespBufOvfW<'_, IntEnaSpec> {
        RespBufOvfW::new(self, 10)
    }
    #[doc = "Bit 11 - NA"]
    #[inline(always)]
    pub fn ibi_data_buf_ovf(&mut self) -> IbiDataBufOvfW<'_, IntEnaSpec> {
        IbiDataBufOvfW::new(self, 11)
    }
    #[doc = "Bit 12 - NA"]
    #[inline(always)]
    pub fn ibi_status_buf_ovf(&mut self) -> IbiStatusBufOvfW<'_, IntEnaSpec> {
        IbiStatusBufOvfW::new(self, 12)
    }
    #[doc = "Bit 13 - NA"]
    #[inline(always)]
    pub fn ibi_handle_done(&mut self) -> IbiHandleDoneW<'_, IntEnaSpec> {
        IbiHandleDoneW::new(self, 13)
    }
    #[doc = "Bit 14 - NA"]
    #[inline(always)]
    pub fn ibi_detect(&mut self) -> IbiDetectW<'_, IntEnaSpec> {
        IbiDetectW::new(self, 14)
    }
    #[doc = "Bit 15 - NA"]
    #[inline(always)]
    pub fn cmd_ccc_mismatch(&mut self) -> CmdCccMismatchW<'_, IntEnaSpec> {

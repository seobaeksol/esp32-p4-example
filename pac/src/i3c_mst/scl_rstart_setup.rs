...
pub type RegSclRstartSetupTimeR = crate::FieldReader<u16>;
#[doc = "Field `REG_SCL_RSTART_SETUP_TIME` writer - I2C_SCL_RSTART_SETUP_TIME"]
pub type RegSclRstartSetupTimeW<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    #[doc = "Bits 0:8 - I2C_SCL_RSTART_SETUP_TIME"]
    #[inline(always)]
    pub fn reg_scl_rstart_setup_time(&self) -> RegSclRstartSetupTimeR {
        RegSclRstartSetupTimeR::new((self.bits & 0x01ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:8 - I2C_SCL_RSTART_SETUP_TIME"]
    #[inline(always)]
    pub fn reg_scl_rstart_setup_time(&mut self) -> RegSclRstartSetupTimeW<'_, SclRstartSetupSpec> {
        RegSclRstartSetupTimeW::new(self, 0)
    }
}

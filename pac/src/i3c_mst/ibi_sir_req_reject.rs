...
pub type R = crate::R<IbiSirReqRejectSpec>;
#[doc = "Register `IBI_SIR_REQ_REJECT` writer"]
pub type W = crate::W<IbiSirReqRejectSpec>;
...
pub type RegSirReqRejectR = crate::FieldReader<u32>;
...
pub type RegSirReqRejectW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - The application of controller can decide whether to send ACK or NACK for Slave request received from any I3C device. A device specific response control bit is provided to select the response option, Master will ACK/NACK the Master Request based on programming of control bit, corresponding to the interrupting device. 0:ACK the SIR Request 1:NACK and send direct auto disable CCC"]
    #[inline(always)]
    pub fn reg_sir_req_reject(&self) -> RegSirReqRejectR {
        RegSirReqRejectR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - The application of controller can decide whether to send ACK or NACK for Slave request received from any I3C device. A device specific response control bit is provided to select the response option, Master will ACK/NACK the Master Request based on programming of control bit, corresponding to the interrupting device. 0:ACK the SIR Request 1:NACK and send direct auto disable CCC"]
    #[inline(always)]
    pub fn reg_sir_req_reject(&mut self) -> RegSirReqRejectW<'_, IbiSirReqRejectSpec> {
        RegSirReqRejectW::new(self, 0)
    }
}
...
pub struct IbiSirReqRejectSpec;
impl crate::RegisterSpec for IbiSirReqRejectSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ibi_sir_req_reject::R`](R) reader structure"]
impl crate::Readable for IbiSirReqRejectSpec {}
#[doc = "`write(|w| ..)` method takes [`ibi_sir_req_reject::W`](W) writer structure"]
impl crate::Writable for IbiSirReqRejectSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets IBI_SIR_REQ_REJECT to value 0"]
impl crate::Resettable for IbiSirReqRejectSpec {}

...
pub type RegRndEcoEnR = crate::BitReader;
#[doc = "Field `REG_RND_ECO_EN` writer - NA"]
pub type RegRndEcoEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RND_ECO_RESULT` reader - NA"]
pub type RndEcoResultR = crate::BitReader;
impl R {
    #[doc = "Bit 0 - NA"]
    #[inline(always)]
    pub fn reg_rnd_eco_en(&self) -> RegRndEcoEnR {
        RegRndEcoEnR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - NA"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - NA"]
    #[inline(always)]
    pub fn reg_rnd_eco_en(&mut self) -> RegRndEcoEnW<'_, RndEcoCsSpec> {
        RegRndEcoEnW::new(self, 0)
    }
}

...
pub type R = crate::R<Emacaddr4lowSpec>;
#[doc = "Register `EMACADDR4LOW` writer"]
pub type W = crate::W<Emacaddr4lowSpec>;
...
pub struct Emacaddr4lowSpec;
impl crate::RegisterSpec for Emacaddr4lowSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`emacaddr4low::R`](R) reader structure"]
impl crate::Readable for Emacaddr4lowSpec {}
#[doc = "`write(|w| ..)` method takes [`emacaddr4low::W`](W) writer structure"]
impl crate::Writable for Emacaddr4lowSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EMACADDR4LOW to value 0"]
impl crate::Resettable for Emacaddr4lowSpec {}

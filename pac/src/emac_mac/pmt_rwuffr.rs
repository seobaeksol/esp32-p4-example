...
pub type R = crate::R<PmtRwuffrSpec>;
...
pub struct PmtRwuffrSpec;
impl crate::RegisterSpec for PmtRwuffrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmt_rwuffr::R`](R) reader structure"]
impl crate::Readable for PmtRwuffrSpec {}
#[doc = "`reset()` method sets PMT_RWUFFR to value 0"]
impl crate::Resettable for PmtRwuffrSpec {}

...
pub type R = crate::R<Emacaddr0lowSpec>;
#[doc = "Register `EMACADDR0LOW` writer"]
pub type W = crate::W<Emacaddr0lowSpec>;
...
pub struct Emacaddr0lowSpec;
impl crate::RegisterSpec for Emacaddr0lowSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`emacaddr0low::R`](R) reader structure"]
impl crate::Readable for Emacaddr0lowSpec {}
#[doc = "`write(|w| ..)` method takes [`emacaddr0low::W`](W) writer structure"]
impl crate::Writable for Emacaddr0lowSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EMACADDR0LOW to value 0"]
impl crate::Resettable for Emacaddr0lowSpec {}

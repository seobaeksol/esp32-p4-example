...
pub type R = crate::R<EmaclpiCrsSpec>;
...
pub struct EmaclpiCrsSpec;
impl crate::RegisterSpec for EmaclpiCrsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`emaclpi_crs::R`](R) reader structure"]
impl crate::Readable for EmaclpiCrsSpec {}
#[doc = "`reset()` method sets EMACLPI_CRS to value 0"]
impl crate::Resettable for EmaclpiCrsSpec {}

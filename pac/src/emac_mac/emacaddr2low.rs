...
pub type R = crate::R<Emacaddr2lowSpec>;
#[doc = "Register `EMACADDR2LOW` writer"]
pub type W = crate::W<Emacaddr2lowSpec>;
...
pub struct Emacaddr2lowSpec;
impl crate::RegisterSpec for Emacaddr2lowSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`emacaddr2low::R`](R) reader structure"]
impl crate::Readable for Emacaddr2lowSpec {}
#[doc = "`write(|w| ..)` method takes [`emacaddr2low::W`](W) writer structure"]
impl crate::Writable for Emacaddr2lowSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EMACADDR2LOW to value 0"]
impl crate::Resettable for Emacaddr2lowSpec {}

...
pub type R = crate::R<EmacdebugSpec>;
...
pub type MacrpesR = crate::BitReader;
...
pub type MacrffcsR = crate::FieldReader;
...
pub type MtlrfwcasR = crate::BitReader;
...
pub type MtlrfrcsR = crate::FieldReader;
...
pub type MtlrfflsR = crate::FieldReader;
...
pub type MactpesR = crate::BitReader;
...
pub type MactfcsR = crate::FieldReader;
...
pub type MactpR = crate::BitReader;
...
pub type MtltfrcsR = crate::FieldReader;
...
pub type MtltfwcsR = crate::BitReader;
...
pub type MtltfnesR = crate::BitReader;
...
pub type MtltsffsR = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn macrpes(&self) -> MacrpesR {
        MacrpesR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn macrffcs(&self) -> MacrffcsR {
        MacrffcsR::new(((self.bits >> 1) & 3) as u8)
    }
    ...
    #[inline(always)]
    pub fn mtlrfwcas(&self) -> MtlrfwcasR {
        MtlrfwcasR::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn mtlrfrcs(&self) -> MtlrfrcsR {
        MtlrfrcsR::new(((self.bits >> 5) & 3) as u8)
    }
    ...
    #[inline(always)]
    pub fn mtlrffls(&self) -> MtlrfflsR {
        MtlrfflsR::new(((self.bits >> 8) & 3) as u8)
    }
    ...
    #[inline(always)]
    pub fn mactpes(&self) -> MactpesR {
        MactpesR::new(((self.bits >> 16) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn mactfcs(&self) -> MactfcsR {
        MactfcsR::new(((self.bits >> 17) & 3) as u8)
    }
    ...
    #[inline(always)]
    pub fn mactp(&self) -> MactpR {
        MactpR::new(((self.bits >> 19) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn mtltfrcs(&self) -> MtltfrcsR {
        MtltfrcsR::new(((self.bits >> 20) & 3) as u8)
    }
    ...
    #[inline(always)]
    pub fn mtltfwcs(&self) -> MtltfwcsR {
        MtltfwcsR::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 24 - When high this bit indicates that the MTL Tx FIFO is not empty and some data is left for Transmission."]
    #[inline(always)]
    pub fn mtltfnes(&self) -> MtltfnesR {
        MtltfnesR::new(((self.bits >> 24) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn mtltsffs(&self) -> MtltsffsR {
        MtltsffsR::new(((self.bits >> 25) & 1) != 0)
    }
}
...
pub struct EmacdebugSpec;
impl crate::RegisterSpec for EmacdebugSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`emacdebug::R`](R) reader structure"]
impl crate::Readable for EmacdebugSpec {}
#[doc = "`reset()` method sets EMACDEBUG to value 0"]
impl crate::Resettable for EmacdebugSpec {}

...
pub type R = crate::R<Emacaddr1lowSpec>;
#[doc = "Register `EMACADDR1LOW` writer"]
pub type W = crate::W<Emacaddr1lowSpec>;
...
pub struct Emacaddr1lowSpec;
impl crate::RegisterSpec for Emacaddr1lowSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`emacaddr1low::R`](R) reader structure"]
impl crate::Readable for Emacaddr1lowSpec {}
#[doc = "`write(|w| ..)` method takes [`emacaddr1low::W`](W) writer structure"]
impl crate::Writable for Emacaddr1lowSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EMACADDR1LOW to value 0"]
impl crate::Resettable for Emacaddr1lowSpec {}

...
pub type R = crate::R<EmaclpitimerscontrolSpec>;
...
pub type LpiTwTimerR = crate::FieldReader<u16>;
...
pub type LpiLsTimerR = crate::FieldReader<u16>;
impl R {
    ...
    #[inline(always)]
    pub fn lpi_tw_timer(&self) -> LpiTwTimerR {
        LpiTwTimerR::new((self.bits & 0xffff) as u16)
    }
    ...
    #[inline(always)]
    pub fn lpi_ls_timer(&self) -> LpiLsTimerR {
        LpiLsTimerR::new(((self.bits >> 16) & 0x03ff) as u16)
    }
}
...
pub struct EmaclpitimerscontrolSpec;
impl crate::RegisterSpec for EmaclpitimerscontrolSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`emaclpitimerscontrol::R`](R) reader structure"]
impl crate::Readable for EmaclpitimerscontrolSpec {}
#[doc = "`reset()` method sets EMACLPITIMERSCONTROL to value 0"]
impl crate::Resettable for EmaclpitimerscontrolSpec {}

...
pub type R = crate::R<IdpartnoSpec>;
#[doc = "Register `IDPARTNO` writer"]
pub type W = crate::W<IdpartnoSpec>;
...
impl W {
    #[doc = "Bits 0:31 - NA"]
    #[inline(always)]
    pub fn partno(&mut self) -> PartnoW<'_, IdpartnoSpec> {
        PartnoW::new(self, 0)
    }
}
...
pub struct IdpartnoSpec;
impl crate::RegisterSpec for IdpartnoSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`idpartno::R`](R) reader structure"]
impl crate::Readable for IdpartnoSpec {}
#[doc = "`write(|w| ..)` method takes [`idpartno::W`](W) writer structure"]
impl crate::Writable for IdpartnoSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets IDPARTNO to value 0"]
impl crate::Resettable for IdpartnoSpec {}

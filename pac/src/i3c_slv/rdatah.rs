...
pub type R = crate::R<RdatahSpec>;
#[doc = "Field `DATA_LSB` reader - NA"]
pub type DataLsbR = crate::FieldReader;
...
pub type DataMsbR = crate::FieldReader;
impl R {
    #[doc = "Bits 0:7 - NA"]
    #[inline(always)]
    pub fn data_lsb(&self) -> DataLsbR {
        DataLsbR::new((self.bits & 0xff) as u8)
    }
    ...
    #[inline(always)]
    pub fn data_msb(&self) -> DataMsbR {
        DataMsbR::new(((self.bits >> 8) & 0xff) as u8)
    }
}
...
pub struct RdatahSpec;
impl crate::RegisterSpec for RdatahSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rdatah::R`](R) reader structure"]
impl crate::Readable for RdatahSpec {}
#[doc = "`reset()` method sets RDATAH to value 0"]
impl crate::Resettable for RdatahSpec {}

...
pub struct RdarabSpec;
impl crate::RegisterSpec for RdarabSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rdarab::R`](R) reader structure"]
impl crate::Readable for RdarabSpec {}
#[doc = "`reset()` method sets RDARAB to value 0"]
impl crate::Resettable for RdarabSpec {}

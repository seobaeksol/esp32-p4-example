...
pub type R = crate::R<LcdFirstCmdValSpec>;
#[doc = "Register `LCD_FIRST_CMD_VAL` writer"]
pub type W = crate::W<LcdFirstCmdValSpec>;
#[doc = "Field `LCD_FIRST_CMD_VALUE` reader - The LCD write command value of first cmd cycle."]
pub type LcdFirstCmdValueR = crate::FieldReader<u32>;
#[doc = "Field `LCD_FIRST_CMD_VALUE` writer - The LCD write command value of first cmd cycle."]
pub type LcdFirstCmdValueW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - The LCD write command value of first cmd cycle."]
    #[inline(always)]
    pub fn lcd_first_cmd_value(&self) -> LcdFirstCmdValueR {
        LcdFirstCmdValueR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - The LCD write command value of first cmd cycle."]
    #[inline(always)]
    pub fn lcd_first_cmd_value(&mut self) -> LcdFirstCmdValueW<'_, LcdFirstCmdValSpec> {
        LcdFirstCmdValueW::new(self, 0)
    }
}
...
pub struct LcdFirstCmdValSpec;
impl crate::RegisterSpec for LcdFirstCmdValSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lcd_first_cmd_val::R`](R) reader structure"]
impl crate::Readable for LcdFirstCmdValSpec {}
#[doc = "`write(|w| ..)` method takes [`lcd_first_cmd_val::W`](W) writer structure"]
impl crate::Writable for LcdFirstCmdValSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LCD_FIRST_CMD_VAL to value 0"]
impl crate::Resettable for LcdFirstCmdValSpec {}

...
pub type R = crate::R<SlaveSpec>;
#[doc = "Register `SLAVE` writer"]
pub type W = crate::W<SlaveSpec>;
...
pub type ClkMode13R = crate::BitReader;
...
pub type ClkMode13W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RsckDataOutR = crate::BitReader;
...
pub type RsckDataOutW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SlvRddmaBitlenEnR = crate::BitReader;
...
pub type SlvRddmaBitlenEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SlvWrdmaBitlenEnR = crate::BitReader;
...
pub type SlvWrdmaBitlenEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SlvRdbufBitlenEnR = crate::BitReader;
...
pub type SlvRdbufBitlenEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SlvWrbufBitlenEnR = crate::BitReader;
...
pub type SlvWrbufBitlenEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type UsrConfR = crate::BitReader;
...
pub type UsrConfW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type MstFdWaitDmaTxDataR = crate::BitReader;
...
pub type MstFdWaitDmaTxDataW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn clk_mode_13(&self) -> ClkMode13R {
        ClkMode13R::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn rsck_data_out(&self) -> RsckDataOutR {
        RsckDataOutR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn slv_rddma_bitlen_en(&self) -> SlvRddmaBitlenEnR {
        SlvRddmaBitlenEnR::new(((self.bits >> 8) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn slv_wrdma_bitlen_en(&self) -> SlvWrdmaBitlenEnR {
        SlvWrdmaBitlenEnR::new(((self.bits >> 9) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn slv_rdbuf_bitlen_en(&self) -> SlvRdbufBitlenEnR {
        SlvRdbufBitlenEnR::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn slv_wrbuf_bitlen_en(&self) -> SlvWrbufBitlenEnR {
        SlvWrbufBitlenEnR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bits 12:19 - Represents the effective bit of the last received data byte in SPI slave FD and HD mode."]
    #[inline(always)]
    pub fn slv_last_byte_strb(&self) -> SlvLastByteStrbR {
        SlvLastByteStrbR::new(((self.bits >> 12) & 0xff) as u8)
    }
    #[doc = "Bits 22:25 - The magic value of BM table in master DMA seg-trans."]
    #[inline(always)]
    pub fn dma_seg_magic_value(&self) -> DmaSegMagicValueR {
        DmaSegMagicValueR::new(((self.bits >> 22) & 0x0f) as u8)
    }
    #[doc = "Bit 26 - Set SPI work mode. 1: slave mode 0: master mode."]
    #[inline(always)]
    pub fn mode(&self) -> ModeR {
        ModeR::new(((self.bits >> 26) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn usr_conf(&self) -> UsrConfR {
        UsrConfR::new(((self.bits >> 28) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn mst_fd_wait_dma_tx_data(&self) -> MstFdWaitDmaTxDataR {
        MstFdWaitDmaTxDataR::new(((self.bits >> 29) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - SPI clock mode bits. 0: SPI clock is off when CS inactive 1: SPI clock is delayed one cycle after CS inactive 2: SPI clock is delayed two cycles after CS inactive 3: SPI clock is alwasy on. Can be configured in CONF state."]
    #[inline(always)]
    pub fn clk_mode(&mut self) -> ClkModeW<'_, SlaveSpec> {
        ClkModeW::new(self, 0)
    }
    #[doc = "Bit 2 - {CPOL, CPHA},1: support spi clk mode 1 and 3, first edge output data B\\[0\\]/B\\[7\\]. 0: support spi clk mode 0 and 2, first edge output data B\\[1\\]/B\\[6\\]."]
    #[inline(always)]
    pub fn clk_mode_13(&mut self) -> ClkMode13W<'_, SlaveSpec> {
        ClkMode13W::new(self, 2)
    }
    #[doc = "Bit 3 - It saves half a cycle when tsck is the same as rsck. 1: output data at rsck posedge 0: output data at tsck posedge"]
    #[inline(always)]
    pub fn rsck_data_out(&mut self) -> RsckDataOutW<'_, SlaveSpec> {
        RsckDataOutW::new(self, 3)
    }
    #[doc = "Bit 8 - 1: SPI_SLV_DATA_BITLEN stores data bit length of master-read-slave data length in DMA controlled mode(Rd_DMA). 0: others"]
    #[inline(always)]
    pub fn slv_rddma_bitlen_en(&mut self) -> SlvRddmaBitlenEnW<'_, SlaveSpec> {
        SlvRddmaBitlenEnW::new(self, 8)
    }
    #[doc = "Bit 9 - 1: SPI_SLV_DATA_BITLEN stores data bit length of master-write-to-slave data length in DMA controlled mode(Wr_DMA). 0: others"]
    #[inline(always)]
    pub fn slv_wrdma_bitlen_en(&mut self) -> SlvWrdmaBitlenEnW<'_, SlaveSpec> {
        SlvWrdmaBitlenEnW::new(self, 9)
    }
    #[doc = "Bit 10 - 1: SPI_SLV_DATA_BITLEN stores data bit length of master-read-slave data length in CPU controlled mode(Rd_BUF). 0: others"]
    #[inline(always)]
    pub fn slv_rdbuf_bitlen_en(&mut self) -> SlvRdbufBitlenEnW<'_, SlaveSpec> {
        SlvRdbufBitlenEnW::new(self, 10)
    }
    #[doc = "Bit 11 - 1: SPI_SLV_DATA_BITLEN stores data bit length of master-write-to-slave data length in CPU controlled mode(Wr_BUF). 0: others"]
    #[inline(always)]
    pub fn slv_wrbuf_bitlen_en(&mut self) -> SlvWrbufBitlenEnW<'_, SlaveSpec> {
        SlvWrbufBitlenEnW::new(self, 11)
    }
    #[doc = "Bits 22:25 - The magic value of BM table in master DMA seg-trans."]
    #[inline(always)]
    pub fn dma_seg_magic_value(&mut self) -> DmaSegMagicValueW<'_, SlaveSpec> {
        DmaSegMagicValueW::new(self, 22)
    }
    #[doc = "Bit 26 - Set SPI work mode. 1: slave mode 0: master mode."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, SlaveSpec> {
        ModeW::new(self, 26)
    }
    #[doc = "Bit 27 - Software reset enable, reset the spi clock line cs line and data lines. Can be configured in CONF state."]
    #[inline(always)]
    pub fn soft_reset(&mut self) -> SoftResetW<'_, SlaveSpec> {
        SoftResetW::new(self, 27)
    }
    #[doc = "Bit 28 - 1: Enable the DMA CONF phase of current seg-trans operation, which means seg-trans will start. 0: This is not seg-trans mode."]
    #[inline(always)]
    pub fn usr_conf(&mut self) -> UsrConfW<'_, SlaveSpec> {
        UsrConfW::new(self, 28)
    }
    #[doc = "Bit 29 - In master full-duplex mode, 1: GP-SPI will wait DMA TX data is ready before starting SPI transfer. 0: GP-SPI does not wait DMA TX data before starting SPI transfer."]
    #[inline(always)]
    pub fn mst_fd_wait_dma_tx_data(&mut self) -> MstFdWaitDmaTxDataW<'_, SlaveSpec> {
        MstFdWaitDmaTxDataW::new(self, 29)
    }
}

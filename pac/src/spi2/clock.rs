...
pub type ClkcntLW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
pub type ClkcntHW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
pub type ClkEdgeSelR = crate::BitReader;
...
pub type ClkEdgeSelW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    pub fn clkcnt_l(&self) -> ClkcntLR {
        ClkcntLR::new((self.bits & 0x3f) as u8)
    }
    ...
    pub fn clkcnt_h(&self) -> ClkcntHR {
        ClkcntHR::new(((self.bits >> 6) & 0x3f) as u8)
    }
    ...
    pub fn clkcnt_n(&self) -> ClkcntNR {
        ClkcntNR::new(((self.bits >> 12) & 0x3f) as u8)
    }
    #[doc = "Bits 18:21 - In the master mode it is pre-divider of spi_clk. Can be configured in CONF state."]
    #[inline(always)]
    pub fn clkdiv_pre(&self) -> ClkdivPreR {
        ClkdivPreR::new(((self.bits >> 18) & 0x0f) as u8)
    }
    ...
    #[inline(always)]
    pub fn clk_edge_sel(&self) -> ClkEdgeSelR {
        ClkEdgeSelR::new(((self.bits >> 30) & 1) != 0)
    }
...
impl W {
    ...
    pub fn clkcnt_n(&mut self) -> ClkcntNW<'_, ClockSpec> {
        ClkcntNW::new(self, 12)
    }
    #[doc = "Bits 18:21 - In the master mode it is pre-divider of spi_clk. Can be configured in CONF state."]
    #[inline(always)]
    pub fn clkdiv_pre(&mut self) -> ClkdivPreW<'_, ClockSpec> {
        ClkdivPreW::new(self, 18)
    }
    #[doc = "Bit 30 - Configures use standard clock sampling edge or delay the sampling edge by half a cycle in master transfer.\\\\ 0: clock sampling edge is delayed by half a cycle.\\\\ 1: clock sampling edge is standard.\\\\ Can be configured in CONF state."]
    #[inline(always)]
    pub fn clk_edge_sel(&mut self) -> ClkEdgeSelW<'_, ClockSpec> {
        ClkEdgeSelW::new(self, 30)
    }
    #[doc = "Bit 31 - In the master mode 1: spi_clk is eqaul to system 0: spi_clk is divided from system clock. Can be configured in CONF state."]
    #[inline(always)]

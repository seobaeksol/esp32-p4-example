...
pub type DummyOutR = crate::BitReader;
...
pub type DummyOutW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FreadOctR = crate::BitReader;
...
pub type FreadOctW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HoldPolR = crate::BitReader;
...
pub type HoldPolW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type WpPolR = crate::BitReader;
...
pub type WrBitOrderR = crate::FieldReader;
...
pub type WrBitOrderW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ...
    #[inline(always)]
    pub fn dummy_out(&self) -> DummyOutR {
        DummyOutR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    pub fn faddr_quad(&self) -> FaddrQuadR {
        FaddrQuadR::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn hold_pol(&self) -> HoldPolR {
        HoldPolR::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - Write protect signal output when SPI is idle. 1: output high, 0: output low. Can be configured in CONF state."]
    #[inline(always)]
    pub fn wp_pol(&self) -> WpPolR {
        WpPolR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bits 23:24 - In read-data (MISO) phase 1: LSB first 0: MSB first. Can be configured in CONF state."]
    #[inline(always)]
    pub fn rd_bit_order(&self) -> RdBitOrderR {
        RdBitOrderR::new(((self.bits >> 23) & 3) as u8)
    }
    #[doc = "Bits 25:26 - In command address write-data (MOSI) phases 1: LSB firs 0: MSB first. Can be configured in CONF state."]
    #[inline(always)]
    pub fn wr_bit_order(&self) -> WrBitOrderR {
        WrBitOrderR::new(((self.bits >> 25) & 3) as u8)
    }
}
impl W {
    #[doc = "Bit 3 - 0: In the dummy phase, the FSPI bus signals are not output. 1: In the dummy phase, the FSPI bus signals are output. Can be configured in CONF state."]
    #[inline(always)]
    pub fn dummy_out(&mut self) -> DummyOutW<'_, CtrlSpec> {
        DummyOutW::new(self, 3)
    }
    #[doc = "Bit 5 - Apply 2 signals during addr phase 1:enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn faddr_dual(&mut self) -> FaddrDualW<'_, CtrlSpec> {
        FaddrDualW::new(self, 5)
    }
    #[doc = "Bit 6 - Apply 4 signals during addr phase 1:enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn faddr_quad(&mut self) -> FaddrQuadW<'_, CtrlSpec> {
        FaddrQuadW::new(self, 6)
    }
    #[doc = "Bit 7 - Apply 8 signals during addr phase 1:enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn faddr_oct(&mut self) -> FaddrOctW<'_, CtrlSpec> {
        FaddrOctW::new(self, 7)
    }
    #[doc = "Bit 8 - Apply 2 signals during command phase 1:enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn fcmd_dual(&mut self) -> FcmdDualW<'_, CtrlSpec> {
        FcmdDualW::new(self, 8)
    }
    #[doc = "Bit 9 - Apply 4 signals during command phase 1:enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn fcmd_quad(&mut self) -> FcmdQuadW<'_, CtrlSpec> {
        FcmdQuadW::new(self, 9)
    }
    #[doc = "Bit 10 - Apply 8 signals during command phase 1:enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn fcmd_oct(&mut self) -> FcmdOctW<'_, CtrlSpec> {
        FcmdOctW::new(self, 10)
    }
    #[doc = "Bit 14 - In the read operations, read-data phase apply 2 signals. 1: enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    ...
    pub fn fread_quad(&mut self) -> FreadQuadW<'_, CtrlSpec> {
        FreadQuadW::new(self, 15)
    }
    #[doc = "Bit 16 - In the read operations read-data phase apply 8 signals. 1: enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn fread_oct(&mut self) -> FreadOctW<'_, CtrlSpec> {
        FreadOctW::new(self, 16)
    }
    #[doc = "Bit 18 - The bit is used to set MISO line polarity, 1: high 0, low. Can be configured in CONF state."]
    #[inline(always)]
    ...
    #[doc = "Bit 20 - SPI_HOLD output value when SPI is idle. 1: output high, 0: output low. Can be configured in CONF state."]
    #[inline(always)]
    pub fn hold_pol(&mut self) -> HoldPolW<'_, CtrlSpec> {
        HoldPolW::new(self, 20)
    }
    #[doc = "Bit 21 - Write protect signal output when SPI is idle. 1: output high, 0: output low. Can be configured in CONF state."]
    #[inline(always)]
    pub fn wp_pol(&mut self) -> WpPolW<'_, CtrlSpec> {
        WpPolW::new(self, 21)
    }
    #[doc = "Bits 23:24 - In read-data (MISO) phase 1: LSB first 0: MSB first. Can be configured in CONF state."]
    #[inline(always)]
    pub fn rd_bit_order(&mut self) -> RdBitOrderW<'_, CtrlSpec> {
        RdBitOrderW::new(self, 23)
    }
    #[doc = "Bits 25:26 - In command address write-data (MOSI) phases 1: LSB firs 0: MSB first. Can be configured in CONF state."]
    #[inline(always)]
    pub fn wr_bit_order(&mut self) -> WrBitOrderW<'_, CtrlSpec> {
        WrBitOrderW::new(self, 25)
    }
}

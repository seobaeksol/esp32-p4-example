...
pub type UsrAddrValueR = crate::FieldReader<u32>;
#[doc = "Field `USR_ADDR_VALUE` writer - Address to slave. Can be configured in CONF state."]
pub type UsrAddrValueW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Address to slave. Can be configured in CONF state."]
    #[inline(always)]
    pub fn usr_addr_value(&self) -> UsrAddrValueR {
        UsrAddrValueR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Address to slave. Can be configured in CONF state."]
    #[inline(always)]
    pub fn usr_addr_value(&mut self) -> UsrAddrValueW<'_, AddrSpec> {
        UsrAddrValueW::new(self, 0)
    }
}

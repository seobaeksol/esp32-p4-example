...
pub type DmaOutfifoEmptyR = crate::BitReader;
...
pub type SlvRxSegTransClrEnR = crate::BitReader;
...
pub type SlvRxSegTransClrEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SlvTxSegTransClrEnR = crate::BitReader;
...
pub type SlvTxSegTransClrEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RxEofEnR = crate::BitReader;
...
pub type RxAfifoRstW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type BufAfifoRstW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DmaAfifoRstW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn dma_outfifo_empty(&self) -> DmaOutfifoEmptyR {
        DmaOutfifoEmptyR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn dma_infifo_full(&self) -> DmaInfifoFullR {
        DmaInfifoFullR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 18 - Enable dma segment transfer in spi dma half slave mode. 1: enable. 0: disable."]
    #[inline(always)]
    pub fn dma_slv_seg_trans_en(&self) -> DmaSlvSegTransEnR {
        DmaSlvSegTransEnR::new(((self.bits >> 18) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn slv_rx_seg_trans_clr_en(&self) -> SlvRxSegTransClrEnR {
        SlvRxSegTransClrEnR::new(((self.bits >> 19) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn slv_tx_seg_trans_clr_en(&self) -> SlvTxSegTransClrEnR {
        SlvTxSegTransClrEnR::new(((self.bits >> 20) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn rx_eof_en(&self) -> RxEofEnR {
        RxEofEnR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 27 - Set this bit to enable SPI DMA controlled receive data mode."]
    #[inline(always)]
    pub fn dma_rx_ena(&self) -> DmaRxEnaR {
        DmaRxEnaR::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - Set this bit to enable SPI DMA controlled send data mode."]
    #[inline(always)]
    pub fn dma_tx_ena(&self) -> DmaTxEnaR {
        DmaTxEnaR::new(((self.bits >> 28) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 18 - Enable dma segment transfer in spi dma half slave mode. 1: enable. 0: disable."]
    #[inline(always)]
    pub fn dma_slv_seg_trans_en(&mut self) -> DmaSlvSegTransEnW<'_, DmaConfSpec> {
        DmaSlvSegTransEnW::new(self, 18)
    }
    #[doc = "Bit 19 - 1: spi_dma_infifo_full_vld is cleared by spi slave cmd 5. 0: spi_dma_infifo_full_vld is cleared by spi_trans_done."]
    #[inline(always)]
    pub fn slv_rx_seg_trans_clr_en(&mut self) -> SlvRxSegTransClrEnW<'_, DmaConfSpec> {
        SlvRxSegTransClrEnW::new(self, 19)
    }
    #[doc = "Bit 20 - 1: spi_dma_outfifo_empty_vld is cleared by spi slave cmd 6. 0: spi_dma_outfifo_empty_vld is cleared by spi_trans_done."]
    #[inline(always)]
    pub fn slv_tx_seg_trans_clr_en(&mut self) -> SlvTxSegTransClrEnW<'_, DmaConfSpec> {
        SlvTxSegTransClrEnW::new(self, 20)
    }
    #[doc = "Bit 21 - 1: spi_dma_inlink_eof is set when the number of dma pushed data bytes is equal to the value of spi_slv/mst_dma_rd_bytelen\\[19:0\\] in spi dma transition. 0: spi_dma_inlink_eof is set by spi_trans_done in non-seg-trans or spi_dma_seg_trans_done in seg-trans."]
    #[inline(always)]
    pub fn rx_eof_en(&mut self) -> RxEofEnW<'_, DmaConfSpec> {
        RxEofEnW::new(self, 21)
    }
    #[doc = "Bit 27 - Set this bit to enable SPI DMA controlled receive data mode."]
    #[inline(always)]
    pub fn dma_rx_ena(&mut self) -> DmaRxEnaW<'_, DmaConfSpec> {
        DmaRxEnaW::new(self, 27)
    }
    #[doc = "Bit 28 - Set this bit to enable SPI DMA controlled send data mode."]
    #[inline(always)]
    pub fn dma_tx_ena(&mut self) -> DmaTxEnaW<'_, DmaConfSpec> {
        DmaTxEnaW::new(self, 28)
    }
    #[doc = "Bit 29 - Set this bit to reset RX AFIFO, which is used to receive data in SPI master and slave mode transfer."]
    #[inline(always)]
    pub fn rx_afifo_rst(&mut self) -> RxAfifoRstW<'_, DmaConfSpec> {
        RxAfifoRstW::new(self, 29)
    }
    ...
    #[inline(always)]
    pub fn buf_afifo_rst(&mut self) -> BufAfifoRstW<'_, DmaConfSpec> {
        BufAfifoRstW::new(self, 30)
    }
    #[doc = "Bit 31 - Set this bit to reset DMA TX AFIFO, which is used to send data out in SPI slave DMA controlled mode transfer."]
    #[inline(always)]
    pub fn dma_afifo_rst(&mut self) -> DmaAfifoRstW<'_, DmaConfSpec> {
        DmaAfifoRstW::new(self, 31)
    }
}

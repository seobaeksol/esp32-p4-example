...
pub type MstRemptyErrEndEnR = crate::BitReader;
...
pub type MstRemptyErrEndEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn mst_rempty_err_end_en(&self) -> MstRemptyErrEndEnR {
        MstRemptyErrEndEnR::new(((self.bits >> 27) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 27 - 1: SPI transfer is ended when SPI TX AFIFO read empty error is valid in GP-SPI master FD/HD-mode. 0: SPI transfer is not ended when SPI TX AFIFO read empty error is valid in GP-SPI master FD/HD-mode."]
    #[inline(always)]
    pub fn mst_rempty_err_end_en(&mut self) -> MstRemptyErrEndEnW<'_, User2Spec> {
        MstRemptyErrEndEnW::new(self, 27)
    }
    #[doc = "Bits 28:31 - The length in bits of command phase. The register value shall be (bit_num-1). Can be configured in CONF state."]
    #[inline(always)]

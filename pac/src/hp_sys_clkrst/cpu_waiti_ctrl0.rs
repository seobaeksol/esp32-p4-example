...
pub type R = crate::R<CpuWaitiCtrl0Spec>;
#[doc = "Register `CPU_WAITI_CTRL0` writer"]
pub type W = crate::W<CpuWaitiCtrl0Spec>;
...
pub type Core0WaitiIcgEnR = crate::BitReader;
...
pub type Core0WaitiIcgEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Core1WaitiIcgEnR = crate::BitReader;
...
pub type Core1WaitiIcgEnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn core0_waiti_icg_en(&self) -> Core0WaitiIcgEnR {
        Core0WaitiIcgEnR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn core1_waiti_icg_en(&self) -> Core1WaitiIcgEnR {
        Core1WaitiIcgEnR::new(((self.bits >> 1) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Configures whether cpu core0 waiti signal can control clock gate. If both core0 and core1 waiti_icg_en is 1, then only when core0 and core1 all in waiti will close related clock"]
    #[inline(always)]
    pub fn core0_waiti_icg_en(&mut self) -> Core0WaitiIcgEnW<'_, CpuWaitiCtrl0Spec> {
        Core0WaitiIcgEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Configures whether cpu core1 waiti signal can control clock gate. If both core0 and core1 waiti_icg_en is 1, then only when core0 and core1 all in waiti will close related clock"]
    #[inline(always)]
    pub fn core1_waiti_icg_en(&mut self) -> Core1WaitiIcgEnW<'_, CpuWaitiCtrl0Spec> {
        Core1WaitiIcgEnW::new(self, 1)
    }
}
...
pub struct CpuWaitiCtrl0Spec;
impl crate::RegisterSpec for CpuWaitiCtrl0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpu_waiti_ctrl0::R`](R) reader structure"]
impl crate::Readable for CpuWaitiCtrl0Spec {}
#[doc = "`write(|w| ..)` method takes [`cpu_waiti_ctrl0::W`](W) writer structure"]
impl crate::Writable for CpuWaitiCtrl0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CPU_WAITI_CTRL0 to value 0x03"]
impl crate::Resettable for CpuWaitiCtrl0Spec {

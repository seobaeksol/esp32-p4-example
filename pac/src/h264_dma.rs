...
pub struct RegisterBlock {
    out_ch: (),
    _reserved1: [u8; 0x0500],
    in_ch: (),
    _reserved2: [u8; 0x0500],
    in_ch5: InCh5,
    _reserved3: [u8; 0x70],
    inter_axi_err: InterAxiErr,
    exter_axi_err: ExterAxiErr,
    rst_conf: RstConf,
    inter_mem_start_addr0: InterMemStartAddr0,
    inter_mem_end_addr0: InterMemEndAddr0,
    inter_mem_start_addr1: InterMemStartAddr1,
    inter_mem_end_addr1: InterMemEndAddr1,
    _reserved10: [u8; 0x04],
    exter_mem_start_addr0: ExterMemStartAddr0,
    exter_mem_end_addr0: ExterMemEndAddr0,
    exter_mem_start_addr1: ExterMemStartAddr1,
    exter_mem_end_addr1: ExterMemEndAddr1,
    out_arb_config: OutArbConfig,
    in_arb_config: InArbConfig,
    _reserved16: [u8; 0x04],
    date: Date,
    _reserved17: [u8; 0x10],
    counter_rst: CounterRst,
    rx_ch0_counter: RxCh0Counter,
    rx_ch1_counter: RxCh1Counter,
    rx_ch2_counter: RxCh2Counter,
    rx_ch5_counter: RxCh5Counter,
    pbyte: Pbyte,
    ch_dbg_en: ChDbgEn,
    out_ch0_dbg_data_l: OutCh0DbgDataL,
    out_ch0_dbg_data_h: OutCh0DbgDataH,
    out_ch1_dbg_data_l: OutCh1DbgDataL,
    out_ch1_dbg_data_h: OutCh1DbgDataH,
    out_ch2_dbg_data_l: OutCh2DbgDataL,
    out_ch2_dbg_data_h: OutCh2DbgDataH,
    out_ch3_dbg_data_l: OutCh3DbgDataL,
    out_ch3_dbg_data_h: OutCh3DbgDataH,
    out_ch4_dbg_data_l: OutCh4DbgDataL,
    out_ch4_dbg_data_h: OutCh4DbgDataH,
    in_ch0_dbg_data_l: InCh0DbgDataL,
    in_ch0_dbg_data_h: InCh0DbgDataH,
    in_ch1_dbg_data_l: InCh1DbgDataL,
    in_ch1_dbg_data_h: InCh1DbgDataH,
    in_ch2_dbg_data_l: InCh2DbgDataL,
    in_ch2_dbg_data_h: InCh2DbgDataH,
    in_ch3_dbg_data_l: InCh3DbgDataL,
    in_ch3_dbg_data_h: InCh3DbgDataH,
    in_ch4_dbg_data_l: InCh4DbgDataL,
    in_ch4_dbg_data_h: InCh4DbgDataH,
    in_ch5_dbg_data_l: InCh5DbgDataL,
    in_ch5_dbg_data_h: InCh5DbgDataH,
}
impl RegisterBlock {
    #[doc = "0x00..0x294 - Cluster OUT_CH%s, containing OUT_CONF0_CH?, OUT_INT_RAW_CH?, OUT_INT_ENA_CH?, OUT_INT_ST_CH?, OUT_INT_CLR_CH?, OUTFIFO_STATUS_CH?, OUT_PUSH_CH?, OUT_LINK_CONF_CH?, OUT_LINK_ADDR_CH?, OUT_STATE_CH?, OUT_EOF_DES_ADDR_CH?, OUT_DSCR_CH?, OUT_DSCR_BF0_CH?, OUT_DSCR_BF1_CH?, OUT_ARB_CH?, OUT_RO_STATUS_CH?, OUT_RO_PD_CONF_CH?, OUT_MODE_ENABLE_CH?, OUT_MODE_YUV_CH?, OUT_ETM_CONF_CH?, OUT_BUF_LEN_CH?, OUT_FIFO_BCNT_CH?, OUT_PUSH_BYTECNT_CH?, OUT_XADDR_CH?, OUT_BLOCK_BUF_LEN_CH?"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn in_ch5(&self) -> &InCh5 {
        &self.in_ch5
    }
    #[doc = "0xb00 - inter memory axi err register"]
    #[inline(always)]
    pub const fn inter_axi_err(&self) -> &InterAxiErr {
        &self.inter_axi_err
    }
    #[doc = "0xb04 - exter memory axi err register"]
    #[inline(always)]
    pub const fn exter_axi_err(&self) -> &ExterAxiErr {
        &self.exter_axi_err
    }
    ...
    #[inline(always)]
    pub const fn counter_rst(&self) -> &CounterRst {
        &self.counter_rst
    }
    #[doc = "0xb54 - rx ch0 counter register"]
    #[inline(always)]
    pub const fn rx_ch0_counter(&self) -> &RxCh0Counter {
        &self.rx_ch0_counter
    }
    #[doc = "0xb58 - rx ch1 counter register"]
    #[inline(always)]
    pub const fn rx_ch1_counter(&self) -> &RxCh1Counter {
        &self.rx_ch1_counter
    }
    #[doc = "0xb5c - rx ch2 counter register"]
    #[inline(always)]
    pub const fn rx_ch2_counter(&self) -> &RxCh2Counter {
        &self.rx_ch2_counter
    }
    #[doc = "0xb60 - rx ch5 counter register"]
    #[inline(always)]
    pub const fn rx_ch5_counter(&self) -> &RxCh5Counter {
        &self.rx_ch5_counter
    }
...
#[doc(alias = "INTER_AXI_ERR")]
pub type InterAxiErr = crate::Reg<inter_axi_err::InterAxiErrSpec>;
...
#[doc(alias = "EXTER_AXI_ERR")]
pub type ExterAxiErr = crate::Reg<exter_axi_err::ExterAxiErrSpec>;
...
#[doc(alias = "INTER_MEM_START_ADDR0")]
pub type InterMemStartAddr0 = crate::Reg<inter_mem_start_addr0::InterMemStartAddr0Spec>;
...
#[doc(alias = "INTER_MEM_END_ADDR0")]
pub type InterMemEndAddr0 = crate::Reg<inter_mem_end_addr0::InterMemEndAddr0Spec>;
...
#[doc(alias = "INTER_MEM_START_ADDR1")]
pub type InterMemStartAddr1 = crate::Reg<inter_mem_start_addr1::InterMemStartAddr1Spec>;
...
#[doc(alias = "INTER_MEM_END_ADDR1")]
pub type InterMemEndAddr1 = crate::Reg<inter_mem_end_addr1::InterMemEndAddr1Spec>;
...
#[doc(alias = "EXTER_MEM_START_ADDR0")]
pub type ExterMemStartAddr0 = crate::Reg<exter_mem_start_addr0::ExterMemStartAddr0Spec>;
...
#[doc(alias = "EXTER_MEM_END_ADDR0")]
pub type ExterMemEndAddr0 = crate::Reg<exter_mem_end_addr0::ExterMemEndAddr0Spec>;
...
#[doc(alias = "EXTER_MEM_START_ADDR1")]
pub type ExterMemStartAddr1 = crate::Reg<exter_mem_start_addr1::ExterMemStartAddr1Spec>;
...
#[doc(alias = "EXTER_MEM_END_ADDR1")]
pub type ExterMemEndAddr1 = crate::Reg<exter_mem_end_addr1::ExterMemEndAddr1Spec>;
...
#[doc(alias = "OUT_ARB_CONFIG")]
pub type OutArbConfig = crate::Reg<out_arb_config::OutArbConfigSpec>;
#[doc = "reserved"]
...
#[doc(alias = "IN_ARB_CONFIG")]
pub type InArbConfig = crate::Reg<in_arb_config::InArbConfigSpec>;
#[doc = "reserved"]
...
#[doc(alias = "COUNTER_RST")]
pub type CounterRst = crate::Reg<counter_rst::CounterRstSpec>;
...
#[doc(alias = "RX_CH0_COUNTER")]
pub type RxCh0Counter = crate::Reg<rx_ch0_counter::RxCh0CounterSpec>;
...
#[doc(alias = "RX_CH1_COUNTER")]
pub type RxCh1Counter = crate::Reg<rx_ch1_counter::RxCh1CounterSpec>;
...
#[doc(alias = "RX_CH2_COUNTER")]
pub type RxCh2Counter = crate::Reg<rx_ch2_counter::RxCh2CounterSpec>;
...
#[doc(alias = "RX_CH5_COUNTER")]
pub type RxCh5Counter = crate::Reg<rx_ch5_counter::RxCh5CounterSpec>;
...
#[doc(alias = "PBYTE")]
pub type Pbyte = crate::Reg<pbyte::PbyteSpec>;
...
#[doc(alias = "CH_DBG_EN")]
pub type ChDbgEn = crate::Reg<ch_dbg_en::ChDbgEnSpec>;
...
#[doc(alias = "OUT_CH0_DBG_DATA_L")]
pub type OutCh0DbgDataL = crate::Reg<out_ch0_dbg_data_l::OutCh0DbgDataLSpec>;
...
#[doc(alias = "OUT_CH0_DBG_DATA_H")]
pub type OutCh0DbgDataH = crate::Reg<out_ch0_dbg_data_h::OutCh0DbgDataHSpec>;
#[doc = "out channel 0 debug data register"]
...
#[doc(alias = "OUT_CH1_DBG_DATA_L")]
pub type OutCh1DbgDataL = crate::Reg<out_ch1_dbg_data_l::OutCh1DbgDataLSpec>;
...
#[doc(alias = "OUT_CH1_DBG_DATA_H")]
pub type OutCh1DbgDataH = crate::Reg<out_ch1_dbg_data_h::OutCh1DbgDataHSpec>;
#[doc = "out channel 1 debug data register"]
...
#[doc(alias = "OUT_CH2_DBG_DATA_L")]
pub type OutCh2DbgDataL = crate::Reg<out_ch2_dbg_data_l::OutCh2DbgDataLSpec>;
...
#[doc(alias = "OUT_CH2_DBG_DATA_H")]
pub type OutCh2DbgDataH = crate::Reg<out_ch2_dbg_data_h::OutCh2DbgDataHSpec>;
#[doc = "out channel 2 debug data register"]
...
#[doc(alias = "OUT_CH3_DBG_DATA_L")]
pub type OutCh3DbgDataL = crate::Reg<out_ch3_dbg_data_l::OutCh3DbgDataLSpec>;
...
#[doc(alias = "OUT_CH3_DBG_DATA_H")]
pub type OutCh3DbgDataH = crate::Reg<out_ch3_dbg_data_h::OutCh3DbgDataHSpec>;
#[doc = "out channel 3 debug data register"]
...
#[doc(alias = "OUT_CH4_DBG_DATA_L")]
pub type OutCh4DbgDataL = crate::Reg<out_ch4_dbg_data_l::OutCh4DbgDataLSpec>;
...
#[doc(alias = "OUT_CH4_DBG_DATA_H")]
pub type OutCh4DbgDataH = crate::Reg<out_ch4_dbg_data_h::OutCh4DbgDataHSpec>;
#[doc = "out channel 4 debug data register"]
...
#[doc(alias = "IN_CH0_DBG_DATA_L")]
pub type InCh0DbgDataL = crate::Reg<in_ch0_dbg_data_l::InCh0DbgDataLSpec>;
...
#[doc(alias = "IN_CH0_DBG_DATA_H")]
pub type InCh0DbgDataH = crate::Reg<in_ch0_dbg_data_h::InCh0DbgDataHSpec>;
#[doc = "in channel 0 debug data register"]
...
#[doc(alias = "IN_CH1_DBG_DATA_L")]
pub type InCh1DbgDataL = crate::Reg<in_ch1_dbg_data_l::InCh1DbgDataLSpec>;
...
#[doc(alias = "IN_CH1_DBG_DATA_H")]
pub type InCh1DbgDataH = crate::Reg<in_ch1_dbg_data_h::InCh1DbgDataHSpec>;
#[doc = "in channel 1 debug data register"]
...
#[doc(alias = "IN_CH2_DBG_DATA_L")]
pub type InCh2DbgDataL = crate::Reg<in_ch2_dbg_data_l::InCh2DbgDataLSpec>;
...
#[doc(alias = "IN_CH2_DBG_DATA_H")]
pub type InCh2DbgDataH = crate::Reg<in_ch2_dbg_data_h::InCh2DbgDataHSpec>;
#[doc = "in channel 2 debug data register"]
...
#[doc(alias = "IN_CH3_DBG_DATA_L")]
pub type InCh3DbgDataL = crate::Reg<in_ch3_dbg_data_l::InCh3DbgDataLSpec>;
...
#[doc(alias = "IN_CH3_DBG_DATA_H")]
pub type InCh3DbgDataH = crate::Reg<in_ch3_dbg_data_h::InCh3DbgDataHSpec>;
#[doc = "in channel 3 debug data register"]
...
#[doc(alias = "IN_CH4_DBG_DATA_L")]
pub type InCh4DbgDataL = crate::Reg<in_ch4_dbg_data_l::InCh4DbgDataLSpec>;
...
#[doc(alias = "IN_CH4_DBG_DATA_H")]
pub type InCh4DbgDataH = crate::Reg<in_ch4_dbg_data_h::InCh4DbgDataHSpec>;
#[doc = "in channel 4 debug data register"]
...
#[doc(alias = "IN_CH5_DBG_DATA_L")]
pub type InCh5DbgDataL = crate::Reg<in_ch5_dbg_data_l::InCh5DbgDataLSpec>;
...
#[doc(alias = "IN_CH5_DBG_DATA_H")]
pub type InCh5DbgDataH = crate::Reg<in_ch5_dbg_data_h::InCh5DbgDataHSpec>;
#[doc = "in channel 5 debug data register"]

...
pub type LedcDateR = crate::FieldReader<u32>;
#[doc = "Field `LEDC_DATE` writer - Configures the version."]
pub type LedcDateW<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    #[doc = "Bits 0:27 - Configures the version."]
    #[inline(always)]
    pub fn ledc_date(&self) -> LedcDateR {
        LedcDateR::new(self.bits & 0x0fff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:27 - Configures the version."]
    #[inline(always)]
    pub fn ledc_date(&mut self) -> LedcDateW<'_, DateSpec> {
        LedcDateW::new(self, 0)
    }
}

...
pub type TimerSelR = crate::FieldReader;
...
pub type TimerSelW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type SigOutEnR = crate::BitReader;
...
pub type SigOutEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type IdleLvR = crate::BitReader;
...
pub type IdleLvW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type ParaUpW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OvfNumR = crate::FieldReader<u16>;
...
pub type OvfCntResetW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn idle_lv(&self) -> IdleLvR {
        IdleLvR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn ovf_num(&self) -> OvfNumR {
        OvfNumR::new(((self.bits >> 5) & 0x03ff) as u16)
    }
    #[doc = "Bit 15 - Configures whether or not to enable the ovf_cnt of channel %s.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ovf_cnt_en(&self) -> OvfCntEnR {
        OvfCntEnR::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - Configures which timer is channel %s selected.\\\\0: Select timer0\\\\1: Select timer1\\\\2: Select timer2\\\\3: Select timer3"]
    #[inline(always)]
    pub fn timer_sel(&mut self) -> TimerSelW<'_, Conf0Spec> {
        TimerSelW::new(self, 0)
    }
    #[doc = "Bit 2 - Configures whether or not to enable signal output on channel %s.\\\\0: Signal output disable\\\\1: Signal output enable"]
    #[inline(always)]
    pub fn sig_out_en(&mut self) -> SigOutEnW<'_, Conf0Spec> {
        SigOutEnW::new(self, 2)
    }
    #[doc = "Bit 3 - Configures the output value when channel %s is inactive. Valid only when LEDC_SIG_OUT_EN_CH%s is 0.\\\\0: Output level is low\\\\1: Output level is high"]
    #[inline(always)]
    pub fn idle_lv(&mut self) -> IdleLvW<'_, Conf0Spec> {
        IdleLvW::new(self, 3)
    }
    #[doc = "Bit 4 - Configures whether or not to update LEDC_HPOINT_CH%s, LEDC_DUTY_START_CH%s, LEDC_SIG_OUT_EN_CH%s, LEDC_TIMER_SEL_CH%s, LEDC_DUTY_NUM_CH%s, LEDC_DUTY_CYCLE_CH%s, LEDC_DUTY_SCALE_CH%s, LEDC_DUTY_INC_CH%s, and LEDC_OVF_CNT_EN_CH%s fields for channel %s, and will be automatically cleared by hardware.\\\\0: Invalid. No effect\\\\1: Update"]
    #[inline(always)]
    pub fn para_up(&mut self) -> ParaUpW<'_, Conf0Spec> {
        ParaUpW::new(self, 4)
    }
    #[doc = "Bits 5:14 - Configures the maximum times of overflow minus 1.The LEDC_OVF_CNT_CH%s_INT interrupt will be triggered when channel %s overflows for (LEDC_OVF_NUM_CH%s + 1) times."]
    #[inline(always)]
    pub fn ovf_num(&mut self) -> OvfNumW<'_, Conf0Spec> {
        OvfNumW::new(self, 5)
    }
    #[doc = "Bit 15 - Configures whether or not to enable the ovf_cnt of channel %s.\\\\0: Disable\\\\1: Enable"]
    #[inline(always)]
    pub fn ovf_cnt_en(&mut self) -> OvfCntEnW<'_, Conf0Spec> {
        OvfCntEnW::new(self, 15)
    }
    #[doc = "Bit 16 - Configures whether or not to reset the ovf_cnt of channel %s.\\\\0: Invalid. No effect\\\\1: Reset the ovf_cnt"]
    #[inline(always)]
    pub fn ovf_cnt_reset(&mut self) -> OvfCntResetW<'_, Conf0Spec> {
        OvfCntResetW::new(self, 16)
    }
}

...
impl W {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `TIMER0_OVF` field.</div>"]
    #[inline(always)]
    pub fn timer_ovf(&mut self, n: u8) -> TimerOvfW<'_, IntEnaSpec> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[doc = "Bit 0 - The interrupt enable bit for the TIMER0_OVF interrupt."]
    #[inline(always)]
    pub fn timer0_ovf(&mut self) -> TimerOvfW<'_, IntEnaSpec> {
        TimerOvfW::new(self, 0)
    }
    #[doc = "Bit 1 - The interrupt enable bit for the TIMER1_OVF interrupt."]
    #[inline(always)]
    pub fn timer1_ovf(&mut self) -> TimerOvfW<'_, IntEnaSpec> {
        TimerOvfW::new(self, 1)
    }
    #[doc = "Bit 2 - The interrupt enable bit for the TIMER2_OVF interrupt."]
    #[inline(always)]
    pub fn timer2_ovf(&mut self) -> TimerOvfW<'_, IntEnaSpec> {
        TimerOvfW::new(self, 2)
    }
    #[doc = "Bit 3 - The interrupt enable bit for the TIMER3_OVF interrupt."]
    #[inline(always)]
    pub fn timer3_ovf(&mut self) -> TimerOvfW<'_, IntEnaSpec> {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `DUTY_CHNG_END_CH0` field.</div>"]
    #[inline(always)]
    pub fn duty_chng_end_ch(&mut self, n: u8) -> DutyChngEndChW<'_, IntEnaSpec> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[doc = "Bit 4 - The interrupt enable bit for the DUTY_CHNG_END_CH0 interrupt."]
    #[inline(always)]
    pub fn duty_chng_end_ch0(&mut self) -> DutyChngEndChW<'_, IntEnaSpec> {
        DutyChngEndChW::new(self, 4)
    }
    #[doc = "Bit 5 - The interrupt enable bit for the DUTY_CHNG_END_CH1 interrupt."]
    #[inline(always)]
    pub fn duty_chng_end_ch1(&mut self) -> DutyChngEndChW<'_, IntEnaSpec> {
        DutyChngEndChW::new(self, 5)
    }
    #[doc = "Bit 6 - The interrupt enable bit for the DUTY_CHNG_END_CH2 interrupt."]
    #[inline(always)]
    pub fn duty_chng_end_ch2(&mut self) -> DutyChngEndChW<'_, IntEnaSpec> {
        DutyChngEndChW::new(self, 6)
    }
    #[doc = "Bit 7 - The interrupt enable bit for the DUTY_CHNG_END_CH3 interrupt."]
    #[inline(always)]
    pub fn duty_chng_end_ch3(&mut self) -> DutyChngEndChW<'_, IntEnaSpec> {
        DutyChngEndChW::new(self, 7)
    }
    #[doc = "Bit 8 - The interrupt enable bit for the DUTY_CHNG_END_CH4 interrupt."]
    #[inline(always)]
    pub fn duty_chng_end_ch4(&mut self) -> DutyChngEndChW<'_, IntEnaSpec> {
        DutyChngEndChW::new(self, 8)
    }
    #[doc = "Bit 9 - The interrupt enable bit for the DUTY_CHNG_END_CH5 interrupt."]
    #[inline(always)]
    pub fn duty_chng_end_ch5(&mut self) -> DutyChngEndChW<'_, IntEnaSpec> {
        DutyChngEndChW::new(self, 9)
    }
    #[doc = "Bit 10 - The interrupt enable bit for the DUTY_CHNG_END_CH6 interrupt."]
    #[inline(always)]
    pub fn duty_chng_end_ch6(&mut self) -> DutyChngEndChW<'_, IntEnaSpec> {
        DutyChngEndChW::new(self, 10)
    }
    #[doc = "Bit 11 - The interrupt enable bit for the DUTY_CHNG_END_CH7 interrupt."]
    #[inline(always)]
    pub fn duty_chng_end_ch7(&mut self) -> DutyChngEndChW<'_, IntEnaSpec> {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `OVF_CNT_CH0` field.</div>"]
    #[inline(always)]
    pub fn ovf_cnt_ch(&mut self, n: u8) -> OvfCntChW<'_, IntEnaSpec> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[doc = "Bit 12 - The interrupt enable bit for the OVF_CNT_CH0 interrupt."]
    #[inline(always)]
    pub fn ovf_cnt_ch0(&mut self) -> OvfCntChW<'_, IntEnaSpec> {
        OvfCntChW::new(self, 12)
    }
    #[doc = "Bit 13 - The interrupt enable bit for the OVF_CNT_CH1 interrupt."]
    #[inline(always)]
    pub fn ovf_cnt_ch1(&mut self) -> OvfCntChW<'_, IntEnaSpec> {
        OvfCntChW::new(self, 13)
    }
    #[doc = "Bit 14 - The interrupt enable bit for the OVF_CNT_CH2 interrupt."]
    #[inline(always)]
    pub fn ovf_cnt_ch2(&mut self) -> OvfCntChW<'_, IntEnaSpec> {
        OvfCntChW::new(self, 14)
    }
    #[doc = "Bit 15 - The interrupt enable bit for the OVF_CNT_CH3 interrupt."]
    #[inline(always)]
    pub fn ovf_cnt_ch3(&mut self) -> OvfCntChW<'_, IntEnaSpec> {
        OvfCntChW::new(self, 15)
    }
    #[doc = "Bit 16 - The interrupt enable bit for the OVF_CNT_CH4 interrupt."]
    #[inline(always)]
    pub fn ovf_cnt_ch4(&mut self) -> OvfCntChW<'_, IntEnaSpec> {
        OvfCntChW::new(self, 16)
    }
    #[doc = "Bit 17 - The interrupt enable bit for the OVF_CNT_CH5 interrupt."]
    #[inline(always)]
    pub fn ovf_cnt_ch5(&mut self) -> OvfCntChW<'_, IntEnaSpec> {
        OvfCntChW::new(self, 17)
    }
    #[doc = "Bit 18 - The interrupt enable bit for the OVF_CNT_CH6 interrupt."]
    #[inline(always)]
    pub fn ovf_cnt_ch6(&mut self) -> OvfCntChW<'_, IntEnaSpec> {
        OvfCntChW::new(self, 18)
    }
    #[doc = "Bit 19 - The interrupt enable bit for the OVF_CNT_CH7 interrupt."]
    #[inline(always)]
    pub fn ovf_cnt_ch7(&mut self) -> OvfCntChW<'_, IntEnaSpec> {

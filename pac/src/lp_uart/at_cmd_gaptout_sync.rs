...
pub type R = crate::R<AtCmdGaptoutSyncSpec>;
#[doc = "Register `AT_CMD_GAPTOUT_SYNC` writer"]
pub type W = crate::W<AtCmdGaptoutSyncSpec>;
...
impl W {
    #[doc = "Bits 0:15 - This register is used to configure the duration time between the at_cmd chars."]
    #[inline(always)]
    pub fn rx_gap_tout(&mut self) -> RxGapToutW<'_, AtCmdGaptoutSyncSpec> {
...
pub struct AtCmdGaptoutSyncSpec;
impl crate::RegisterSpec for AtCmdGaptoutSyncSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`at_cmd_gaptout_sync::R`](R) reader structure"]
impl crate::Readable for AtCmdGaptoutSyncSpec {}
#[doc = "`write(|w| ..)` method takes [`at_cmd_gaptout_sync::W`](W) writer structure"]
impl crate::Writable for AtCmdGaptoutSyncSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AT_CMD_GAPTOUT_SYNC to value 0x0b"]
impl crate::Resettable for AtCmdGaptoutSyncSpec {

...
pub struct MemRxStatusSpec;
impl crate::RegisterSpec for MemRxStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mem_rx_status::R`](R) reader structure"]
impl crate::Readable for MemRxStatusSpec {}
#[doc = "`reset()` method sets MEM_RX_STATUS to value 0x0001_0080"]
impl crate::Resettable for MemRxStatusSpec {

...
pub type R = crate::R<IdleConfSyncSpec>;
#[doc = "Register `IDLE_CONF_SYNC` writer"]
pub type W = crate::W<IdleConfSyncSpec>;
...
impl W {
    #[doc = "Bits 0:9 - It will produce frame end signal when receiver takes more time to receive one byte data than this register value."]
    #[inline(always)]
    pub fn rx_idle_thrhd(&mut self) -> RxIdleThrhdW<'_, IdleConfSyncSpec> {
        RxIdleThrhdW::new(self, 0)
    }
    #[doc = "Bits 10:19 - This register is used to configure the duration time between transfers."]
    #[inline(always)]
    pub fn tx_idle_num(&mut self) -> TxIdleNumW<'_, IdleConfSyncSpec> {
...
pub struct IdleConfSyncSpec;
impl crate::RegisterSpec for IdleConfSyncSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`idle_conf_sync::R`](R) reader structure"]
impl crate::Readable for IdleConfSyncSpec {}
#[doc = "`write(|w| ..)` method takes [`idle_conf_sync::W`](W) writer structure"]
impl crate::Writable for IdleConfSyncSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets IDLE_CONF_SYNC to value 0x0004_0100"]
impl crate::Resettable for IdleConfSyncSpec {

...
pub type R = crate::R<SwfcConf0SyncSpec>;
#[doc = "Register `SWFC_CONF0_SYNC` writer"]
pub type W = crate::W<SwfcConf0SyncSpec>;
...
impl W {
    #[doc = "Bits 0:7 - This register stores the Xon flow control char."]
    #[inline(always)]
    pub fn xon_char(&mut self) -> XonCharW<'_, SwfcConf0SyncSpec> {
        XonCharW::new(self, 0)
    }
    #[doc = "Bits 8:15 - This register stores the Xoff flow control char."]
    #[inline(always)]
    pub fn xoff_char(&mut self) -> XoffCharW<'_, SwfcConf0SyncSpec> {
        XoffCharW::new(self, 8)
    }
    #[doc = "Bit 16 - In software flow control mode, UART Tx is disabled once UART Rx receives XOFF. In this status, UART Tx can not transmit XOFF even the received data number is larger than UART_XOFF_THRESHOLD. Set this bit to enable UART Tx can transmit XON/XOFF when UART Tx is disabled."]
    #[inline(always)]
    pub fn xon_xoff_still_send(&mut self) -> XonXoffStillSendW<'_, SwfcConf0SyncSpec> {
        XonXoffStillSendW::new(self, 16)
    }
    #[doc = "Bit 17 - Set this bit to enable software flow control. It is used with register sw_xon or sw_xoff."]
    #[inline(always)]
    pub fn sw_flow_con_en(&mut self) -> SwFlowConEnW<'_, SwfcConf0SyncSpec> {
        SwFlowConEnW::new(self, 17)
    }
    #[doc = "Bit 18 - Set this bit to remove flow control char from the received data."]
    #[inline(always)]
    pub fn xonoff_del(&mut self) -> XonoffDelW<'_, SwfcConf0SyncSpec> {
        XonoffDelW::new(self, 18)
    }
    #[doc = "Bit 19 - Set this bit to enable the transmitter to go on sending data."]
    #[inline(always)]
    pub fn force_xon(&mut self) -> ForceXonW<'_, SwfcConf0SyncSpec> {
        ForceXonW::new(self, 19)
    }
    #[doc = "Bit 20 - Set this bit to stop the transmitter from sending data."]
    #[inline(always)]
    pub fn force_xoff(&mut self) -> ForceXoffW<'_, SwfcConf0SyncSpec> {
        ForceXoffW::new(self, 20)
    }
    #[doc = "Bit 21 - Set this bit to send Xon char. It is cleared by hardware automatically."]
    #[inline(always)]
    pub fn send_xon(&mut self) -> SendXonW<'_, SwfcConf0SyncSpec> {
        SendXonW::new(self, 21)
    }
    #[doc = "Bit 22 - Set this bit to send Xoff char. It is cleared by hardware automatically."]
    #[inline(always)]
    pub fn send_xoff(&mut self) -> SendXoffW<'_, SwfcConf0SyncSpec> {
...
pub struct SwfcConf0SyncSpec;
impl crate::RegisterSpec for SwfcConf0SyncSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`swfc_conf0_sync::R`](R) reader structure"]
impl crate::Readable for SwfcConf0SyncSpec {}
#[doc = "`write(|w| ..)` method takes [`swfc_conf0_sync::W`](W) writer structure"]
impl crate::Writable for SwfcConf0SyncSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SWFC_CONF0_SYNC to value 0x1311"]
impl crate::Resettable for SwfcConf0SyncSpec {

...
pub type R = crate::R<HwfcConfSyncSpec>;
#[doc = "Register `HWFC_CONF_SYNC` writer"]
pub type W = crate::W<HwfcConfSyncSpec>;
...
pub type RxFlowThrhdW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
impl R {
    ...
    pub fn rx_flow_thrhd(&self) -> RxFlowThrhdR {
        RxFlowThrhdR::new(((self.bits >> 3) & 0x1f) as u8)
    }
...
impl W {
    #[doc = "Bits 3:7 - This register is used to configure the maximum amount of data that can be received when hardware flow control works."]
    #[inline(always)]
    pub fn rx_flow_thrhd(&mut self) -> RxFlowThrhdW<'_, HwfcConfSyncSpec> {
        RxFlowThrhdW::new(self, 3)
    }
    #[doc = "Bit 8 - This is the flow enable bit for UART receiver."]
    #[inline(always)]
    pub fn rx_flow_en(&mut self) -> RxFlowEnW<'_, HwfcConfSyncSpec> {
...
pub struct HwfcConfSyncSpec;
impl crate::RegisterSpec for HwfcConfSyncSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hwfc_conf_sync::R`](R) reader structure"]
impl crate::Readable for HwfcConfSyncSpec {}
#[doc = "`write(|w| ..)` method takes [`hwfc_conf_sync::W`](W) writer structure"]
impl crate::Writable for HwfcConfSyncSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HWFC_CONF_SYNC to value 0"]
impl crate::Resettable for HwfcConfSyncSpec {}

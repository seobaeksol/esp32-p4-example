...
pub type StUrxOutR = crate::FieldReader;
#[doc = "Field `ST_UTX_OUT` reader - This is the status register of transmitter."]
pub type StUtxOutR = crate::FieldReader;
impl R {
    #[doc = "Bits 0:3 - This is the status register of receiver."]
    #[inline(always)]
    pub fn st_urx_out(&self) -> StUrxOutR {
        StUrxOutR::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bits 4:7 - This is the status register of transmitter."]
    #[inline(always)]
    pub fn st_utx_out(&self) -> StUtxOutR {
        StUtxOutR::new(((self.bits >> 4) & 0x0f) as u8)
    }
}

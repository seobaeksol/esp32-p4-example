...
pub type Ch1Dar0R = crate::FieldReader<u32>;
#[doc = "Field `CH1_DAR0` writer - NA"]
pub type Ch1Dar0W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - NA"]
    #[inline(always)]
    pub fn ch1_dar0(&self) -> Ch1Dar0R {
        Ch1Dar0R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - NA"]
    #[inline(always)]
    pub fn ch1_dar0(&mut self) -> Ch1Dar0W<'_, Dar0Spec> {
        Ch1Dar0W::new(self, 0)
    }
}

...
pub type Ch1Sar0R = crate::FieldReader<u32>;
#[doc = "Field `CH1_SAR0` writer - NA"]
pub type Ch1Sar0W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - NA"]
    #[inline(always)]
    pub fn ch1_sar0(&self) -> Ch1Sar0R {
        Ch1Sar0R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - NA"]
    #[inline(always)]
    pub fn ch1_sar0(&mut self) -> Ch1Sar0W<'_, Sar0Spec> {
        Ch1Sar0W::new(self, 0)
    }
}

...
pub type Ch1Sar1R = crate::FieldReader<u32>;
#[doc = "Field `CH1_SAR1` writer - NA"]
pub type Ch1Sar1W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - NA"]
    #[inline(always)]
    pub fn ch1_sar1(&self) -> Ch1Sar1R {
        Ch1Sar1R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - NA"]
    #[inline(always)]
    pub fn ch1_sar1(&mut self) -> Ch1Sar1W<'_, Sar1Spec> {
        Ch1Sar1W::new(self, 0)
    }
}

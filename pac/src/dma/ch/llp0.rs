...
pub type Ch1LmsR = crate::BitReader;
#[doc = "Field `CH1_LMS` writer - NA"]
pub type Ch1LmsW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CH1_LOC0` reader - NA"]
pub type Ch1Loc0R = crate::FieldReader<u32>;
#[doc = "Field `CH1_LOC0` writer - NA"]
pub type Ch1Loc0W<'a, REG> = crate::FieldWriter<'a, REG, 26, u32>;
impl R {
    #[doc = "Bit 0 - NA"]
    #[inline(always)]
    pub fn ch1_lms(&self) -> Ch1LmsR {
        Ch1LmsR::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 6:31 - NA"]
    #[inline(always)]
    pub fn ch1_loc0(&self) -> Ch1Loc0R {
        Ch1Loc0R::new((self.bits >> 6) & 0x03ff_ffff)
    }
}
impl W {
    #[doc = "Bit 0 - NA"]
    #[inline(always)]
    pub fn ch1_lms(&mut self) -> Ch1LmsW<'_, Llp0Spec> {
        Ch1LmsW::new(self, 0)
    }
    #[doc = "Bits 6:31 - NA"]
    #[inline(always)]
    pub fn ch1_loc0(&mut self) -> Ch1Loc0W<'_, Llp0Spec> {
        Ch1Loc0W::new(self, 6)
    }
}
...
impl crate::Resettable for Llp0Spec {}

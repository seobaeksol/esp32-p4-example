...
pub type SerialInEpDataFreeR = crate::BitReader;
#[doc = "Field `SERIAL_OUT_EP_DATA_AVAIL` reader - 1'b1: Indicate there is data in UART Rx FIFO."]
pub type SerialOutEpDataAvailR = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn serial_in_ep_data_free(&self) -> SerialInEpDataFreeR {
        SerialInEpDataFreeR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - 1'b1: Indicate there is data in UART Rx FIFO."]
    #[inline(always)]
    pub fn serial_out_ep_data_avail(&self) -> SerialOutEpDataAvailR {
        SerialOutEpDataAvailR::new(((self.bits >> 2) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Set this bit to indicate writing byte data to UART Tx FIFO is done."]
    #[inline(always)]
    pub fn wr_done(&mut self) -> WrDoneW<'_, Ep1ConfSpec> {
        WrDoneW::new(self, 0)
    }
}
...
pub struct Ep1ConfSpec;
impl crate::RegisterSpec for Ep1ConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ep1_conf::R`](R) reader structure"]
impl crate::Readable for Ep1ConfSpec {}
#[doc = "`write(|w| ..)` method takes [`ep1_conf::W`](W) writer structure"]
impl crate::Writable for Ep1ConfSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EP1_CONF to value 0x02"]
impl crate::Resettable for Ep1ConfSpec {

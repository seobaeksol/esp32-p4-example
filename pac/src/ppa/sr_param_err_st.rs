...
pub type R = crate::R<SrParamErrStSpec>;
...
pub type TxDscrVbErrStR = crate::BitReader;
...
pub type RxDscrVbErrStR = crate::BitReader;
...
pub type RxDscrHbErrStR = crate::BitReader;
...
pub type XYuv420RxScaleErrStR = crate::BitReader;
...
pub type YYuv420RxScaleErrStR = crate::BitReader;
...
pub type XYuv420TxScaleErrStR = crate::BitReader;
...
pub type YYuv420TxScaleErrStR = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn tx_dscr_vb_err_st(&self) -> TxDscrVbErrStR {
        TxDscrVbErrStR::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn tx_dscr_hb_err_st(&self) -> TxDscrHbErrStR {
        TxDscrHbErrStR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - The error is that the PPA_SR_SCAL_Y_INT and PPA_SR_CAL_Y_FRAG both are 0."]
    #[inline(always)]
    pub fn y_rx_scal_equal_0_err_st(&self) -> YRxScalEqual0ErrStR {
        YRxScalEqual0ErrStR::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn rx_dscr_vb_err_st(&self) -> RxDscrVbErrStR {
        RxDscrVbErrStR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn ydst_len_too_samll_err_st(&self) -> YdstLenTooSamllErrStR {
        YdstLenTooSamllErrStR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - The error is that the scaled width is larger than (2^13 - 1)."]
    #[inline(always)]
    pub fn ydst_len_too_large_err_st(&self) -> YdstLenTooLargeErrStR {
        YdstLenTooLargeErrStR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - The error is that the scaled image height is 0."]
    #[inline(always)]
    pub fn x_rx_scal_equal_0_err_st(&self) -> XRxScalEqual0ErrStR {
        XRxScalEqual0ErrStR::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn rx_dscr_hb_err_st(&self) -> RxDscrHbErrStR {
        RxDscrHbErrStR::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn xdst_len_too_samll_err_st(&self) -> XdstLenTooSamllErrStR {
        XdstLenTooSamllErrStR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - The error is that the scaled image height is larger than (2^13 - 1)."]
    #[inline(always)]
    pub fn xdst_len_too_large_err_st(&self) -> XdstLenTooLargeErrStR {
        XdstLenTooLargeErrStR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - The error is that the ha/hb/x param in dma2d descriptor is an odd num when enable yuv422 or yuv420 rx"]
    #[inline(always)]
    pub fn x_yuv420_rx_scale_err_st(&self) -> XYuv420RxScaleErrStR {
        XYuv420RxScaleErrStR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - The error is that the va/vb/y param in dma2d descriptor is an odd num when enable yuv420 rx"]
    #[inline(always)]
    pub fn y_yuv420_rx_scale_err_st(&self) -> YYuv420RxScaleErrStR {
        YYuv420RxScaleErrStR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - The error is that the ha/hb/x param in dma2d descriptor is an odd num when enable yuv422 or yuv420 tx"]
    #[inline(always)]
    pub fn x_yuv420_tx_scale_err_st(&self) -> XYuv420TxScaleErrStR {
        XYuv420TxScaleErrStR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - The error is that the va/vb/y param in dma2d descriptor is an odd num when enable yuv420 tx"]
    #[inline(always)]
    pub fn y_yuv420_tx_scale_err_st(&self) -> YYuv420TxScaleErrStR {
        YYuv420TxScaleErrStR::new(((self.bits >> 13) & 1) != 0)
    }
}
...
pub struct SrParamErrStSpec;
impl crate::RegisterSpec for SrParamErrStSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sr_param_err_st::R`](R) reader structure"]
impl crate::Readable for SrParamErrStSpec {}
#[doc = "`reset()` method sets SR_PARAM_ERR_ST to value 0"]
impl crate::Resettable for SrParamErrStSpec {}

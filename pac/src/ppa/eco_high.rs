...
pub type R = crate::R<EcoHighSpec>;
#[doc = "Register `ECO_HIGH` writer"]
pub type W = crate::W<EcoHighSpec>;
...
impl W {
    #[doc = "Bits 0:31 - Reserved."]
    #[inline(always)]
    pub fn rnd_eco_high(&mut self) -> RndEcoHighW<'_, EcoHighSpec> {
...
pub struct EcoHighSpec;
impl crate::RegisterSpec for EcoHighSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eco_high::R`](R) reader structure"]
impl crate::Readable for EcoHighSpec {}
#[doc = "`write(|w| ..)` method takes [`eco_high::W`](W) writer structure"]
impl crate::Writable for EcoHighSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ECO_HIGH to value 0xffff_ffff"]
impl crate::Resettable for EcoHighSpec {

...
pub type R = crate::R<Rgb2graySpec>;
#[doc = "Register `RGB2GRAY` writer"]
pub type W = crate::W<Rgb2graySpec>;
...
impl W {
    #[doc = "Bits 0:7 - Configures the b parameter for rgb2gray"]
    #[inline(always)]
    pub fn b(&mut self) -> BW<'_, Rgb2graySpec> {
        BW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Configures the g parameter for rgb2gray"]
    #[inline(always)]
    pub fn g(&mut self) -> GW<'_, Rgb2graySpec> {
        GW::new(self, 8)
    }
    #[doc = "Bits 16:23 - Configures the r parameter for rgb2gray"]
    #[inline(always)]
    pub fn r(&mut self) -> RW<'_, Rgb2graySpec> {
        RW::new(self, 16)
    }
}
...
pub struct Rgb2graySpec;
impl crate::RegisterSpec for Rgb2graySpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rgb2gray::R`](R) reader structure"]
impl crate::Readable for Rgb2graySpec {}
#[doc = "`write(|w| ..)` method takes [`rgb2gray::W`](W) writer structure"]
impl crate::Writable for Rgb2graySpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RGB2GRAY to value 0x0055_5655"]
impl crate::Resettable for Rgb2graySpec {

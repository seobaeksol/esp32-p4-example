...
pub type MemAuxCtrlR = crate::FieldReader<u16>;
#[doc = "Field `MEM_AUX_CTRL` writer - Control signals"]
pub type MemAuxCtrlW<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    #[doc = "Bits 0:13 - Control signals"]
    #[inline(always)]
    pub fn mem_aux_ctrl(&self) -> MemAuxCtrlR {
        MemAuxCtrlR::new((self.bits & 0x3fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:13 - Control signals"]
    #[inline(always)]
    pub fn mem_aux_ctrl(&mut self) -> MemAuxCtrlW<'_, SramCtrlSpec> {
        MemAuxCtrlW::new(self, 0)
    }
}

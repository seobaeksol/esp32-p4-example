...
pub type R = crate::R<EcoCellCtrlSpec>;
#[doc = "Register `ECO_CELL_CTRL` writer"]
pub type W = crate::W<EcoCellCtrlSpec>;
...
impl R {
    ...
    pub fn rdn_result(&self) -> RdnResultR {
        RdnResultR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Reserved."]
    #[inline(always)]
    pub fn rdn_ena(&self) -> RdnEnaR {
        RdnEnaR::new(((self.bits >> 1) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 1 - Reserved."]
    #[inline(always)]
    pub fn rdn_ena(&mut self) -> RdnEnaW<'_, EcoCellCtrlSpec> {
        RdnEnaW::new(self, 1)
    }
}
...
pub struct EcoCellCtrlSpec;
impl crate::RegisterSpec for EcoCellCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eco_cell_ctrl::R`](R) reader structure"]
impl crate::Readable for EcoCellCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`eco_cell_ctrl::W`](W) writer structure"]
impl crate::Writable for EcoCellCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ECO_CELL_CTRL to value 0"]
impl crate::Resettable for EcoCellCtrlSpec {}

...
impl W {
    #[doc = "Bit 0 - The interrupt enable bit for CH0_TX_END_INT."]
    #[inline(always)]
    pub fn ch0_tx_end(&mut self) -> Ch0TxEndW<'_, IntEnaSpec> {
        Ch0TxEndW::new(self, 0)
    }
    #[doc = "Bit 1 - The interrupt enable bit for CH1_TX_END_INT."]
    #[inline(always)]
    pub fn ch1_tx_end(&mut self) -> Ch1TxEndW<'_, IntEnaSpec> {
        Ch1TxEndW::new(self, 1)
    }
    #[doc = "Bit 2 - The interrupt enable bit for CH2_TX_END_INT."]
    #[inline(always)]
    pub fn ch2_tx_end(&mut self) -> Ch2TxEndW<'_, IntEnaSpec> {
        Ch2TxEndW::new(self, 2)
    }
    #[doc = "Bit 3 - The interrupt enable bit for CH3_TX_END_INT."]
    #[inline(always)]
    pub fn ch3_tx_end(&mut self) -> Ch3TxEndW<'_, IntEnaSpec> {
        Ch3TxEndW::new(self, 3)
    }
    #[doc = "Bit 4 - The interrupt enable bit for CH0_ERR_INT."]
    #[inline(always)]
    pub fn ch0_err(&mut self) -> Ch0ErrW<'_, IntEnaSpec> {
        Ch0ErrW::new(self, 4)
    }
    #[doc = "Bit 5 - The interrupt enable bit for CH1_ERR_INT."]
    #[inline(always)]
    pub fn ch1_err(&mut self) -> Ch1ErrW<'_, IntEnaSpec> {
        Ch1ErrW::new(self, 5)
    }
    #[doc = "Bit 6 - The interrupt enable bit for CH2_ERR_INT."]
    #[inline(always)]
    pub fn ch2_err(&mut self) -> Ch2ErrW<'_, IntEnaSpec> {
        Ch2ErrW::new(self, 6)
    }
    #[doc = "Bit 7 - The interrupt enable bit for CH3_ERR_INT."]
    #[inline(always)]
    pub fn ch3_err(&mut self) -> Ch3ErrW<'_, IntEnaSpec> {
        Ch3ErrW::new(self, 7)
    }
    #[doc = "Bit 8 - The interrupt enable bit for CH0_TX_THR_EVENT_INT."]
    #[inline(always)]
    pub fn ch0_tx_thr_event(&mut self) -> Ch0TxThrEventW<'_, IntEnaSpec> {
        Ch0TxThrEventW::new(self, 8)
    }
    #[doc = "Bit 9 - The interrupt enable bit for CH1_TX_THR_EVENT_INT."]
    #[inline(always)]
    pub fn ch1_tx_thr_event(&mut self) -> Ch1TxThrEventW<'_, IntEnaSpec> {
        Ch1TxThrEventW::new(self, 9)
    }
    #[doc = "Bit 10 - The interrupt enable bit for CH2_TX_THR_EVENT_INT."]
    #[inline(always)]
    pub fn ch2_tx_thr_event(&mut self) -> Ch2TxThrEventW<'_, IntEnaSpec> {
        Ch2TxThrEventW::new(self, 10)
    }
    #[doc = "Bit 11 - The interrupt enable bit for CH3_TX_THR_EVENT_INT."]
    #[inline(always)]
    pub fn ch3_tx_thr_event(&mut self) -> Ch3TxThrEventW<'_, IntEnaSpec> {
        Ch3TxThrEventW::new(self, 11)
    }
    #[doc = "Bit 12 - The interrupt enable bit for CH0_TX_LOOP_INT."]
    #[inline(always)]
    pub fn ch0_tx_loop(&mut self) -> Ch0TxLoopW<'_, IntEnaSpec> {
        Ch0TxLoopW::new(self, 12)
    }
    #[doc = "Bit 13 - The interrupt enable bit for CH1_TX_LOOP_INT."]
    #[inline(always)]
    pub fn ch1_tx_loop(&mut self) -> Ch1TxLoopW<'_, IntEnaSpec> {
        Ch1TxLoopW::new(self, 13)
    }
    #[doc = "Bit 14 - The interrupt enable bit for CH2_TX_LOOP_INT."]
    #[inline(always)]
    pub fn ch2_tx_loop(&mut self) -> Ch2TxLoopW<'_, IntEnaSpec> {
        Ch2TxLoopW::new(self, 14)
    }
    #[doc = "Bit 15 - The interrupt enable bit for CH3_TX_LOOP_INT."]
    #[inline(always)]
    pub fn ch3_tx_loop(&mut self) -> Ch3TxLoopW<'_, IntEnaSpec> {
        Ch3TxLoopW::new(self, 15)
    }
    #[doc = "Bit 16 - The interrupt enable bit for CH4_RX_END_INT."]
    #[inline(always)]
    pub fn ch4_rx_end(&mut self) -> Ch4RxEndW<'_, IntEnaSpec> {
        Ch4RxEndW::new(self, 16)
    }
    #[doc = "Bit 17 - The interrupt enable bit for CH5_RX_END_INT."]
    #[inline(always)]
    pub fn ch5_rx_end(&mut self) -> Ch5RxEndW<'_, IntEnaSpec> {
        Ch5RxEndW::new(self, 17)
    }
    #[doc = "Bit 18 - The interrupt enable bit for CH6_RX_END_INT."]
    #[inline(always)]
    pub fn ch6_rx_end(&mut self) -> Ch6RxEndW<'_, IntEnaSpec> {
        Ch6RxEndW::new(self, 18)
    }
    #[doc = "Bit 19 - The interrupt enable bit for CH7_RX_END_INT."]
    #[inline(always)]
    pub fn ch7_rx_end(&mut self) -> Ch7RxEndW<'_, IntEnaSpec> {
        Ch7RxEndW::new(self, 19)
    }
    #[doc = "Bit 20 - The interrupt enable bit for CH4_ERR_INT."]
    #[inline(always)]
    pub fn ch4_err(&mut self) -> Ch4ErrW<'_, IntEnaSpec> {
        Ch4ErrW::new(self, 20)
    }
    #[doc = "Bit 21 - The interrupt enable bit for CH5_ERR_INT."]
    #[inline(always)]
    pub fn ch5_err(&mut self) -> Ch5ErrW<'_, IntEnaSpec> {
        Ch5ErrW::new(self, 21)
    }
    #[doc = "Bit 22 - The interrupt enable bit for CH6_ERR_INT."]
    #[inline(always)]
    pub fn ch6_err(&mut self) -> Ch6ErrW<'_, IntEnaSpec> {
        Ch6ErrW::new(self, 22)
    }
    #[doc = "Bit 23 - The interrupt enable bit for CH7_ERR_INT."]
    #[inline(always)]
    pub fn ch7_err(&mut self) -> Ch7ErrW<'_, IntEnaSpec> {
        Ch7ErrW::new(self, 23)
    }
    #[doc = "Bit 24 - The interrupt enable bit for CH4_RX_THR_EVENT_INT."]
    #[inline(always)]
    pub fn ch4_rx_thr_event(&mut self) -> Ch4RxThrEventW<'_, IntEnaSpec> {
        Ch4RxThrEventW::new(self, 24)
    }
    #[doc = "Bit 25 - The interrupt enable bit for CH5_RX_THR_EVENT_INT."]
    #[inline(always)]
    pub fn ch5_rx_thr_event(&mut self) -> Ch5RxThrEventW<'_, IntEnaSpec> {
        Ch5RxThrEventW::new(self, 25)
    }
    #[doc = "Bit 26 - The interrupt enable bit for CH6_RX_THR_EVENT_INT."]
    #[inline(always)]
    pub fn ch6_rx_thr_event(&mut self) -> Ch6RxThrEventW<'_, IntEnaSpec> {
        Ch6RxThrEventW::new(self, 26)
    }
    #[doc = "Bit 27 - The interrupt enable bit for CH7_RX_THR_EVENT_INT."]
    #[inline(always)]
    pub fn ch7_rx_thr_event(&mut self) -> Ch7RxThrEventW<'_, IntEnaSpec> {
        Ch7RxThrEventW::new(self, 27)
    }
    #[doc = "Bit 28 - The interrupt enable bit for CH3_DMA_ACCESS_FAIL_INT."]
    #[inline(always)]
    pub fn ch3_dma_access_fail(&mut self) -> Ch3DmaAccessFailW<'_, IntEnaSpec> {
        Ch3DmaAccessFailW::new(self, 28)
    }
    #[doc = "Bit 29 - The interrupt enable bit for CH7_DMA_ACCESS_FAIL_INT."]
    #[inline(always)]
    pub fn ch7_dma_access_fail(&mut self) -> Ch7DmaAccessFailW<'_, IntEnaSpec> {

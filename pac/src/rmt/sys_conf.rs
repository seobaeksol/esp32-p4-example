...
pub type R = crate::R<SysConfSpec>;
#[doc = "Register `SYS_CONF` writer"]
pub type W = crate::W<SysConfSpec>;
...
impl R {
    ...
    pub fn mem_force_pd(&self) -> MemForcePdR {
        MemForcePdR::new(((self.bits >> 2) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - 1'h1: access memory directly. 1'h0: access memory by FIFO."]
    #[inline(always)]
    pub fn apb_fifo_mask(&mut self) -> ApbFifoMaskW<'_, SysConfSpec> {
        ApbFifoMaskW::new(self, 0)
    }
    #[doc = "Bit 1 - Set this bit to enable the clock for RMT memory."]
    #[inline(always)]
    pub fn mem_clk_force_on(&mut self) -> MemClkForceOnW<'_, SysConfSpec> {
        MemClkForceOnW::new(self, 1)
    }
    #[doc = "Bit 2 - Set this bit to power down RMT memory."]
    #[inline(always)]
    pub fn mem_force_pd(&mut self) -> MemForcePdW<'_, SysConfSpec> {
        MemForcePdW::new(self, 2)
    }
    #[doc = "Bit 3 - 1: Disable RMT memory light sleep power down function. 0: Power down RMT memory when RMT is in light sleep mode."]
    #[inline(always)]
    pub fn mem_force_pu(&mut self) -> MemForcePuW<'_, SysConfSpec> {
        MemForcePuW::new(self, 3)
    }
    #[doc = "Bits 4:11 - the integral part of the fractional divisor"]
    #[inline(always)]
    pub fn sclk_div_num(&mut self) -> SclkDivNumW<'_, SysConfSpec> {
        SclkDivNumW::new(self, 4)
    }
    #[doc = "Bits 12:17 - the numerator of the fractional part of the fractional divisor"]
    #[inline(always)]
    pub fn sclk_div_a(&mut self) -> SclkDivAW<'_, SysConfSpec> {
        SclkDivAW::new(self, 12)
    }
    #[doc = "Bits 18:23 - the denominator of the fractional part of the fractional divisor"]
    #[inline(always)]
    pub fn sclk_div_b(&mut self) -> SclkDivBW<'_, SysConfSpec> {
        SclkDivBW::new(self, 18)
    }
    #[doc = "Bits 24:25 - choose the clock source of rmt_sclk. 1:CLK_80Mhz.2:CLK_8MHz.3:XTAL"]
    #[inline(always)]
    pub fn sclk_sel(&mut self) -> SclkSelW<'_, SysConfSpec> {
        SclkSelW::new(self, 24)
    }
    #[doc = "Bit 26 - rmt_sclk switch"]
    #[inline(always)]
    pub fn sclk_active(&mut self) -> SclkActiveW<'_, SysConfSpec> {
        SclkActiveW::new(self, 26)
    }
    #[doc = "Bit 31 - RMT register clock gate enable signal. 1: Power up the drive clock of registers. 0: Power down the drive clock of registers"]
    #[inline(always)]
    pub fn clk_en(&mut self) -> ClkEnW<'_, SysConfSpec> {
        ClkEnW::new(self, 31)
    }
}
...
pub struct SysConfSpec;
impl crate::RegisterSpec for SysConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sys_conf::R`](R) reader structure"]
impl crate::Readable for SysConfSpec {}
#[doc = "`write(|w| ..)` method takes [`sys_conf::W`](W) writer structure"]
impl crate::Writable for SysConfSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SYS_CONF to value 0x0500_0010"]
impl crate::Resettable for SysConfSpec {

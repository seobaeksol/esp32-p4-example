...
pub struct ChRxLimSpec;
impl crate::RegisterSpec for ChRxLimSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch_rx_lim::R`](R) reader structure"]
impl crate::Readable for ChRxLimSpec {}
#[doc = "`write(|w| ..)` method takes [`ch_rx_lim::W`](W) writer structure"]
impl crate::Writable for ChRxLimSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH%s_RX_LIM to value 0x80"]
impl crate::Resettable for ChRxLimSpec {

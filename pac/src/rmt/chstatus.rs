...
pub type MemEmptyCh0R = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn mem_empty_ch0(&self) -> MemEmptyCh0R {
        MemEmptyCh0R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - This status bit will be set if the offset address out of memory size when writes via APB bus."]
    #[inline(always)]
    pub fn apb_mem_wr_err_ch0(&self) -> ApbMemWrErrCh0R {
        ApbMemWrErrCh0R::new(((self.bits >> 26) & 1) != 0)
    }
}

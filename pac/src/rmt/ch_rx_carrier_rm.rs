...
pub type R = crate::R<ChRxCarrierRmSpec>;
#[doc = "Register `CH%s_RX_CARRIER_RM` writer"]
pub type W = crate::W<ChRxCarrierRmSpec>;
...
pub type CarrierLowThresChR = crate::FieldReader<u16>;
...
pub type CarrierLowThresChW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
...
pub type CarrierHighThresChR = crate::FieldReader<u16>;
...
pub type CarrierHighThresChW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - The low level period in a carrier modulation mode is (REG_RMT_REG_CARRIER_LOW_THRES_CH%s + 1) for channel %s."]
    #[inline(always)]
    pub fn carrier_low_thres_ch(&self) -> CarrierLowThresChR {
        CarrierLowThresChR::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - The high level period in a carrier modulation mode is (REG_RMT_REG_CARRIER_HIGH_THRES_CH%s + 1) for channel %s."]
    #[inline(always)]
    pub fn carrier_high_thres_ch(&self) -> CarrierHighThresChR {
        CarrierHighThresChR::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - The low level period in a carrier modulation mode is (REG_RMT_REG_CARRIER_LOW_THRES_CH%s + 1) for channel %s."]
    #[inline(always)]
    pub fn carrier_low_thres_ch(&mut self) -> CarrierLowThresChW<'_, ChRxCarrierRmSpec> {
        CarrierLowThresChW::new(self, 0)
    }
    #[doc = "Bits 16:31 - The high level period in a carrier modulation mode is (REG_RMT_REG_CARRIER_HIGH_THRES_CH%s + 1) for channel %s."]
    #[inline(always)]
    pub fn carrier_high_thres_ch(&mut self) -> CarrierHighThresChW<'_, ChRxCarrierRmSpec> {
        CarrierHighThresChW::new(self, 16)
    }
}
...
pub struct ChRxCarrierRmSpec;
impl crate::RegisterSpec for ChRxCarrierRmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch_rx_carrier_rm::R`](R) reader structure"]
impl crate::Readable for ChRxCarrierRmSpec {}
#[doc = "`write(|w| ..)` method takes [`ch_rx_carrier_rm::W`](W) writer structure"]
impl crate::Writable for ChRxCarrierRmSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH%s_RX_CARRIER_RM to value 0"]
impl crate::Resettable for ChRxCarrierRmSpec {}

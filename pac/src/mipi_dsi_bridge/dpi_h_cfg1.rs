...
pub struct DpiHCfg1Spec;
impl crate::RegisterSpec for DpiHCfg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dpi_h_cfg1::R`](R) reader structure"]
impl crate::Readable for DpiHCfg1Spec {}
#[doc = "`write(|w| ..)` method takes [`dpi_h_cfg1::W`](W) writer structure"]
impl crate::Writable for DpiHCfg1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DPI_H_CFG1 to value 0x0060_0030"]
impl crate::Resettable for DpiHCfg1Spec {

...
pub struct DpiRsvDpiDataSpec;
impl crate::RegisterSpec for DpiRsvDpiDataSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dpi_rsv_dpi_data::R`](R) reader structure"]
impl crate::Readable for DpiRsvDpiDataSpec {}
#[doc = "`write(|w| ..)` method takes [`dpi_rsv_dpi_data::W`](W) writer structure"]
impl crate::Writable for DpiRsvDpiDataSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DPI_RSV_DPI_DATA to value 0x3fff"]
impl crate::Resettable for DpiRsvDpiDataSpec {

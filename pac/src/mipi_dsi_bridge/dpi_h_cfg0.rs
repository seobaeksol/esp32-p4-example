...
pub type R = crate::R<DpiHCfg0Spec>;
#[doc = "Register `DPI_H_CFG0` writer"]
pub type W = crate::W<DpiHCfg0Spec>;
...
pub type HtotalR = crate::FieldReader<u16>;
...
impl R {
    ...
    #[inline(always)]
    pub fn htotal(&self) -> HtotalR {
        HtotalR::new((self.bits & 0x0fff) as u16)
    }
    #[doc = "Bits 16:27 - this field configures the length of valid pixel data (by pixel num) for dpi output"]
    #[inline(always)]
    pub fn hdisp(&self) -> HdispR {
        HdispR::new(((self.bits >> 16) & 0x0fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:11 - this field configures the total length of one line (by pixel num) for dpi output, must meet: reg_htotal > reg_hdisp+reg_hsync+reg_hbank"]
    #[inline(always)]
    pub fn htotal(&mut self) -> HtotalW<'_, DpiHCfg0Spec> {
        HtotalW::new(self, 0)
    }
    #[doc = "Bits 16:27 - this field configures the length of valid pixel data (by pixel num) for dpi output"]
    #[inline(always)]
    pub fn hdisp(&mut self) -> HdispW<'_, DpiHCfg0Spec> {
        HdispW::new(self, 16)
    }
}
...
pub struct DpiHCfg0Spec;
impl crate::RegisterSpec for DpiHCfg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dpi_h_cfg0::R`](R) reader structure"]
impl crate::Readable for DpiHCfg0Spec {}
#[doc = "`write(|w| ..)` method takes [`dpi_h_cfg0::W`](W) writer structure"]
impl crate::Writable for DpiHCfg0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DPI_H_CFG0 to value 0x0280_0320"]
impl crate::Resettable for DpiHCfg0Spec {

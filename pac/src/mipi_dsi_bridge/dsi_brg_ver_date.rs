...
pub type R = crate::R<DsiBrgVerDateSpec>;
#[doc = "Register `DSI_BRG_VER_DATE` writer"]
pub type W = crate::W<DsiBrgVerDateSpec>;
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn val(&mut self) -> ValW<'_, DsiBrgVerDateSpec> {
        ValW::new(self, 0)
    }
}
...
pub struct DsiBrgVerDateSpec;
impl crate::RegisterSpec for DsiBrgVerDateSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dsi_brg_ver_date::R`](R) reader structure"]
impl crate::Readable for DsiBrgVerDateSpec {}
#[doc = "`write(|w| ..)` method takes [`dsi_brg_ver_date::W`](W) writer structure"]
impl crate::Writable for DsiBrgVerDateSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DSI_BRG_VER_DATE to value 0"]
impl crate::Resettable for DsiBrgVerDateSpec {}

...
pub type R = crate::R<RawBufAlmostEmptyThrdSpec>;
#[doc = "Register `RAW_BUF_ALMOST_EMPTY_THRD` writer"]
pub type W = crate::W<RawBufAlmostEmptyThrdSpec>;
...
pub type DsiRawBufAlmostEmptyThrdR = crate::FieldReader<u16>;
...
pub type DsiRawBufAlmostEmptyThrdW<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
impl R {
    #[doc = "Bits 0:10 - this field configures the fifo almost empty threshold, is valid only when dmac as flow controller"]
    #[inline(always)]
    pub fn dsi_raw_buf_almost_empty_thrd(&self) -> DsiRawBufAlmostEmptyThrdR {
        DsiRawBufAlmostEmptyThrdR::new((self.bits & 0x07ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:10 - this field configures the fifo almost empty threshold, is valid only when dmac as flow controller"]
    ...
    pub fn dsi_raw_buf_almost_empty_thrd(
        &mut self,
    ) -> DsiRawBufAlmostEmptyThrdW<'_, RawBufAlmostEmptyThrdSpec> {
        DsiRawBufAlmostEmptyThrdW::new(self, 0)
    }
}
...
pub struct RawBufAlmostEmptyThrdSpec;
impl crate::RegisterSpec for RawBufAlmostEmptyThrdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`raw_buf_almost_empty_thrd::R`](R) reader structure"]
impl crate::Readable for RawBufAlmostEmptyThrdSpec {}
#[doc = "`write(|w| ..)` method takes [`raw_buf_almost_empty_thrd::W`](W) writer structure"]
impl crate::Writable for RawBufAlmostEmptyThrdSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RAW_BUF_ALMOST_EMPTY_THRD to value 0x0200"]
impl crate::Resettable for RawBufAlmostEmptyThrdSpec {

...
pub type R = crate::R<RawBufCreditCtlSpec>;
#[doc = "Register `RAW_BUF_CREDIT_CTL` writer"]
pub type W = crate::W<RawBufCreditCtlSpec>;
...
pub type CreditThrdR = crate::FieldReader<u16>;
...
pub type CreditThrdW<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
...
pub type CreditBurstThrdR = crate::FieldReader<u16>;
...
pub type CreditBurstThrdW<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
...
pub type CreditResetR = crate::BitReader;
...
pub type CreditResetW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn credit_thrd(&self) -> CreditThrdR {
        CreditThrdR::new((self.bits & 0x7fff) as u16)
    }
    ...
    #[inline(always)]
    pub fn credit_burst_thrd(&self) -> CreditBurstThrdR {
        CreditBurstThrdR::new(((self.bits >> 16) & 0x7fff) as u16)
    }
    #[doc = "Bit 31 - this bit configures internal credit cnt clear, 0: non, 1: reset. valid only when dsi_bridge as flow controller"]
    #[inline(always)]
    pub fn credit_reset(&self) -> CreditResetR {
        CreditResetR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:14 - this field configures the threshold whether dsi_bridge fifo can receive one more 64-bit, valid only when dsi_bridge as flow controller"]
    #[inline(always)]
    pub fn credit_thrd(&mut self) -> CreditThrdW<'_, RawBufCreditCtlSpec> {
        CreditThrdW::new(self, 0)
    }
    #[doc = "Bits 16:30 - this field configures the threshold whether dsi_bridge fifo can receive one more dma burst, valid only when dsi_bridge as flow controller"]
    #[inline(always)]
    pub fn credit_burst_thrd(&mut self) -> CreditBurstThrdW<'_, RawBufCreditCtlSpec> {
        CreditBurstThrdW::new(self, 16)
    }
    #[doc = "Bit 31 - this bit configures internal credit cnt clear, 0: non, 1: reset. valid only when dsi_bridge as flow controller"]
    #[inline(always)]
    pub fn credit_reset(&mut self) -> CreditResetW<'_, RawBufCreditCtlSpec> {
        CreditResetW::new(self, 31)
    }
}
...
pub struct RawBufCreditCtlSpec;
impl crate::RegisterSpec for RawBufCreditCtlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`raw_buf_credit_ctl::R`](R) reader structure"]
impl crate::Readable for RawBufCreditCtlSpec {}
#[doc = "`write(|w| ..)` method takes [`raw_buf_credit_ctl::W`](W) writer structure"]
impl crate::Writable for RawBufCreditCtlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RAW_BUF_CREDIT_CTL to value 0x0320_0400"]
impl crate::Resettable for RawBufCreditCtlSpec {

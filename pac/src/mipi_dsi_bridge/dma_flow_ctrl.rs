...
pub type R = crate::R<DmaFlowCtrlSpec>;
#[doc = "Register `DMA_FLOW_CTRL` writer"]
pub type W = crate::W<DmaFlowCtrlSpec>;
...
pub type DsiDmaFlowControllerR = crate::BitReader;
...
pub type DsiDmaFlowControllerW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DmaFlowMultiblkNumR = crate::FieldReader;
...
pub type DmaFlowMultiblkNumW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bit 0 - this bit configures the flow controller, 0: dmac as flow controller, 1:dsi_bridge as flow controller"]
    #[inline(always)]
    pub fn dsi_dma_flow_controller(&self) -> DsiDmaFlowControllerR {
        DsiDmaFlowControllerR::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 4:7 - this field configures the num of blocks when multi-blk is enable and dmac as flow controller"]
    #[inline(always)]
    pub fn dma_flow_multiblk_num(&self) -> DmaFlowMultiblkNumR {
        DmaFlowMultiblkNumR::new(((self.bits >> 4) & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - this bit configures the flow controller, 0: dmac as flow controller, 1:dsi_bridge as flow controller"]
    #[inline(always)]
    pub fn dsi_dma_flow_controller(&mut self) -> DsiDmaFlowControllerW<'_, DmaFlowCtrlSpec> {
        DsiDmaFlowControllerW::new(self, 0)
    }
    #[doc = "Bits 4:7 - this field configures the num of blocks when multi-blk is enable and dmac as flow controller"]
    #[inline(always)]
    pub fn dma_flow_multiblk_num(&mut self) -> DmaFlowMultiblkNumW<'_, DmaFlowCtrlSpec> {
        DmaFlowMultiblkNumW::new(self, 4)
    }
}
...
pub struct DmaFlowCtrlSpec;
impl crate::RegisterSpec for DmaFlowCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_flow_ctrl::R`](R) reader structure"]
impl crate::Readable for DmaFlowCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`dma_flow_ctrl::W`](W) writer structure"]
impl crate::Writable for DmaFlowCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DMA_FLOW_CTRL to value 0x11"]
impl crate::Resettable for DmaFlowCtrlSpec {

...
pub type ScanDoneW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `DONE` writer - need_des"]
pub type DoneW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `ACTIVE` writer - need_des"]
pub type ActiveW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `INACTIVE` writer - need_des"]
pub type InactiveW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type ApproachLoopDoneW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `BASELINE_UPDATE` writer - need_des"]
pub type BaselineUpdateW<'a, REG> = crate::BitWriter1C<'a, REG>;
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn scan_done(&mut self) -> ScanDoneW<'_, IntClrSpec> {
    ...
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn active(&mut self) -> ActiveW<'_, IntClrSpec> {
        ActiveW::new(self, 2)
    }
    #[doc = "Bit 3 - need_des"]
    #[inline(always)]
    pub fn inactive(&mut self) -> InactiveW<'_, IntClrSpec> {
        InactiveW::new(self, 3)
    }
    #[doc = "Bit 4 - need_des"]
    #[inline(always)]
    pub fn timeout(&mut self) -> TimeoutW<'_, IntClrSpec> {
        TimeoutW::new(self, 4)
    }
    #[doc = "Bit 5 - need_des"]
    #[inline(always)]
    pub fn approach_loop_done(&mut self) -> ApproachLoopDoneW<'_, IntClrSpec> {
        ApproachLoopDoneW::new(self, 5)
    }
    #[doc = "Bit 6 - need_des"]
    #[inline(always)]
    pub fn baseline_update(&mut self) -> BaselineUpdateW<'_, IntClrSpec> {

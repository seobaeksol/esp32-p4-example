...
pub type R = crate::R<RxStartCfgSpec>;
#[doc = "Register `RX_START_CFG` writer"]
pub type W = crate::W<RxStartCfgSpec>;
...
impl R {
    ...
    pub fn rx_start(&self) -> RxStartR {
        RxStartR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 31 - Write 1 to start rx data sampling."]
    #[inline(always)]
    pub fn rx_start(&mut self) -> RxStartW<'_, RxStartCfgSpec> {
        RxStartW::new(self, 31)
    }
}
...
pub struct RxStartCfgSpec;
impl crate::RegisterSpec for RxStartCfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rx_start_cfg::R`](R) reader structure"]
impl crate::Readable for RxStartCfgSpec {}
#[doc = "`write(|w| ..)` method takes [`rx_start_cfg::W`](W) writer structure"]
impl crate::Writable for RxStartCfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RX_START_CFG to value 0"]
impl crate::Resettable for RxStartCfgSpec {}

...
pub type R = crate::R<RegdmaClkConfSpec>;
#[doc = "Register `REGDMA_CLK_CONF` writer"]
pub type W = crate::W<RegdmaClkConfSpec>;
...
impl W {
    #[doc = "Bit 0 - clock enable"]
    #[inline(always)]
    pub fn clk_en(&mut self) -> ClkEnW<'_, RegdmaClkConfSpec> {
        ClkEnW::new(self, 0)
    }
}
...
pub struct RegdmaClkConfSpec;
impl crate::RegisterSpec for RegdmaClkConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`regdma_clk_conf::R`](R) reader structure"]
impl crate::Readable for RegdmaClkConfSpec {}
#[doc = "`write(|w| ..)` method takes [`regdma_clk_conf::W`](W) writer structure"]
impl crate::Writable for RegdmaClkConfSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets REGDMA_CLK_CONF to value 0"]
impl crate::Resettable for RegdmaClkConfSpec {}

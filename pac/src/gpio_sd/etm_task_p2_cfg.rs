...
pub type R = crate::R<EtmTaskP2CfgSpec>;
#[doc = "Register `ETM_TASK_P2_CFG` writer"]
pub type W = crate::W<EtmTaskP2CfgSpec>;
...
impl W {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO8_EN` field.</div>"]
    #[inline(always)]
    pub fn gpio_en(&mut self, n: u8) -> GpioEnW<'_, EtmTaskP2CfgSpec> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[doc = "Bit 0 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio8_en(&mut self) -> GpioEnW<'_, EtmTaskP2CfgSpec> {
        GpioEnW::new(self, 0)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio9_en(&mut self) -> GpioEnW<'_, EtmTaskP2CfgSpec> {
        GpioEnW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio10_en(&mut self) -> GpioEnW<'_, EtmTaskP2CfgSpec> {
        GpioEnW::new(self, 16)
    }
    #[doc = "Bit 24 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio11_en(&mut self) -> GpioEnW<'_, EtmTaskP2CfgSpec> {
        GpioEnW::new(self, 24)
    }
    #[doc = "GPIO choose a etm task channel."]
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO8_SEL` field.</div>"]
    #[inline(always)]
    pub fn gpio_sel(&mut self, n: u8) -> GpioSelW<'_, EtmTaskP2CfgSpec> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[doc = "Bits 1:3 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio8_sel(&mut self) -> GpioSelW<'_, EtmTaskP2CfgSpec> {
        GpioSelW::new(self, 1)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio9_sel(&mut self) -> GpioSelW<'_, EtmTaskP2CfgSpec> {
        GpioSelW::new(self, 9)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio10_sel(&mut self) -> GpioSelW<'_, EtmTaskP2CfgSpec> {
        GpioSelW::new(self, 17)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio11_sel(&mut self) -> GpioSelW<'_, EtmTaskP2CfgSpec> {
...
pub struct EtmTaskP2CfgSpec;
impl crate::RegisterSpec for EtmTaskP2CfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`etm_task_p2_cfg::R`](R) reader structure"]
impl crate::Readable for EtmTaskP2CfgSpec {}
#[doc = "`write(|w| ..)` method takes [`etm_task_p2_cfg::W`](W) writer structure"]
impl crate::Writable for EtmTaskP2CfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ETM_TASK_P2_CFG to value 0"]
impl crate::Resettable for EtmTaskP2CfgSpec {}

...
pub type R = crate::R<EtmTaskP8CfgSpec>;
#[doc = "Register `ETM_TASK_P8_CFG` writer"]
pub type W = crate::W<EtmTaskP8CfgSpec>;
...
impl W {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO32_EN` field.</div>"]
    #[inline(always)]
    pub fn gpio_en(&mut self, n: u8) -> GpioEnW<'_, EtmTaskP8CfgSpec> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[doc = "Bit 0 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio32_en(&mut self) -> GpioEnW<'_, EtmTaskP8CfgSpec> {
        GpioEnW::new(self, 0)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio33_en(&mut self) -> GpioEnW<'_, EtmTaskP8CfgSpec> {
        GpioEnW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio34_en(&mut self) -> GpioEnW<'_, EtmTaskP8CfgSpec> {
        GpioEnW::new(self, 16)
    }
    #[doc = "Bit 24 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio35_en(&mut self) -> GpioEnW<'_, EtmTaskP8CfgSpec> {
        GpioEnW::new(self, 24)
    }
    #[doc = "GPIO choose a etm task channel."]
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO32_SEL` field.</div>"]
    #[inline(always)]
    pub fn gpio_sel(&mut self, n: u8) -> GpioSelW<'_, EtmTaskP8CfgSpec> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[doc = "Bits 1:3 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio32_sel(&mut self) -> GpioSelW<'_, EtmTaskP8CfgSpec> {
        GpioSelW::new(self, 1)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio33_sel(&mut self) -> GpioSelW<'_, EtmTaskP8CfgSpec> {
        GpioSelW::new(self, 9)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio34_sel(&mut self) -> GpioSelW<'_, EtmTaskP8CfgSpec> {
        GpioSelW::new(self, 17)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio35_sel(&mut self) -> GpioSelW<'_, EtmTaskP8CfgSpec> {
...
pub struct EtmTaskP8CfgSpec;
impl crate::RegisterSpec for EtmTaskP8CfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`etm_task_p8_cfg::R`](R) reader structure"]
impl crate::Readable for EtmTaskP8CfgSpec {}
#[doc = "`write(|w| ..)` method takes [`etm_task_p8_cfg::W`](W) writer structure"]
impl crate::Writable for EtmTaskP8CfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ETM_TASK_P8_CFG to value 0"]
impl crate::Resettable for EtmTaskP8CfgSpec {}

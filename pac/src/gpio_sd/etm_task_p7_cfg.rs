...
pub type R = crate::R<EtmTaskP7CfgSpec>;
#[doc = "Register `ETM_TASK_P7_CFG` writer"]
pub type W = crate::W<EtmTaskP7CfgSpec>;
...
impl W {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO28_EN` field.</div>"]
    #[inline(always)]
    pub fn gpio_en(&mut self, n: u8) -> GpioEnW<'_, EtmTaskP7CfgSpec> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[doc = "Bit 0 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio28_en(&mut self) -> GpioEnW<'_, EtmTaskP7CfgSpec> {
        GpioEnW::new(self, 0)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio29_en(&mut self) -> GpioEnW<'_, EtmTaskP7CfgSpec> {
        GpioEnW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio30_en(&mut self) -> GpioEnW<'_, EtmTaskP7CfgSpec> {
        GpioEnW::new(self, 16)
    }
    #[doc = "Bit 24 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio31_en(&mut self) -> GpioEnW<'_, EtmTaskP7CfgSpec> {
        GpioEnW::new(self, 24)
    }
    #[doc = "GPIO choose a etm task channel."]
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO28_SEL` field.</div>"]
    #[inline(always)]
    pub fn gpio_sel(&mut self, n: u8) -> GpioSelW<'_, EtmTaskP7CfgSpec> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[doc = "Bits 1:3 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio28_sel(&mut self) -> GpioSelW<'_, EtmTaskP7CfgSpec> {
        GpioSelW::new(self, 1)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio29_sel(&mut self) -> GpioSelW<'_, EtmTaskP7CfgSpec> {
        GpioSelW::new(self, 9)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio30_sel(&mut self) -> GpioSelW<'_, EtmTaskP7CfgSpec> {
        GpioSelW::new(self, 17)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio31_sel(&mut self) -> GpioSelW<'_, EtmTaskP7CfgSpec> {
...
pub struct EtmTaskP7CfgSpec;
impl crate::RegisterSpec for EtmTaskP7CfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`etm_task_p7_cfg::R`](R) reader structure"]
impl crate::Readable for EtmTaskP7CfgSpec {}
#[doc = "`write(|w| ..)` method takes [`etm_task_p7_cfg::W`](W) writer structure"]
impl crate::Writable for EtmTaskP7CfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ETM_TASK_P7_CFG to value 0"]
impl crate::Resettable for EtmTaskP7CfgSpec {}

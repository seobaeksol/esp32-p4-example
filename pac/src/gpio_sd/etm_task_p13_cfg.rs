...
pub type R = crate::R<EtmTaskP13CfgSpec>;
#[doc = "Register `ETM_TASK_P13_CFG` writer"]
pub type W = crate::W<EtmTaskP13CfgSpec>;
...
impl W {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO52_EN` field.</div>"]
    #[inline(always)]
    pub fn gpio_en(&mut self, n: u8) -> GpioEnW<'_, EtmTaskP13CfgSpec> {
        #[allow(clippy::no_effect)]
        [(); 3][n as usize];
    ...
    #[doc = "Bit 0 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio52_en(&mut self) -> GpioEnW<'_, EtmTaskP13CfgSpec> {
        GpioEnW::new(self, 0)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio53_en(&mut self) -> GpioEnW<'_, EtmTaskP13CfgSpec> {
        GpioEnW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio54_en(&mut self) -> GpioEnW<'_, EtmTaskP13CfgSpec> {
        GpioEnW::new(self, 16)
    }
    #[doc = "GPIO choose a etm task channel."]
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO52_SEL` field.</div>"]
    #[inline(always)]
    pub fn gpio_sel(&mut self, n: u8) -> GpioSelW<'_, EtmTaskP13CfgSpec> {
        #[allow(clippy::no_effect)]
        [(); 3][n as usize];
    ...
    #[doc = "Bits 1:3 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio52_sel(&mut self) -> GpioSelW<'_, EtmTaskP13CfgSpec> {
        GpioSelW::new(self, 1)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio53_sel(&mut self) -> GpioSelW<'_, EtmTaskP13CfgSpec> {
        GpioSelW::new(self, 9)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio54_sel(&mut self) -> GpioSelW<'_, EtmTaskP13CfgSpec> {
...
pub struct EtmTaskP13CfgSpec;
impl crate::RegisterSpec for EtmTaskP13CfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`etm_task_p13_cfg::R`](R) reader structure"]
impl crate::Readable for EtmTaskP13CfgSpec {}
#[doc = "`write(|w| ..)` method takes [`etm_task_p13_cfg::W`](W) writer structure"]
impl crate::Writable for EtmTaskP13CfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ETM_TASK_P13_CFG to value 0"]
impl crate::Resettable for EtmTaskP13CfgSpec {}

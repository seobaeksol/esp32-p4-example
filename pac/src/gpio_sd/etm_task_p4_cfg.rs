...
pub type R = crate::R<EtmTaskP4CfgSpec>;
#[doc = "Register `ETM_TASK_P4_CFG` writer"]
pub type W = crate::W<EtmTaskP4CfgSpec>;
...
impl W {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO16_EN` field.</div>"]
    #[inline(always)]
    pub fn gpio_en(&mut self, n: u8) -> GpioEnW<'_, EtmTaskP4CfgSpec> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[doc = "Bit 0 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio16_en(&mut self) -> GpioEnW<'_, EtmTaskP4CfgSpec> {
        GpioEnW::new(self, 0)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio17_en(&mut self) -> GpioEnW<'_, EtmTaskP4CfgSpec> {
        GpioEnW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio18_en(&mut self) -> GpioEnW<'_, EtmTaskP4CfgSpec> {
        GpioEnW::new(self, 16)
    }
    #[doc = "Bit 24 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio19_en(&mut self) -> GpioEnW<'_, EtmTaskP4CfgSpec> {
        GpioEnW::new(self, 24)
    }
    #[doc = "GPIO choose a etm task channel."]
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO16_SEL` field.</div>"]
    #[inline(always)]
    pub fn gpio_sel(&mut self, n: u8) -> GpioSelW<'_, EtmTaskP4CfgSpec> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[doc = "Bits 1:3 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio16_sel(&mut self) -> GpioSelW<'_, EtmTaskP4CfgSpec> {
        GpioSelW::new(self, 1)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio17_sel(&mut self) -> GpioSelW<'_, EtmTaskP4CfgSpec> {
        GpioSelW::new(self, 9)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio18_sel(&mut self) -> GpioSelW<'_, EtmTaskP4CfgSpec> {
        GpioSelW::new(self, 17)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio19_sel(&mut self) -> GpioSelW<'_, EtmTaskP4CfgSpec> {
...
pub struct EtmTaskP4CfgSpec;
impl crate::RegisterSpec for EtmTaskP4CfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`etm_task_p4_cfg::R`](R) reader structure"]
impl crate::Readable for EtmTaskP4CfgSpec {}
#[doc = "`write(|w| ..)` method takes [`etm_task_p4_cfg::W`](W) writer structure"]
impl crate::Writable for EtmTaskP4CfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ETM_TASK_P4_CFG to value 0"]
impl crate::Resettable for EtmTaskP4CfgSpec {}

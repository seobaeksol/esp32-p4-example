...
impl W {
    #[doc = "Bits 0:7 - This field is used to configure the duty cycle of sigma delta modulation output."]
    #[inline(always)]
    pub fn in_(&mut self) -> InW<'_, SigmadeltaSpec> {
        InW::new(self, 0)
    }
    #[doc = "Bits 8:15 - This field is used to set a divider value to divide APB clock."]
    #[inline(always)]
    pub fn prescale(&mut self) -> PrescaleW<'_, SigmadeltaSpec> {
...
pub struct SigmadeltaSpec;
impl crate::RegisterSpec for SigmadeltaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sigmadelta::R`](R) reader structure"]
impl crate::Readable for SigmadeltaSpec {}
#[doc = "`write(|w| ..)` method takes [`sigmadelta::W`](W) writer structure"]
impl crate::Writable for SigmadeltaSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SIGMADELTA%s to value 0xff00"]
impl crate::Resettable for SigmadeltaSpec {

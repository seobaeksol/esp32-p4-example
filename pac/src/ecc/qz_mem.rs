...
pub type R = crate::R<QzMemSpec>;
#[doc = "Register `QZ_MEM%s` writer"]
pub type W = crate::W<QzMemSpec>;
...
pub struct QzMemSpec;
impl crate::RegisterSpec for QzMemSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qz_mem::R`](R) reader structure"]
impl crate::Readable for QzMemSpec {}
#[doc = "`write(|w| ..)` method takes [`qz_mem::W`](W) writer structure"]
impl crate::Writable for QzMemSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets QZ_MEM%s to value 0"]
impl crate::Resettable for QzMemSpec {}

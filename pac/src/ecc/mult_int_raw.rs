...
pub type R = crate::R<MultIntRawSpec>;
...
pub struct MultIntRawSpec;
impl crate::RegisterSpec for MultIntRawSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mult_int_raw::R`](R) reader structure"]
impl crate::Readable for MultIntRawSpec {}
#[doc = "`reset()` method sets MULT_INT_RAW to value 0"]
impl crate::Resettable for MultIntRawSpec {}

...
pub type R = crate::R<MultIntStSpec>;
...
pub struct MultIntStSpec;
impl crate::RegisterSpec for MultIntStSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mult_int_st::R`](R) reader structure"]
impl crate::Readable for MultIntStSpec {}
#[doc = "`reset()` method sets MULT_INT_ST to value 0"]
impl crate::Resettable for MultIntStSpec {}

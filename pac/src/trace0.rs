...
pub struct RegisterBlock {
    mem_start_addr: MemStartAddr,
    mem_end_addr: MemEndAddr,
    mem_current_addr: MemCurrentAddr,
    mem_addr_update: MemAddrUpdate,
    ...
    filter_match_control: FilterMatchControl,
    filter_comparator_control: FilterComparatorControl,
    filter_p_comparator_match: FilterPComparatorMatch,
    filter_s_comparator_match: FilterSComparatorMatch,
    resync_prolonged: ResyncProlonged,
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn mem_start_addr(&self) -> &MemStartAddr {
        &self.mem_start_addr
    }
    #[doc = "0x04 - mem end addr"]
    #[inline(always)]
    pub const fn mem_end_addr(&self) -> &MemEndAddr {
        &self.mem_end_addr
    }
    #[doc = "0x08 - mem current addr"]
    #[inline(always)]
    pub const fn mem_current_addr(&self) -> &MemCurrentAddr {
        &self.mem_current_addr
    }
    #[doc = "0x0c - mem addr update"]
    #[inline(always)]
    pub const fn mem_addr_update(&self) -> &MemAddrUpdate {
    ...
    #[inline(always)]
    pub const fn intr_ena(&self) -> &IntrEna {
        &self.intr_ena
    }
    #[doc = "0x18 - interrupt status register"]
    #[inline(always)]
    pub const fn intr_raw(&self) -> &IntrRaw {
        &self.intr_raw
    }
    #[doc = "0x1c - interrupt clear register"]
    #[inline(always)]
    pub const fn intr_clr(&self) -> &IntrClr {
        &self.intr_clr
    }
    ...
    #[inline(always)]
    pub const fn filter_control(&self) -> &FilterControl {
        &self.filter_control
    }
    #[doc = "0x2c - filter match control register"]
    #[inline(always)]
    pub const fn filter_match_control(&self) -> &FilterMatchControl {
        &self.filter_match_control
    }
    #[doc = "0x30 - filter comparator match control register"]
    #[inline(always)]
    pub const fn filter_comparator_control(&self) -> &FilterComparatorControl {
        &self.filter_comparator_control
    }
    #[doc = "0x34 - primary comparator match value"]
    #[inline(always)]
    pub const fn filter_p_comparator_match(&self) -> &FilterPComparatorMatch {
        &self.filter_p_comparator_match
    }
    #[doc = "0x38 - secondary comparator match value"]
    #[inline(always)]
    pub const fn filter_s_comparator_match(&self) -> &FilterSComparatorMatch {
        &self.filter_s_comparator_match
    }
    #[doc = "0x3c - resync configuration register"]
    #[inline(always)]
    pub const fn resync_prolonged(&self) -> &ResyncProlonged {
        &self.resync_prolonged
    }
    #[doc = "0x40 - AHB config register"]
    #[inline(always)]
    pub const fn ahb_config(&self) -> &AhbConfig {
        &self.ahb_config
    }
...
#[doc(alias = "MEM_START_ADDR")]
pub type MemStartAddr = crate::Reg<mem_start_addr::MemStartAddrSpec>;
#[doc = "mem start addr"]
...
#[doc(alias = "MEM_END_ADDR")]
pub type MemEndAddr = crate::Reg<mem_end_addr::MemEndAddrSpec>;
#[doc = "mem end addr"]
...
#[doc(alias = "MEM_CURRENT_ADDR")]
pub type MemCurrentAddr = crate::Reg<mem_current_addr::MemCurrentAddrSpec>;
...
#[doc(alias = "MEM_ADDR_UPDATE")]
pub type MemAddrUpdate = crate::Reg<mem_addr_update::MemAddrUpdateSpec>;
#[doc = "mem addr update"]
...
#[doc(alias = "INTR_ENA")]
pub type IntrEna = crate::Reg<intr_ena::IntrEnaSpec>;
...
#[doc(alias = "INTR_RAW")]
pub type IntrRaw = crate::Reg<intr_raw::IntrRawSpec>;
...
#[doc(alias = "INTR_CLR")]
pub type IntrClr = crate::Reg<intr_clr::IntrClrSpec>;
...
#[doc(alias = "FILTER_CONTROL")]
pub type FilterControl = crate::Reg<filter_control::FilterControlSpec>;
...
#[doc(alias = "FILTER_MATCH_CONTROL")]
pub type FilterMatchControl = crate::Reg<filter_match_control::FilterMatchControlSpec>;
...
#[doc(alias = "FILTER_COMPARATOR_CONTROL")]
pub type FilterComparatorControl =
    crate::Reg<filter_comparator_control::FilterComparatorControlSpec>;
...
#[doc(alias = "FILTER_P_COMPARATOR_MATCH")]
pub type FilterPComparatorMatch = crate::Reg<filter_p_comparator_match::FilterPComparatorMatchSpec>;
...
#[doc(alias = "FILTER_S_COMPARATOR_MATCH")]
pub type FilterSComparatorMatch = crate::Reg<filter_s_comparator_match::FilterSComparatorMatchSpec>;
...
#[doc(alias = "RESYNC_PROLONGED")]
pub type ResyncProlonged = crate::Reg<resync_prolonged::ResyncProlongedSpec>;
...
#[doc(alias = "AHB_CONFIG")]
pub type AhbConfig = crate::Reg<ahb_config::AhbConfigSpec>;
